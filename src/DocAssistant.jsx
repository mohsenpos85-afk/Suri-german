...
"fr":{"title":"Assistant à la documentation","subtitle":"Scanner, comprendre et analyser des documents.","ob1t":"Comprendre tout document","ob1b":"Lettres officielles, formulaires, contrats, factures — l'IA explique ce qu'ils signifient, pas seulement une traduction.","ob2t":"Scanner ou importer","ob2b":"Prenez une photo ou choisissez un fichier. Aucune sélection de type de document nécessaire — elle est reconnue automatiquement.","ob3t":"Demandez n'importe quoi","ob3b":"Discutez avec l'assistant au sujet de votre document : délais, prochaines étapes ou rédiger une réponse.","skip":"Sauter","next":"Continuer","start":"Commencez","takePhoto":"Prenez une photo","importFile":"Importer un fichier","homeHint":"Photo, PDF ou image d'un document","recent":"Récent","noRecent":"Vos documents numérisés apparaîtront ici.","analysing":"Analyse du document...","analysingHint":"Lecture et compréhension de votre document","detectedLang":"Langue","docType":"Type de document","confidence":"Confiance","s_summary":"Résumé","s_purpose":"Pourquoi ai-je reçu ça?","s_info":"Informations importantes","s_todo":"Que dois-je faire?","s_warn":"Avertissements importants","s_detail":"Explication détaillée","s_faq":"Questions fréquemment posées","s_next":"Prochaines étapes suggérées","s_trans":"Texte original","showOriginal":"Original: ANGLAIS","showApp":"Expliquée","quickTitle":"Actions rapides","qa_reply":"Réponse à cette lettre","qa_summary":"Résumé","qa_simple":"Expliquez simplement","qa_checklist":"Créer une liste de contrôle","qa_dates":"Dates d'extraction","qa_addr":"Extraire les adresses","qa_phone":"Extraire les numéros de téléphone","qa_email":"Extraire les courriels","qa_iban":"Extraits d'IBAN","qa_copy":"Copier le texte","qa_share":"Partager","chatTitle":"Demandez-nous ce document","chatPlaceholder":"Demandez quelque chose sur ce document...","disclaimer":"Cette explication est destinée à vous aider à comprendre le document. Il ne remplace pas les conseils juridiques, fiscaux ou médicaux professionnels.","newScan":"Nouveau scan","back":"Précédent","errTitle":"Quelque chose a mal tourné","signIn":"Veuillez vous connecter pour utiliser l'assistant de document.","retry":"Essayez encore","copied":"Copied","thinking":"Penser..."}};
...
"fr":{"pv_title":"Confidentialité et consentement","pv_b1":"Pour l'analyser, votre document est envoyé en toute sécurité au service AI.","pv_b2":"Il est utilisé uniquement pour créer votre explication — jamais pour la publicité.","pv_b3":"Si vous n'utilisez que des documents qui vous appartiennent ou que vous êtes autorisé à utiliser.","pv_accept":"Je comprends et continue","pv_cancel":"Annuler","pv_foot":"Cela ne remplace pas les conseils juridiques, fiscaux ou médicaux professionnels."}};
...
"fr":{"qa_pdf":"Exporter en format PDF","qa_share":"Partager","qa_calendar":"Ajouter à l'agenda","noDates":"Aucune date trouvée","shared":"Partage","openRecent":"Ouvrir"}};
...
"fr":{"pv_secure":"Pour l'analyser, votre document est envoyé en toute sécurité à un fournisseur d'IA (par exemple Anthropic, USA).","pv_purpose":"Il est utilisé uniquement pour créer votre explication — pas pour la publicité ou la formation de modèle.","pv_local":"Les résultats sont stockés uniquement sur votre appareil (Récent) et vous pouvez les supprimer à tout moment.","pv_ai":"L'IA peut faire des erreurs. Ceci est informationnel seulement, pas juridique, fiscal ou médical conseil.","pv_own":"Si vous n'utilisez que des documents qui vous appartiennent ou que vous êtes autorisé à utiliser.","pv_check":"Je consens à ce que mon document — qui peut contenir des données sensibles (par exemple, santé) — soit traité par le service de l'IA, y compris le transfert aux États-Unis.","pv_privacy":"Politique de confidentialité","pv_impressum":"Empreinte"}};
...
"es":{"title":"Cámara","hint":"Colocar el documento dentro del marco","capture":"Toma una foto.","cancel":"Cancelar","flip":"Cambiar la cámara","unavailable":"El acceso a la cámara no está disponible en este navegador.","denied":"Se denegó el permiso de cámara. Permita el acceso a la cámara en la configuración del navegador e inténtelo de nuevo.","failed":"La cámara no se pudo iniciar. Cierre otras aplicaciones con la cámara e inténtelo de nuevo."},"fr":{"title":"Caméra","hint":"Placer le document à l'intérieur du cadre","capture":"Prendre une photo","cancel":"Annuler","flip":"Interrupteur de la caméra","unavailable":"L'accès à la caméra n'est pas disponible dans ce navigateur.","denied":"La permission de la caméra a été refusée. Autoriser l'accès de la caméra dans les paramètres du navigateur et essayer à nouveau.","failed":"La caméra ne pouvait pas être démarrée. Fermez d'autres applications en utilisant la caméra et essayez à nouveau."}};
