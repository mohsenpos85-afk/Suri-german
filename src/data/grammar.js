export const GRAMMAR = {
  A1: [
    ...
    { de: "Negation: nicht / kein", ku: "نەرێ کردن (nicht/kein)", icon: "⊘",
      ...
      ex: [ { de: "Ich verstehe nicht.", ku: "تێناگەم.", tr: "Anlamıyorum.", en: "I don't understand.", ar: "لا أفهم.", uk: "Я не розумію.", fa: "من نمی‌فهمم." }, { de: "Ich habe kein Geld.", ku: "پارەم نییە.", tr: "Param yok.", en: "I have no money.", ar: "ليس لدي مال.", uk: "У мене немає грошей.", fa: "من پول ندارم." }, { de: "Das ist nicht richtig.", ku: "ئەمە ڕاست نییە.", tr: "Bu doğru değil.", en: "That is not correct.", ar: "هذا ليس صحيحا.", uk: "Це неправильно.", fa: "این درست نیست." }, { de: "Er ist nicht hier.", ku: "ئەو لێرە نییە.", tr: "O burada değil.", en: "He is not here.", ar: "هو ليس هنا.", uk: "Його тут немає.", fa: "او اینجا نیست." }, { de: "Ich habe keine Zeit.", ku: "کاتم نییە.", tr: "Zamanım yok.", en: "I have no time.", ar: "ليس لدي وقت.", uk: "У мене немає часу.", fa: "من وقت ندارم." }, { de: "Das macht keinen Spaß.", ku: "ئەمە خۆش نییە.", tr: "Bu eğlenceli değil.", en: "That's not fun.", ar: "هذا ليس ممتعا.", uk: "Це не весело.", fa: "این اصلاً لذت‌بخش نیست." } ] },
    { de: "W-Fragen", ku: "پرسیاری W", icon: "?",
      ...
      ex: [ { de: "Wo wohnst du?", ku: "لەکوێ نیشتەجێیت؟", tr: "Nerede yaşıyorsun?", en: "Where do you live?", ar: "أين تسكن؟", uk: "Де ти живеш?", fa: "کجا زندگی می‌کنی؟" }, { de: "Was machst du?", ku: "چی دەکەیت؟", tr: "Ne yapıyorsun?", en: "What are you doing?", ar: "ماذا تفعل؟", uk: "Що ти робиш?", fa: "چه کار می‌کنی؟" }, { de: "Wann kommst du?", ku: "کەی دێیت؟", tr: "Ne zaman geliyorsun?", en: "When are you coming?", ar: "متى ستأتي؟", uk: "Коли ти прийдеш?", fa: "کِی می‌آیی؟" }, { de: "Wer ist das?", ku: "ئەمە کێیە؟", tr: "Bu kim?", en: "Who is that?", ar: "من هذا؟", uk: "Хто це?", fa: "این کیست؟" }, { de: "Wie heißt du?", ku: "ناوت چییە؟", tr: "Adın ne?", en: "What is your name?", ar: "ما اسمك؟", uk: "Як тебе звати?", fa: "اسمت چیست؟" }, { de: "Warum lernst du Deutsch?", ku: "بۆچی ئەڵمانی فێردەبیت؟", tr: "Neden Almanca öğreniyorsun?", en: "Why are you learning German?", ar: "لماذا تتعلم الألمانية؟", uk: "Чому ти вчиш німецьку?", fa: "چرا آلمانی یاد می‌گیری؟" } ] },
    { de: "Ja/Nein-Fragen", ku: "پرسیاری بەڵێ/نەخێر", icon: "↔",
      ...
      ex: [ { de: "Kommst du mit?", ku: "لەگەڵم دێیت؟", tr: "Benimle geliyor musun?", en: "Are you coming along?", ar: "هل ستأتي معي؟", uk: "Ти йдеш зі мною?", fa: "با من می‌آیی؟" }, { de: "Hast du Zeit?", ku: "کاتت هەیە؟", tr: "Zamanın var mı?", en: "Do you have time?", ar: "هل لديك وقت؟", uk: "У тебе є час?", fa: "وقت داری؟" }, { de: "Ist das richtig?", ku: "ئەمە ڕاستە؟", tr: "Bu doğru mu?", en: "Is that correct?", ar: "هل هذا صحيح؟", uk: "Це правильно?", fa: "این درست است؟" }, { de: "Sprichst du Englisch?", ku: "ئینگلیزی قسە دەکەیت؟", tr: "İngilizce konuşuyor musun?", en: "Do you speak English?", ar: "هل تتحدث الإنجليزية؟", uk: "Ти розмовляєш англійською?", fa: "انگلیسی صحبت می‌کنی؟" }, { de: "Magst du Tee?", ku: "حەزت لە چایە؟", tr: "Çayı sever misin?", en: "Do you like tea?", ar: "هل تحب الشاي؟", uk: "Ти любиш чай?", fa: "چای دوست داری؟" }, { de: "Wohnst du hier?", ku: "لێرە نیشتەجێیت؟", tr: "Burada mı yaşıyorsun?", en: "Do you live here?", ar: "هل تسكن هنا؟", uk: "Ти тут живеш?", fa: "اینجا زندگی می‌کنی؟" } ] },
    { de: "Satzstellung", ku: "ڕیزبەندی ڕستە", icon: "≡",
      ...
      ex: [ { de: "Ich lerne heute Deutsch.", ku: "ئەمڕۆ ئەڵمانی فێردەبم.", tr: "Bugün Almanca öğreniyorum.", en: "I am learning German today.", ar: "أتعلم الألمانية اليوم.", uk: "Сьогодні я вчу німецьку.", fa: "من امروز آلمانی یاد می‌گیرم." }, { de: "Heute lerne ich Deutsch.", ku: "ئەمڕۆ ئەڵمانی فێردەبم (کردار هێشتا جێی ٢).", tr: "Bugün Almanca öğreniyorum (fiil hâlâ 2. sırada).", en: "Today I am learning German (verb still in position 2).", ar: "اليوم أتعلم الألمانية (الفعل ما زال في الموضع الثاني).", uk: "Сьогодні я вчу німецьку (дієслово все одно на другій позиції).", fa: "امروز آلمانی یاد می‌گیرم (فعل باز هم در جایگاه دوم است)." }, { de: "Morgen gehe ich nach Hause.", ku: "سبەینێ دەچمە ماڵەوە.", tr: "Yarın eve gidiyorum.", en: "Tomorrow I am going home.", ar: "غدا سأذهب إلى البيت.", uk: "Завтра я йду додому.", fa: "فردا به خانه می‌روم." }, { de: "Am Abend sehe ich fern.", ku: "ئێوارە تەلەفزیۆن سەیر دەکەم.", tr: "Akşam televizyon izliyorum.", en: "In the evening I watch TV.", ar: "في المساء أشاهد التلفاز.", uk: "Увечері я дивлюся телевізор.", fa: "شب تلویزیون تماشا می‌کنم." }, { de: "In Bochum wohne ich.", ku: "لە بۆخوم نیشتەجێم.", tr: "Bochum'da yaşıyorum.", en: "I live in Bochum.", ar: "أسكن في بوخوم.", uk: "Я живу в Бохумі.", fa: "من در بوخوم زندگی می‌کنم." }, { de: "Jetzt esse ich.", ku: "ئێستا دەخۆم.", tr: "Şimdi yiyorum.", en: "Now I am eating.", ar: "الآن أنا آكل.", uk: "Зараз я їм.", fa: "الان غذا می‌خورم." } ] },
    { de: "Modalverben", ku: "کرداری یاریدەدەر (مۆداڵ)", icon: "◆",
      ...
      ex: [ { de: "Ich kann schwimmen.", ku: "دەتوانم مەلە بکەم.", tr: "Yüzebiliyorum.", en: "I can swim.", ar: "أستطيع السباحة.", uk: "Я вмію плавати.", fa: "من می‌توانم شنا کنم." }, { de: "Du musst lernen.", ku: "دەبێت فێربیت.", tr: "Çalışmak zorundasın.", en: "You have to study.", ar: "يجب أن تدرس.", uk: "Ти мусиш вчитися.", fa: "تو باید درس بخوانی." }, { de: "Wir wollen essen.", ku: "دەمانەوێت بخۆین.", tr: "Yemek istiyoruz.", en: "We want to eat.", ar: "نريد أن نأكل.", uk: "Ми хочемо їсти.", fa: "ما می‌خواهیم غذا بخوریم." }, { de: "Darf ich rein?", ku: "دەکرێت بێمە ژوورەوە؟", tr: "İçeri girebilir miyim?", en: "May I come in?", ar: "هل يمكنني الدخول؟", uk: "Можна мені зайти?", fa: "اجازه دارم بیایم داخل؟" }, { de: "Du sollst warten.", ku: "دەبێت چاوەڕێ بکەیت.", tr: "Beklemelisin.", en: "You should wait.", ar: "ينبغي أن تنتظر.", uk: "Ти маєш почекати.", fa: "تو باید صبر کنی." }, { de: "Ich möchte Kaffee.", ku: "قاوەم دەوێت.", tr: "Kahve istiyorum.", en: "I would like coffee.", ar: "أريد قهوة.", uk: "Я хотів би кави.", fa: "من قهوه می‌خواهم." } ] },
    { de: "Unregelmäßige Verben", ku: "کرداری ناڕێک (بنەڕەتی)", icon: "↯",
      ...
      ex: [ { de: "fahren → er fährt", ku: "لێخوڕین → ئەو لێدەخوڕێت", tr: "gitmek → o gidiyor", en: "to drive → he drives", ar: "يقود ← هو يقود", uk: "їхати → він їде", fa: "راندن ← او می‌راند" }, { de: "essen → du isst", ku: "خواردن → تۆ دەخۆیت", tr: "yemek → sen yiyorsun", en: "to eat → you eat", ar: "يأكل ← أنت تأكل", uk: "їсти → ти їси", fa: "خوردن ← تو می‌خوری" }, { de: "sehen → er sieht", ku: "بینین → ئەو دەبینێت", tr: "görmek → o görüyor", en: "to see → he sees", ar: "يرى ← هو يرى", uk: "бачити → він бачить", fa: "دیدن ← او می‌بیند" }, { de: "geben → du gibst", ku: "دان → تۆ دەدەیت", tr: "vermek → sen veriyorsun", en: "to give → you give", ar: "يعطي ← أنت تعطي", uk: "давати → ти даєш", fa: "دادن ← تو می‌دهی" }, { de: "lesen → sie liest", ku: "خوێندنەوە → ئەو دەیخوێنێتەوە", tr: "okumak → o okuyor", en: "to read → she reads", ar: "يقرأ ← هي تقرأ", uk: "читати → вона читає", fa: "خواندن ← او می‌خواند" }, { de: "schlafen → er schläft", ku: "خەوتن → ئەو دەخەوێت", tr: "uyumak → o uyuyor", en: "to sleep → he sleeps", ar: "ينام ← هو ينام", uk: "спати → він спить", fa: "خوابیدن ← او می‌خوابد" } ] },
    { de: "Trennbare Verben", ku: "کرداری لێکدراو", icon: "⇿",
      ...
      ex: [ { de: "Ich stehe um 7 auf.", ku: "کاتژمێر ٧ هەڵدەستم.", tr: "Saat 7'de kalkıyorum.", en: "I get up at 7.", ar: "أستيقظ الساعة السابعة.", uk: "Я встаю о 7-й.", fa: "من ساعت ۷ بیدار می‌شوم." }, { de: "Er kauft ein.", ku: "ئەو بازاڕ دەکات.", tr: "O alışveriş yapıyor.", en: "He goes shopping.", ar: "هو يتسوّق.", uk: "Він робить покупки.", fa: "او خرید می‌کند." }, { de: "Wir kommen an.", ku: "ئێمە دەگەین.", tr: "Biz varıyoruz.", en: "We arrive.", ar: "نحن نصل.", uk: "Ми прибуваємо.", fa: "ما می‌رسیم." }, { de: "Ruf mich an!", ku: "پەیوەندیم پێوە بکە!", tr: "Beni ara!", en: "Call me!", ar: "اتصل بي!", uk: "Зателефонуй мені!", fa: "به من زنگ بزن!" }, { de: "Der Zug fährt ab.", ku: "شەمەندەفەرەکە بەڕێدەکەوێت.", tr: "Tren kalkıyor.", en: "The train departs.", ar: "القطار يغادر.", uk: "Потяг відходить.", fa: "قطار حرکت می‌کند." }, { de: "Ich räume das Zimmer auf.", ku: "ژوورەکە ڕێک دەخەم.", tr: "Odayı toparlıyorum.", en: "I am tidying up the room.", ar: "أرتّب الغرفة.", uk: "Я прибираю кімнату.", fa: "من اتاق را مرتب می‌کنم." } ] },
    { de: "Imperativ", ku: "فەرمان", icon: "!",
      ...
      ex: [ { de: "Komm her!", ku: "وەرە ئێرە!", tr: "Buraya gel!", en: "Come here!", ar: "تعال هنا!", uk: "Іди сюди!", fa: "بیا اینجا!" }, { de: "Macht die Tür zu!", ku: "دەرگاکە دابخەن!", tr: "Kapıyı kapatın!", en: "Close the door!", ar: "أغلقوا الباب!", uk: "Зачиніть двері!", fa: "در را ببندید!" }, { de: "Warten Sie bitte!", ku: "تکایە چاوەڕێ بکەن!", tr: "Lütfen bekleyin!", en: "Please wait!", ar: "من فضلكم انتظروا!", uk: "Зачекайте, будь ласка!", fa: "لطفاً صبر کنید!" }, { de: "Iss dein Essen!", ku: "خواردنەکەت بخۆ!", tr: "Yemeğini ye!", en: "Eat your food!", ar: "كل طعامك!", uk: "Їж свою їжу!", fa: "غذایت را بخور!" }, { de: "Sei ruhig!", ku: "بێدەنگ بە!", tr: "Sessiz ol!", en: "Be quiet!", ar: "كن هادئا!", uk: "Будь тихо!", fa: "ساکت باش!" }, { de: "Hören Sie zu!", ku: "گوێ بگرن!", tr: "Dinleyin!", en: "Listen!", ar: "استمعوا!", uk: "Слухайте!", fa: "گوش کنید!" } ] },
    { de: "Präpositionen: Ort & Zeit", ku: "ئامرازی شوێن و کات", icon: "⌖",
      ...
      ex: [ { de: "Ich bin in der Schule.", ku: "لە قوتابخانەم.", tr: "Okuldayım.", en: "I am at school.", ar: "أنا في المدرسة.", uk: "Я в школі.", fa: "من در مدرسه هستم." }, { de: "Um 8 Uhr.", ku: "کاتژمێر ٨.", tr: "Saat 8.", en: "At 8 o'clock.", ar: "الساعة الثامنة.", uk: "О 8-й годині.", fa: "ساعت ۸." }, { de: "Im Sommer.", ku: "لە هاویندا.", tr: "Yazın.", en: "In summer.", ar: "في الصيف.", uk: "Влітку.", fa: "در تابستان." }, { de: "Am Montag arbeite ich.", ku: "دووشەممە کار دەکەم.", tr: "Pazartesi çalışıyorum.", en: "I work on Monday.", ar: "أعمل يوم الاثنين.", uk: "У понеділок я працюю.", fa: "روز دوشنبه کار می‌کنم." }, { de: "Das Bild ist an der Wand.", ku: "وێنەکە لەسەر دیوارەکەیە.", tr: "Resim duvardaki.", en: "The picture is on the wall.", ar: "اللوحة على الحائط.", uk: "Картина на стіні.", fa: "تابلو روی دیوار است." }, { de: "Die Tasche ist auf dem Tisch.", ku: "جانتاکە لەسەر مێزەکەیە.", tr: "Çanta masanın üzerinde.", en: "The bag is on the table.", ar: "الحقيبة على الطاولة.", uk: "Сумка на столі.", fa: "کیف روی میز است." } ] },
  ],
  A2: [
    { de: "Perfekt", ku: "کاتی ڕابردووی تەواو (Perfekt)", icon: "↩",
      ...
      ex: [ { de: "Ich habe gegessen.", ku: "خواردم.", tr: "Yedim.", en: "I have eaten.", ar: "أكلتُ.", uk: "Я поїв.", fa: "من غذا خورده‌ام." }, { de: "Wir haben gelernt.", ku: "فێربووین.", tr: "Öğrendik.", en: "We have learned.", ar: "تعلّمنا.", uk: "Ми навчилися.", fa: "ما یاد گرفته‌ایم." }, { de: "Er ist gegangen.", ku: "ئەو ڕۆیشت.", tr: "O gitti.", en: "He went.", ar: "لقد ذهب.", uk: "Він пішов.", fa: "او رفته است." }, { de: "Sie hat ein Buch gekauft.", ku: "کتێبێکی کڕی.", tr: "Bir kitap satın aldı.", en: "She bought a book.", ar: "اشترت كتابًا.", uk: "Вона купила книгу.", fa: "او یک کتاب خریده است." }, { de: "Ich bin nach Berlin gefahren.", ku: "چووم بۆ بەرلین.", tr: "Berlin'e gittim.", en: "I traveled to Berlin.", ar: "سافرتُ إلى برلين.", uk: "Я поїхав до Берліна.", fa: "من به برلین رفته‌ام." }, { de: "Hast du das gesehen?", ku: "ئەمەت بینی؟", tr: "Bunu gördün mü?", en: "Did you see that?", ar: "هل رأيت ذلك؟", uk: "Ти це бачив?", fa: "این را دیدی؟" } ] },
    { de: "Präteritum (sein, haben, Modalverben)", ku: "ڕابردووی سادە", icon: "↪",
      ...
      ex: [ { de: "Ich war krank.", ku: "نەخۆش بووم.", tr: "Hasta idim.", en: "I was sick.", ar: "كنتُ مريضًا.", uk: "Я був хворий.", fa: "من مریض بودم." }, { de: "Sie hatte Zeit.", ku: "کاتی هەبوو.", tr: "Zamanı vardı.", en: "She had time.", ar: "كان لديها وقت.", uk: "У неї був час.", fa: "او وقت داشت." }, { de: "Wir konnten nicht kommen.", ku: "نەماندەتوانی بێین.", tr: "Gelemezdik.", en: "We could not come.", ar: "لم نستطع القدوم.", uk: "Ми не могли прийти.", fa: "ما نتوانستیم بیاییم." }, { de: "Es war sehr kalt.", ku: "زۆر سارد بوو.", tr: "Çok soğuktu.", en: "It was very cold.", ar: "كان الجو باردًا جدًا.", uk: "Було дуже холодно.", fa: "هوا خیلی سرد بود." }, { de: "Er musste arbeiten.", ku: "پێویست بوو کار بکات.", tr: "Çalışmak zorundaydı.", en: "He had to work.", ar: "كان عليه أن يعمل.", uk: "Він мусив працювати.", fa: "او مجبور بود کار کند." }, { de: "Ich hatte keine Wahl.", ku: "هیچ هەڵبژاردنێکم نەبوو.", tr: "Seçeneğim yoktu.", en: "I had no choice.", ar: "لم يكن لديّ خيار.", uk: "У мене не було вибору.", fa: "من چاره‌ای نداشتم." } ] },
    { de: "Dativ", ku: "داتیڤ (بەرکاری ناڕاستەوخۆ)", icon: "→",
      ...
      ex: [ { de: "Ich gebe dem Kind ein Buch.", ku: "کتێبێک دەدەم بە منداڵەکە.", tr: "Çocuğa bir kitap veriyorum.", en: "I am giving the child a book.", ar: "أعطي الطفلَ كتابًا.", uk: "Я даю дитині книгу.", fa: "من به کودک یک کتاب می‌دهم." }, { de: "Ich helfe der Frau.", ku: "یارمەتی ژنەکە دەدەم.", tr: "Kadına yardım ediyorum.", en: "I am helping the woman.", ar: "أساعد المرأةَ.", uk: "Я допомагаю жінці.", fa: "من به زن کمک می‌کنم." }, { de: "Es gehört dem Mann.", ku: "هی پیاوەکەیە.", tr: "O adama ait.", en: "It belongs to the man.", ar: "إنه يخص الرجل.", uk: "Це належить чоловікові.", fa: "این متعلق به مرد است." }, { de: "Ich danke dir.", ku: "سوپاست دەکەم.", tr: "Sana teşekkür ederim.", en: "I thank you.", ar: "أشكرك.", uk: "Я дякую тобі.", fa: "از تو تشکر می‌کنم." }, { de: "Das Buch gehört mir.", ku: "کتێبەکە هی منە.", tr: "Kitap bana ait.", en: "The book belongs to me.", ar: "الكتاب لي.", uk: "Книга належить мені.", fa: "کتاب متعلق به من است." }, { de: "Sie hilft den Kindern.", ku: "یارمەتی منداڵەکان دەدات.", tr: "Çocuklara yardım ediyor.", en: "She helps the children.", ar: "تساعد الأطفالَ.", uk: "Вона допомагає дітям.", fa: "او به کودکان کمک می‌کند." } ] },
    { de: "Wechselpräpositionen", ku: "ئامرازی دوولایەن", icon: "⇆",
      ...
      ex: [ { de: "Ich gehe in die Schule.", ku: "دەچمە قوتابخانە (جووڵە/Akk).", tr: "Okula gidiyorum (hareket/Akk).", en: "I am going to school (motion/Akk).", ar: "أذهب إلى المدرسة (حركة/نصب).", uk: "Я йду до школи (рух/Akk).", fa: "من به مدرسه می‌روم (حرکت/Akk)." }, { de: "Ich bin in der Schule.", ku: "لە قوتابخانەم (شوێن/Dativ).", tr: "Okuldayım (yer/Datif).", en: "I am at school (location/Dativ).", ar: "أنا في المدرسة (مكان/جر).", uk: "Я в школі (місце/Dativ).", fa: "من در مدرسه هستم (مکان/Dativ)." }, { de: "Das Buch liegt auf dem Tisch.", ku: "کتێبەکە لەسەر مێزەکەیە.", tr: "Kitap masanın üzerinde.", en: "The book is lying on the table.", ar: "الكتاب موضوع على الطاولة.", uk: "Книга лежить на столі.", fa: "کتاب روی میز قرار دارد." }, { de: "Ich lege das Buch auf den Tisch.", ku: "کتێبەکە دەخەمە سەر مێزەکە.", tr: "Kitabı masanın üzerine koyuyorum.", en: "I am putting the book on the table.", ar: "أضع الكتاب على الطاولة.", uk: "Я кладу книгу на стіл.", fa: "من کتاب را روی میز می‌گذارم." }, { de: "Die Katze ist unter dem Bett.", ku: "پشیلەکە لەژێر جێگاکەیە.", tr: "Kedi yatağın altında.", en: "The cat is under the bed.", ar: "القطة تحت السرير.", uk: "Кішка під ліжком.", fa: "گربه زیر تخت است." }, { de: "Er hängt das Bild an die Wand.", ku: "وێنەکە بە دیوارەوە هەڵدەواسێت.", tr: "Resmi duvara asıyor.", en: "He is hanging the picture on the wall.", ar: "يعلّق الصورة على الحائط.", uk: "Він вішає картину на стіну.", fa: "او تابلو را به دیوار می‌آویزد." } ] },
    { de: "Pronomen: Personal-, Possessiv-, Demonstrativ-", ku: "جۆرەکانی جێناو", icon: "⁂",
      ...
      ex: [ { de: "Ich sehe ihn.", ku: "ئەو دەبینم.", tr: "Onu görüyorum.", en: "I see him.", ar: "أراه.", uk: "Я бачу його.", fa: "من او را می‌بینم." }, { de: "Dieser Stuhl ist frei.", ku: "ئەم کورسییە بەتاڵە.", tr: "Bu sandalye boş.", en: "This chair is free.", ar: "هذا الكرسي فارغ.", uk: "Цей стілець вільний.", fa: "این صندلی خالی است." }, { de: "Das ist meiner.", ku: "ئەمە هی منە.", tr: "Bu benimki.", en: "That is mine.", ar: "هذا لي.", uk: "Це моє.", fa: "این مالِ من است." }, { de: "Ich gebe ihm das Buch.", ku: "کتێبەکەی دەدەمێ.", tr: "Ona kitabı veriyorum.", en: "I am giving him the book.", ar: "أعطيه الكتاب.", uk: "Я даю йому книгу.", fa: "من کتاب را به او می‌دهم." }, { de: "Diese Tasche ist schön.", ku: "ئەم جانتایە جوانە.", tr: "Bu çanta güzel.", en: "This bag is beautiful.", ar: "هذه الحقيبة جميلة.", uk: "Ця сумка гарна.", fa: "این کیف قشنگ است." }, { de: "Welches möchtest du? Dieses.", ku: "کامەت دەوێت؟ ئەمە.", tr: "Hangisini istiyorsun? Bunu.", en: "Which one do you want? This one.", ar: "أيّها تريد؟ هذا.", uk: "Яку ти хочеш? Оцю.", fa: "کدام را می‌خواهی؟ این یکی." } ] },
    { de: "Reflexive Verben", ku: "کرداری لێکدراوەی خۆ", icon: "↺",
      ...
      ex: [ { de: "Ich freue mich.", ku: "دڵخۆشم.", tr: "Sevincim var.", en: "I am glad.", ar: "أنا سعيد.", uk: "Я радію.", fa: "من خوشحالم." }, { de: "Er wäscht sich.", ku: "خۆی دەشوات.", tr: "O yıkanıyor.", en: "He is washing himself.", ar: "هو يغتسل.", uk: "Він миється.", fa: "او خودش را می‌شوید." }, { de: "Wir treffen uns.", ku: "یەکتر دەبینین.", tr: "Birbirimizle buluşuyoruz.", en: "We are meeting each other.", ar: "نلتقي ببعضنا.", uk: "Ми зустрічаємося.", fa: "ما همدیگر را می‌بینیم." }, { de: "Setz dich bitte.", ku: "تکایە دانیشە.", tr: "Lütfen oturun.", en: "Please sit down.", ar: "تفضل بالجلوس من فضلك.", uk: "Сідай, будь ласка.", fa: "لطفاً بنشین." }, { de: "Sie interessiert sich für Musik.", ku: "ئارەزووی مۆسیقا دەکات.", tr: "Müziğe ilgi duyuyor.", en: "She is interested in music.", ar: "هي مهتمة بالموسيقى.", uk: "Вона цікавиться музикою.", fa: "او به موسیقی علاقه دارد." }, { de: "Ich fühle mich gut.", ku: "هەست بە باشی دەکەم.", tr: "Kendimi iyi hissediyorum.", en: "I feel good.", ar: "أشعر بأنني بخير.", uk: "Я почуваюся добре.", fa: "من احساس خوبی دارم." } ] },
    { de: "Komparativ", ku: "بەراوردی (پلەی بەرز)", icon: "≷",
      ...
      ex: [ { de: "Er ist größer als ich.", ku: "ئەو لە من گەورەترە.", tr: "O benden uzun.", en: "He is taller than me.", ar: "هو أطول مني.", uk: "Він вищий за мене.", fa: "او از من بلندقدتر است." }, { de: "Heute ist es kälter.", ku: "ئەمڕۆ ساردترە.", tr: "Bugün daha soğuk.", en: "Today it is colder.", ar: "اليوم الجو أبرد.", uk: "Сьогодні холодніше.", fa: "امروز سردتر است." }, { de: "Das ist besser.", ku: "ئەمە باشترە.", tr: "Bu daha iyi.", en: "That is better.", ar: "هذا أفضل.", uk: "Це краще.", fa: "این بهتر است." }, { de: "Sie ist jünger als er.", ku: "ئەو لە ئەو گەنجترە.", tr: "O ondan genç.", en: "She is younger than him.", ar: "هي أصغر منه سنًا.", uk: "Вона молодша за нього.", fa: "او از او جوان‌تر است." }, { de: "Dieses Auto ist teurer.", ku: "ئەم ئۆتۆمبێلە گرانترە.", tr: "Bu araba daha pahalı.", en: "This car is more expensive.", ar: "هذه السيارة أغلى.", uk: "Ця машина дорожча.", fa: "این خودرو گران‌تر است." }, { de: "Deutsch ist schwerer als Englisch.", ku: "ئەڵمانی لە ئینگلیزی قورسترە.", tr: "Almanca İngilizce'den zor.", en: "German is harder than English.", ar: "الألمانية أصعب من الإنجليزية.", uk: "Німецька важча за англійську.", fa: "آلمانی از انگلیسی سخت‌تر است." } ] },
    { de: "Superlativ", ku: "بەرزترین پلە", icon: "★",
      ...
      ex: [ { de: "Er ist am größten.", ku: "ئەو گەورەترینە.", tr: "O en uzun.", en: "He is the tallest.", ar: "هو الأطول.", uk: "Він найвищий.", fa: "او بلندقدترین است." }, { de: "Das ist das beste Buch.", ku: "ئەمە باشترین کتێبە.", tr: "Bu en iyi kitap.", en: "That is the best book.", ar: "هذا أفضل كتاب.", uk: "Це найкраща книга.", fa: "این بهترین کتاب است." }, { de: "Sie läuft am schnellsten.", ku: "ئەو خێراترین ڕادەکات.", tr: "O en hızlı koşuyor.", en: "She runs the fastest.", ar: "هي تركض الأسرع.", uk: "Вона біжить найшвидше.", fa: "او سریع‌ترین می‌دود." }, { de: "Das ist der höchste Berg.", ku: "ئەمە بەرزترین شاخە.", tr: "Bu en yüksek dağ.", en: "That is the highest mountain.", ar: "هذا أعلى جبل.", uk: "Це найвища гора.", fa: "این بلندترین کوه است." }, { de: "Heute ist der kälteste Tag.", ku: "ئەمڕۆ ساردترین ڕۆژە.", tr: "Bugün en soğuk gün.", en: "Today is the coldest day.", ar: "اليوم هو أبرد يوم.", uk: "Сьогодні найхолодніший день.", fa: "امروز سردترین روز است." }, { de: "Du bist mein bester Freund.", ku: "تۆ باشترین هاوڕێمی.", tr: "Sen en iyi arkadaşımsın.", en: "You are my best friend.", ar: "أنت أفضل صديق لي.", uk: "Ти мій найкращий друг.", fa: "تو بهترین دوست من هستی." } ] },
    { de: "Konjunktionen: und, oder, aber, denn, sondern", ku: "گرێدەرە سادەکان", icon: "&",
      ...
      ex: [ { de: "Ich lerne, denn es ist wichtig.", ku: "فێردەبم، چونکە گرنگە.", tr: "Öğreniyorum, çünkü önemli.", en: "I am studying, because it is important.", ar: "أتعلّم لأنه مهم.", uk: "Я вчуся, бо це важливо.", fa: "من درس می‌خوانم، زیرا مهم است." }, { de: "Tee oder Kaffee?", ku: "چا یان قاوە؟", tr: "Çay mı kahve mi?", en: "Tea or coffee?", ar: "شاي أم قهوة؟", uk: "Чай чи кава?", fa: "چای یا قهوه؟" }, { de: "Nicht heute, sondern morgen.", ku: "نەک ئەمڕۆ، بەڵکو سبەینێ.", tr: "Bugün değil, yarın.", en: "Not today, but tomorrow.", ar: "ليس اليوم، بل غدًا.", uk: "Не сьогодні, а завтра.", fa: "نه امروز، بلکه فردا." }, { de: "Ich bin müde, aber glücklich.", ku: "ماندووم، بەڵام بەختەوەرم.", tr: "Yorgunum ama mutluyum.", en: "I am tired, but happy.", ar: "أنا متعب لكن سعيد.", uk: "Я втомлений, але щасливий.", fa: "من خسته‌ام، اما خوشحالم." }, { de: "Er kommt und sie geht.", ku: "ئەو دێت و ئەو دەڕوات.", tr: "O geliyor, o gidiyor.", en: "He is coming and she is going.", ar: "هو يأتي وهي تذهب.", uk: "Він приходить, а вона йде.", fa: "او می‌آید و او می‌رود." }, { de: "Ich bleibe, aber du gehst.", ku: "دەمێنمەوە، بەڵام تۆ دەڕۆیت.", tr: "Kalıyorum ama sen gidiyorsun.", en: "I am staying, but you are going.", ar: "أنا أبقى لكنك تذهب.", uk: "Я залишаюся, але ти йдеш.", fa: "من می‌مانم، اما تو می‌روی." } ] },
    { de: "Nebensatz: weil, dass", ku: "ڕستەی لاوەکی (weil/dass)", icon: "⟜",
      ...
      ex: [ { de: "Ich bleibe, weil ich krank bin.", ku: "دەمێنمەوە، چونکە نەخۆشم.", tr: "Kalıyorum çünkü hastayım.", en: "I am staying because I am sick.", ar: "أبقى لأني مريض.", uk: "Я залишаюся, бо я хворий.", fa: "من می‌مانم، زیرا مریض هستم." }, { de: "Ich weiß, dass du kommst.", ku: "دەزانم کە دێیت.", tr: "Geldiğini biliyorum.", en: "I know that you are coming.", ar: "أعلم أنك قادم.", uk: "Я знаю, що ти прийдеш.", fa: "من می‌دانم که تو می‌آیی." }, { de: "Er sagt, dass es regnet.", ku: "دەڵێت کە باران دەبارێت.", tr: "Yağmur yağdığını söylüyor.", en: "He says that it is raining.", ar: "يقول إنّ المطر يهطل.", uk: "Він каже, що йде дощ.", fa: "او می‌گوید که باران می‌بارد." }, { de: "Ich lerne, weil ich es brauche.", ku: "فێردەبم، چونکە پێویستمە.", tr: "İhtiyacım olduğu için öğreniyorum.", en: "I am learning because I need it.", ar: "أتعلّم لأنني بحاجة إليه.", uk: "Я вчуся, бо мені це потрібно.", fa: "من درس می‌خوانم، زیرا به آن نیاز دارم." }, { de: "Sie glaubt, dass es stimmt.", ku: "پێیوایە کە ڕاستە.", tr: "Doğru olduğuna inanıyor.", en: "She believes that it is true.", ar: "تعتقد أن ذلك صحيح.", uk: "Вона вірить, що це правда.", fa: "او باور دارد که درست است." }, { de: "Wir gehen, weil es spät ist.", ku: "دەڕۆین، چونکە درەنگە.", tr: "Geç olduğu için gidiyoruz.", en: "We are leaving because it is late.", ar: "نذهب لأن الوقت متأخر.", uk: "Ми йдемо, бо вже пізно.", fa: "ما می‌رویم، زیرا دیر است." } ] },
