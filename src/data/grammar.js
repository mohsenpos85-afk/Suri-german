export const GRAMMAR = {
  A1: [
    { de: "Personalpronomen", ku: "جێناوی کەسی", icon: "✺",
      ...
      ex: [ { de: "Ich bin Student.", ku: "من خوێندکارم.", tr: "Ben öğrenciyim.", en: "I am a student.", ar: "أنا طالب.", uk: "Я студент.", fa: "من دانشجو هستم." }, { de: "Wir lernen Deutsch.", ku: "ئێمە ئەڵمانی فێردەبین.", tr: "Almanca öğreniyoruz.", en: "We are learning German.", ar: "نحن نتعلم الألمانية.", uk: "Ми вивчаємо німецьку.", fa: "ما آلمانی یاد می‌گیریم." }, { de: "Sie ist Lehrerin.", ku: "ئەو (مێ) مامۆستایە.", tr: "O (dişil) öğretmen.", en: "She is a teacher.", ar: "هي معلمة.", uk: "Вона вчителька.", fa: "او (مؤنث) معلم است." }, { de: "Er kommt aus Erbil.", ku: "ئەو خەڵکی هەولێرە.", tr: "O Erbil'den.", en: "He is from Erbil.", ar: "هو من أربيل.", uk: "Він з Ербіля.", fa: "او اهل اربیل است." }, { de: "Ihr seid willkommen.", ku: "ئێوە بەخێربێن.", tr: "Siz hoş geldiniz.", en: "You (all) are welcome.", ar: "أنتم مرحب بكم.", uk: "Ласкаво просимо.", fa: "شما خوش آمدید." }, { de: "Es ist kalt heute.", ku: "ئەمڕۆ ساردە.", tr: "Bugün soğuk.", en: "It is cold today.", ar: "الجو بارد اليوم.", uk: "Сьогодні холодно.", fa: "امروز هوا سرد است." } ] },
    { de: "sein und haben", ku: "کرداری «بوون» و «هەبوون»", icon: "◈",
      ...
      ex: [ { de: "Ich bin müde.", ku: "ماندووم.", tr: "Yorgunum.", en: "I am tired.", ar: "أنا متعب.", uk: "Я втомився.", fa: "من خسته‌ام." }, { de: "Du hast Zeit.", ku: "کاتت هەیە.", tr: "Zamanın var.", en: "You have time.", ar: "لديك وقت.", uk: "У тебе є час.", fa: "تو وقت داری." }, { de: "Wir sind hier.", ku: "ئێمە لێرەین.", tr: "Biz buradayız.", en: "We are here.", ar: "نحن هنا.", uk: "Ми тут.", fa: "ما اینجا هستیم." }, { de: "Er ist mein Bruder.", ku: "ئەو برامە.", tr: "O benim kardeşim.", en: "He is my brother.", ar: "هو أخي.", uk: "Він мій брат.", fa: "او برادر من است." }, { de: "Sie hat ein Auto.", ku: "ئەو ئۆتۆمبێلێکی هەیە.", tr: "Onun arabası var.", en: "She has a car.", ar: "لديها سيارة.", uk: "У неї є машина.", fa: "او یک ماشین دارد." }, { de: "Ihr seid spät.", ku: "ئێوە درەنگن.", tr: "Siz geç kaldınız.", en: "You (all) are late.", ar: "أنتم متأخرون.", uk: "Ви запізнилися.", fa: "شما دیر کرده‌اید." } ] },
    { de: "Präsens — regelmäßige Verben", ku: "کاتی ئێستا — کرداری ڕێکوپێک", icon: "▸",
      ...
      ex: [ { de: "ich lerne", ku: "فێردەبم", tr: "öğreniyorum", en: "I learn / I am learning", ar: "أنا أتعلّم", uk: "я вчуся / я навчаюся", fa: "من یاد می‌گیرم" }, { de: "du lernst", ku: "تۆ فێردەبیت", tr: "sen öğreniyorsun", en: "you learn / you are learning", ar: "أنت تتعلّم", uk: "ти вчишся", fa: "تو یاد می‌گیری" }, { de: "wir lernen", ku: "ئێمە فێردەبین", tr: "biz öğreniyoruz", en: "we learn / we are learning", ar: "نحن نتعلّم", uk: "ми вчимося", fa: "ما یاد می‌گیریم" }, { de: "er spielt Fußball.", ku: "ئەو تۆپی پێ یاری دەکات.", tr: "O futbol oynuyor.", en: "He plays football.", ar: "هو يلعب كرة القدم.", uk: "Він грає у футбол.", fa: "او فوتبال بازی می‌کند." }, { de: "ihr arbeitet viel.", ku: "ئێوە زۆر کار دەکەن.", tr: "Siz çok çalışıyorsunuz.", en: "You (all) work a lot.", ar: "أنتم تعملون كثيرا.", uk: "Ви багато працюєте.", fa: "شما زیاد کار می‌کنید." }, { de: "sie wohnen hier.", ku: "ئەوان لێرە نیشتەجێن.", tr: "Onlar burada yaşıyor.", en: "They live here.", ar: "هم يسكنون هنا.", uk: "Вони тут живуть.", fa: "آن‌ها اینجا زندگی می‌کنند." } ] },
    { de: "Artikel: der, die, das", ku: "ئارتیکڵ (der/die/das)", icon: "✦",
      ...
      groups: [
        { art: "der", emoji: "🔵", uk: "Чоловічий (männlich)", fa: "مذکر (männlich)", rulesUk: ["Дні тижня, місяці, пори року","Більшість професій","Закінчення: -er, -en, -el (часто)","Більшість осіб чоловічої статі"], rulesFa: ["روزهای هفته، ماه‌ها، فصل‌ها","بیشتر مشاغل","پایانه‌ها: -er، -en، -el (اغلب)","بیشتر افراد مذکر"], tr: "Eril (männlich)", ku: "نێر (männlich)", color: "#2f6f8f", rules: ["ڕۆژەکانی هەفتە، مانگەکان، وەرزەکان", "زۆربەی پیشەکان", "کۆتاییەکان: -er، -en، -el (زۆرجار)", "زۆربەی کەسانی نێر"], rulesTr: ["Haftanın günleri, aylar, mevsimler", "Çoğu meslek", "Sonekler: -er, -en, -el (çoğunlukla)", "Çoğu erkek kişi"], rulesEn: ["Days of the week, months, seasons", "Most professions", "Endings: -er, -en, -el (often)", "Most male persons"], rulesAr: ["أيام الأسبوع، الأشهر، الفصول", "معظم المهن", "اللواحق: -er، -en، -el (غالبًا)", "معظم الأشخاص الذكور"], words: [["der Mann","پیاو","adam","man","رجل","чоловік","مرد"],["der Vater","باوک","baba","father","أب","батько","پدر"],["der Sohn","کوڕ","oğul","son","ابن","син","پسر"],["der Bruder","برا","erkek kardeş","brother","أخ","брат","برادر"],["der Lehrer","مامۆستا","öğretmen","teacher","معلم","вчитель","معلم"],["der Arzt","پزیشک","doktor","doctor","طبيب","лікар","پزشک"],["der Student","خوێندکار","öğrenci","student","طالب","студент","دانشجو"],["der Fahrer","شۆفێر","şoför","driver","سائق","водій","راننده"],["der Bäcker","نانەوا","fırıncı","baker","خبّاز","пекар","نانوا"],["der Computer","کۆمپیوتەر","bilgisayar","computer","حاسوب","комп'ютер","رایانه"],["der Tisch","مێز","masa","table","طاولة","стіл","میز"],["der Stuhl","کورسی","sandalye","chair","كرسي","стілець","صندلی"],["der Fernseher","تەلەفزیۆن","televizyon","television","تلفاز","телевізор","تلویزیون"],["der Kühlschrank","بەفرگر / سەلاجە","buzdolabı","refrigerator","ثلاجة","холодильник","یخچال"],["der Montag","دووشەممە","pazartesi","Monday","الاثنين","понеділок","دوشنبه"],["der Dienstag","سێشەممە","salı","Tuesday","الثلاثاء","вівторок","سه‌شنبه"],["der Mittwoch","چوارشەممە","çarşamba","Wednesday","الأربعاء","середа","چهارشنبه"],["der Januar","ژانویە","ocak","January","يناير","січень","ژانویه"],["der Februar","شوبات","şubat","February","فبراير","лютий","فوریه"],["der Sommer","هاوین","yaz","summer","الصيف","літо","تابستان"],["der Winter","زستان","kış","winter","الشتاء","зима","زمستان"]] },
        { art: "die", emoji: "🔴", uk: "Жіночий (feminin)", fa: "مؤنث (feminin)", rulesUk: ["Закінчення: -e, -ung, -heit, -keit, -ion, -schaft, -ie","Більшість осіб жіночої статі","Більшість міст і предметів"], rulesFa: ["پایانه‌ها: -e، -ung، -heit، -keit، -ion، -schaft، -ie","بیشتر افراد مؤنث","بیشتر شهرها و اشیاء"], tr: "Dişil (feminin)", ku: "مێ (feminin)", color: "#b8412e", rules: ["کۆتاییەکان: -e، -ung، -heit، -keit، -ion، -schaft، -ie", "زۆربەی کەسانی مێ", "زۆربەی شار و شتەکان"], rulesTr: ["Sonekler: -e, -ung, -heit, -keit, -ion, -schaft, -ie", "Çoğu dişi kişi", "Çoğu şehir ve nesne"], rulesEn: ["Endings: -e, -ung, -heit, -keit, -ion, -schaft, -ie", "Most female persons", "Most cities and objects"], rulesAr: ["اللواحق: -e، -ung، -heit، -keit، -ion، -schaft، -ie", "معظم الأشخاص الإناث", "معظم المدن والأشياء"], words: [["die Frau","ژن","kadın","woman","امرأة","жінка","زن"],["die Mutter","دایک","anne","mother","أم","мати","مادر"],["die Tochter","کچ","kız","daughter","ابنة","донька","دختر"],["die Schwester","خوشک","kız kardeş","sister","أخت","сестра","خواهر"],["die Lehrerin","مامۆستا (ژن)","öğretmen (kadın)","teacher (female)","معلمة","вчителька","معلم (زن)"],["die Ärztin","پزیشک (ژن)","doktor (kadın)","doctor (female)","طبيبة","лікарка","پزشک (زن)"],["die Lampe","چرا / لامپە","lamba","lamp","مصباح","лампа","لامپ"],["die Tür","دەرگا","kapı","door","باب","двері","در"],["die Schule","قوتابخانە","okul","school","مدرسة","школа","مدرسه"],["die Stadt","شار","şehir","city","مدينة","місто","شهر"],["die Wohnung","ئەپارتمان / نیشتەجێ","daire","apartment","شقة","квартира","آپارتمان"],["die Küche","چێشتخانە","mutfak","kitchen","مطبخ","кухня","آشپزخانه"],["die Straße","شەقام","sokak","street","شارع","вулиця","خیابان"],["die Prüfung","تاقیکردنەوە","sınav","exam","امتحان","іспит","امتحان"],["die Zeitung","ڕۆژنامە","gazete","newspaper","جريدة","газета","روزنامه"],["die Meinung","بۆچوون","görüş","opinion","رأي","думка","نظر"],["die Freiheit","ئازادی","özgürlük","freedom","حرية","свобода","آزادی"],["die Möglichkeit","دەرفەت / ئەگەر","olasılık / imkân","possibility","إمكانية","можливість","امکان"],["die Freundschaft","هاوڕێیەتی","arkadaşlık","friendship","صداقة","дружба","دوستی"],["die Nation","نەتەوە","millet","nation","أمة","нація","ملت"],["die Situation","بارودۆخ","durum","situation","وضع / حالة","ситуація","وضعیت"],["die Biologie","زیندەزانی","biyoloji","biology","علم الأحياء","біологія","زیست‌شناسی"],["die Musik","مۆسیقا","müzik","music","موسيقى","музика","موسیقی"]] },
        { art: "das", emoji: "🟡", uk: "Середній (neutral)", fa: "خنثی (neutral)", rulesUk: ["Закінчення: -chen, -lein, -ment, -um","Дієслова, вжиті як іменники","Діти та предмети"], rulesFa: ["پایانه‌ها: -chen، -lein، -ment، -um","افعالِ به‌کاررفته به‌عنوان اسم","کودکان و اشیاء"], tr: "Nötr (neutral)", ku: "بێلایەن (neutral)", color: "#c8922a", rules: ["کۆتاییەکان: -chen، -lein، -ment، -um", "کردار وەک ناو", "منداڵ و شتەکان"], rulesTr: ["Sonekler: -chen, -lein, -ment, -um", "İsim olarak kullanılan fiiller", "Çocuklar ve nesneler"], rulesEn: ["Endings: -chen, -lein, -ment, -um", "Verbs used as nouns", "Children and objects"], rulesAr: ["اللواحق: -chen، -lein، -ment، -um", "الأفعال المستخدمة كأسماء", "الأطفال والأشياء"], words: [["das Kind","منداڵ","çocuk","child","طفل","дитина","کودک"],["das Baby","کۆرپە","bebek","baby","رضيع","немовля","نوزاد"],["das Mädchen","کچ (بچووک)","kız (küçük)","girl (young)","فتاة (صغيرة)","дівчинка","دختر (کوچک)"],["das Haus","ماڵ / خانوو","ev","house","بيت / منزل","будинок","خانه"],["das Auto","ئۆتۆمبێل","araba","car","سيارة","автомобіль","خودرو"],["das Buch","کتێب","kitap","book","كتاب","книга","کتاب"],["das Fenster","پەنجەرە","pencere","window","نافذة","вікно","پنجره"],["das Wasser","ئاو","su","water","ماء","вода","آب"],["das Essen","خواردن","yemek","food","طعام","їжа","غذا"],["das Trinken","خواردنەوە","içecek","drinking / beverage","شرب / مشروب","напій","نوشیدنی"],["das Spiel","یاری","oyun","game","لعبة","гра","بازی"],["das Zimmer","ژوور","oda","room","غرفة","кімната","اتاق"],["das Krankenhaus","نەخۆشخانە","hastane","hospital","مستشفى","лікарня","بیمارستان"],["das Studium","خوێندن","üniversite eğitimi","university studies","الدراسة الجامعية","навчання","تحصیلات دانشگاهی"],["das Museum","مۆزەخانە","müze","museum","متحف","музей","موزه"],["das Zentrum","ناوەند","merkez","center","مركز","центр","مرکز"],["das Instrument","ئامێری مۆسیقا","enstrüman","instrument","آلة موسيقية","інструмент","ساز"],["das Problem","کێشە","sorun","problem","مشكلة","проблема","مشکل"],["das Telefon","تەلەفۆن","telefon","telephone","هاتف","телефон","تلفن"],["das Foto","وێنە","fotoğraf","photo","صورة","фото","عکس"]] },
      ],
      ...
      ex: [ { de: "der Tisch", ku: "مێز (نێر)", tr: "masa (eril)", en: "table (masculine)", ar: "طاولة (مذكر)", uk: "стіл (чоловічий рід)", fa: "میز (مذکر)" }, { de: "die Lampe", ku: "چرا (مێ)", tr: "lamba (dişil)", en: "lamp (feminine)", ar: "مصباح (مؤنث)", uk: "лампа (жіночий рід)", fa: "لامپ (مؤنث)" }, { de: "das Buch", ku: "کتێب (بێلایەن)", tr: "kitap (yansız)", en: "book (neuter)", ar: "كتاب (محايد)", uk: "книга (середній рід)", fa: "کتاب (خنثی)" }, { de: "der Stuhl ist neu.", ku: "کورسییەکە نوێیە.", tr: "Sandalye yeni.", en: "The chair is new.", ar: "الكرسي جديد.", uk: "Стілець новий.", fa: "صندلی نو است." }, { de: "die Tür ist offen.", ku: "دەرگاکە کراوەیە.", tr: "Kapı açık.", en: "The door is open.", ar: "الباب مفتوح.", uk: "Двері відчинені.", fa: "در باز است." }, { de: "das Fenster ist groß.", ku: "پەنجەرەکە گەورەیە.", tr: "Pencere büyük.", en: "The window is big.", ar: "النافذة كبيرة.", uk: "Вікно велике.", fa: "پنجره بزرگ است." } ] },
    { de: "Plural", ku: "کۆ (زۆرینە)", icon: "❖",
      ...
      ex: [ { de: "das Kind → die Kinder", ku: "منداڵ → منداڵان", tr: "çocuk → çocuklar", en: "the child → the children", ar: "الطفل ← الأطفال", uk: "дитина → діти", fa: "کودک ← کودکان" }, { de: "die Frau → die Frauen", ku: "ژن → ژنان", tr: "kadın → kadınlar", en: "the woman → the women", ar: "المرأة ← النساء", uk: "жінка → жінки", fa: "زن ← زنان" }, { de: "das Auto → die Autos", ku: "ئۆتۆمبێل → ئۆتۆمبێلەکان", tr: "araba → arabalar", en: "the car → the cars", ar: "السيارة ← السيارات", uk: "машина → машини", fa: "خودرو ← خودروها" }, { de: "der Tisch → die Tische", ku: "مێز → مێزەکان", tr: "masa → masalar", en: "the table → the tables", ar: "الطاولة ← الطاولات", uk: "стіл → столи", fa: "میز ← میزها" }, { de: "der Apfel → die Äpfel", ku: "سێو → سێوەکان", tr: "elma → elmalar", en: "the apple → the apples", ar: "التفاحة ← التفاحات", uk: "яблуко → яблука", fa: "سیب ← سیب‌ها" }, { de: "das Buch → die Bücher", ku: "کتێب → کتێبەکان", tr: "kitap → kitaplar", en: "the book → the books", ar: "الكتاب ← الكتب", uk: "книга → книги", fa: "کتاب ← کتاب‌ها" } ] },
    { de: "Bestimmte / unbestimmte Artikel", ku: "ئارتیکڵی دیاریکراو و نادیار", icon: "✧",
      ...
      ex: [ { de: "Das ist ein Buch.", ku: "ئەمە کتێبێکە (نادیار).", tr: "Bu bir kitap. (belirsiz)", en: "This is a book. (indefinite)", ar: "هذا كتاب. (نكرة)", uk: "Це книга. (неозначений)", fa: "این یک کتاب است. (نکره)" }, { de: "Das Buch ist neu.", ku: "کتێبەکە نوێیە (دیاریکراو).", tr: "Kitap yeni. (belirli)", en: "The book is new. (definite)", ar: "الكتاب جديد. (معرفة)", uk: "Книга нова. (означений)", fa: "کتاب نو است. (معرفه)" }, { de: "Ich habe eine Frage.", ku: "پرسیارێکم هەیە.", tr: "Bir sorum var.", en: "I have a question.", ar: "لدي سؤال.", uk: "У мене є питання.", fa: "من یک سؤال دارم." }, { de: "Ein Mann wartet draußen.", ku: "پیاوێک لە دەرەوە چاوەڕێیە.", tr: "Dışarıda bir adam bekliyor.", en: "A man is waiting outside.", ar: "رجل ينتظر في الخارج.", uk: "Надворі чекає чоловік.", fa: "مردی بیرون منتظر است." }, { de: "Der Mann ist mein Vater.", ku: "پیاوەکە باوکمە.", tr: "Adam babam.", en: "The man is my father.", ar: "الرجل هو أبي.", uk: "Цей чоловік — мій батько.", fa: "این مرد پدر من است." }, { de: "Eine Katze schläft hier.", ku: "پشیلەیەک لێرە خەوتووە.", tr: "Burada bir kedi uyuyor.", en: "A cat is sleeping here.", ar: "قطة نائمة هنا.", uk: "Тут спить кішка.", fa: "گربه‌ای اینجا خوابیده است." } ] },
    { de: "Akkusativ", ku: "ئاککوزاتیڤ (بەرکاری ڕاستەوخۆ)", icon: "→",
      ...
      ex: [ { de: "Ich sehe den Mann.", ku: "پیاوەکە دەبینم.", tr: "Adamı görüyorum.", en: "I see the man.", ar: "أرى الرجل.", uk: "Я бачу чоловіка.", fa: "من مرد را می‌بینم." }, { de: "Ich kaufe einen Apfel.", ku: "سێوێک دەکڕم.", tr: "Bir elma satın alıyorum.", en: "I am buying an apple.", ar: "أشتري تفاحة.", uk: "Я купую яблуко.", fa: "من یک سیب می‌خرم." }, { de: "Ich lese das Buch.", ku: "کتێبەکە دەخوێنمەوە.", tr: "Kitabı okuyorum.", en: "I am reading the book.", ar: "أقرأ الكتاب.", uk: "Я читаю книгу.", fa: "من کتاب را می‌خوانم." }, { de: "Er hat einen Hund.", ku: "سەگێکی هەیە.", tr: "Bir köpeği var.", en: "He has a dog.", ar: "لديه كلب.", uk: "У нього є собака.", fa: "او یک سگ دارد." }, { de: "Wir brauchen den Schlüssel.", ku: "پێویستیمان بە کلیلەکەیە.", tr: "Anahtara ihtiyacımız var.", en: "We need the key.", ar: "نحتاج إلى المفتاح.", uk: "Нам потрібен ключ.", fa: "ما به کلید نیاز داریم." }, { de: "Ich trinke eine Cola.", ku: "کۆلایەک دەخۆمەوە.", tr: "Bir kola içiyorum.", en: "I am drinking a cola.", ar: "أشرب كولا.", uk: "Я п'ю колу.", fa: "من یک نوشابه می‌نوشم." } ] },
    { de: "Possessivartikel", ku: "ئارتیکڵی خاوەندارێتی", icon: "✪",
      ...
      ex: [ { de: "Das ist mein Buch.", ku: "ئەمە کتێبی منە.", tr: "Bu benim kitabım.", en: "This is my book.", ar: "هذا كتابي.", uk: "Це моя книга.", fa: "این کتاب من است." }, { de: "Deine Tasche ist schön.", ku: "جانتاکەت جوانە.", tr: "Çantan güzel.", en: "Your bag is nice.", ar: "حقيبتك جميلة.", uk: "Твоя сумка гарна.", fa: "کیف تو قشنگ است." }, { de: "Sein Auto ist neu.", ku: "ئۆتۆمبێلەکەی نوێیە.", tr: "Onun arabası yeni.", en: "His car is new.", ar: "سيارته جديدة.", uk: "Його машина нова.", fa: "ماشین او نو است." }, { de: "Ihre Mutter ist Ärztin.", ku: "دایکی پزیشکە.", tr: "Annesi doktor.", en: "Her mother is a doctor.", ar: "أمها طبيبة.", uk: "Її мати лікарка.", fa: "مادر او پزشک است." }, { de: "Unser Haus ist groß.", ku: "خانووەکەمان گەورەیە.", tr: "Evimiz büyük.", en: "Our house is big.", ar: "بيتنا كبير.", uk: "Наш будинок великий.", fa: "خانهٔ ما بزرگ است." }, { de: "Euer Lehrer ist nett.", ku: "مامۆستاکەتان بەسۆزە.", tr: "Öğretmeniniz nazik.", en: "Your (all) teacher is nice.", ar: "معلمكم لطيف.", uk: "Ваш учитель добрий.", fa: "معلم شما مهربان است." } ] },
