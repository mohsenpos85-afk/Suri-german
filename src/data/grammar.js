export const GRAMMAR = {
  A1: [
    { de: "Personalpronomen", ku: "جێناوی کەسی", icon: "✺",
      ...
      ar: "ضمائر الشخص", uk: "Особові займенники", expAr: "الضمائر: ich (أنا)، du (أنت)، er/sie/es (هو/هي/هو-محايد)، wir (نحن)، ihr (أنتم)، sie (هم)، Sie (أنتم - رسمي).", expUk: "Займенники: ich (я), du (ти), er/sie/es (він/вона/воно), wir (ми), ihr (ви), sie (вони), Sie (Ви — ввічлива форма).",
      ex: [ { de: "Ich bin Student.", ku: "من خوێندکارم.", tr: "Ben öğrenciyim.", en: "I am a student.", ar: "أنا طالب.", uk: "Я студент." }, { de: "Wir lernen Deutsch.", ku: "ئێمە ئەڵمانی فێردەبین.", tr: "Almanca öğreniyoruz.", en: "We are learning German.", ar: "نحن نتعلم الألمانية.", uk: "Ми вивчаємо німецьку." }, { de: "Sie ist Lehrerin.", ku: "ئەو (مێ) مامۆستایە.", tr: "O (dişil) öğretmen.", en: "She is a teacher.", ar: "هي معلمة.", uk: "Вона вчителька." }, { de: "Er kommt aus Erbil.", ku: "ئەو خەڵکی هەولێرە.", tr: "O Erbil'den.", en: "He is from Erbil.", ar: "هو من أربيل.", uk: "Він з Ербіля." }, { de: "Ihr seid willkommen.", ku: "ئێوە بەخێربێن.", tr: "Siz hoş geldiniz.", en: "You (all) are welcome.", ar: "أنتم مرحب بكم.", uk: "Ласкаво просимо." }, { de: "Es ist kalt heute.", ku: "ئەمڕۆ ساردە.", tr: "Bugün soğuk.", en: "It is cold today.", ar: "الجو بارد اليوم.", uk: "Сьогодні холодно." } ] },
    { de: "sein und haben", ku: "کرداری «بوون» و «هەبوون»", icon: "◈",
      ...
      ar: "فعلا «sein» و«haben» (الكينونة والامتلاك)", uk: "Дієслова «sein» і «haben» (бути / мати)", expAr: "sein (يكون): ich bin، du bist، er ist، wir sind، ihr seid، sie sind. haben (يملك): ich habe، du hast، er hat، wir haben، ihr habt، sie haben. مهمّان جدا لأنهما أساس أشياء كثيرة.", expUk: "sein (бути): ich bin, du bist, er ist, wir sind, ihr seid, sie sind. haben (мати): ich habe, du hast, er hat, wir haben, ihr habt, sie haben. Вони дуже важливі, бо є основою багатьох речей.",
      ex: [ { de: "Ich bin müde.", ku: "ماندووم.", tr: "Yorgunum.", en: "I am tired.", ar: "أنا متعب.", uk: "Я втомився." }, { de: "Du hast Zeit.", ku: "کاتت هەیە.", tr: "Zamanın var.", en: "You have time.", ar: "لديك وقت.", uk: "У тебе є час." }, { de: "Wir sind hier.", ku: "ئێمە لێرەین.", tr: "Biz buradayız.", en: "We are here.", ar: "نحن هنا.", uk: "Ми тут." }, { de: "Er ist mein Bruder.", ku: "ئەو برامە.", tr: "O benim kardeşim.", en: "He is my brother.", ar: "هو أخي.", uk: "Він мій брат." }, { de: "Sie hat ein Auto.", ku: "ئەو ئۆتۆمبێلێکی هەیە.", tr: "Onun arabası var.", en: "She has a car.", ar: "لديها سيارة.", uk: "У неї є машина." }, { de: "Ihr seid spät.", ku: "ئێوە درەنگن.", tr: "Siz geç kaldınız.", en: "You (all) are late.", ar: "أنتم متأخرون.", uk: "Ви запізнилися." } ] },
    { de: "Präsens — regelmäßige Verben", ku: "کاتی ئێستا — کرداری ڕێکوپێک", icon: "▸",
      ...
      ar: "المضارع — الأفعال المنتظمة", uk: "Теперішній час — правильні дієслова", expAr: "جذر الفعل + النهاية: ich -e، du -st، er/sie/es -t، wir -en، ihr -t، sie/Sie -en. مثال: lernen ← ich lerne.", expUk: "Основа дієслова + закінчення: ich -e, du -st, er/sie/es -t, wir -en, ihr -t, sie/Sie -en. Приклад: lernen → ich lerne.",
      ex: [ { de: "ich lerne", ku: "فێردەبم", tr: "öğreniyorum", en: "I learn / I am learning", ar: "أنا أتعلّم", uk: "я вчуся / я навчаюся" }, { de: "du lernst", ku: "تۆ فێردەبیت", tr: "sen öğreniyorsun", en: "you learn / you are learning", ar: "أنت تتعلّم", uk: "ти вчишся" }, { de: "wir lernen", ku: "ئێمە فێردەبین", tr: "biz öğreniyoruz", en: "we learn / we are learning", ar: "نحن نتعلّم", uk: "ми вчимося" }, { de: "er spielt Fußball.", ku: "ئەو تۆپی پێ یاری دەکات.", tr: "O futbol oynuyor.", en: "He plays football.", ar: "هو يلعب كرة القدم.", uk: "Він грає у футбол." }, { de: "ihr arbeitet viel.", ku: "ئێوە زۆر کار دەکەن.", tr: "Siz çok çalışıyorsunuz.", en: "You (all) work a lot.", ar: "أنتم تعملون كثيرا.", uk: "Ви багато працюєте." }, { de: "sie wohnen hier.", ku: "ئەوان لێرە نیشتەجێن.", tr: "Onlar burada yaşıyor.", en: "They live here.", ar: "هم يسكنون هنا.", uk: "Вони тут живуть." } ] },
    { de: "Artikel: der, die, das", ku: "ئارتیکڵ (der/die/das)", icon: "✦",
      ...
      ar: "أدوات التعريف: der, die, das", uk: "Артиклі: der, die, das", expAr: "في اللغة الألمانية لكل اسم جنس نحوي: مذكر «der»، مؤنث «die»، محايد «das». تأتي الأداة قبل الاسم ويجب تعلّمها مع الاسم نفسه، لأن الأمر ليس منطقيا دائما. أدناه القواعد والأمثلة مقسّمة حسب كل أداة.", expUk: "У німецькій мові кожен іменник має рід: чоловічий «der», жіночий «die», середній «das». Артикль стоїть перед іменником, і його треба вчити разом з ним, бо це не завжди логічно. Нижче правила та приклади розподілені за кожним артиклем.",
      groups: [
        { art: "der", emoji: "🔵", uk: "Чоловічий (männlich)", rulesUk: ["Дні тижня, місяці, пори року","Більшість професій","Закінчення: -er, -en, -el (часто)","Більшість осіб чоловічої статі"], tr: "Eril (männlich)", ku: "نێر (männlich)", color: "#2f6f8f", rules: ["ڕۆژەکانی هەفتە، مانگەکان، وەرزەکان", "زۆربەی پیشەکان", "کۆتاییەکان: -er، -en، -el (زۆرجار)", "زۆربەی کەسانی نێر"], rulesTr: ["Haftanın günleri, aylar, mevsimler", "Çoğu meslek", "Sonekler: -er, -en, -el (çoğunlukla)", "Çoğu erkek kişi"], rulesEn: ["Days of the week, months, seasons", "Most professions", "Endings: -er, -en, -el (often)", "Most male persons"], rulesAr: ["أيام الأسبوع، الأشهر، الفصول", "معظم المهن", "اللواحق: -er، -en، -el (غالبًا)", "معظم الأشخاص الذكور"], words: [["der Mann","پیاو","adam","man","رجل","чоловік"],["der Vater","باوک","baba","father","أب","батько"],["der Sohn","کوڕ","oğul","son","ابن","син"],["der Bruder","برا","erkek kardeş","brother","أخ","брат"],["der Lehrer","مامۆستا","öğretmen","teacher","معلم","вчитель"],["der Arzt","پزیشک","doktor","doctor","طبيب","лікар"],["der Student","خوێندکار","öğrenci","student","طالب","студент"],["der Fahrer","شۆفێر","şoför","driver","سائق","водій"],["der Bäcker","نانەوا","fırıncı","baker","خبّاز","пекар"],["der Computer","کۆمپیوتەر","bilgisayar","computer","حاسوب","комп'ютер"],["der Tisch","مێز","masa","table","طاولة","стіл"],["der Stuhl","کورسی","sandalye","chair","كرسي","стілець"],["der Fernseher","تەلەفزیۆن","televizyon","television","تلفاز","телевізор"],["der Kühlschrank","بەفرگر / سەلاجە","buzdolabı","refrigerator","ثلاجة","холодильник"],["der Montag","دووشەممە","pazartesi","Monday","الاثنين","понеділок"],["der Dienstag","سێشەممە","salı","Tuesday","الثلاثاء","вівторок"],["der Mittwoch","چوارشەممە","çarşamba","Wednesday","الأربعاء","середа"],["der Januar","ژانویە","ocak","January","يناير","січень"],["der Februar","شوبات","şubat","February","فبراير","лютий"],["der Sommer","هاوین","yaz","summer","الصيف","літо"],["der Winter","زستان","kış","winter","الشتاء","зима"]] },
        { art: "die", emoji: "🔴", uk: "Жіночий (feminin)", rulesUk: ["Закінчення: -e, -ung, -heit, -keit, -ion, -schaft, -ie","Більшість осіб жіночої статі","Більшість міст і предметів"], tr: "Dişil (feminin)", ku: "مێ (feminin)", color: "#b8412e", rules: ["کۆتاییەکان: -e، -ung، -heit، -keit، -ion، -schaft، -ie", "زۆربەی کەسانی مێ", "زۆربەی شار و شتەکان"], rulesTr: ["Sonekler: -e, -ung, -heit, -keit, -ion, -schaft, -ie", "Çoğu dişi kişi", "Çoğu şehir ve nesne"], rulesEn: ["Endings: -e, -ung, -heit, -keit, -ion, -schaft, -ie", "Most female persons", "Most cities and objects"], rulesAr: ["اللواحق: -e، -ung، -heit، -keit، -ion، -schaft، -ie", "معظم الأشخاص الإناث", "معظم المدن والأشياء"], words: [["die Frau","ژن","kadın","woman","امرأة","жінка"],["die Mutter","دایک","anne","mother","أم","мати"],["die Tochter","کچ","kız","daughter","ابنة","донька"],["die Schwester","خوشک","kız kardeş","sister","أخت","сестра"],["die Lehrerin","مامۆستا (ژن)","öğretmen (kadın)","teacher (female)","معلمة","вчителька"],["die Ärztin","پزیشک (ژن)","doktor (kadın)","doctor (female)","طبيبة","лікарка"],["die Lampe","چرا / لامپە","lamba","lamp","مصباح","лампа"],["die Tür","دەرگا","kapı","door","باب","двері"],["die Schule","قوتابخانە","okul","school","مدرسة","школа"],["die Stadt","شار","şehir","city","مدينة","місто"],["die Wohnung","ئەپارتمان / نیشتەجێ","daire","apartment","شقة","квартира"],["die Küche","چێشتخانە","mutfak","kitchen","مطبخ","кухня"],["die Straße","شەقام","sokak","street","شارع","вулиця"],["die Prüfung","تاقیکردنەوە","sınav","exam","امتحان","іспит"],["die Zeitung","ڕۆژنامە","gazete","newspaper","جريدة","газета"],["die Meinung","بۆچوون","görüş","opinion","رأي","думка"],["die Freiheit","ئازادی","özgürlük","freedom","حرية","свобода"],["die Möglichkeit","دەرفەت / ئەگەر","olasılık / imkân","possibility","إمكانية","можливість"],["die Freundschaft","هاوڕێیەتی","arkadaşlık","friendship","صداقة","дружба"],["die Nation","نەتەوە","millet","nation","أمة","нація"],["die Situation","بارودۆخ","durum","situation","وضع / حالة","ситуація"],["die Biologie","زیندەزانی","biyoloji","biology","علم الأحياء","біологія"],["die Musik","مۆسیقا","müzik","music","موسيقى","музика"]] },
        { art: "das", emoji: "🟡", uk: "Середній (neutral)", rulesUk: ["Закінчення: -chen, -lein, -ment, -um","Дієслова, вжиті як іменники","Діти та предмети"], tr: "Nötr (neutral)", ku: "بێلایەن (neutral)", color: "#c8922a", rules: ["کۆتاییەکان: -chen، -lein، -ment، -um", "کردار وەک ناو", "منداڵ و شتەکان"], rulesTr: ["Sonekler: -chen, -lein, -ment, -um", "İsim olarak kullanılan fiiller", "Çocuklar ve nesneler"], rulesEn: ["Endings: -chen, -lein, -ment, -um", "Verbs used as nouns", "Children and objects"], rulesAr: ["اللواحق: -chen، -lein، -ment، -um", "الأفعال المستخدمة كأسماء", "الأطفال والأشياء"], words: [["das Kind","منداڵ","çocuk","child","طفل","дитина"],["das Baby","کۆرپە","bebek","baby","رضيع","немовля"],["das Mädchen","کچ (بچووک)","kız (küçük)","girl (young)","فتاة (صغيرة)","дівчинка"],["das Haus","ماڵ / خانوو","ev","house","بيت / منزل","будинок"],["das Auto","ئۆتۆمبێل","araba","car","سيارة","автомобіль"],["das Buch","کتێب","kitap","book","كتاب","книга"],["das Fenster","پەنجەرە","pencere","window","نافذة","вікно"],["das Wasser","ئاو","su","water","ماء","вода"],["das Essen","خواردن","yemek","food","طعام","їжа"],["das Trinken","خواردنەوە","içecek","drinking / beverage","شرب / مشروب","напій"],["das Spiel","یاری","oyun","game","لعبة","гра"],["das Zimmer","ژوور","oda","room","غرفة","кімната"],["das Krankenhaus","نەخۆشخانە","hastane","hospital","مستشفى","лікарня"],["das Studium","خوێندن","üniversite eğitimi","university studies","الدراسة الجامعية","навчання"],["das Museum","مۆزەخانە","müze","museum","متحف","музей"],["das Zentrum","ناوەند","merkez","center","مركز","центр"],["das Instrument","ئامێری مۆسیقا","enstrüman","instrument","آلة موسيقية","інструмент"],["das Problem","کێشە","sorun","problem","مشكلة","проблема"],["das Telefon","تەلەفۆن","telefon","telephone","هاتف","телефон"],["das Foto","وێنە","fotoğraf","photo","صورة","фото"]] },
      ],
      ...
      ex: [ { de: "der Tisch", ku: "مێز (نێر)", tr: "masa (eril)", en: "table (masculine)", ar: "طاولة (مذكر)", uk: "стіл (чоловічий рід)" }, { de: "die Lampe", ku: "چرا (مێ)", tr: "lamba (dişil)", en: "lamp (feminine)", ar: "مصباح (مؤنث)", uk: "лампа (жіночий рід)" }, { de: "das Buch", ku: "کتێب (بێلایەن)", tr: "kitap (yansız)", en: "book (neuter)", ar: "كتاب (محايد)", uk: "книга (середній рід)" }, { de: "der Stuhl ist neu.", ku: "کورسییەکە نوێیە.", tr: "Sandalye yeni.", en: "The chair is new.", ar: "الكرسي جديد.", uk: "Стілець новий." }, { de: "die Tür ist offen.", ku: "دەرگاکە کراوەیە.", tr: "Kapı açık.", en: "The door is open.", ar: "الباب مفتوح.", uk: "Двері відчинені." }, { de: "das Fenster ist groß.", ku: "پەنجەرەکە گەورەیە.", tr: "Pencere büyük.", en: "The window is big.", ar: "النافذة كبيرة.", uk: "Вікно велике." } ] },
    { de: "Plural", ku: "کۆ (زۆرینە)", icon: "❖",
      ...
      ar: "الجمع", uk: "Множина", expAr: "في اللغة الألمانية هناك عدة طرق لتكوين الجمع: -e، -n/-en، -er، -s، أو بدون تغيير. في الجمع تكون الأداة دائما «die».", expUk: "У німецькій мові є кілька способів утворення множини: -e, -n/-en, -er, -s або без змін. У множині артикль завжди «die».",
      ex: [ { de: "das Kind → die Kinder", ku: "منداڵ → منداڵان", tr: "çocuk → çocuklar", en: "the child → the children", ar: "الطفل ← الأطفال", uk: "дитина → діти" }, { de: "die Frau → die Frauen", ku: "ژن → ژنان", tr: "kadın → kadınlar", en: "the woman → the women", ar: "المرأة ← النساء", uk: "жінка → жінки" }, { de: "das Auto → die Autos", ku: "ئۆتۆمبێل → ئۆتۆمبێلەکان", tr: "araba → arabalar", en: "the car → the cars", ar: "السيارة ← السيارات", uk: "машина → машини" }, { de: "der Tisch → die Tische", ku: "مێز → مێزەکان", tr: "masa → masalar", en: "the table → the tables", ar: "الطاولة ← الطاولات", uk: "стіл → столи" }, { de: "der Apfel → die Äpfel", ku: "سێو → سێوەکان", tr: "elma → elmalar", en: "the apple → the apples", ar: "التفاحة ← التفاحات", uk: "яблуко → яблука" }, { de: "das Buch → die Bücher", ku: "کتێب → کتێبەکان", tr: "kitap → kitaplar", en: "the book → the books", ar: "الكتاب ← الكتب", uk: "книга → книги" } ] },
    { de: "Bestimmte / unbestimmte Artikel", ku: "ئارتیکڵی دیاریکراو و نادیار", icon: "✧",
      ...
      ar: "أدوات التعريف المعرّفة والنكرة", uk: "Означений / неозначений артикль", expAr: "تُستخدم «der/die/das» للأشياء المعرّفة (التي نعرفها). وتُستخدم «ein/eine» للأشياء غير المعرّفة (شيء يُذكر لأول مرة). للمحايد والمذكر تُستخدم «ein»، وللمؤنث تُستخدم «eine».", expUk: "«der/die/das» вживається для означених речей (які ми вже знаємо). «ein/eine» вживається для неозначених речей (про які згадують уперше). Для середнього і чоловічого роду вживається «ein», для жіночого — «eine».",
      ex: [ { de: "Das ist ein Buch.", ku: "ئەمە کتێبێکە (نادیار).", tr: "Bu bir kitap. (belirsiz)", en: "This is a book. (indefinite)", ar: "هذا كتاب. (نكرة)", uk: "Це книга. (неозначений)" }, { de: "Das Buch ist neu.", ku: "کتێبەکە نوێیە (دیاریکراو).", tr: "Kitap yeni. (belirli)", en: "The book is new. (definite)", ar: "الكتاب جديد. (معرفة)", uk: "Книга нова. (означений)" }, { de: "Ich habe eine Frage.", ku: "پرسیارێکم هەیە.", tr: "Bir sorum var.", en: "I have a question.", ar: "لدي سؤال.", uk: "У мене є питання." }, { de: "Ein Mann wartet draußen.", ku: "پیاوێک لە دەرەوە چاوەڕێیە.", tr: "Dışarıda bir adam bekliyor.", en: "A man is waiting outside.", ar: "رجل ينتظر في الخارج.", uk: "Надворі чекає чоловік." }, { de: "Der Mann ist mein Vater.", ku: "پیاوەکە باوکمە.", tr: "Adam babam.", en: "The man is my father.", ar: "الرجل هو أبي.", uk: "Цей чоловік — мій батько." }, { de: "Eine Katze schläft hier.", ku: "پشیلەیەک لێرە خەوتووە.", tr: "Burada bir kedi uyuyor.", en: "A cat is sleeping here.", ar: "قطة نائمة هنا.", uk: "Тут спить кішка." } ] },
    { de: "Akkusativ", ku: "ئاککوزاتیڤ (بەرکاری ڕاستەوخۆ)", icon: "→",
      ...
      ar: "حالة النصب (الأكوزاتيف)", uk: "Знахідний відмінок (Akkusativ)", expAr: "حالة النصب (الأكوزاتيف) هي حالة المفعول به المباشر. تتغير فقط أداة المذكر: der ← den، ein ← einen. أما المؤنث والمحايد فلا يتغيران.", expUk: "Знахідний відмінок — це відмінок прямого додатка. Змінюється лише артикль чоловічого роду: der → den, ein → einen. Жіночий і середній рід не змінюються.",
      ex: [ { de: "Ich sehe den Mann.", ku: "پیاوەکە دەبینم.", tr: "Adamı görüyorum.", en: "I see the man.", ar: "أرى الرجل.", uk: "Я бачу чоловіка." }, { de: "Ich kaufe einen Apfel.", ku: "سێوێک دەکڕم.", tr: "Bir elma satın alıyorum.", en: "I am buying an apple.", ar: "أشتري تفاحة.", uk: "Я купую яблуко." }, { de: "Ich lese das Buch.", ku: "کتێبەکە دەخوێنمەوە.", tr: "Kitabı okuyorum.", en: "I am reading the book.", ar: "أقرأ الكتاب.", uk: "Я читаю книгу." }, { de: "Er hat einen Hund.", ku: "سەگێکی هەیە.", tr: "Bir köpeği var.", en: "He has a dog.", ar: "لديه كلب.", uk: "У нього є собака." }, { de: "Wir brauchen den Schlüssel.", ku: "پێویستیمان بە کلیلەکەیە.", tr: "Anahtara ihtiyacımız var.", en: "We need the key.", ar: "نحتاج إلى المفتاح.", uk: "Нам потрібен ключ." }, { de: "Ich trinke eine Cola.", ku: "کۆلایەک دەخۆمەوە.", tr: "Bir kola içiyorum.", en: "I am drinking a cola.", ar: "أشرب كولا.", uk: "Я п'ю колу." } ] },
    { de: "Possessivartikel", ku: "ئارتیکڵی خاوەندارێتی", icon: "✪",
      ...
      ar: "أدوات الملكية", uk: "Присвійні артиклі", expAr: "mein (ملكي)، dein (ملكك)، sein (ملكه - للمذكر)، ihr (ملكها - للمؤنث)، unser (ملكنا). تتوافق مع جنس الاسم.", expUk: "mein (мій), dein (твій), sein (його), ihr (її), unser (наш). Вони узгоджуються з родом іменника.",
      ex: [ { de: "Das ist mein Buch.", ku: "ئەمە کتێبی منە.", tr: "Bu benim kitabım.", en: "This is my book.", ar: "هذا كتابي.", uk: "Це моя книга." }, { de: "Deine Tasche ist schön.", ku: "جانتاکەت جوانە.", tr: "Çantan güzel.", en: "Your bag is nice.", ar: "حقيبتك جميلة.", uk: "Твоя сумка гарна." }, { de: "Sein Auto ist neu.", ku: "ئۆتۆمبێلەکەی نوێیە.", tr: "Onun arabası yeni.", en: "His car is new.", ar: "سيارته جديدة.", uk: "Його машина нова." }, { de: "Ihre Mutter ist Ärztin.", ku: "دایکی پزیشکە.", tr: "Annesi doktor.", en: "Her mother is a doctor.", ar: "أمها طبيبة.", uk: "Її мати лікарка." }, { de: "Unser Haus ist groß.", ku: "خانووەکەمان گەورەیە.", tr: "Evimiz büyük.", en: "Our house is big.", ar: "بيتنا كبير.", uk: "Наш будинок великий." }, { de: "Euer Lehrer ist nett.", ku: "مامۆستاکەتان بەسۆزە.", tr: "Öğretmeniniz nazik.", en: "Your (all) teacher is nice.", ar: "معلمكم لطيف.", uk: "Ваш учитель добрий." } ] },
    { de: "Negation: nicht / kein", ku: "نەرێ کردن (nicht/kein)", icon: "⊘",
      ...
      ar: "النفي: nicht / kein", uk: "Заперечення: nicht / kein", expAr: "«nicht» تُستخدم لنفي الفعل أو الصفة أو الجملة. «kein» تُستخدم لنفي الاسم (مع أداة النكرة أو بدون أداة).", expUk: "«nicht» заперечує дієслово, прикметник або речення. «kein» заперечує іменник (вживається з неозначеним артиклем або без артикля).",
      ex: [ { de: "Ich verstehe nicht.", ku: "تێناگەم.", tr: "Anlamıyorum.", en: "I don't understand.", ar: "لا أفهم.", uk: "Я не розумію." }, { de: "Ich habe kein Geld.", ku: "پارەم نییە.", tr: "Param yok.", en: "I have no money.", ar: "ليس لدي مال.", uk: "У мене немає грошей." }, { de: "Das ist nicht richtig.", ku: "ئەمە ڕاست نییە.", tr: "Bu doğru değil.", en: "That is not correct.", ar: "هذا ليس صحيحا.", uk: "Це неправильно." }, { de: "Er ist nicht hier.", ku: "ئەو لێرە نییە.", tr: "O burada değil.", en: "He is not here.", ar: "هو ليس هنا.", uk: "Його тут немає." }, { de: "Ich habe keine Zeit.", ku: "کاتم نییە.", tr: "Zamanım yok.", en: "I have no time.", ar: "ليس لدي وقت.", uk: "У мене немає часу." }, { de: "Das macht keinen Spaß.", ku: "ئەمە خۆش نییە.", tr: "Bu eğlenceli değil.", en: "That's not fun.", ar: "هذا ليس ممتعا.", uk: "Це не весело." } ] },
    { de: "W-Fragen", ku: "پرسیاری W", icon: "?",
      ...
      ar: "أسئلة الاستفهام (W-Fragen)", uk: "Питання з W (питальні слова)", expAr: "يبدأ السؤال بكلمة استفهام: wer (من)، was (ماذا)، wo (أين)، wann (متى)، wie (كيف)، warum (لماذا). يأتي الفعل في الموضع الثاني.", expUk: "Питання починається з питального слова: wer (хто), was (що), wo (де), wann (коли), wie (як), warum (чому). Дієслово стоїть на другому місці.",
      ex: [ { de: "Wo wohnst du?", ku: "لەکوێ نیشتەجێیت؟", tr: "Nerede yaşıyorsun?", en: "Where do you live?", ar: "أين تسكن؟", uk: "Де ти живеш?" }, { de: "Was machst du?", ku: "چی دەکەیت؟", tr: "Ne yapıyorsun?", en: "What are you doing?", ar: "ماذا تفعل؟", uk: "Що ти робиш?" }, { de: "Wann kommst du?", ku: "کەی دێیت؟", tr: "Ne zaman geliyorsun?", en: "When are you coming?", ar: "متى ستأتي؟", uk: "Коли ти прийдеш?" }, { de: "Wer ist das?", ku: "ئەمە کێیە؟", tr: "Bu kim?", en: "Who is that?", ar: "من هذا؟", uk: "Хто це?" }, { de: "Wie heißt du?", ku: "ناوت چییە؟", tr: "Adın ne?", en: "What is your name?", ar: "ما اسمك؟", uk: "Як тебе звати?" }, { de: "Warum lernst du Deutsch?", ku: "بۆچی ئەڵمانی فێردەبیت؟", tr: "Neden Almanca öğreniyorsun?", en: "Why are you learning German?", ar: "لماذا تتعلم الألمانية؟", uk: "Чому ти вчиш німецьку?" } ] },
    { de: "Ja/Nein-Fragen", ku: "پرسیاری بەڵێ/نەخێر", icon: "↔",
      ...
      ar: "أسئلة نعم/لا", uk: "Питання так/ні", expAr: "تبدأ هذه الأسئلة بالفعل (يأتي الفعل في الموضع الأول). الجواب يكون ja (نعم) أو nein (لا).", expUk: "Ці питання починаються з дієслова (дієслово стоїть на першому місці). Відповідь — ja (так) або nein (ні).",
      ex: [ { de: "Kommst du mit?", ku: "لەگەڵم دێیت؟", tr: "Benimle geliyor musun?", en: "Are you coming along?", ar: "هل ستأتي معي؟", uk: "Ти йдеш зі мною?" }, { de: "Hast du Zeit?", ku: "کاتت هەیە؟", tr: "Zamanın var mı?", en: "Do you have time?", ar: "هل لديك وقت؟", uk: "У тебе є час?" }, { de: "Ist das richtig?", ku: "ئەمە ڕاستە؟", tr: "Bu doğru mu?", en: "Is that correct?", ar: "هل هذا صحيح؟", uk: "Це правильно?" }, { de: "Sprichst du Englisch?", ku: "ئینگلیزی قسە دەکەیت؟", tr: "İngilizce konuşuyor musun?", en: "Do you speak English?", ar: "هل تتحدث الإنجليزية؟", uk: "Ти розмовляєш англійською?" }, { de: "Magst du Tee?", ku: "حەزت لە چایە؟", tr: "Çayı sever misin?", en: "Do you like tea?", ar: "هل تحب الشاي؟", uk: "Ти любиш чай?" }, { de: "Wohnst du hier?", ku: "لێرە نیشتەجێیت؟", tr: "Burada mı yaşıyorsun?", en: "Do you live here?", ar: "هل تسكن هنا؟", uk: "Ти тут живеш?" } ] },
    { de: "Satzstellung", ku: "ڕیزبەندی ڕستە", icon: "≡",
      ...
      ar: "ترتيب الجملة", uk: "Порядок слів", expAr: "في الجملة العادية يكون الفعل دائما في الموضع الثاني. «الموضع الثاني» قاعدة مهمة جدا في اللغة الألمانية.", expUk: "У звичайному реченні дієслово завжди стоїть на другому місці. «Друга позиція» — дуже важливе правило німецької мови.",
      ex: [ { de: "Ich lerne heute Deutsch.", ku: "ئەمڕۆ ئەڵمانی فێردەبم.", tr: "Bugün Almanca öğreniyorum.", en: "I am learning German today.", ar: "أتعلم الألمانية اليوم.", uk: "Сьогодні я вчу німецьку." }, { de: "Heute lerne ich Deutsch.", ku: "ئەمڕۆ ئەڵمانی فێردەبم (کردار هێشتا جێی ٢).", tr: "Bugün Almanca öğreniyorum (fiil hâlâ 2. sırada).", en: "Today I am learning German (verb still in position 2).", ar: "اليوم أتعلم الألمانية (الفعل ما زال في الموضع الثاني).", uk: "Сьогодні я вчу німецьку (дієслово все одно на другій позиції)." }, { de: "Morgen gehe ich nach Hause.", ku: "سبەینێ دەچمە ماڵەوە.", tr: "Yarın eve gidiyorum.", en: "Tomorrow I am going home.", ar: "غدا سأذهب إلى البيت.", uk: "Завтра я йду додому." }, { de: "Am Abend sehe ich fern.", ku: "ئێوارە تەلەفزیۆن سەیر دەکەم.", tr: "Akşam televizyon izliyorum.", en: "In the evening I watch TV.", ar: "في المساء أشاهد التلفاز.", uk: "Увечері я дивлюся телевізор." }, { de: "In Bochum wohne ich.", ku: "لە بۆخوم نیشتەجێم.", tr: "Bochum'da yaşıyorum.", en: "I live in Bochum.", ar: "أسكن في بوخوم.", uk: "Я живу в Бохумі." }, { de: "Jetzt esse ich.", ku: "ئێستا دەخۆم.", tr: "Şimdi yiyorum.", en: "Now I am eating.", ar: "الآن أنا آكل.", uk: "Зараз я їм." } ] },
    { de: "Modalverben", ku: "کرداری یاریدەدەر (مۆداڵ)", icon: "◆",
      ...
      ar: "الأفعال الناقصة (المودالية)", uk: "Модальні дієслова", expAr: "können (يستطيع)، müssen (يجب)، wollen (يريد)، dürfen (يُسمح له)، sollen (ينبغي)، möchten (يرغب). يذهب الفعل الثاني إلى نهاية الجملة بصيغة المصدر.", expUk: "können (могти), müssen (мусити), wollen (хотіти), dürfen (мати дозвіл), sollen (мати повинність), möchten (хотіти б). Друге дієслово стоїть у кінці речення в неозначеній формі.",
      ex: [ { de: "Ich kann schwimmen.", ku: "دەتوانم مەلە بکەم.", tr: "Yüzebiliyorum.", en: "I can swim.", ar: "أستطيع السباحة.", uk: "Я вмію плавати." }, { de: "Du musst lernen.", ku: "دەبێت فێربیت.", tr: "Çalışmak zorundasın.", en: "You have to study.", ar: "يجب أن تدرس.", uk: "Ти мусиш вчитися." }, { de: "Wir wollen essen.", ku: "دەمانەوێت بخۆین.", tr: "Yemek istiyoruz.", en: "We want to eat.", ar: "نريد أن نأكل.", uk: "Ми хочемо їсти." }, { de: "Darf ich rein?", ku: "دەکرێت بێمە ژوورەوە؟", tr: "İçeri girebilir miyim?", en: "May I come in?", ar: "هل يمكنني الدخول؟", uk: "Можна мені зайти?" }, { de: "Du sollst warten.", ku: "دەبێت چاوەڕێ بکەیت.", tr: "Beklemelisin.", en: "You should wait.", ar: "ينبغي أن تنتظر.", uk: "Ти маєш почекати." }, { de: "Ich möchte Kaffee.", ku: "قاوەم دەوێت.", tr: "Kahve istiyorum.", en: "I would like coffee.", ar: "أريد قهوة.", uk: "Я хотів би кави." } ] },
    { de: "Unregelmäßige Verben", ku: "کرداری ناڕێک (بنەڕەتی)", icon: "↯",
      ...
      ar: "الأفعال الشاذة", uk: "Неправильні дієслова", expAr: "بعض الأفعال تغيّر حرف العلة في صيغتي «du» و«er/sie/es» (a←ä، e←i/ie). مثال: fahren ← du fährst، essen ← du isst.", expUk: "Деякі дієслова змінюють голосну у формах «du» та «er/sie/es» (a→ä, e→i/ie). Приклад: fahren → du fährst, essen → du isst.",
      ex: [ { de: "fahren → er fährt", ku: "لێخوڕین → ئەو لێدەخوڕێت", tr: "gitmek → o gidiyor", en: "to drive → he drives", ar: "يقود ← هو يقود", uk: "їхати → він їде" }, { de: "essen → du isst", ku: "خواردن → تۆ دەخۆیت", tr: "yemek → sen yiyorsun", en: "to eat → you eat", ar: "يأكل ← أنت تأكل", uk: "їсти → ти їси" }, { de: "sehen → er sieht", ku: "بینین → ئەو دەبینێت", tr: "görmek → o görüyor", en: "to see → he sees", ar: "يرى ← هو يرى", uk: "бачити → він бачить" }, { de: "geben → du gibst", ku: "دان → تۆ دەدەیت", tr: "vermek → sen veriyorsun", en: "to give → you give", ar: "يعطي ← أنت تعطي", uk: "давати → ти даєш" }, { de: "lesen → sie liest", ku: "خوێندنەوە → ئەو دەیخوێنێتەوە", tr: "okumak → o okuyor", en: "to read → she reads", ar: "يقرأ ← هي تقرأ", uk: "читати → вона читає" }, { de: "schlafen → er schläft", ku: "خەوتن → ئەو دەخەوێت", tr: "uyumak → o uyuyor", en: "to sleep → he sleeps", ar: "ينام ← هو ينام", uk: "спати → він спить" } ] },
    { de: "Trennbare Verben", ku: "کرداری لێکدراو", icon: "⇿",
      ...
      ar: "الأفعال القابلة للانفصال", uk: "Дієслова з відокремлюваними префіксами", expAr: "بعض الأفعال لها بادئة تنفصل في زمن المضارع وتذهب إلى نهاية الجملة. مثال: aufstehen ← ich stehe auf.", expUk: "Деякі дієслова мають префікс, який у теперішньому часі відокремлюється й переходить у кінець речення. Приклад: aufstehen → ich stehe auf.",
      ex: [ { de: "Ich stehe um 7 auf.", ku: "کاتژمێر ٧ هەڵدەستم.", tr: "Saat 7'de kalkıyorum.", en: "I get up at 7.", ar: "أستيقظ الساعة السابعة.", uk: "Я встаю о 7-й." }, { de: "Er kauft ein.", ku: "ئەو بازاڕ دەکات.", tr: "O alışveriş yapıyor.", en: "He goes shopping.", ar: "هو يتسوّق.", uk: "Він робить покупки." }, { de: "Wir kommen an.", ku: "ئێمە دەگەین.", tr: "Biz varıyoruz.", en: "We arrive.", ar: "نحن نصل.", uk: "Ми прибуваємо." }, { de: "Ruf mich an!", ku: "پەیوەندیم پێوە بکە!", tr: "Beni ara!", en: "Call me!", ar: "اتصل بي!", uk: "Зателефонуй мені!" }, { de: "Der Zug fährt ab.", ku: "شەمەندەفەرەکە بەڕێدەکەوێت.", tr: "Tren kalkıyor.", en: "The train departs.", ar: "القطار يغادر.", uk: "Потяг відходить." }, { de: "Ich räume das Zimmer auf.", ku: "ژوورەکە ڕێک دەخەم.", tr: "Odayı toparlıyorum.", en: "I am tidying up the room.", ar: "أرتّب الغرفة.", uk: "Я прибираю кімнату." } ] },
    { de: "Imperativ", ku: "فەرمان", icon: "!",
      ...
      ar: "صيغة الأمر", uk: "Наказовий спосіб", expAr: "لإصدار الأوامر. du: جذر الفعل (Komm!). ihr: الجذر + t (Kommt!). Sie: الفعل + Sie (Kommen Sie!).", expUk: "Для віддавання наказів. du: основа дієслова (Komm!). ihr: основа + t (Kommt!). Sie: дієслово + Sie (Kommen Sie!).",
      ex: [ { de: "Komm her!", ku: "وەرە ئێرە!", tr: "Buraya gel!", en: "Come here!", ar: "تعال هنا!", uk: "Іди сюди!" }, { de: "Macht die Tür zu!", ku: "دەرگاکە دابخەن!", tr: "Kapıyı kapatın!", en: "Close the door!", ar: "أغلقوا الباب!", uk: "Зачиніть двері!" }, { de: "Warten Sie bitte!", ku: "تکایە چاوەڕێ بکەن!", tr: "Lütfen bekleyin!", en: "Please wait!", ar: "من فضلكم انتظروا!", uk: "Зачекайте, будь ласка!" }, { de: "Iss dein Essen!", ku: "خواردنەکەت بخۆ!", tr: "Yemeğini ye!", en: "Eat your food!", ar: "كل طعامك!", uk: "Їж свою їжу!" }, { de: "Sei ruhig!", ku: "بێدەنگ بە!", tr: "Sessiz ol!", en: "Be quiet!", ar: "كن هادئا!", uk: "Будь тихо!" }, { de: "Hören Sie zu!", ku: "گوێ بگرن!", tr: "Dinleyin!", en: "Listen!", ar: "استمعوا!", uk: "Слухайте!" } ] },
    { de: "Präpositionen: Ort & Zeit", ku: "ئامرازی شوێن و کات", icon: "⌖",
      ...
      ar: "حروف الجر: المكان والزمان", uk: "Прийменники: місце і час", expAr: "المكان: in (في داخل)، an (بجانب/عند)، auf (على)، neben (بجانب). الزمان: um (للساعة)، am (لليوم)، im (للشهر/الفصل).", expUk: "Місце: in (всередині), an (біля/на), auf (зверху на), neben (поряд). Час: um (для точної години), am (для дня), im (для місяця/пори року).",
      ex: [ { de: "Ich bin in der Schule.", ku: "لە قوتابخانەم.", tr: "Okuldayım.", en: "I am at school.", ar: "أنا في المدرسة.", uk: "Я в школі." }, { de: "Um 8 Uhr.", ku: "کاتژمێر ٨.", tr: "Saat 8.", en: "At 8 o'clock.", ar: "الساعة الثامنة.", uk: "О 8-й годині." }, { de: "Im Sommer.", ku: "لە هاویندا.", tr: "Yazın.", en: "In summer.", ar: "في الصيف.", uk: "Влітку." }, { de: "Am Montag arbeite ich.", ku: "دووشەممە کار دەکەم.", tr: "Pazartesi çalışıyorum.", en: "I work on Monday.", ar: "أعمل يوم الاثنين.", uk: "У понеділок я працюю." }, { de: "Das Bild ist an der Wand.", ku: "وێنەکە لەسەر دیوارەکەیە.", tr: "Resim duvardaki.", en: "The picture is on the wall.", ar: "اللوحة على الحائط.", uk: "Картина на стіні." }, { de: "Die Tasche ist auf dem Tisch.", ku: "جانتاکە لەسەر مێزەکەیە.", tr: "Çanta masanın üzerinde.", en: "The bag is on the table.", ar: "الحقيبة على الطاولة.", uk: "Сумка на столі." } ] },
  ],
  A2: [
    { de: "Perfekt", ku: "کاتی ڕابردووی تەواو (Perfekt)", icon: "↩",
      ...
      ar: "الماضي التام (Perfekt)", uk: "Доконаний минулий час (Perfekt)", expAr: "haben/sein + Partizip II. معظم الأفعال تأخذ haben؛ أفعال الحركة والتغيير تأخذ sein. صيغة Partizip II غالبًا ما تُبنى بـ ge...t أو ge...en.", expUk: "haben/sein + Partizip II. Більшість дієслів беруть haben; дієслова руху й зміни стану беруть sein. Partizip II зазвичай утворюється за допомогою ge...t або ge...en.",
      ex: [ { de: "Ich habe gegessen.", ku: "خواردم.", tr: "Yedim.", en: "I have eaten.", ar: "أكلتُ.", uk: "Я поїв." }, { de: "Wir haben gelernt.", ku: "فێربووین.", tr: "Öğrendik.", en: "We have learned.", ar: "تعلّمنا.", uk: "Ми навчилися." }, { de: "Er ist gegangen.", ku: "ئەو ڕۆیشت.", tr: "O gitti.", en: "He went.", ar: "لقد ذهب.", uk: "Він пішов." }, { de: "Sie hat ein Buch gekauft.", ku: "کتێبێکی کڕی.", tr: "Bir kitap satın aldı.", en: "She bought a book.", ar: "اشترت كتابًا.", uk: "Вона купила книгу." }, { de: "Ich bin nach Berlin gefahren.", ku: "چووم بۆ بەرلین.", tr: "Berlin'e gittim.", en: "I traveled to Berlin.", ar: "سافرتُ إلى برلين.", uk: "Я поїхав до Берліна." }, { de: "Hast du das gesehen?", ku: "ئەمەت بینی؟", tr: "Bunu gördün mü?", en: "Did you see that?", ar: "هل رأيت ذلك؟", uk: "Ти це бачив?" } ] },
    { de: "Präteritum (sein, haben, Modalverben)", ku: "ڕابردووی سادە", icon: "↪",
      ...
      ar: "الماضي البسيط (sein وhaben والأفعال الناقصة)", uk: "Простий минулий час (sein, haben, модальні дієслова)", expAr: "بالنسبة إلى sein وhaben والأفعال الوجوبية (المودالية)، يُستخدم الماضي البسيط (Präteritum) أيضًا في الحديث اليومي: war (كان)، hatte (كان لديه)، konnte (استطاع)، musste (كان مضطرًا).", expUk: "Для sein, haben та модальних дієслів у повсякденному мовленні також вживається Präteritum (простий минулий час): war (був), hatte (мав), konnte (міг), musste (мусив).",
      ex: [ { de: "Ich war krank.", ku: "نەخۆش بووم.", tr: "Hasta idim.", en: "I was sick.", ar: "كنتُ مريضًا.", uk: "Я був хворий." }, { de: "Sie hatte Zeit.", ku: "کاتی هەبوو.", tr: "Zamanı vardı.", en: "She had time.", ar: "كان لديها وقت.", uk: "У неї був час." }, { de: "Wir konnten nicht kommen.", ku: "نەماندەتوانی بێین.", tr: "Gelemezdik.", en: "We could not come.", ar: "لم نستطع القدوم.", uk: "Ми не могли прийти." }, { de: "Es war sehr kalt.", ku: "زۆر سارد بوو.", tr: "Çok soğuktu.", en: "It was very cold.", ar: "كان الجو باردًا جدًا.", uk: "Було дуже холодно." }, { de: "Er musste arbeiten.", ku: "پێویست بوو کار بکات.", tr: "Çalışmak zorundaydı.", en: "He had to work.", ar: "كان عليه أن يعمل.", uk: "Він мусив працювати." }, { de: "Ich hatte keine Wahl.", ku: "هیچ هەڵبژاردنێکم نەبوو.", tr: "Seçeneğim yoktu.", en: "I had no choice.", ar: "لم يكن لديّ خيار.", uk: "У мене не було вибору." } ] },
    { de: "Dativ", ku: "داتیڤ (بەرکاری ناڕاستەوخۆ)", icon: "→",
      ...
      ar: "حالة الجر (الداتيف)", uk: "Давальний відмінок (Dativ)", expAr: "حالة الجر (الداتيف) هي حالة المفعول به غير المباشر (لمن؟). تتغيّر أداة التعريف: der→dem، die→der، das→dem، die (الجمع)→den+n.", expUk: "Давальний відмінок — це відмінок непрямого додатка (кому?). Артикль змінюється: der→dem, die→der, das→dem, die (множина)→den+n.",
      ex: [ { de: "Ich gebe dem Kind ein Buch.", ku: "کتێبێک دەدەم بە منداڵەکە.", tr: "Çocuğa bir kitap veriyorum.", en: "I am giving the child a book.", ar: "أعطي الطفلَ كتابًا.", uk: "Я даю дитині книгу." }, { de: "Ich helfe der Frau.", ku: "یارمەتی ژنەکە دەدەم.", tr: "Kadına yardım ediyorum.", en: "I am helping the woman.", ar: "أساعد المرأةَ.", uk: "Я допомагаю жінці." }, { de: "Es gehört dem Mann.", ku: "هی پیاوەکەیە.", tr: "O adama ait.", en: "It belongs to the man.", ar: "إنه يخص الرجل.", uk: "Це належить чоловікові." }, { de: "Ich danke dir.", ku: "سوپاست دەکەم.", tr: "Sana teşekkür ederim.", en: "I thank you.", ar: "أشكرك.", uk: "Я дякую тобі." }, { de: "Das Buch gehört mir.", ku: "کتێبەکە هی منە.", tr: "Kitap bana ait.", en: "The book belongs to me.", ar: "الكتاب لي.", uk: "Книга належить мені." }, { de: "Sie hilft den Kindern.", ku: "یارمەتی منداڵەکان دەدات.", tr: "Çocuklara yardım ediyor.", en: "She helps the children.", ar: "تساعد الأطفالَ.", uk: "Вона допомагає дітям." } ] },
    { de: "Wechselpräpositionen", ku: "ئامرازی دوولایەن", icon: "⇆",
      ...
      ar: "حروف الجر ثنائية الحالة", uk: "Прийменники подвійного керування", expAr: "تسعة حروف جر (in, an, auf, über, unter, vor, hinter, neben, zwischen) تأخذ حالة النصب (Akkusativ) وحالة الجر (Dativ) معًا. الحركة → نصب (إلى أين؟)، والمكان → جر (أين؟).", expUk: "Дев'ять прийменників (in, an, auf, über, unter, vor, hinter, neben, zwischen) керують як знахідним, так і давальним відмінком. Рух→знахідний (куди?), місцезнаходження→давальний (де?).",
      ex: [ { de: "Ich gehe in die Schule.", ku: "دەچمە قوتابخانە (جووڵە/Akk).", tr: "Okula gidiyorum (hareket/Akk).", en: "I am going to school (motion/Akk).", ar: "أذهب إلى المدرسة (حركة/نصب).", uk: "Я йду до школи (рух/Akk)." }, { de: "Ich bin in der Schule.", ku: "لە قوتابخانەم (شوێن/Dativ).", tr: "Okuldayım (yer/Datif).", en: "I am at school (location/Dativ).", ar: "أنا في المدرسة (مكان/جر).", uk: "Я в школі (місце/Dativ)." }, { de: "Das Buch liegt auf dem Tisch.", ku: "کتێبەکە لەسەر مێزەکەیە.", tr: "Kitap masanın üzerinde.", en: "The book is lying on the table.", ar: "الكتاب موضوع على الطاولة.", uk: "Книга лежить на столі." }, { de: "Ich lege das Buch auf den Tisch.", ku: "کتێبەکە دەخەمە سەر مێزەکە.", tr: "Kitabı masanın üzerine koyuyorum.", en: "I am putting the book on the table.", ar: "أضع الكتاب على الطاولة.", uk: "Я кладу книгу на стіл." }, { de: "Die Katze ist unter dem Bett.", ku: "پشیلەکە لەژێر جێگاکەیە.", tr: "Kedi yatağın altında.", en: "The cat is under the bed.", ar: "القطة تحت السرير.", uk: "Кішка під ліжком." }, { de: "Er hängt das Bild an die Wand.", ku: "وێنەکە بە دیوارەوە هەڵدەواسێت.", tr: "Resmi duvara asıyor.", en: "He is hanging the picture on the wall.", ar: "يعلّق الصورة على الحائط.", uk: "Він вішає картину на стіну." } ] },
    { de: "Pronomen: Personal-, Possessiv-, Demonstrativ-", ku: "جۆرەکانی جێناو", icon: "⁂",
      ...
      ar: "الضمائر: الشخصية والملكية والإشارية", uk: "Займенники: особові, присвійні, вказівні", expAr: "الضمائر الشخصية (er, ihn, ihm)، والضمائر الملكية (meiner, deiner)، وضمائر الإشارة (dieser, jener) — للإشارة إلى الأشياء وتجنّب تكرار الاسم.", expUk: "Особові займенники (er, ihn, ihm), присвійні займенники (meiner, deiner), вказівні займенники (dieser, jener) — для вказування на предмети та уникнення повторення іменника.",
      ex: [ { de: "Ich sehe ihn.", ku: "ئەو دەبینم.", tr: "Onu görüyorum.", en: "I see him.", ar: "أراه.", uk: "Я бачу його." }, { de: "Dieser Stuhl ist frei.", ku: "ئەم کورسییە بەتاڵە.", tr: "Bu sandalye boş.", en: "This chair is free.", ar: "هذا الكرسي فارغ.", uk: "Цей стілець вільний." }, { de: "Das ist meiner.", ku: "ئەمە هی منە.", tr: "Bu benimki.", en: "That is mine.", ar: "هذا لي.", uk: "Це моє." }, { de: "Ich gebe ihm das Buch.", ku: "کتێبەکەی دەدەمێ.", tr: "Ona kitabı veriyorum.", en: "I am giving him the book.", ar: "أعطيه الكتاب.", uk: "Я даю йому книгу." }, { de: "Diese Tasche ist schön.", ku: "ئەم جانتایە جوانە.", tr: "Bu çanta güzel.", en: "This bag is beautiful.", ar: "هذه الحقيبة جميلة.", uk: "Ця сумка гарна." }, { de: "Welches möchtest du? Dieses.", ku: "کامەت دەوێت؟ ئەمە.", tr: "Hangisini istiyorsun? Bunu.", en: "Which one do you want? This one.", ar: "أيّها تريد؟ هذا.", uk: "Яку ти хочеш? Оцю." } ] },
    { de: "Reflexive Verben", ku: "کرداری لێکدراوەی خۆ", icon: "↺",
      ...
      ar: "الأفعال الانعكاسية", uk: "Зворотні дієслова", expAr: "بعض الأفعال تأخذ ضمير انعكاس (mich, dich, sich…). مثال: sich freuen (أن يفرح)، sich waschen (أن يغتسل).", expUk: "Деякі дієслова беруть зворотний займенник (mich, dich, sich…). Приклад: sich freuen (радіти), sich waschen (митися).",
      ex: [ { de: "Ich freue mich.", ku: "دڵخۆشم.", tr: "Sevincim var.", en: "I am glad.", ar: "أنا سعيد.", uk: "Я радію." }, { de: "Er wäscht sich.", ku: "خۆی دەشوات.", tr: "O yıkanıyor.", en: "He is washing himself.", ar: "هو يغتسل.", uk: "Він миється." }, { de: "Wir treffen uns.", ku: "یەکتر دەبینین.", tr: "Birbirimizle buluşuyoruz.", en: "We are meeting each other.", ar: "نلتقي ببعضنا.", uk: "Ми зустрічаємося." }, { de: "Setz dich bitte.", ku: "تکایە دانیشە.", tr: "Lütfen oturun.", en: "Please sit down.", ar: "تفضل بالجلوس من فضلك.", uk: "Сідай, будь ласка." }, { de: "Sie interessiert sich für Musik.", ku: "ئارەزووی مۆسیقا دەکات.", tr: "Müziğe ilgi duyuyor.", en: "She is interested in music.", ar: "هي مهتمة بالموسيقى.", uk: "Вона цікавиться музикою." }, { de: "Ich fühle mich gut.", ku: "هەست بە باشی دەکەم.", tr: "Kendimi iyi hissediyorum.", en: "I feel good.", ar: "أشعر بأنني بخير.", uk: "Я почуваюся добре." } ] },
    { de: "Komparativ", ku: "بەراوردی (پلەی بەرز)", icon: "≷",
      ...
      ar: "صيغة المقارنة (التفضيل)", uk: "Вищий ступінь порівняння", expAr: "للمقارنة: الصفة + -er + als. مثال: groß → größer als. بعض الصفات الشاذة: gut → besser.", expUk: "Для порівняння: прикметник + -er + als. Приклад: groß → größer als. Деякі неправильні: gut → besser.",
      ex: [ { de: "Er ist größer als ich.", ku: "ئەو لە من گەورەترە.", tr: "O benden uzun.", en: "He is taller than me.", ar: "هو أطول مني.", uk: "Він вищий за мене." }, { de: "Heute ist es kälter.", ku: "ئەمڕۆ ساردترە.", tr: "Bugün daha soğuk.", en: "Today it is colder.", ar: "اليوم الجو أبرد.", uk: "Сьогодні холодніше." }, { de: "Das ist besser.", ku: "ئەمە باشترە.", tr: "Bu daha iyi.", en: "That is better.", ar: "هذا أفضل.", uk: "Це краще." }, { de: "Sie ist jünger als er.", ku: "ئەو لە ئەو گەنجترە.", tr: "O ondan genç.", en: "She is younger than him.", ar: "هي أصغر منه سنًا.", uk: "Вона молодша за нього." }, { de: "Dieses Auto ist teurer.", ku: "ئەم ئۆتۆمبێلە گرانترە.", tr: "Bu araba daha pahalı.", en: "This car is more expensive.", ar: "هذه السيارة أغلى.", uk: "Ця машина дорожча." }, { de: "Deutsch ist schwerer als Englisch.", ku: "ئەڵمانی لە ئینگلیزی قورسترە.", tr: "Almanca İngilizce'den zor.", en: "German is harder than English.", ar: "الألمانية أصعب من الإنجليزية.", uk: "Німецька важча за англійську." } ] },
    { de: "Superlativ", ku: "بەرزترین پلە", icon: "★",
      ...
      ar: "صيغة التفضيل المطلق", uk: "Найвищий ступінь порівняння", expAr: "صيغة التفضيل المطلق: am + الصفة + -sten، أو der/die/das + -ste. مثال: am größten (الأكبر).", expUk: "Найвищий ступінь: am + прикметник + -sten або der/die/das + -ste. Приклад: am größten (найбільший/найвищий).",
      ex: [ { de: "Er ist am größten.", ku: "ئەو گەورەترینە.", tr: "O en uzun.", en: "He is the tallest.", ar: "هو الأطول.", uk: "Він найвищий." }, { de: "Das ist das beste Buch.", ku: "ئەمە باشترین کتێبە.", tr: "Bu en iyi kitap.", en: "That is the best book.", ar: "هذا أفضل كتاب.", uk: "Це найкраща книга." }, { de: "Sie läuft am schnellsten.", ku: "ئەو خێراترین ڕادەکات.", tr: "O en hızlı koşuyor.", en: "She runs the fastest.", ar: "هي تركض الأسرع.", uk: "Вона біжить найшвидше." }, { de: "Das ist der höchste Berg.", ku: "ئەمە بەرزترین شاخە.", tr: "Bu en yüksek dağ.", en: "That is the highest mountain.", ar: "هذا أعلى جبل.", uk: "Це найвища гора." }, { de: "Heute ist der kälteste Tag.", ku: "ئەمڕۆ ساردترین ڕۆژە.", tr: "Bugün en soğuk gün.", en: "Today is the coldest day.", ar: "اليوم هو أبرد يوم.", uk: "Сьогодні найхолодніший день." }, { de: "Du bist mein bester Freund.", ku: "تۆ باشترین هاوڕێمی.", tr: "Sen en iyi arkadaşımsın.", en: "You are my best friend.", ar: "أنت أفضل صديق لي.", uk: "Ти мій найкращий друг." } ] },
    { de: "Konjunktionen: und, oder, aber, denn, sondern", ku: "گرێدەرە سادەکان", icon: "&",
      ...
      ar: "أدوات الربط: und، oder، aber، denn، sondern", uk: "Сполучники: und, oder, aber, denn, sondern", expAr: "هذه الأدوات الرابطة لا تغيّر ترتيب الجملة (يبقى الفعل في الموضع الثاني): und (و)، oder (أو)، aber (لكن)، denn (لأنّ)، sondern (بل).", expUk: "Ці сполучники не змінюють порядок слів (дієслово залишається на другій позиції): und (і), oder (або), aber (але), denn (бо), sondern (а навпаки).",
      ex: [ { de: "Ich lerne, denn es ist wichtig.", ku: "فێردەبم، چونکە گرنگە.", tr: "Öğreniyorum, çünkü önemli.", en: "I am studying, because it is important.", ar: "أتعلّم لأنه مهم.", uk: "Я вчуся, бо це важливо." }, { de: "Tee oder Kaffee?", ku: "چا یان قاوە؟", tr: "Çay mı kahve mi?", en: "Tea or coffee?", ar: "شاي أم قهوة؟", uk: "Чай чи кава?" }, { de: "Nicht heute, sondern morgen.", ku: "نەک ئەمڕۆ، بەڵکو سبەینێ.", tr: "Bugün değil, yarın.", en: "Not today, but tomorrow.", ar: "ليس اليوم، بل غدًا.", uk: "Не сьогодні, а завтра." }, { de: "Ich bin müde, aber glücklich.", ku: "ماندووم، بەڵام بەختەوەرم.", tr: "Yorgunum ama mutluyum.", en: "I am tired, but happy.", ar: "أنا متعب لكن سعيد.", uk: "Я втомлений, але щасливий." }, { de: "Er kommt und sie geht.", ku: "ئەو دێت و ئەو دەڕوات.", tr: "O geliyor, o gidiyor.", en: "He is coming and she is going.", ar: "هو يأتي وهي تذهب.", uk: "Він приходить, а вона йде." }, { de: "Ich bleibe, aber du gehst.", ku: "دەمێنمەوە، بەڵام تۆ دەڕۆیت.", tr: "Kalıyorum ama sen gidiyorsun.", en: "I am staying, but you are going.", ar: "أنا أبقى لكنك تذهب.", uk: "Я залишаюся, але ти йдеш." } ] },
    { de: "Nebensatz: weil, dass", ku: "ڕستەی لاوەکی (weil/dass)", icon: "⟜",
      ...
      ar: "الجمل الثانوية: weil، dass", uk: "Підрядні речення: weil, dass", expAr: "بعد weil (لأنّ) وdass (أنّ)، ينتقل الفعل إلى نهاية الجملة الفرعية. هذا فرق كبير عن الجملة البسيطة.", expUk: "Після weil (тому що) і dass (що) дієслово переходить у кінець підрядного речення. Це головна відмінність від простого речення.",
      ex: [ { de: "Ich bleibe, weil ich krank bin.", ku: "دەمێنمەوە، چونکە نەخۆشم.", tr: "Kalıyorum çünkü hastayım.", en: "I am staying because I am sick.", ar: "أبقى لأني مريض.", uk: "Я залишаюся, бо я хворий." }, { de: "Ich weiß, dass du kommst.", ku: "دەزانم کە دێیت.", tr: "Geldiğini biliyorum.", en: "I know that you are coming.", ar: "أعلم أنك قادم.", uk: "Я знаю, що ти прийдеш." }, { de: "Er sagt, dass es regnet.", ku: "دەڵێت کە باران دەبارێت.", tr: "Yağmur yağdığını söylüyor.", en: "He says that it is raining.", ar: "يقول إنّ المطر يهطل.", uk: "Він каже, що йде дощ." }, { de: "Ich lerne, weil ich es brauche.", ku: "فێردەبم، چونکە پێویستمە.", tr: "İhtiyacım olduğu için öğreniyorum.", en: "I am learning because I need it.", ar: "أتعلّم لأنني بحاجة إليه.", uk: "Я вчуся, бо мені це потрібно." }, { de: "Sie glaubt, dass es stimmt.", ku: "پێیوایە کە ڕاستە.", tr: "Doğru olduğuna inanıyor.", en: "She believes that it is true.", ar: "تعتقد أن ذلك صحيح.", uk: "Вона вірить, що це правда." }, { de: "Wir gehen, weil es spät ist.", ku: "دەڕۆین، چونکە درەنگە.", tr: "Geç olduğu için gidiyoruz.", en: "We are leaving because it is late.", ar: "نذهب لأن الوقت متأخر.", uk: "Ми йдемо, бо вже пізно." } ] },
    { de: "Relativsätze (basic)", ku: "ڕستەی پەیوەندیدار (سادە)", icon: "⌐",
      ...
      ar: "جمل الصلة (أساسي)", uk: "Підрядні означальні речення (основи)", expAr: "تُستخدم لإعطاء معلومات إضافية عن الاسم. الضمير الموصول (der, die, das) يتوافق مع جنس الاسم، وينتقل الفعل إلى نهاية الجملة.", expUk: "Вживаються, щоб дати більше інформації про іменник. Відносний займенник (der, die, das) узгоджується з родом іменника, а дієслово переходить у кінець.",
      ex: [ { de: "Der Mann, der dort steht, ...", ku: "ئەو پیاوەی لەوێ ڕاوەستاوە، ...", tr: "Orada duran adam, ...", en: "The man who is standing there, ...", ar: "الرجل الذي يقف هناك، ...", uk: "Чоловік, який там стоїть, …" }, { de: "Das Buch, das ich lese, ...", ku: "ئەو کتێبەی دەیخوێنمەوە، ...", tr: "Okuduğum kitap, ...", en: "The book that I am reading, ...", ar: "الكتاب الذي أقرؤه، ...", uk: "Книга, яку я читаю, …" }, { de: "Die Frau, die singt, ...", ku: "ئەو ژنەی گۆرانی دەڵێت، ...", tr: "Şarkı söyleyen kadın, ...", en: "The woman who is singing, ...", ar: "المرأة التي تغني، ...", uk: "Жінка, яка співає, …" }, { de: "Das Auto, das rot ist, ...", ku: "ئەو ئۆتۆمبێلەی سوورە، ...", tr: "Kırmızı araba, ...", en: "The red car, ...", ar: "السيارة الحمراء، ...", uk: "Машина, яка червона, …" }, { de: "Der Freund, der hilft, ...", ku: "ئەو هاوڕێیەی یارمەتی دەدات، ...", tr: "Yardım eden arkadaş, ...", en: "The friend who helps, ...", ar: "الصديق الذي يساعد، ...", uk: "Друг, який допомагає, …" }, { de: "Die Stadt, die schön ist, ...", ku: "ئەو شارەی جوانە، ...", tr: "Güzel şehir, ...", en: "The beautiful city, ...", ar: "المدينة الجميلة، ...", uk: "Місто, яке гарне, …" } ] },
    { de: "Genitiv (Einführung)", ku: "گەنیتیڤ (ناساندن)", icon: "'s",
      ...
      ar: "حالة الإضافة (الجنيتيف) - مقدمة", uk: "Родовий відмінок (вступ)", expAr: "حالة الإضافة (الجينيتيف) تدل على الملكية (ملك من؟). أداة التعريف: des/eines (+s للمذكر والمحايد)، der (للمؤنث).", expUk: "Родовий відмінок показує належність (чий?). Артикль: des/eines (+s для іменників чоловічого/середнього роду), der (жіночий).",
      ex: [ { de: "das Auto des Mannes", ku: "ئۆتۆمبێلی پیاوەکە", tr: "adamın arabası", en: "the man's car", ar: "سيارة الرجل", uk: "машина чоловіка" }, { de: "die Farbe der Blume", ku: "ڕەنگی گوڵەکە", tr: "çiçeğin rengi", en: "the flower's color", ar: "لون الزهرة", uk: "колір квітки" }, { de: "der Titel des Buches", ku: "ناونیشانی کتێبەکە", tr: "kitabın başlığı", en: "the book's title", ar: "عنوان الكتاب", uk: "назва книги" }, { de: "das Haus meiner Eltern", ku: "خانووی دایک و باوکم", tr: "annemin babamın evi", en: "my parents' house", ar: "بيت والدَيّ", uk: "будинок моїх батьків" }, { de: "der Name des Kindes", ku: "ناوی منداڵەکە", tr: "çocuğun adı", en: "the child's name", ar: "اسم الطفل", uk: "ім'я дитини" }, { de: "die Tür des Hauses", ku: "دەرگای خانووەکە", tr: "evin kapısı", en: "the house's door", ar: "باب البيت", uk: "двері будинку" } ] },
  ],
  B1: [
    { de: "Adjektivdeklination", ku: "ڕەوانبێژی سیفەت", icon: "✦",
      ...
      ar: "تصريف الصفات", uk: "Відмінювання прикметників", expAr: "عندما تأتي الصفة قبل الاسم، تتغير نهايتها حسب أداة التعريف والجنس والحالة الإعرابية. بعد der/die/das تكون عادة -e أو -en.", expUk: "Коли прикметник стоїть перед іменником, його закінчення змінюється відповідно до артикля, роду й відмінка. Після der/die/das воно зазвичай -e або -en.",
      ex: [ { de: "der rote Apfel", ku: "سێوە سوورەکە", tr: "kırmızı elma (belirli eril)", en: "the red apple (definite masculine)", ar: "التفاحة الحمراء (مذكر معرّف)", uk: "червоне яблуко (означений, чоловічий рід)" }, { de: "ein roter Apfel", ku: "سێوێکی سوور", tr: "kırmızı bir elma (belirsiz)", en: "a red apple (indefinite)", ar: "تفاحة حمراء (نكرة)", uk: "червоне яблуко (неозначений)" }, { de: "mit dem roten Auto", ku: "بە ئۆتۆمبێلە سوورەکە", tr: "kırmızı arabayla", en: "with the red car", ar: "بالسيارة الحمراء", uk: "з червоною машиною" }, { de: "die schöne Stadt", ku: "شارە جوانەکە", tr: "güzel şehir", en: "the beautiful city", ar: "المدينة الجميلة", uk: "гарне місто" }, { de: "ein gutes Buch", ku: "کتێبێکی باش", tr: "iyi bir kitap", en: "a good book", ar: "كتاب جيد", uk: "хороша книга" }, { de: "kaltes Wasser", ku: "ئاوی سارد", tr: "soğuk su (artikelsiz)", en: "cold water (without article)", ar: "ماء بارد (بدون أداة تعريف)", uk: "холодна вода (без артикля)" } ] },
    { de: "Genitiv", ku: "گەنیتیڤ (تەواو)", icon: "'s",
      ...
      ar: "حالة الإضافة (الجنيتيف) الكاملة", uk: "Родовий відмінок (повний)", expAr: "الملكية والعلاقة. الأسماء المذكرة والمحايدة تأخذ +s. تُستخدم أيضاً مع بعض حروف الجر (wegen، trotz).", expUk: "Належність і зв'язок. Іменники чоловічого/середнього роду беруть +s. Також вживається з певними прийменниками (wegen, trotz).",
      ex: [ { de: "das Haus meines Vaters", ku: "خانووی باوکم", tr: "babamın evi", en: "my father's house", ar: "بيت أبي", uk: "будинок мого батька" }, { de: "wegen des Wetters", ku: "بەهۆی کەش‌وهەواوە", tr: "hava yüzünden", en: "because of the weather", ar: "بسبب الطقس", uk: "через погоду" }, { de: "trotz des Regens", ku: "سەرەڕای بارانەکە", tr: "yağmura rağmen", en: "despite the rain", ar: "رغم المطر", uk: "попри дощ" }, { de: "die Meinung der Leute", ku: "بۆچوونی خەڵک", tr: "halkın görüşü", en: "the opinion of the people", ar: "رأي الناس", uk: "думка людей" }, { de: "während des Tages", ku: "لە ماوەی ڕۆژدا", tr: "gündüz boyunca", en: "during the day", ar: "خلال النهار", uk: "протягом дня" }, { de: "der Anfang des Films", ku: "سەرەتای فیلمەکە", tr: "filmin başlangıcı", en: "the beginning of the film", ar: "بداية الفيلم", uk: "початок фільму" } ] },
    { de: "Präpositionen mit Genitiv", ku: "ئامراز لەگەڵ گەنیتیڤ", icon: "⌖",
      ...
      ar: "حروف الجر مع حالة الإضافة", uk: "Прийменники з родовим відмінком", expAr: "بعض حروف الجر تأخذ حالة الإضافة (Genitiv): wegen (بسبب)، trotz (رغم)، während (أثناء)، (an)statt (بدلاً من).", expUk: "Деякі прийменники керують родовим відмінком: wegen (через), trotz (попри), während (протягом), (an)statt (замість).",
      ex: [ { de: "während des Kurses", ku: "لە ماوەی خولەکەدا", tr: "ders boyunca", en: "during the course", ar: "أثناء الدورة", uk: "протягом курсу" }, { de: "wegen des Problems", ku: "بەهۆی کێشەکەوە", tr: "sorun yüzünden", en: "because of the problem", ar: "بسبب المشكلة", uk: "через проблему" }, { de: "trotz der Kälte", ku: "سەرەڕای ساردی", tr: "soğuğa rağmen", en: "despite the cold", ar: "رغم البرد", uk: "попри холод" }, { de: "statt des Kaffees", ku: "لەبری قاوەکە", tr: "kahve yerine", en: "instead of the coffee", ar: "بدلاً من القهوة", uk: "замість кави" }, { de: "innerhalb einer Woche", ku: "لە ماوەی هەفتەیەکدا", tr: "bir hafta içinde", en: "within a week", ar: "خلال أسبوع", uk: "протягом тижня" }, { de: "außerhalb der Stadt", ku: "لە دەرەوەی شارەکە", tr: "şehrin dışında", en: "outside the city", ar: "خارج المدينة", uk: "за межами міста" } ] },
    { de: "Plusquamperfekt", ku: "ڕابردووی دوور", icon: "⟲",
      ...
      ar: "الماضي البعيد (Plusquamperfekt)", uk: "Давноминулий час (Plusquamperfekt)", expAr: "لفعل حدث قبل فعل آخر في الماضي. hatte/war + التصريف الثالث (Partizip II). كثيراً ما يُستخدم مع nachdem.", expUk: "Для дії, що відбулася перед іншою дією в минулому. hatte/war + Partizip II. Часто вживається з nachdem.",
      ex: [ { de: "Ich hatte schon gegessen.", ku: "پێشتر خواردبووم.", tr: "Daha önce yemiştim.", en: "I had already eaten.", ar: "كنتُ قد أكلتُ بالفعل.", uk: "Я вже поїв." }, { de: "Er war schon gegangen.", ku: "ئەو پێشتر ڕۆیشتبوو.", tr: "O daha önce gitmişti.", en: "He had already left.", ar: "كان قد ذهب بالفعل.", uk: "Він уже пішов." }, { de: "Nachdem ich gegessen hatte, ...", ku: "دوای ئەوەی خواردبووم، ...", tr: "Yedikten sonra, ...", en: "After I had eaten, ...", ar: "بعد أن كنتُ قد أكلتُ، ...", uk: "Після того, як я поїв, …" }, { de: "Sie hatte den Brief geschrieben.", ku: "نامەکەی نووسیبوو.", tr: "Mektubu yazmıştı.", en: "She had written the letter.", ar: "كانت قد كتبت الرسالة.", uk: "Вона написала листа." }, { de: "Wir waren schon angekommen.", ku: "پێشتر گەیشتبووین.", tr: "Daha önce gelmiştik.", en: "We had already arrived.", ar: "كنا قد وصلنا بالفعل.", uk: "Ми вже прибули." }, { de: "Hattest du das gewusst?", ku: "ئەمەت زانیبوو؟", tr: "Bunu biliyor muydun?", en: "Had you known that?", ar: "هل كنتَ قد عرفتَ ذلك؟", uk: "Ти це знав?" } ] },
    { de: "Futur I", ku: "داهاتوو (Futur I)", icon: "⇉",
      ...
      ar: "زمن المستقبل الأول", uk: "Майбутній час I", expAr: "للمستقبل والتخمين. werden + المصدر (في النهاية). لكن غالباً ما يُستخدم زمن المضارع للتعبير عن المستقبل في الحديث اليومي.", expUk: "Для майбутнього і припущень. werden + інфінітив (у кінці). Проте в повсякденному мовленні для майбутнього часто вживають теперішній час.",
      ex: [ { de: "Ich werde Deutsch lernen.", ku: "ئەڵمانی فێردەبم (داهاتوو).", tr: "Almanca öğreneceğim (gelecek).", en: "I will learn German (future).", ar: "سأتعلم الألمانية (المستقبل).", uk: "Я вивчатиму німецьку (майбутній)." }, { de: "Es wird regnen.", ku: "باران دەبارێت.", tr: "Yağmur yağacak.", en: "It will rain.", ar: "ستمطر.", uk: "Буде дощ." }, { de: "Wir werden sehen.", ku: "دەبینین.", tr: "Göreceğiz.", en: "We will see.", ar: "سنرى.", uk: "Побачимо." }, { de: "Sie wird Ärztin werden.", ku: "دەبێتە پزیشک.", tr: "Doktor olacak.", en: "She will become a doctor.", ar: "ستصبح طبيبة.", uk: "Вона стане лікаркою." }, { de: "Ich werde dich anrufen.", ku: "پەیوەندیت پێوە دەکەم.", tr: "Seni arayacağım.", en: "I will call you.", ar: "سأتصل بك.", uk: "Я тобі зателефоную." }, { de: "Morgen wird es kalt sein.", ku: "سبەینێ سارد دەبێت.", tr: "Yarın soğuk olacak.", en: "Tomorrow it will be cold.", ar: "غداً سيكون الجو بارداً.", uk: "Завтра буде холодно." } ] },
    { de: "Konjunktionen: obwohl, wenn, als, während…", ku: "گرێدەرە لاوەکییەکان", icon: "⟜",
      ...
      ar: "أدوات ربط الجمل الثانوية", uk: "Сполучники підрядних речень", expAr: "obwohl (رغم أن)، wenn (إذا/عندما)، als (عندما - ماضٍ)، während (بينما)، bevor (قبل)، nachdem (بعد)، seitdem (منذ ذلك الحين). يذهب الفعل إلى نهاية الجملة.", expUk: "obwohl (хоча), wenn (якщо/коли), als (коли — минуле), während (поки), bevor (перш ніж), nachdem (після того як), seitdem (відтоді як). Дієслово переходить у кінець речення.",
      ex: [ { de: "Als ich klein war, ...", ku: "کاتێک بچووک بووم، ...", tr: "Küçükken, ...", en: "When I was little, ...", ar: "عندما كنتُ صغيراً، ...", uk: "Коли я був малий, …" }, { de: "Bevor ich gehe, esse ich.", ku: "پێش ئەوەی بڕۆم، دەخۆم.", tr: "Gitmeden önce yiyorum.", en: "Before I go, I eat.", ar: "قبل أن أذهب، آكل.", uk: "Перш ніж піти, я їм." }, { de: "Seitdem er hier ist, ...", ku: "لەو کاتەوەی لێرەیە، ...", tr: "O burada olduğundan beri, ...", en: "Since he has been here, ...", ar: "منذ أن أصبح هنا، ...", uk: "Відтоді, як він тут, …" }, { de: "Obwohl es regnet, gehe ich.", ku: "هەرچەندە باران دەبارێت، دەڕۆم.", tr: "Her ne kadar yağmur yağsa da gidiyorum.", en: "Although it's raining, I'm going.", ar: "رغم أن المطر يهطل، سأذهب.", uk: "Хоча йде дощ, я йду." }, { de: "Wenn ich Zeit habe, komme ich.", ku: "ئەگەر کاتم هەبێت، دێم.", tr: "Zamanım olursa gelirim.", en: "If I have time, I'll come.", ar: "إذا كان لدي وقت، سآتي.", uk: "Якщо матиму час, я прийду." }, { de: "Während sie kocht, lese ich.", ku: "لە کاتێکدا ئەو خواردن لێدەنێ، دەخوێنمەوە.", tr: "O pişirirken okuyorum.", en: "While she cooks, I read.", ar: "بينما تطبخ، أقرأ.", uk: "Поки вона готує, я читаю." } ] },
    { de: "Relativsätze (detail)", ku: "ڕستەی پەیوەندیدار (ورد)", icon: "⌐",
      ...
      ar: "جمل الصلة (تفصيلي)", uk: "Підрядні означальні речення (детально)", expAr: "يتغير الضمير الموصول في جميع الحالات الإعرابية: الرفع (der)، النصب (den)، الجر (dem)، الإضافة (dessen/deren).", expUk: "Відносний займенник змінюється в кожному відмінку: називний (der), знахідний (den), давальний (dem), родовий (dessen/deren).",
      ex: [ { de: "Der Mann, dem ich helfe, ...", ku: "ئەو پیاوەی یارمەتی دەدەم، ... (Dativ)", tr: "Yardım ettiğim adam, ... (Datif)", en: "The man whom I help, ... (dative)", ar: "الرجل الذي أساعده، ... (حالة الجر)", uk: "Чоловік, якому я допомагаю, … (давальний)" }, { de: "Das Kind, dessen Buch ...", ku: "ئەو منداڵەی کتێبەکەی ... (Genitiv)", tr: "Kitabı olan çocuk, ... (Genitif)", en: "The child whose book ... (genitive)", ar: "الطفل الذي كتابه ... (حالة الإضافة)", uk: "Дитина, чия книга … (родовий)" }, { de: "Die Stadt, in der ich wohne, ...", ku: "ئەو شارەی تێیدا دەژیم، ...", tr: "İçinde yaşadığım şehir, ...", en: "The city in which I live, ...", ar: "المدينة التي أعيش فيها، ...", uk: "Місто, в якому я живу, …" }, { de: "Der Film, den ich gesehen habe, ...", ku: "ئەو فیلمەی بینیم، ...", tr: "İzlediğim film, ...", en: "The film that I have watched, ...", ar: "الفيلم الذي شاهدته، ...", uk: "Фільм, який я подивився, …" }, { de: "Die Leute, mit denen ich arbeite, ...", ku: "ئەو کەسانەی لەگەڵیان کار دەکەم، ...", tr: "Birlikte çalıştığım insanlar, ...", en: "The people with whom I work, ...", ar: "الأشخاص الذين أعمل معهم، ...", uk: "Люди, з якими я працюю, …" }, { de: "Das Auto, das er kaufte, ...", ku: "ئەو ئۆتۆمبێلەی کڕی، ...", tr: "Satın aldığı araba, ...", en: "The car that he bought, ...", ar: "السيارة التي اشتراها، ...", uk: "Машина, яку він купив, …" } ] },
    { de: "Indirekte Fragen", ku: "پرسیاری ناڕاستەوخۆ", icon: "?",
      ...
      ar: "الأسئلة غير المباشرة", uk: "Непрямі питання", expAr: "يُدرج السؤال داخل جملة؛ ويذهب الفعل إلى النهاية. تُستخدم ob (هل) لأسئلة نعم/لا.", expUk: "Питання вбудоване в речення; дієслово переходить у кінець. З ob (чи) для питань так/ні.",
      ex: [ { de: "Weißt du, wo er ist?", ku: "دەزانیت لەکوێیە؟", tr: "Nerede olduğunu biliyor musun?", en: "Do you know where he is?", ar: "هل تعرف أين هو؟", uk: "Ти знаєш, де він?" }, { de: "Ich frage, ob es regnet.", ku: "دەپرسم ئایا باران دەبارێت.", tr: "Yağmur yağıp yağmadığını soruyorum.", en: "I'm asking whether it's raining.", ar: "أسأل عما إذا كان المطر يهطل.", uk: "Я питаю, чи йде дощ." }, { de: "Sag mir, wann du kommst.", ku: "پێم بڵێ کەی دێیت.", tr: "Ne zaman geldiğini söyle.", en: "Tell me when you're coming.", ar: "أخبرني متى ستأتي.", uk: "Скажи мені, коли ти прийдеш." }, { de: "Ich weiß nicht, was das ist.", ku: "نازانم ئەمە چییە.", tr: "Bunun ne olduğunu bilmiyorum.", en: "I don't know what that is.", ar: "لا أعرف ما هذا.", uk: "Я не знаю, що це." }, { de: "Kannst du mir sagen, wie es geht?", ku: "دەتوانیت پێم بڵێیت چۆنە؟", tr: "Nasıl olduğunu söyleyebilir misiniz?", en: "Can you tell me how it's going?", ar: "هل يمكنك أن تخبرني كيف الحال؟", uk: "Можеш сказати мені, як справи?" }, { de: "Er fragt, warum du gehst.", ku: "دەپرسێت بۆچی دەڕۆیت.", tr: "Neden gittiğini soruyor.", en: "He asks why you're leaving.", ar: "يسأل لماذا تذهب.", uk: "Він питає, чому ти йдеш." } ] },
    { de: "Infinitiv mit zu", ku: "ئینفینیتیڤ لەگەڵ zu", icon: "zu",
      ...
      ar: "المصدر مع «zu»", uk: "Інфінітив із «zu»", expAr: "بعد بعض الأفعال/الأسماء/الصفات، يأتي الفعل الثاني بصيغة «zu + المصدر». مثال: «Ich versuche zu lernen» (أحاول أن أتعلم).", expUk: "Після певних дієслів, іменників або прикметників друге дієслово вживається з «zu + інфінітив». Приклад: «Ich versuche zu lernen» (Я намагаюся вчитися).",
      ex: [ { de: "Ich versuche zu lernen.", ku: "هەوڵ دەدەم فێربم.", tr: "Öğrenmeye çalışıyorum.", en: "I try to learn.", ar: "أحاول أن أتعلم.", uk: "Я намагаюся вчитися." }, { de: "Es ist wichtig zu üben.", ku: "گرنگە مەشق بکەیت.", tr: "Alıştırma yapmak önemli.", en: "It's important to practice.", ar: "من المهم أن تتدرب.", uk: "Важливо тренуватися." }, { de: "Ich habe vergessen anzurufen.", ku: "بیرم چووە پەیوەندی بکەم.", tr: "Aramayı unuttum.", en: "I forgot to call.", ar: "نسيتُ أن أتصل.", uk: "Я забув зателефонувати." }, { de: "Ich hoffe dich zu sehen.", ku: "هیوادارم بتبینم.", tr: "Seni görmeyi umuyorum.", en: "I hope to see you.", ar: "أتمنى أن أراك.", uk: "Сподіваюся тебе побачити." }, { de: "Es macht Spaß zu reisen.", ku: "گەشتکردن خۆشە.", tr: "Seyahat etmek eğlenceli.", en: "Traveling is fun.", ar: "السفر ممتع.", uk: "Подорожувати весело." }, { de: "Ich habe keine Zeit zu warten.", ku: "کاتم نییە چاوەڕێ بکەم.", tr: "Bekleyecek zamanım yok.", en: "I don't have time to wait.", ar: "ليس لدي وقت لأنتظر.", uk: "У мене немає часу чекати." } ] },
    { de: "um…zu / ohne…zu / statt…zu", ku: "um/ohne/statt + zu", icon: "⊕",
      ...
      ar: "um…zu / ohne…zu / statt…zu", uk: "um…zu / ohne…zu / statt…zu", expAr: "um…zu (لكي)، ohne…zu (من دون أن)، statt…zu (بدلاً من أن). كلا الجملتين لهما نفس الفاعل.", expUk: "um…zu (щоб), ohne…zu (не роблячи), statt…zu (замість того щоб). Обидва речення мають той самий підмет.",
      ex: [ { de: "Ich lerne, um zu bestehen.", ku: "فێردەبم بۆ ئەوەی سەربکەوم.", tr: "Sınavı geçmek için çalışıyorum.", en: "I study in order to pass.", ar: "أدرس لكي أنجح.", uk: "Я вчуся, щоб скласти іспит." }, { de: "Er geht, ohne zu grüßen.", ku: "دەڕوات بەبێ ئەوەی سڵاو بکات.", tr: "Selamlama yapmadan gitti.", en: "He leaves without saying hello.", ar: "يذهب من دون أن يلقي التحية.", uk: "Він іде, не привітавшись." }, { de: "Statt zu schlafen, lese ich.", ku: "لەبری خەوتن، دەخوێنمەوە.", tr: "Uyumak yerine okuyorum.", en: "Instead of sleeping, I read.", ar: "بدلاً من أن أنام، أقرأ.", uk: "Замість того щоб спати, я читаю." }, { de: "Ich spare, um ein Auto zu kaufen.", ku: "پارە کۆدەکەمەوە بۆ کڕینی ئۆتۆمبێل.", tr: "Araba almak için para biriktiriyorum.", en: "I'm saving up in order to buy a car.", ar: "أدخر المال لكي أشتري سيارة.", uk: "Я заощаджую, щоб купити машину." }, { de: "Sie ging, ohne etwas zu sagen.", ku: "ڕۆیشت بەبێ ئەوەی شتێک بڵێت.", tr: "Bir şey söylemeden gitti.", en: "She left without saying anything.", ar: "ذهبت من دون أن تقول شيئاً.", uk: "Вона пішла, нічого не сказавши." }, { de: "Statt zu arbeiten, spielt er.", ku: "لەبری کارکردن، یاری دەکات.", tr: "Çalışmak yerine oynuyor.", en: "Instead of working, he plays.", ar: "بدلاً من أن يعمل، يلعب.", uk: "Замість того щоб працювати, він грає." } ] },
    { de: "Passiv (Vorgangspassiv)", ku: "ڕستەی چالاک‌نەبوو", icon: "⊡",
      ...
      ar: "المبني للمجهول (السلبي الإجرائي)", uk: "Пасивний стан (пасив дії)", expAr: "تُستخدم عندما يكون الفعل أهم من فاعله. werden + التصريف الثالث (Partizip II). مثال: «Das Haus wird gebaut» (يُبنى البيت).", expUk: "Вживається, коли дія важливіша за того, хто її виконує. werden + Partizip II. Приклад: «Das Haus wird gebaut» (Будинок будується).",
      ex: [ { de: "Das Auto wird repariert.", ku: "ئۆتۆمبێلەکە چاک دەکرێتەوە.", tr: "Araba tamir ediliyor.", en: "The car is being repaired.", ar: "تُصلَح السيارة.", uk: "Машину ремонтують." }, { de: "Die Tür wird geöffnet.", ku: "دەرگاکە دەکرێتەوە.", tr: "Kapı açılıyor.", en: "The door is being opened.", ar: "يُفتح الباب.", uk: "Двері відчиняють." }, { de: "Deutsch wird hier gesprochen.", ku: "لێرە ئەڵمانی قسە دەکرێت.", tr: "Burada Almanca konuşuluyor.", en: "German is spoken here.", ar: "تُتحدَّث الألمانية هنا.", uk: "Тут розмовляють німецькою." }, { de: "Das Buch wird gelesen.", ku: "کتێبەکە دەخوێنرێتەوە.", tr: "Kitap okunuyor.", en: "The book is being read.", ar: "يُقرأ الكتاب.", uk: "Книгу читають." }, { de: "Die Arbeit wird gemacht.", ku: "کارەکە دەکرێت.", tr: "İş yapılıyor.", en: "The work is being done.", ar: "يُنجَز العمل.", uk: "Роботу виконують." }, { de: "Das Essen wird gekocht.", ku: "خواردنەکە لێدەنرێت.", tr: "Yemek pişiriliyor.", en: "The food is being cooked.", ar: "يُطهى الطعام.", uk: "Їжу готують." } ] },
    { de: "Konjunktiv II", ku: "کۆنیونکتیڤ II (مەرجی)", icon: "≈",
      ...
      ar: "الجملة الشرطية الثانية (Konjunktiv II)", uk: "Умовний спосіб II (Konjunktiv II)", expAr: "للتمني والافتراض والتأدب. würde + المصدر، أو hätte/wäre/könnte. تُستخدم كثيراً لإضفاء اللباقة على الكلام.", expUk: "Для бажань, гіпотез та ввічливості. würde + інфінітив або hätte/wäre/könnte. Часто вживається, щоб звучати ввічливо.",
      ex: [ { de: "Ich würde gern kommen.", ku: "حەز دەکەم بێم.", tr: "Gelmek isterdim.", en: "I would love to come.", ar: "أود أن آتي.", uk: "Я б залюбки прийшов." }, { de: "Ich hätte eine Frage.", ku: "پرسیارێکم هەبووایە.", tr: "Bir sorum olurdu.", en: "I would have a question.", ar: "كان لدي سؤال.", uk: "У мене було б питання." }, { de: "Könnten Sie mir helfen?", ku: "دەتوانن یارمەتیم بدەن؟", tr: "Yardım edebilir misiniz?", en: "Could you help me?", ar: "هل يمكنكم مساعدتي؟", uk: "Ви могли б мені допомогти?" }, { de: "Wenn ich reich wäre, ...", ku: "ئەگەر دەوڵەمەند بوومایە، ...", tr: "Zengin olsaydım, ...", en: "If I were rich, ...", ar: "لو كنتُ غنياً، ...", uk: "Якби я був багатий, …" }, { de: "Das wäre toll.", ku: "ئەمە نایاب دەبوو.", tr: "Harika olurdu.", en: "That would be great.", ar: "سيكون ذلك رائعاً.", uk: "Це було б чудово." }, { de: "Ich würde lieber bleiben.", ku: "پێم باشترە بمێنمەوە.", tr: "Kalmayı tercih ederdim.", en: "I would rather stay.", ar: "أُفضّل البقاء.", uk: "Я б краще залишився." } ] },
  ],
  B2: [
    { de: "Passiv (alle Formen)", ku: "ڕستەی چالاک‌نەبوو (هەموو فۆرمەکان)", icon: "⊡",
      ...
      ex: [ { de: "Das Haus wurde gebaut.", ku: "خانووەکە دروستکرا.", tr: "Ev yapıldı.", en: "The house was built.", ar: "بُني البيت.", uk: "Будинок збудували." }, { de: "Es ist verkauft worden.", ku: "فرۆشراوە.", tr: "Satıldı.", en: "It has been sold.", ar: "لقد بيع.", uk: "Це продали." }, { de: "Das wird gemacht werden.", ku: "ئەمە دەکرێت (داهاتوو).", tr: "Bu yapılacak (gelecek).", en: "This will be done (future).", ar: "سيُفعل هذا (المستقبل).", uk: "Це буде зроблено (майбутній)." }, { de: "Der Brief wurde geschrieben.", ku: "نامەکە نووسرا.", tr: "Mektup yazıldı.", en: "The letter was written.", ar: "كُتبت الرسالة.", uk: "Листа написали." }, { de: "Die Stadt ist zerstört worden.", ku: "شارەکە وێران کراوە.", tr: "Şehir yıkıldı.", en: "The city has been destroyed.", ar: "دُمّرت المدينة.", uk: "Місто зруйнували." }, { de: "Die Regeln werden erklärt.", ku: "یاساکان ڕوون دەکرێنەوە.", tr: "Kurallar açıklanıyor.", en: "The rules are being explained.", ar: "تُشرح القواعد.", uk: "Правила пояснюють." } ] },
    { de: "Zustandspassiv", ku: "Passivی دۆخ", icon: "▣",
      ...
      ex: [ { de: "Das Geschäft ist geschlossen.", ku: "دوکانەکە داخراوە.", tr: "Dükkan kapalı.", en: "The shop is closed.", ar: "المحل مغلق.", uk: "Магазин зачинений." }, { de: "Der Brief ist geschrieben.", ku: "نامەکە نووسراوە.", tr: "Mektup yazılmış.", en: "The letter is written.", ar: "الرسالة مكتوبة.", uk: "Лист написаний." }, { de: "Alles ist vorbereitet.", ku: "هەمووشت ئامادەکراوە.", tr: "Her şey hazır.", en: "Everything is prepared.", ar: "كل شيء جاهز.", uk: "Усе підготовлено." }, { de: "Das Fenster ist geöffnet.", ku: "پەنجەرەکە کراوەیە.", tr: "Pencere açık.", en: "The window is open.", ar: "النافذة مفتوحة.", uk: "Вікно відчинене." }, { de: "Die Arbeit ist erledigt.", ku: "کارەکە تەواوکراوە.", tr: "İş tamamlandı.", en: "The work is done.", ar: "العمل منجز.", uk: "Роботу виконано." }, { de: "Das Problem ist gelöst.", ku: "کێشەکە چارەسەرکراوە.", tr: "Sorun çözüldü.", en: "The problem is solved.", ar: "المشكلة محلولة.", uk: "Проблему вирішено." } ] },
    { de: "Passiv mit Modalverben", ku: "Passiv لەگەڵ مۆداڵ", icon: "⊞",
      ...
      ex: [ { de: "Das muss repariert werden.", ku: "ئەمە دەبێت چاک بکرێتەوە.", tr: "Bu tamir edilmeli.", en: "This must be repaired.", ar: "يجب إصلاح هذا.", uk: "Це треба відремонтувати." }, { de: "Es kann gemacht werden.", ku: "دەکرێت بکرێت.", tr: "Yapılabilir.", en: "It can be done.", ar: "يمكن فعله.", uk: "Це можна зробити." }, { de: "Es sollte vermieden werden.", ku: "دەبێت خۆی لێ بپارێزرێت.", tr: "Kaçınılmalıydı.", en: "It should be avoided.", ar: "ينبغي تجنّب ذلك.", uk: "Цього слід уникати." }, { de: "Das darf nicht gesagt werden.", ku: "ئەمە نابێت بگوترێت.", tr: "Bu söylenmemeli.", en: "This must not be said.", ar: "لا يجوز قول هذا.", uk: "Цього не можна казати." }, { de: "Die Regeln müssen befolgt werden.", ku: "دەبێت یاساکان پەیڕەو بکرێن.", tr: "Kurallara uyulmalı.", en: "The rules must be followed.", ar: "يجب اتباع القواعد.", uk: "Правил треба дотримуватися." }, { de: "Es kann nicht geändert werden.", ku: "ناتوانرێت بگۆڕدرێت.", tr: "Değiştirilemez.", en: "It cannot be changed.", ar: "لا يمكن تغييره.", uk: "Це неможливо змінити." } ] },
    { de: "Konjunktiv II (fortgeschritten)", ku: "کۆنیونکتیڤ II (پێشکەوتوو)", icon: "≈",
      ...
      ex: [ { de: "Ich hätte dir geholfen.", ku: "یارمەتیم بدایایت.", tr: "Sana yardım ederdim.", en: "I would have helped you.", ar: "كنت سأساعدك.", uk: "Я б тобі допоміг." }, { de: "Wenn ich Zeit gehabt hätte, ...", ku: "ئەگەر کاتم هەبووایە، ...", tr: "Zamanım olsaydı, ...", en: "If I had had time, ...", ar: "لو كان لدي وقت، ...", uk: "Якби я мав час, …" }, { de: "Das wäre besser gewesen.", ku: "ئەمە باشتر دەبوو.", tr: "Bu daha iyi olurdu.", en: "That would have been better.", ar: "كان ذلك سيكون أفضل.", uk: "Так було б краще." }, { de: "Ich hätte das nicht gesagt.", ku: "ئەمەم نەدەگوت.", tr: "Bunu söylemezdim.", en: "I would not have said that.", ar: "ما كنت لأقول ذلك.", uk: "Я б цього не сказав." }, { de: "Wärst du gekommen, ...", ku: "ئەگەر هاتبووایت، ...", tr: "Gelmiş olsaydın, ...", en: "Had you come, ...", ar: "لو كنت قد أتيت، ...", uk: "Якби ти прийшов, …" }, { de: "Sie hätte gewinnen können.", ku: "دەیتوانی بباتەوە.", tr: "Kazanabilirdi.", en: "She could have won.", ar: "كان بإمكانها أن تفوز.", uk: "Вона могла б перемогти." } ] },
    { de: "Konjunktiv I (indirekte Rede)", ku: "کۆنیونکتیڤ I (قسەی ناڕاستەوخۆ)", icon: "❝",
      ...
      ex: [ { de: "Er sagt, er sei krank.", ku: "دەڵێت کە نەخۆشە.", tr: "Hasta olduğunu söylüyor.", en: "He says he is sick.", ar: "يقول إنه مريض.", uk: "Він каже, що хворий." }, { de: "Sie meint, sie habe Zeit.", ku: "پێیوایە کاتی هەیە.", tr: "Zamanının olduğunu düşünüyor.", en: "She thinks she has time.", ar: "تعتقد أن لديها وقتاً.", uk: "Вона вважає, що має час." }, { de: "Man sagt, es komme bald.", ku: "دەگوترێت بەم زووانە دێت.", tr: "Yakında geleceği söyleniyor.", en: "They say it will come soon.", ar: "يُقال إنه سيأتي قريباً.", uk: "Кажуть, що це скоро прийде." }, { de: "Er behauptet, er wisse nichts.", ku: "بانگەشە دەکات هیچ نازانێت.", tr: "Hiçbir şey bilmediğini iddia ediyor.", en: "He claims he knows nothing.", ar: "يدّعي أنه لا يعرف شيئاً.", uk: "Він стверджує, що нічого не знає." }, { de: "Sie sagte, sie werde kommen.", ku: "گوتی دێت.", tr: "Geleceğini söyledi.", en: "She said she would come.", ar: "قالت إنها ستأتي.", uk: "Вона сказала, що прийде." }, { de: "Der Minister sagt, er habe recht.", ku: "وەزیر دەڵێت ڕاستە.", tr: "Bakan haklı olduğunu söylüyor.", en: "The minister says he is right.", ar: "يقول الوزير إنه على حق.", uk: "Міністр каже, що має рацію." } ] },
    { de: "Erweiterte Relativsätze", ku: "ڕستەی پەیوەندیداری فراوان", icon: "⌐",
      ...
      ex: [ { de: "der Tag, an dem wir ...", ku: "ئەو ڕۆژەی کە ئێمە ...", tr: "... ettiğimiz gün", en: "the day on which we ...", ar: "اليوم الذي فيه ...", uk: "день, у який ми …" }, { de: "das Thema, über das ...", ku: "ئەو بابەتەی دەربارەی ...", tr: "... hakkında konuştuğumuz konu", en: "the topic about which ...", ar: "الموضوع الذي عنه ...", uk: "тема, про яку …" }, { de: "alles, was du brauchst", ku: "هەرچی پێویستتە", tr: "ihtiyacın olan her şey", en: "everything that you need", ar: "كل ما تحتاجه", uk: "усе, що тобі потрібно" }, { de: "die Firma, bei der ich arbeite, ...", ku: "ئەو کۆمپانیایەی تێیدا کار دەکەم، ...", tr: "çalıştığım şirket, ...", en: "the company where I work, ...", ar: "الشركة التي أعمل بها، ...", uk: "компанія, де я працюю, …" }, { de: "der Grund, aus dem ...", ku: "ئەو هۆکارەی کە ...", tr: "... sebebi", en: "the reason why ...", ar: "السبب الذي ...", uk: "причина, через яку …" }, { de: "das, was wichtig ist, ...", ku: "ئەوەی گرنگە، ...", tr: "önemli olan, ...", en: "what is important, ...", ar: "ما هو مهم، ...", uk: "те, що важливо, …" } ] },
    { de: "Kausale, konsekutive, konzessive Sätze", ku: "ڕستەی هۆکاری، ئەنجامی، ڕێگری", icon: "⟜",
      ...
      ex: [ { de: "Da es regnet, bleiben wir.", ku: "لەبەر ئەوەی باران دەبارێت، دەمێنینەوە.", tr: "Yağmur yağdığı için kalıyoruz.", en: "Since it is raining, we are staying.", ar: "بما أن المطر يهطل، سنبقى.", uk: "Оскільки йде дощ, ми залишаємося." }, { de: "Es war so kalt, dass ...", ku: "ئەوەندە سارد بوو کە ...", tr: "O kadar soğuktu ki ...", en: "It was so cold that ...", ar: "كان الجو بارداً جداً لدرجة أن ...", uk: "Було так холодно, що …" }, { de: "Obwohl er müde ist, arbeitet er.", ku: "هەرچەندە ماندووە، کار دەکات.", tr: "Her ne kadar yorgun olsa da çalışıyor.", en: "Although he is tired, he is working.", ar: "على الرغم من أنه متعب، إلا أنه يعمل.", uk: "Хоча він втомлений, він працює." }, { de: "Er lernte viel, sodass er bestand.", ku: "زۆر خوێندی، بۆیە سەرکەوت.", tr: "Çok çalıştı, bu yüzden başardı.", en: "He studied a lot, so he passed.", ar: "درس كثيراً، لذلك نجح.", uk: "Він багато вчився, тож склав іспит." }, { de: "Weil sie krank war, blieb sie.", ku: "چونکە نەخۆش بوو، مایەوە.", tr: "Hasta olduğu için kaldı.", en: "Because she was sick, she stayed.", ar: "لأنها كانت مريضة، بقيت.", uk: "Оскільки вона була хвора, вона залишилася." }, { de: "Trotzdem gab er nicht auf.", ku: "لەگەڵ ئەوەشدا واز نەهێنا.", tr: "Yine de pes etmedi.", en: "Nevertheless, he did not give up.", ar: "مع ذلك، لم يستسلم.", uk: "Попри це, він не здався." } ] },
    { de: "Futur II", ku: "داهاتووی دووەم", icon: "⇉",
      ...
      ex: [ { de: "Bis morgen werde ich es beendet haben.", ku: "تا سبەینێ تەوای دەکەم.", tr: "Yarına kadar bitirmiş olacağım.", en: "By tomorrow I will have finished it.", ar: "بحلول الغد سأكون قد أنهيته.", uk: "До завтра я це закінчу." }, { de: "Er wird angekommen sein.", ku: "ئەو گەیشتووی دەبێت.", tr: "Varmış olacak.", en: "He will have arrived.", ar: "سيكون قد وصل.", uk: "Він уже прибуде." }, { de: "Sie wird es vergessen haben.", ku: "لەوانەیە بیری چووبێت.", tr: "Unutmuş olabilir.", en: "She will have forgotten it.", ar: "لعلها تكون قد نسيت ذلك.", uk: "Вона це вже забуде." }, { de: "Bis dahin werden wir fertig sein.", ku: "تا ئەو کاتە تەواو دەبین.", tr: "O zamana kadar bitirmiş olacağız.", en: "By then we will be finished.", ar: "بحلول ذلك الوقت سنكون قد انتهينا.", uk: "На той час ми будемо готові." }, { de: "Er wird das gelesen haben.", ku: "ئەو ئەمەی خوێندووەتەوە (گریمانە).", tr: "Okumuş olacak (tahmin).", en: "He will have read that (assumption).", ar: "سيكون قد قرأ ذلك (افتراض).", uk: "Він, напевно, це прочитав (припущення)." }, { de: "Sie werden gegangen sein.", ku: "ئەوان ڕۆیشتوون (گریمانە).", tr: "Gitmiş olacaklar (tahmin).", en: "They will have left (assumption).", ar: "سيكونون قد رحلوا (افتراض).", uk: "Вони, напевно, вже пішли (припущення)." } ] },
    { de: "Partizip I", ku: "پارتیسیپی یەکەم", icon: "Ⅰ",
      ...
      ex: [ { de: "das spielende Kind", ku: "منداڵە یاریکەرەکە", tr: "oynayan çocuk", en: "the playing child", ar: "الطفل اللاعب", uk: "дитина, що грається" }, { de: "die schlafende Katze", ku: "پشیلە خەوتووەکە", tr: "uyuyan kedi", en: "the sleeping cat", ar: "القطة النائمة", uk: "кішка, що спить" }, { de: "lachend", ku: "بەپێکەنینەوە", tr: "gülerek", en: "laughing", ar: "ضاحكاً", uk: "сміючись" }, { de: "die singende Frau", ku: "ژنە گۆرانیبێژەکە", tr: "şarkı söyleyen kadın", en: "the singing woman", ar: "المرأة المغنية", uk: "жінка, що співає" }, { de: "ein weinendes Baby", ku: "کۆرپەیەکی گریان", tr: "ağlayan bir bebek", en: "a crying baby", ar: "طفل رضيع يبكي", uk: "немовля, що плаче" }, { de: "die kommende Woche", ku: "هەفتەی داهاتوو", tr: "gelecek hafta", en: "next week", ar: "الأسبوع القادم", uk: "наступного тижня" } ] },
    { de: "Partizip II als Adjektiv", ku: "پارتیسیپی دووەم وەک سیفەت", icon: "Ⅱ",
      ...
      ex: [ { de: "die geöffnete Tür", ku: "دەرگا کراوەکە", tr: "açık kapı", en: "the open door", ar: "الباب المفتوح", uk: "відчинені двері" }, { de: "ein gebrauchtes Auto", ku: "ئۆتۆمبێلێکی بەکارهاتوو", tr: "kullanılmış araba", en: "a used car", ar: "سيارة مستعملة", uk: "вживана машина" }, { de: "das geschriebene Wort", ku: "وشە نووسراوەکە", tr: "yazılmış kelime", en: "the written word", ar: "الكلمة المكتوبة", uk: "написане слово" }, { de: "die gekochte Suppe", ku: "شۆربا لێنراوەکە", tr: "pişirilmiş çorba", en: "the cooked soup", ar: "الحساء المطبوخ", uk: "зварений суп" }, { de: "ein verlorenes Spiel", ku: "یارییەکی دۆڕاو", tr: "kaybedilmiş oyun", en: "a lost game", ar: "مباراة خاسرة", uk: "програна гра" }, { de: "die reparierte Uhr", ku: "کاتژمێرە چاککراوەکە", tr: "tamir edilmiş saat", en: "the repaired watch", ar: "الساعة المُصلَّحة", uk: "відремонтований годинник" } ] },
    { de: "Nominalisierung", ku: "ناوکردن (نۆمیناڵایزەیشن)", icon: "N",
      ...
      ex: [ { de: "das Lernen", ku: "فێربوون (وەک ناو)", tr: "öğrenme (isim olarak)", en: "learning (as a noun)", ar: "التعلّم (كاسم)", uk: "навчання (як іменник)" }, { de: "beim Lesen", ku: "لە کاتی خوێندنەوەدا", tr: "okuma sırasında", en: "while reading", ar: "أثناء القراءة", uk: "під час читання" }, { de: "nach der Ankunft", ku: "دوای گەیشتن", tr: "varıştan sonra", en: "after arrival", ar: "بعد الوصول", uk: "після прибуття" }, { de: "vor dem Schlafen", ku: "پێش خەوتن", tr: "uyumadan önce", en: "before sleeping", ar: "قبل النوم", uk: "перед сном" }, { de: "das Rauchen ist verboten", ku: "جگەرەکێشان قەدەغەیە", tr: "sigara içmek yasak", en: "smoking is forbidden", ar: "التدخين ممنوع", uk: "паління заборонено" }, { de: "durch das Üben", ku: "بەهۆی مەشقکردنەوە", tr: "pratik yaparak", en: "through practicing", ar: "من خلال الممارسة", uk: "завдяки практиці" } ] },
    { de: "Funktionsverbgefüge", ku: "گرێدانی ناو-کردار", icon: "⚙",
      ...
      ex: [ { de: "eine Entscheidung treffen", ku: "بڕیاردان", tr: "karar vermek", en: "to make a decision", ar: "اتخاذ قرار", uk: "ухвалити рішення" }, { de: "in Frage stellen", ku: "گومان لێکردن", tr: "sorgulamak", en: "to call into question", ar: "التشكيك في", uk: "ставити під сумнів" }, { de: "zur Verfügung stehen", ku: "بەردەست بوون", tr: "mevcut olmak", en: "to be available", ar: "أن يكون متاحاً", uk: "бути в наявності" }, { de: "eine Rolle spielen", ku: "ڕۆڵ گێڕان", tr: "rol oynamak", en: "to play a role", ar: "لعب دور", uk: "відігравати роль" }, { de: "Rücksicht nehmen", ku: "ڕەچاوکردن", tr: "saygı göstermek", en: "to show consideration", ar: "المراعاة", uk: "виявляти увагу" }, { de: "in Anspruch nehmen", ku: "سوود وەرگرتن لە", tr: "yararlanmak", en: "to make use of", ar: "الاستفادة من", uk: "скористатися" } ] },
    { de: "Verben/Adjektive/Nomen mit Präpositionen", ku: "وشە لەگەڵ ئامرازی جێگیر", icon: "⌖",
      ...
      ex: [ { de: "Ich warte auf den Bus.", ku: "چاوەڕوانی پاس دەکەم.", tr: "Otobüsü bekliyorum.", en: "I am waiting for the bus.", ar: "أنا أنتظر الحافلة.", uk: "Я чекаю на автобус." }, { de: "Ich denke an dich.", ku: "بیرت دەکەمەوە.", tr: "Seni düşünüyorum.", en: "I am thinking of you.", ar: "أفكر فيك.", uk: "Я думаю про тебе." }, { de: "stolz auf etwas sein", ku: "شانازی بە شتێک کردن", tr: "bir şeyle gurur duymak", en: "to be proud of something", ar: "أن يكون فخوراً بشيء", uk: "пишатися чимось" }, { de: "Ich freue mich auf das Wochenende.", ku: "بە کۆتایی هەفتە دڵخۆشم.", tr: "Haftasonuna sevindim.", en: "I am looking forward to the weekend.", ar: "أتطلع إلى نهاية الأسبوع.", uk: "Я з нетерпінням чекаю вихідних." }, { de: "Er interessiert sich für Politik.", ku: "ئارەزووی سیاسەت دەکات.", tr: "Siyasetle ilgileniyor.", en: "He is interested in politics.", ar: "إنه مهتم بالسياسة.", uk: "Він цікавиться політикою." }, { de: "die Angst vor dem Versagen", ku: "ترس لە شکستهێنان", tr: "başarısızlık korkusu", en: "the fear of failure", ar: "الخوف من الفشل", uk: "страх перед невдачею" } ] },
    { de: "Wortbildung: Präfixe & Suffixe", ku: "دروستکردنی وشە: پێشگر و پاشگر", icon: "✚",
      ...
      ex: [ { de: "glücklich → das Glück", ku: "بەختەوەر → بەختەوەری", tr: "mutlu → mutluluk", en: "happy → happiness", ar: "سعيد ← السعادة", uk: "щасливий → щастя" }, { de: "frei → die Freiheit", ku: "ئازاد → ئازادی", tr: "özgür → özgürlük", en: "free → freedom", ar: "حر ← الحرية", uk: "вільний → свобода" }, { de: "möglich → unmöglich", ku: "گونجاو → ناگونجاو", tr: "mümkün → imkânsız", en: "possible → impossible", ar: "ممكن ← مستحيل", uk: "можливий → неможливий" }, { de: "arbeiten → die Arbeit", ku: "کارکردن → کار", tr: "çalışmak → iş", en: "to work → work", ar: "يعمل ← العمل", uk: "працювати → робота" }, { de: "krank → die Krankheit", ku: "نەخۆش → نەخۆشی", tr: "hasta → hastalık", en: "sick → illness", ar: "مريض ← المرض", uk: "хворий → хвороба" }, { de: "lesen → der Leser", ku: "خوێندنەوە → خوێنەر", tr: "okumak → okuyucu", en: "to read → reader", ar: "يقرأ ← القارئ", uk: "читати → читач" } ] },
  ],
  C1: [
    ...
    { de: "Kausale & konzessive Konnektoren (C1)", ku: "بەستەرەکانی هۆکاری و ڕێگری (C1)", icon: "↔",
      ...
      ex: [ { de: "Wenngleich es schwierig ist, werden wir weitermachen.", ku: "هەرچەندە سەختە، بەردەوام دەبین.", tr: "Her ne kadar zor olsa da devam edeceğiz.", en: "Although it is difficult, we will continue.", ar: "رغم أن الأمر صعب، سنواصل.", uk: "Хоча це важко, ми продовжимо." }, { de: "Insofern das stimmt, müssen wir handeln.", ku: "لەو ڕووەوە کە ئەمە ڕاستە، دەبێت هەنگاو بنێین.", tr: "Bu doğru olduğu ölçüde harekete geçmemiz gerekir.", en: "Insofar as that is true, we must act.", ar: "بقدر ما يكون هذا صحيحًا، يجب أن نتصرف.", uk: "Остільки це правда, ми маємо діяти." }, { de: "Zumal er krank ist, sollte er sich schonen.", ku: "بەتایبەت کە نەخۆشە، دەبێت خۆی بپارێزێت.", tr: "Özellikle hasta olduğu için dinlenmeli.", en: "Especially since he is sick, he should take it easy.", ar: "لا سيما أنه مريض، ينبغي أن يعتني بنفسه.", uk: "Тим паче що він хворий, йому слід поберегтися." }, { de: "Er kann nicht fahren, geschweige denn fliegen.", ku: "ناتوانێت بمژێت، جا فڕین؟", tr: "Araba süremez, uçmak ise hiç.", en: "He can't drive, let alone fly.", ar: "لا يستطيع القيادة، ناهيك عن الطيران.", uk: "Він не вміє водити, не кажучи вже про те, щоб літати." }, { de: "Sofern keine Einwände bestehen, beginnen wir.", ku: "ئەگەر دژایەتی نەبێت، دەست پێدەکەین.", tr: "İtiraz yoksa başlıyoruz.", en: "Provided there are no objections, we will begin.", ar: "بشرط ألا توجد اعتراضات، سنبدأ.", uk: "За умови, що не буде заперечень, ми почнемо." }, { de: "Ungeachtet der Kritik hielt er an seiner Meinung fest.", ku: "سەرەڕای ڕەخنەکان، لە بۆچوونەکەی مایەوە.", tr: "Eleştirilere rağmen görüşünde ısrar etti.", en: "Regardless of the criticism, he held onto his opinion.", ar: "بصرف النظر عن الانتقادات، تمسك برأيه.", uk: "Попри критику, він тримався своєї думки." } ] },
    { de: "Partizipialkonstruktionen", ku: "دروستکردنی هاوپەیوەند بە بەشداری", icon: "P",
      ...
      ex: [ { de: "Der auf dem Sofa schlafende Mann schnarcht.", ku: "پیاوەکەی کە لەسەر کەناپەکە خەوتووە خڕژاند دەکات.", tr: "Kanepede uyuyan adam horluyor.", en: "The man sleeping on the sofa is snoring.", ar: "الرجل النائم على الأريكة يشخر.", uk: "Чоловік, що спить на дивані, хропе." }, { de: "Das von ihr geschriebene Buch wurde ein Bestseller.", ku: "کتێبەکەی کە ئەوی نووسیوویەتی بەستسێلەر بوو.", tr: "Onun yazdığı kitap çok satanlar listesine girdi.", en: "The book written by her became a bestseller.", ar: "الكتاب الذي كتبته أصبح الأكثر مبيعًا.", uk: "Написана нею книга стала бестселером." }, { de: "Die in der Zeitung erschienene Meldung war falsch.", ku: "هەواڵەکەی کە لە ڕۆژنامەدا چاپکراوە هەڵە بوو.", tr: "Gazetede çıkan haber yanlıştı.", en: "The report that appeared in the newspaper was wrong.", ar: "كان الخبر الذي نُشر في الصحيفة خاطئًا.", uk: "Повідомлення, що з'явилося в газеті, було хибним." }, { de: "Die zubereiteten Speisen rochen gut.", ku: "خواردنەکانی ئامادەکراو بۆی خۆش دەدا.", tr: "Hazırlanan yemekler güzel kokuyordu.", en: "The prepared dishes smelled good.", ar: "كانت الأطباق المُعدّة رائحتها طيبة.", uk: "Приготовані страви приємно пахли." }, { de: "Ein lächelndes Kind kam auf mich zu.", ku: "منداڵێکی پێکەنان لەبەرچاوم هات.", tr: "Gülen bir çocuk yanıma geldi.", en: "A smiling child came up to me.", ar: "اقترب مني طفل مبتسم.", uk: "До мене підійшла усміхнена дитина." }, { de: "Der verlorene Schlüssel war unter dem Tisch.", ku: "کلیلەکەی وەندراو لەژێر مێزەکەدا بوو.", tr: "Kaybolan anahtar masanın altındaydı.", en: "The lost key was under the table.", ar: "كان المفتاح المفقود تحت الطاولة.", uk: "Загублений ключ був під столом." } ] },
    ...
    { de: "Doppelter Infinitiv", ku: "دوو بێناوی تێکەڵ", icon: "∬",
      ...
      ex: [ { de: "Er hat kommen müssen.", ku: "پێویستی بووە بێت.", tr: "Gelmek zorundaydı.", en: "He had to come.", ar: "كان عليه أن يأتي.", uk: "Він мусив прийти." }, { de: "Sie hat es nicht sagen dürfen.", ku: "مۆڵەتی نەبووە بیڵێت.", tr: "Söylemesine izin yoktu.", en: "She was not allowed to say it.", ar: "لم يكن مسموحًا لها أن تقول ذلك.", uk: "Їй не дозволили цього сказати." }, { de: "Wir haben lange warten müssen.", ku: "پێویستمان بووە زۆر چاوەڕوان بین.", tr: "Uzun süre beklemek zorunda kaldık.", en: "We had to wait a long time.", ar: "كان علينا أن ننتظر طويلاً.", uk: "Нам довелося довго чекати." }, { de: "Das hätte nicht passieren dürfen.", ku: "نەبایستی ڕوویدابایە.", tr: "Bu olmamalıydı.", en: "That should not have happened.", ar: "ما كان ينبغي لهذا أن يحدث.", uk: "Цього не мало б статися." }, { de: "Sie haben das Haus verlassen müssen.", ku: "پێویستیان بووە خانووەکە بەجێبهێڵن.", tr: "Evi terk etmek zorunda kaldılar.", en: "They had to leave the house.", ar: "كان عليهم أن يغادروا المنزل.", uk: "Їм довелося покинути будинок." }, { de: "Ich werde es gemacht haben müssen.", ku: "پێویست دەبێت کردیبیت.", tr: "Yapmış olmak zorunda kalacağım.", en: "I will have had to have done it.", ar: "سيكون عليّ أن أكون قد فعلت ذلك.", uk: "Я, напевно, муситиму це зробити." } ] },
    { de: "Nominalisierungsstil", ku: "شێوازی ناوکردن", icon: "N↑",
      ...
      ex: [ { de: "die Durchführung einer Analyse", ku: "ئەنجامدانی شیکاری (لەبری: شیکاری کردن)", tr: "bir analiz yapmak (yazmak yerine: analiz etmek)", en: "carrying out an analysis (instead of: to analyze)", ar: "إجراء تحليل (بدلاً من: أن يحلَّل)", uk: "проведення аналізу (замість: аналізувати)" }, { de: "die Verbesserung der Situation", ku: "باشترکردنی دۆخەکە (لەبری: دۆخەکە باشتر کردن)", tr: "durumu iyileştirmek (durumu iyileştirmek yerine)", en: "the improvement of the situation (instead of: to improve the situation)", ar: "تحسين الوضع (بدلاً من: أن يُحسَّن الوضع)", uk: "поліпшення ситуації (замість: поліпшити ситуацію)" }, { de: "unter Berücksichtigung der Kosten", ku: "لەگەڵ ڕەچاوکردنی تێچووەکان", tr: "maliyetler göz önünde bulundurularak", en: "taking the costs into consideration", ar: "مع مراعاة التكاليف", uk: "з урахуванням витрат" }, { de: "die Erreichung der Ziele", ku: "گەیشتن بە ئامانجەکان", tr: "hedeflere ulaşmak", en: "the achievement of the goals", ar: "تحقيق الأهداف", uk: "досягнення цілей" }, { de: "zur Lösung des Problems beitragen", ku: "بەشداری کردن لە چارەسەرکردنی کێشەکە", tr: "sorunun çözümüne katkıda bulunmak", en: "to contribute to the solution of the problem", ar: "المساهمة في حل المشكلة", uk: "сприяти вирішенню проблеми" }, { de: "die Bearbeitung des Antrags", ku: "مامەڵەکردن لەگەڵ داواکاریەکە", tr: "başvuruyu işleme koymak", en: "the processing of the application", ar: "معالجة الطلب", uk: "опрацювання заяви" } ] },
    { de: "Gehobene Schriftsprache", ku: "نووسینی فەرمی و ئاستبەرز", icon: "✦",
      ...
      ex: [ { de: "Angesichts der aktuellen Lage ist Vorsicht geboten.", ku: "بەرپێی دۆخی ئێستا، وریاکاری پێویستە.", tr: "Mevcut duruma bakıldığında dikkat gerekmektedir.", en: "In view of the current situation, caution is warranted.", ar: "نظرًا للوضع الراهن، يجب توخي الحذر.", uk: "З огляду на теперішню ситуацію, слід бути обережним." }, { de: "Im Hinblick auf die Ergebnisse lässt sich sagen…", ku: "لە ڕووی ئەنجامەکانەوە دەتوانرێت بڵێین…", tr: "Sonuçlar açısından şunu söylenebilir…", en: "With regard to the results, it can be said that…", ar: "فيما يتعلق بالنتائج، يمكن القول إن…", uk: "Що стосується результатів, можна сказати, що…" }, { de: "Es ist darauf hinzuweisen, dass…", ku: "دەبێت سەرنج بدرێتە ئەوەی کە…", tr: "Şunu belirtmek gerekmektedir ki…", en: "It should be pointed out that…", ar: "تجدر الإشارة إلى أن…", uk: "Слід зазначити, що…" }, { de: "Gemäß den Vorschriften ist zu beachten…", ku: "بەپێی رێنماییەکان دەبێت ئامانج بدرێت…", tr: "Yönetmeliklere göre dikkat edilmesi gereken…", en: "In accordance with the regulations, it must be noted…", ar: "وفقًا للوائح، يجب مراعاة…", uk: "Згідно з приписами, треба зважати…" }, { de: "Infolgedessen wurde die Maßnahme ergriffen.", ku: "لە ئەنجامدا ئەم ڕێوشوێنە گرتە دەست.", tr: "Sonuç olarak bu önlem alındı.", en: "As a result, the measure was taken.", ar: "ونتيجة لذلك، تم اتخاذ هذا الإجراء.", uk: "Внаслідок цього було вжито заходу." }, { de: "Unter Berücksichtigung aller Faktoren…", ku: "لە ڕووی هەموو هۆکارەکانەوە…", tr: "Tüm faktörler göz önünde bulundurulduğunda…", en: "Taking all factors into consideration…", ar: "مع مراعاة جميع العوامل…", uk: "З урахуванням усіх чинників…" } ] },
    { de: "Modalpartikeln", ku: "بەشداری هەستیار", icon: "~",
      ...
      ex: [ { de: "Komm doch mal vorbei!", ku: "تکایە ئەوبارە وەرە سەردانی بکە!", tr: "Bir ara uğra ya!", en: "Do come by sometime!", ar: "تعال لزيارتي في وقت ما!", uk: "Зайди ж якось!" }, { de: "Das ist eigentlich ganz einfach.", ku: "ئەمە لە ڕاستیدا تەواو ئاسانە.", tr: "Bu aslında çok basit.", en: "That's actually quite simple.", ar: "هذا في الحقيقة بسيط جدًا.", uk: "Це, власне, доволі просто." }, { de: "Er ist wohl krank.", ku: "بیم هەیە نەخۆشە.", tr: "Sanırım hasta.", en: "He's probably sick.", ar: "أظنه مريض.", uk: "Він, мабуть, хворий." }, { de: "Das ist eben so.", ku: "ئەوەیە دیکە، ئاوایە.", tr: "İşte böyle.", en: "That's just how it is.", ar: "هكذا هو الحال ببساطة.", uk: "Так уже воно є." }, { de: "Das weißt du ja.", ku: "تۆیش دەزانیت باشە.", tr: "Biliyorsun zaten.", en: "You know that already, don't you.", ar: "أنت تعرف ذلك أصلاً.", uk: "Ти ж це вже знаєш." }, { de: "Was machst du denn hier?", ku: "ئیتا تۆ لێرەدا چی دەکەیت؟", tr: "Peki sen burada ne yapıyorsun?", en: "So what are you doing here?", ar: "إذن ماذا تفعل هنا؟", uk: "Що ж ти тут робиш?" } ] },
  ],
  C2: [
    { de: "Komplexe Satzgefüge", ku: "دروستکردنی ڕستەی پێچەواندار", icon: "🔗",
      ...
      ex: [ { de: "Da er sich vorbereitet hatte, gelang es, obwohl es schwierig war.", ku: "چونکە خۆی ئامادە کردبوو، سەرکەوتووی بوو هەرچەندە سەخت بوو.", tr: "Hazırlandığı için, zor da olsa başardı.", en: "Because he had prepared, he succeeded, even though it was difficult.", ar: "لأنه كان قد استعد، نجح رغم أن الأمر كان صعباً.", uk: "Оскільки він підготувався, йому вдалося, хоча це було важко." }, { de: "Nicht nur dass er zu spät kam, er hatte auch nichts mitgebracht.", ku: "نەتەنها دواخست، بەڵکو هیچیشی نەهاورد.", tr: "Sadece geç kalmakla kalmadı, bir şey de getirmedi.", en: "Not only did he arrive late, he also hadn't brought anything.", ar: "لم يتأخر فحسب، بل لم يُحضر معه شيئاً أيضاً.", uk: "Він не лише запізнився, а й нічого не приніс." }, { de: "Je mehr man lernt, desto mehr erkennt man, wie viel man nicht weiß.", ku: "هەرچەند زیاتر فێربیت، زیاتر دەزانیت چەند نازانیت.", tr: "Ne kadar çok öğrenirsen, o kadar çok bilmediğini anlarsın.", en: "The more you learn, the more you realize how much you don't know.", ar: "كلما تعلّم المرء أكثر، أدرك أكثر كم هو لا يعرف.", uk: "Чим більше вчишся, тим більше усвідомлюєш, як багато не знаєш." }, { de: "Wäre er pünktlich gewesen, hätte er den Zug nicht verpasst.", ku: "ئەگەر کاتی بووایە، ترینەکەی لەدەست نەدایە.", tr: "Vaktinde olsaydı, treni kaçırmazdı.", en: "Had he been on time, he would not have missed the train.", ar: "لو كان قد وصل في الوقت المحدد، لما فاته القطار.", uk: "Якби він був вчасно, він би не пропустив потяг." }, { de: "Kaum hatte er das Haus verlassen, fing es an zu regnen.", ku: "هێندە ئەوەی خانووەکەی بەجێهێڵا، باران دەستی کرد.", tr: "Evi terkeder terketmez yağmur başladı.", en: "Hardly had he left the house when it started to rain.", ar: "ما إن غادر المنزل حتى بدأ المطر بالهطول.", uk: "Щойно він вийшов з дому, як почався дощ." }, { de: "So wichtig das auch sein mag, es darf nicht alles bestimmen.", ku: "هەرچەند گرنگیش بێت، نابێت هەموو شت بخاتە بەژێر دەستی.", tr: "Bu önemli de olsa, her şeyi belirlememelidir.", en: "As important as that may be, it must not determine everything.", ar: "مهما كان ذلك مهماً، فلا يجوز أن يتحكم في كل شيء.", uk: "Хоч яким важливим це не було б, воно не повинно вирішувати все." } ] },
    { de: "Negationsstrukturen (C2)", ku: "دروستکردنی نەرێن (ئاستبەرز)", icon: "¬",
      ...
      ex: [ { de: "Weder er noch sie hat Recht.", ku: "نە ئەو نە ئەو تری ڕاستیان هەیە.", tr: "Ne o ne de o haklı.", en: "Neither he nor she is right.", ar: "لا هو على حق ولا هي.", uk: "Ні він, ні вона не мають рації." }, { de: "Das ist keineswegs akzeptabel.", ku: "بە هیچ شێوەیەک پەسەند نییە.", tr: "Bu hiçbir şekilde kabul edilemez.", en: "That is by no means acceptable.", ar: "هذا غير مقبول بأي حال من الأحوال.", uk: "Це аж ніяк не прийнятно." }, { de: "Nicht nur er, sondern auch sie war dabei.", ku: "نەتەنها ئەو، بەڵکو ئەو تریش تێیدا بوو.", tr: "Sadece o değil, o da oradaydı.", en: "Not only he but she too was present.", ar: "لم يكن هو فقط حاضراً، بل هي أيضاً.", uk: "Не лише він, а й вона була присутня." }, { de: "Das stimmt mitnichten.", ku: "ئەمە بە هیچ جۆرێک ڕاست نییە.", tr: "Bu hiç doğru değil.", en: "That is not true in the least.", ar: "هذا غير صحيح إطلاقاً.", uk: "Це зовсім не так." }, { de: "Bei weitem nicht genug.", ku: "بە دوورکەوتنی زۆر بەسنییە.", tr: "Yeterli değil, çok uzak.", en: "Far from enough.", ar: "غير كافٍ على الإطلاق.", uk: "Далеко не достатньо." }, { de: "Keiner der Anwesenden sprach dagegen.", ku: "هیچکام لە ئامادەبووان دژی قسە نەکرد.", tr: "Oradakilerin hiçbiri itiraz etmedi.", en: "None of those present spoke against it.", ar: "لم يعترض أحد من الحاضرين.", uk: "Ніхто з присутніх не виступив проти." } ] },
    { de: "Register & Stilebenen", ku: "ئاستەکانی زمان و شێواز", icon: "≡",
      ...
      ex: [ { de: "Ich kriege keinen Hunger. (umgangssprachlich)", ku: "براشم نییە. (قسەی ڕۆژانە)", tr: "Açım. (günlük)", en: "I'm hungry. (colloquial)", ar: "أنا جوعان. (عامي)", uk: "Я голодний. (розмовно)" }, { de: "Ich habe keinen Appetit. (Standard)", ku: "خواست نییە بخۆم. (نڕمی)", tr: "Yemek yemek istemiyorum. (standart)", en: "I don't want to eat. (standard)", ar: "لا أريد أن آكل. (معياري)", uk: "Я не хочу їсти. (стандарт)" }, { de: "Mir fehlt der Appetit. (gehoben)", ku: "خواستم نییە. (فەرمی)", tr: "İştahım yok. (resmi)", en: "I have no appetite. (formal)", ar: "لا شهية لي. (رسمي)", uk: "У мене немає апетиту. (формально)" }, { de: "Was machst du? → Womit beschäftigen Sie sich?", ku: "چی دەکەیت؟ → بە چی بەرپرسی؟ (فەرمی)", tr: "Ne yapıyorsun? → Ne ile meşgulsünüz? (resmi)", en: "What are you doing? → What are you occupied with? (formal)", ar: "ماذا تفعل؟ ← بماذا تنشغلون؟ (رسمي)", uk: "Що ти робиш? → Чим Ви займаєтеся? (формально)" }, { de: "Klar! (umg.) → Selbstverständlich. (formell)", ku: "باشە! → بەتەواوی. (فەرمی)", tr: "Tabii! (günlük) → Elbette. (resmi)", en: "Sure! (colloquial) → Certainly. (formal)", ar: "أكيد! (عامي) ← بالتأكيد. (رسمي)", uk: "Звісно! (розмовно) → Безумовно. (формально)" }, { de: "Das geht nicht. → Das ist nicht möglich.", ku: "ئەمە نابێت. → ئەمە گونجاو نییە. (فەرمی)", tr: "Bu olmaz. → Bu mümkün değil. (resmi)", en: "That won't work. → That is not possible. (formal)", ar: "هذا لا يصلح. ← هذا غير ممكن. (رسمي)", uk: "Це не вийде. → Це неможливо. (формально)" } ] },
    { de: "Stilmittel", ku: "ئامرازەکانی شێواز", icon: "✍",
      ...
      ex: [ { de: "Das Leben ist ein Fluss. (Metapher)", ku: "ژیان ڕووبارێکە. (وێنەگرتن)", tr: "Hayat bir nehirdir. (Metafor)", en: "Life is a river. (metaphor)", ar: "الحياة نهر. (استعارة)", uk: "Життя — це річка. (метафора)" }, { de: "Ja, das war wirklich klug! (Ironie)", ku: "بەڵێ، ئەمە زۆر زیرەکانەیە! (پاقجی)", tr: "Evet, bu gerçekten akıllıca! (İroni)", en: "Yes, that was really clever! (irony)", ar: "نعم، كان ذلك ذكياً حقاً! (سخرية)", uk: "Так, це було справді розумно! (іронія)" }, { de: "arm und reich, jung und alt (Antithese)", ku: "هەژار و دەوڵەمەند، گەنج و پیر (دژایەتی)", tr: "fakir ve zengin, genç ve yaşlı (Antitez)", en: "poor and rich, young and old (antithesis)", ar: "فقير وغني، شاب وعجوز (طباق)", uk: "бідні й багаті, молоді й старі (антитеза)" }, { de: "Ich kam, ich sah, ich siegte. (Anapher)", ku: "هاتم، بینم، برم. (دووبارەکردنەوە)", tr: "Geldim, gördüm, kazandım. (Anafora)", en: "I came, I saw, I conquered. (anaphora)", ar: "أتيت، رأيت، انتصرت. (تكرار استهلالي)", uk: "Я прийшов, я побачив, я переміг. (анафора)" }, { de: "Das hab ich dir tausendmal gesagt! (Hyperbel)", ku: "هەزار جارت گوتووتمە! (زەیانی)", tr: "Bunu sana bin kez söyledim! (Abartma)", en: "I've told you that a thousand times! (hyperbole)", ar: "قلت لك هذا ألف مرة! (مبالغة)", uk: "Я казав тобі це тисячу разів! (гіпербола)" }, { de: "Das ist nicht schlecht. (Litotes = es ist gut)", ku: "ئەمە خراپ نییە. (واتا: باشە — Litotes)", tr: "Bu fena değil. (yani: iyi — Litotes)", en: "That's not bad. (litotes = it is good)", ar: "هذا ليس سيئاً. (أي: إنه جيد — تلطيف)", uk: "Це непогано. (літота = це добре)" } ] },
    { de: "Kollokationen", ku: "کۆمەڵی وشەی جێگیر", icon: "⊕",
      ...
      ex: [ { de: "eine Entscheidung treffen", ku: "بڕیاردان (نەک: مەرج کردن)", tr: "karar vermek (yapmak değil)", en: "to make a decision (not: to do a decision)", ar: "اتخاذ قرار (وليس: صنع قرار)", uk: "ухвалити рішення (не: зробити рішення)" }, { de: "eine Frage stellen", ku: "پرسیار کردن (نەک: دانان)", tr: "soru sormak (koymak değil)", en: "to ask a question (not: to put a question)", ar: "طرح سؤال (وليس: وضع سؤال)", uk: "поставити питання (не: покласти питання)" }, { de: "Verantwortung übernehmen", ku: "بەرپرسیارێتی وەرگرتن", tr: "sorumluluk üstlenmek", en: "to take on responsibility", ar: "تحمّل المسؤولية", uk: "взяти на себе відповідальність" }, { de: "einen Fehler begehen", ku: "هەڵەیەک کردن (فەرمی)", tr: "hata yapmak (resmi)", en: "to commit an error (formal)", ar: "ارتكاب خطأ (رسمي)", uk: "припуститися помилки (формально)" }, { de: "in Betracht ziehen", ku: "بیر لێ کردنەوە / ڕەچاوکردن", tr: "göz önünde bulundurmak", en: "to take into consideration", ar: "أخذ بعين الاعتبار", uk: "взяти до уваги" }, { de: "Rücksicht nehmen auf", ku: "ڕەچاو کردنی / گوێگرتن لە", tr: "saygı göstermek", en: "to show consideration for", ar: "مراعاة / إظهار الاحترام لـ", uk: "виявляти увагу до" } ] },
    { de: "Redewendungen & Sprichwörter", ku: "دەستانووس و پەندوامۆڵ", icon: "💬",
      ...
      ex: [ { de: "Das ist nicht mein Bier.", ku: "ئەمە کارەکەم نییە.", tr: "Bu benim işim değil.", en: "That's not my business.", ar: "هذا ليس شأني.", uk: "Це не моя справа." }, { de: "Lügen haben kurze Beine.", ku: "درۆ لەپێی خۆدا دەمێنێت.", tr: "Yalancının mumu yatsıya kadar yanar.", en: "Lies have short legs. (the truth always comes out)", ar: "للكذب أرجل قصيرة. (الحقيقة تظهر دائماً)", uk: "У брехні короткі ноги. (правда завжди виходить назовні)" }, { de: "Tomaten auf den Augen haben.", ku: "گومرا بوون / نەدیتن چییە پێشتا.", tr: "Görmemek / Gözü kapalı olmak.", en: "To have tomatoes on one's eyes. (to fail to notice the obvious)", ar: "أن يكون لديه طماطم على عينيه. (أي لا يلاحظ ما هو واضح)", uk: "Мати помідори на очах. (не помічати очевидного)" }, { de: "Den Nagel auf den Kopf treffen.", ku: "تێی گەیشتن / ڕاستی گوتن.", tr: "Tam yerine oturmak / Doğruyu söylemek.", en: "To hit the nail on the head.", ar: "أن يضرب المسمار على رأسه. (أي يصيب كبد الحقيقة)", uk: "Влучити цвяхом у голову. (влучити в саму суть)" }, { de: "Alles hat ein Ende, nur die Wurst hat zwei.", ku: "هەموو شتێک کۆتاییەکی هەیە.", tr: "Her şeyin bir sonu vardır.", en: "Everything has an end, only the sausage has two.", ar: "لكل شيء نهاية، أما السجق فله نهايتان.", uk: "Усе має кінець, лише ковбаса має два." }, { de: "Wer zuletzt lacht, lacht am besten.", ku: "ئەوەی دوایین دەپێکنێت باشترین پێکەنینی هەیە.", tr: "En son gülen en iyi güler.", en: "He who laughs last, laughs best.", ar: "من يضحك أخيراً يضحك أطول.", uk: "Хто сміється останнім, той сміється найкраще." } ] },
    { de: "Dialekte & Varietäten", ku: "شێوەزارەکان و جۆرجۆری زمان", icon: "🗺",
      ...
      ex: [ { de: "Grüß Gott! (bayerisch) = Guten Tag!", ku: "سڵاوت لەگەڵ خودا! = ڕۆژباش! (بایەری)", tr: "Grüß Gott! (Bavyera) = Günaydın!", en: "Grüß Gott! (Bavarian) = Good day!", ar: "Grüß Gott! (بافارية) = طاب يومك!", uk: "Grüß Gott! (баварською) = Добрий день!" }, { de: "Servus! (österreichisch) = Hallo / Tschüss", ku: "سێروس! = سڵاو / خوداحافیز (ئەوستری)", tr: "Servus! (Avusturya) = Merhaba / Hoşça kal", en: "Servus! (Austrian) = Hello / Goodbye", ar: "Servus! (نمساوية) = مرحباً / وداعاً", uk: "Servus! (австрійською) = Привіт / Бувай" }, { de: "Berlinerisch: ick statt ich", ku: "لە بەرلیندا: «ick» لەبری «ich»", tr: "Berlin'de: «ick» yerine «ich»", en: "Berlin dialect: 'ick' instead of 'ich'", ar: "في لهجة برلين: «ick» بدلاً من «ich»", uk: "Берлінський діалект: «ick» замість «ich»" }, { de: "In der Schweiz: Grüezi! = Guten Tag", ku: "لە سویسرادا: «گرییتسی!» = ڕۆژباش", tr: "İsviçre'de: «Grüezi!» = Günaydın", en: "In Switzerland: 'Grüezi!' = Good day", ar: "في سويسرا: «Grüezi!» = طاب يومك", uk: "У Швейцарії: «Grüezi!» = Добрий день" }, { de: "Net statt nicht (süddeutsch)", ku: "«نێت» لەبری «نیخت» (باشووری ئەڵمانیا)", tr: "«Net» yerine «nicht» (Güney Almanya)", en: "'Net' instead of 'nicht' (Southern Germany)", ar: "«Net» بدلاً من «nicht» (جنوب ألمانيا)", uk: "«Net» замість «nicht» (південнонімецькою)" }, { de: "Nix statt nichts (umgangssprachlich)", ku: "«نیکس» لەبری «نیختس» (قسەی ڕۆژانە)", tr: "«Nix» yerine «nichts» (günlük)", en: "'Nix' instead of 'nichts' (colloquial)", ar: "«Nix» بدلاً من «nichts» (عامية)", uk: "«Nix» замість «nichts» (розмовно)" } ] },
    { de: "Historisches Deutsch", ku: "زمانی ئەڵمانیی مێژووی", icon: "📜",
      ...
      ex: [ { de: "Habt Ihr das getan? (historisch formell)", ku: "ئایا ئێوە ئەمەی کردووە؟ (کۆن فەرمی)", tr: "Bunu yaptınız mı? (tarihsel resmi)", en: "Have you done that? (historical formal)", ar: "هل فعلتم ذلك؟ (تاريخي رسمي)", uk: "Ви це зробили? (історично формально)" }, { de: "Es ward Licht. (Bibeldeutsch)", ku: "ڕووناکی بوو. (زمانی کتێبی پیرۆز)", tr: "Işık olsun. (Kutsal Kitap Almancası)", en: "Let there be light. (Biblical German)", ar: "وليكن نور. (ألمانية الكتاب المقدس)", uk: "І стало світло. (біблійна німецька)" }, { de: "Ich bin's. (kontrahiert = ich bin es)", ku: "منم. (کورتکراو)", tr: "Benim. (kısaltılmış = ich bin es)", en: "It's me. (contracted = ich bin es)", ar: "هذا أنا. (مختصر = ich bin es)", uk: "Це я. (стягнено = ich bin es)" }, { de: "Welch ein schöner Tag! (gehobene alte Form)", ku: "چەند ڕۆژێکی جوان! (کۆن فەرمی)", tr: "Ne güzel bir gün! (eski resmi)", en: "What a beautiful day! (elevated old form)", ar: "يا له من يوم جميل! (صيغة قديمة راقية)", uk: "Який гарний день! (піднесена стара форма)" }, { de: "Das Wort «Weib» bedeutete früher «Frau».", ku: "وشەی «ڤایب» لەمێژوودا مانای «ژن» هەیدا.", tr: "«Weib» kelimesi eskiden «kadın» anlamına gelirdi.", en: "The word 'Weib' used to mean 'woman'.", ar: "كانت كلمة «Weib» تعني سابقاً «امرأة».", uk: "Слово «Weib» колись означало «жінка»." }, { de: "Man sprach damals anders.", ku: "لەو کاتەدا جیاوازتر قسە دەکران.", tr: "O zamanlar farklı konuşulurdu.", en: "People spoke differently back then.", ar: "كان الناس يتحدثون بشكل مختلف في ذلك الزمان.", uk: "Тоді говорили інакше." } ] },
  ],
};
