export const GRAMMAR = {
  ...
  A2: [
    ...
    { de: "Relativsätze (basic)", ku: "ڕستەی پەیوەندیدار (سادە)", icon: "⌐",
      ...
      ex: [ { de: "Der Mann, der dort steht, ...", ku: "ئەو پیاوەی لەوێ ڕاوەستاوە، ...", tr: "Orada duran adam, ...", en: "The man who is standing there, ...", ar: "الرجل الذي يقف هناك، ...", uk: "Чоловік, який там стоїть, …", fa: "مردی که آنجا ایستاده است، …" }, { de: "Das Buch, das ich lese, ...", ku: "ئەو کتێبەی دەیخوێنمەوە، ...", tr: "Okuduğum kitap, ...", en: "The book that I am reading, ...", ar: "الكتاب الذي أقرؤه، ...", uk: "Книга, яку я читаю, …", fa: "کتابی که می‌خوانم، …" }, { de: "Die Frau, die singt, ...", ku: "ئەو ژنەی گۆرانی دەڵێت، ...", tr: "Şarkı söyleyen kadın, ...", en: "The woman who is singing, ...", ar: "المرأة التي تغني، ...", uk: "Жінка, яка співає, …", fa: "زنی که آواز می‌خواند، …" }, { de: "Das Auto, das rot ist, ...", ku: "ئەو ئۆتۆمبێلەی سوورە، ...", tr: "Kırmızı araba, ...", en: "The red car, ...", ar: "السيارة الحمراء، ...", uk: "Машина, яка червона, …", fa: "خودرویی که قرمز است، …" }, { de: "Der Freund, der hilft, ...", ku: "ئەو هاوڕێیەی یارمەتی دەدات، ...", tr: "Yardım eden arkadaş, ...", en: "The friend who helps, ...", ar: "الصديق الذي يساعد، ...", uk: "Друг, який допомагає, …", fa: "دوستی که کمک می‌کند، …" }, { de: "Die Stadt, die schön ist, ...", ku: "ئەو شارەی جوانە، ...", tr: "Güzel şehir, ...", en: "The beautiful city, ...", ar: "المدينة الجميلة، ...", uk: "Місто, яке гарне, …", fa: "شهری که زیبا است، …" } ] },
    { de: "Genitiv (Einführung)", ku: "گەنیتیڤ (ناساندن)", icon: "'s",
      ...
      ex: [ { de: "das Auto des Mannes", ku: "ئۆتۆمبێلی پیاوەکە", tr: "adamın arabası", en: "the man's car", ar: "سيارة الرجل", uk: "машина чоловіка", fa: "خودروی آن مرد" }, { de: "die Farbe der Blume", ku: "ڕەنگی گوڵەکە", tr: "çiçeğin rengi", en: "the flower's color", ar: "لون الزهرة", uk: "колір квітки", fa: "رنگ آن گل" }, { de: "der Titel des Buches", ku: "ناونیشانی کتێبەکە", tr: "kitabın başlığı", en: "the book's title", ar: "عنوان الكتاب", uk: "назва книги", fa: "عنوان آن کتاب" }, { de: "das Haus meiner Eltern", ku: "خانووی دایک و باوکم", tr: "annemin babamın evi", en: "my parents' house", ar: "بيت والدَيّ", uk: "будинок моїх батьків", fa: "خانهٔ والدینم" }, { de: "der Name des Kindes", ku: "ناوی منداڵەکە", tr: "çocuğun adı", en: "the child's name", ar: "اسم الطفل", uk: "ім'я дитини", fa: "نامِ آن کودک" }, { de: "die Tür des Hauses", ku: "دەرگای خانووەکە", tr: "evin kapısı", en: "the house's door", ar: "باب البيت", uk: "двері будинку", fa: "درِ آن خانه" } ] },
  ],
  B1: [
    { de: "Adjektivdeklination", ku: "ڕەوانبێژی سیفەت", icon: "✦",
      ...
      ex: [ { de: "der rote Apfel", ku: "سێوە سوورەکە", tr: "kırmızı elma (belirli eril)", en: "the red apple (definite masculine)", ar: "التفاحة الحمراء (مذكر معرّف)", uk: "червоне яблуко (означений, чоловічий рід)", fa: "سیب قرمز (معرفه، مذکر)" }, { de: "ein roter Apfel", ku: "سێوێکی سوور", tr: "kırmızı bir elma (belirsiz)", en: "a red apple (indefinite)", ar: "تفاحة حمراء (نكرة)", uk: "червоне яблуко (неозначений)", fa: "یک سیب قرمز (نکره)" }, { de: "mit dem roten Auto", ku: "بە ئۆتۆمبێلە سوورەکە", tr: "kırmızı arabayla", en: "with the red car", ar: "بالسيارة الحمراء", uk: "з червоною машиною", fa: "با خودروی قرمز" }, { de: "die schöne Stadt", ku: "شارە جوانەکە", tr: "güzel şehir", en: "the beautiful city", ar: "المدينة الجميلة", uk: "гарне місто", fa: "شهر زیبا" }, { de: "ein gutes Buch", ku: "کتێبێکی باش", tr: "iyi bir kitap", en: "a good book", ar: "كتاب جيد", uk: "хороша книга", fa: "یک کتاب خوب" }, { de: "kaltes Wasser", ku: "ئاوی سارد", tr: "soğuk su (artikelsiz)", en: "cold water (without article)", ar: "ماء بارد (بدون أداة تعريف)", uk: "холодна вода (без артикля)", fa: "آب سرد (بدون حرف تعریف)" } ] },
    { de: "Genitiv", ku: "گەنیتیڤ (تەواو)", icon: "'s",
      ...
      ex: [ { de: "das Haus meines Vaters", ku: "خانووی باوکم", tr: "babamın evi", en: "my father's house", ar: "بيت أبي", uk: "будинок мого батька", fa: "خانهٔ پدرم" }, { de: "wegen des Wetters", ku: "بەهۆی کەش‌وهەواوە", tr: "hava yüzünden", en: "because of the weather", ar: "بسبب الطقس", uk: "через погоду", fa: "به‌خاطر هوا" }, { de: "trotz des Regens", ku: "سەرەڕای بارانەکە", tr: "yağmura rağmen", en: "despite the rain", ar: "رغم المطر", uk: "попри дощ", fa: "با وجود باران" }, { de: "die Meinung der Leute", ku: "بۆچوونی خەڵک", tr: "halkın görüşü", en: "the opinion of the people", ar: "رأي الناس", uk: "думка людей", fa: "نظر مردم" }, { de: "während des Tages", ku: "لە ماوەی ڕۆژدا", tr: "gündüz boyunca", en: "during the day", ar: "خلال النهار", uk: "протягом дня", fa: "در طول روز" }, { de: "der Anfang des Films", ku: "سەرەتای فیلمەکە", tr: "filmin başlangıcı", en: "the beginning of the film", ar: "بداية الفيلم", uk: "початок фільму", fa: "آغاز فیلم" } ] },
    { de: "Präpositionen mit Genitiv", ku: "ئامراز لەگەڵ گەنیتیڤ", icon: "⌖",
      ...
      ex: [ { de: "während des Kurses", ku: "لە ماوەی خولەکەدا", tr: "ders boyunca", en: "during the course", ar: "أثناء الدورة", uk: "протягом курсу", fa: "در طول دوره" }, { de: "wegen des Problems", ku: "بەهۆی کێشەکەوە", tr: "sorun yüzünden", en: "because of the problem", ar: "بسبب المشكلة", uk: "через проблему", fa: "به‌خاطر مشکل" }, { de: "trotz der Kälte", ku: "سەرەڕای ساردی", tr: "soğuğa rağmen", en: "despite the cold", ar: "رغم البرد", uk: "попри холод", fa: "با وجود سرما" }, { de: "statt des Kaffees", ku: "لەبری قاوەکە", tr: "kahve yerine", en: "instead of the coffee", ar: "بدلاً من القهوة", uk: "замість кави", fa: "به‌جای قهوه" }, { de: "innerhalb einer Woche", ku: "لە ماوەی هەفتەیەکدا", tr: "bir hafta içinde", en: "within a week", ar: "خلال أسبوع", uk: "протягом тижня", fa: "ظرف یک هفته" }, { de: "außerhalb der Stadt", ku: "لە دەرەوەی شارەکە", tr: "şehrin dışında", en: "outside the city", ar: "خارج المدينة", uk: "за межами міста", fa: "بیرون از شهر" } ] },
    { de: "Plusquamperfekt", ku: "ڕابردووی دوور", icon: "⟲",
      ...
      ex: [ { de: "Ich hatte schon gegessen.", ku: "پێشتر خواردبووم.", tr: "Daha önce yemiştim.", en: "I had already eaten.", ar: "كنتُ قد أكلتُ بالفعل.", uk: "Я вже поїв.", fa: "من از قبل غذا خورده بودم." }, { de: "Er war schon gegangen.", ku: "ئەو پێشتر ڕۆیشتبوو.", tr: "O daha önce gitmişti.", en: "He had already left.", ar: "كان قد ذهب بالفعل.", uk: "Він уже пішов.", fa: "او از قبل رفته بود." }, { de: "Nachdem ich gegessen hatte, ...", ku: "دوای ئەوەی خواردبووم، ...", tr: "Yedikten sonra, ...", en: "After I had eaten, ...", ar: "بعد أن كنتُ قد أكلتُ، ...", uk: "Після того, як я поїв, …", fa: "بعد از اینکه غذا خورده بودم، …" }, { de: "Sie hatte den Brief geschrieben.", ku: "نامەکەی نووسیبوو.", tr: "Mektubu yazmıştı.", en: "She had written the letter.", ar: "كانت قد كتبت الرسالة.", uk: "Вона написала листа.", fa: "او نامه را نوشته بود." }, { de: "Wir waren schon angekommen.", ku: "پێشتر گەیشتبووین.", tr: "Daha önce gelmiştik.", en: "We had already arrived.", ar: "كنا قد وصلنا بالفعل.", uk: "Ми вже прибули.", fa: "ما از قبل رسیده بودیم." }, { de: "Hattest du das gewusst?", ku: "ئەمەت زانیبوو؟", tr: "Bunu biliyor muydun?", en: "Had you known that?", ar: "هل كنتَ قد عرفتَ ذلك؟", uk: "Ти це знав?", fa: "آیا این را می‌دانستی؟" } ] },
    { de: "Futur I", ku: "داهاتوو (Futur I)", icon: "⇉",
      ...
      ex: [ { de: "Ich werde Deutsch lernen.", ku: "ئەڵمانی فێردەبم (داهاتوو).", tr: "Almanca öğreneceğim (gelecek).", en: "I will learn German (future).", ar: "سأتعلم الألمانية (المستقبل).", uk: "Я вивчатиму німецьку (майбутній).", fa: "من آلمانی یاد خواهم گرفت (آینده)." }, { de: "Es wird regnen.", ku: "باران دەبارێت.", tr: "Yağmur yağacak.", en: "It will rain.", ar: "ستمطر.", uk: "Буде дощ.", fa: "باران خواهد بارید." }, { de: "Wir werden sehen.", ku: "دەبینین.", tr: "Göreceğiz.", en: "We will see.", ar: "سنرى.", uk: "Побачимо.", fa: "خواهیم دید." }, { de: "Sie wird Ärztin werden.", ku: "دەبێتە پزیشک.", tr: "Doktor olacak.", en: "She will become a doctor.", ar: "ستصبح طبيبة.", uk: "Вона стане лікаркою.", fa: "او پزشک خواهد شد." }, { de: "Ich werde dich anrufen.", ku: "پەیوەندیت پێوە دەکەم.", tr: "Seni arayacağım.", en: "I will call you.", ar: "سأتصل بك.", uk: "Я тобі зателефоную.", fa: "من به تو زنگ خواهم زد." }, { de: "Morgen wird es kalt sein.", ku: "سبەینێ سارد دەبێت.", tr: "Yarın soğuk olacak.", en: "Tomorrow it will be cold.", ar: "غداً سيكون الجو بارداً.", uk: "Завтра буде холодно.", fa: "فردا هوا سرد خواهد بود." } ] },
    { de: "Konjunktionen: obwohl, wenn, als, während…", ku: "گرێدەرە لاوەکییەکان", icon: "⟜",
      ...
      ex: [ { de: "Als ich klein war, ...", ku: "کاتێک بچووک بووم، ...", tr: "Küçükken, ...", en: "When I was little, ...", ar: "عندما كنتُ صغيراً، ...", uk: "Коли я був малий, …", fa: "وقتی کوچک بودم، …" }, { de: "Bevor ich gehe, esse ich.", ku: "پێش ئەوەی بڕۆم، دەخۆم.", tr: "Gitmeden önce yiyorum.", en: "Before I go, I eat.", ar: "قبل أن أذهب، آكل.", uk: "Перш ніж піти, я їм.", fa: "پیش از رفتن، غذا می‌خورم." }, { de: "Seitdem er hier ist, ...", ku: "لەو کاتەوەی لێرەیە، ...", tr: "O burada olduğundan beri, ...", en: "Since he has been here, ...", ar: "منذ أن أصبح هنا، ...", uk: "Відтоді, як він тут, …", fa: "از وقتی که او اینجاست، …" }, { de: "Obwohl es regnet, gehe ich.", ku: "هەرچەندە باران دەبارێت، دەڕۆم.", tr: "Her ne kadar yağmur yağsa da gidiyorum.", en: "Although it's raining, I'm going.", ar: "رغم أن المطر يهطل، سأذهب.", uk: "Хоча йде дощ, я йду.", fa: "اگرچه باران می‌بارد، من می‌روم." }, { de: "Wenn ich Zeit habe, komme ich.", ku: "ئەگەر کاتم هەبێت، دێم.", tr: "Zamanım olursa gelirim.", en: "If I have time, I'll come.", ar: "إذا كان لدي وقت، سآتي.", uk: "Якщо матиму час, я прийду.", fa: "اگر وقت داشته باشم، می‌آیم." }, { de: "Während sie kocht, lese ich.", ku: "لە کاتێکدا ئەو خواردن لێدەنێ، دەخوێنمەوە.", tr: "O pişirirken okuyorum.", en: "While she cooks, I read.", ar: "بينما تطبخ، أقرأ.", uk: "Поки вона готує, я читаю.", fa: "در حالی که او آشپزی می‌کند، من می‌خوانم." } ] },
    { de: "Relativsätze (detail)", ku: "ڕستەی پەیوەندیدار (ورد)", icon: "⌐",
      ...
      ex: [ { de: "Der Mann, dem ich helfe, ...", ku: "ئەو پیاوەی یارمەتی دەدەم، ... (Dativ)", tr: "Yardım ettiğim adam, ... (Datif)", en: "The man whom I help, ... (dative)", ar: "الرجل الذي أساعده، ... (حالة الجر)", uk: "Чоловік, якому я допомагаю, … (давальний)", fa: "مردی که به او کمک می‌کنم، … (Dativ)" }, { de: "Das Kind, dessen Buch ...", ku: "ئەو منداڵەی کتێبەکەی ... (Genitiv)", tr: "Kitabı olan çocuk, ... (Genitif)", en: "The child whose book ... (genitive)", ar: "الطفل الذي كتابه ... (حالة الإضافة)", uk: "Дитина, чия книга … (родовий)", fa: "کودکی که کتابش … (Genitiv)" }, { de: "Die Stadt, in der ich wohne, ...", ku: "ئەو شارەی تێیدا دەژیم، ...", tr: "İçinde yaşadığım şehir, ...", en: "The city in which I live, ...", ar: "المدينة التي أعيش فيها، ...", uk: "Місто, в якому я живу, …", fa: "شهری که در آن زندگی می‌کنم، …" }, { de: "Der Film, den ich gesehen habe, ...", ku: "ئەو فیلمەی بینیم، ...", tr: "İzlediğim film, ...", en: "The film that I have watched, ...", ar: "الفيلم الذي شاهدته، ...", uk: "Фільм, який я подивився, …", fa: "فیلمی که دیده‌ام، …" }, { de: "Die Leute, mit denen ich arbeite, ...", ku: "ئەو کەسانەی لەگەڵیان کار دەکەم، ...", tr: "Birlikte çalıştığım insanlar, ...", en: "The people with whom I work, ...", ar: "الأشخاص الذين أعمل معهم، ...", uk: "Люди, з якими я працюю, …", fa: "کسانی که با آن‌ها کار می‌کنم، …" }, { de: "Das Auto, das er kaufte, ...", ku: "ئەو ئۆتۆمبێلەی کڕی، ...", tr: "Satın aldığı araba, ...", en: "The car that he bought, ...", ar: "السيارة التي اشتراها، ...", uk: "Машина, яку він купив, …", fa: "خودرویی که او خرید، …" } ] },
    { de: "Indirekte Fragen", ku: "پرسیاری ناڕاستەوخۆ", icon: "?",
      ...
      ex: [ { de: "Weißt du, wo er ist?", ku: "دەزانیت لەکوێیە؟", tr: "Nerede olduğunu biliyor musun?", en: "Do you know where he is?", ar: "هل تعرف أين هو؟", uk: "Ти знаєш, де він?", fa: "می‌دانی او کجاست؟" }, { de: "Ich frage, ob es regnet.", ku: "دەپرسم ئایا باران دەبارێت.", tr: "Yağmur yağıp yağmadığını soruyorum.", en: "I'm asking whether it's raining.", ar: "أسأل عما إذا كان المطر يهطل.", uk: "Я питаю, чи йде дощ.", fa: "می‌پرسم آیا باران می‌بارد." }, { de: "Sag mir, wann du kommst.", ku: "پێم بڵێ کەی دێیت.", tr: "Ne zaman geldiğini söyle.", en: "Tell me when you're coming.", ar: "أخبرني متى ستأتي.", uk: "Скажи мені, коли ти прийдеш.", fa: "به من بگو کِی می‌آیی." }, { de: "Ich weiß nicht, was das ist.", ku: "نازانم ئەمە چییە.", tr: "Bunun ne olduğunu bilmiyorum.", en: "I don't know what that is.", ar: "لا أعرف ما هذا.", uk: "Я не знаю, що це.", fa: "نمی‌دانم این چیست." }, { de: "Kannst du mir sagen, wie es geht?", ku: "دەتوانیت پێم بڵێیت چۆنە؟", tr: "Nasıl olduğunu söyleyebilir misiniz?", en: "Can you tell me how it's going?", ar: "هل يمكنك أن تخبرني كيف الحال؟", uk: "Можеш сказати мені, як справи?", fa: "می‌توانی به من بگویی اوضاع چطور است؟" }, { de: "Er fragt, warum du gehst.", ku: "دەپرسێت بۆچی دەڕۆیت.", tr: "Neden gittiğini soruyor.", en: "He asks why you're leaving.", ar: "يسأل لماذا تذهب.", uk: "Він питає, чому ти йдеш.", fa: "او می‌پرسد چرا می‌روی." } ] },
    { de: "Infinitiv mit zu", ku: "ئینفینیتیڤ لەگەڵ zu", icon: "zu",
      ...
      ex: [ { de: "Ich versuche zu lernen.", ku: "هەوڵ دەدەم فێربم.", tr: "Öğrenmeye çalışıyorum.", en: "I try to learn.", ar: "أحاول أن أتعلم.", uk: "Я намагаюся вчитися.", fa: "من سعی می‌کنم یاد بگیرم." }, { de: "Es ist wichtig zu üben.", ku: "گرنگە مەشق بکەیت.", tr: "Alıştırma yapmak önemli.", en: "It's important to practice.", ar: "من المهم أن تتدرب.", uk: "Важливо тренуватися.", fa: "تمرین کردن مهم است." }, { de: "Ich habe vergessen anzurufen.", ku: "بیرم چووە پەیوەندی بکەم.", tr: "Aramayı unuttum.", en: "I forgot to call.", ar: "نسيتُ أن أتصل.", uk: "Я забув зателефонувати.", fa: "فراموش کردم زنگ بزنم." }, { de: "Ich hoffe dich zu sehen.", ku: "هیوادارم بتبینم.", tr: "Seni görmeyi umuyorum.", en: "I hope to see you.", ar: "أتمنى أن أراك.", uk: "Сподіваюся тебе побачити.", fa: "امیدوارم تو را ببینم." }, { de: "Es macht Spaß zu reisen.", ku: "گەشتکردن خۆشە.", tr: "Seyahat etmek eğlenceli.", en: "Traveling is fun.", ar: "السفر ممتع.", uk: "Подорожувати весело.", fa: "سفر کردن لذت‌بخش است." }, { de: "Ich habe keine Zeit zu warten.", ku: "کاتم نییە چاوەڕێ بکەم.", tr: "Bekleyecek zamanım yok.", en: "I don't have time to wait.", ar: "ليس لدي وقت لأنتظر.", uk: "У мене немає часу чекати.", fa: "من وقت ندارم صبر کنم." } ] },
    { de: "um…zu / ohne…zu / statt…zu", ku: "um/ohne/statt + zu", icon: "⊕",
      ...
      ex: [ { de: "Ich lerne, um zu bestehen.", ku: "فێردەبم بۆ ئەوەی سەربکەوم.", tr: "Sınavı geçmek için çalışıyorum.", en: "I study in order to pass.", ar: "أدرس لكي أنجح.", uk: "Я вчуся, щоб скласти іспит.", fa: "من درس می‌خوانم تا قبول شوم." }, { de: "Er geht, ohne zu grüßen.", ku: "دەڕوات بەبێ ئەوەی سڵاو بکات.", tr: "Selamlama yapmadan gitti.", en: "He leaves without saying hello.", ar: "يذهب من دون أن يلقي التحية.", uk: "Він іде, не привітавшись.", fa: "او می‌رود بدون اینکه سلام کند." }, { de: "Statt zu schlafen, lese ich.", ku: "لەبری خەوتن، دەخوێنمەوە.", tr: "Uyumak yerine okuyorum.", en: "Instead of sleeping, I read.", ar: "بدلاً من أن أنام، أقرأ.", uk: "Замість того щоб спати, я читаю.", fa: "به‌جای اینکه بخوابم، می‌خوانم." }, { de: "Ich spare, um ein Auto zu kaufen.", ku: "پارە کۆدەکەمەوە بۆ کڕینی ئۆتۆمبێل.", tr: "Araba almak için para biriktiriyorum.", en: "I'm saving up in order to buy a car.", ar: "أدخر المال لكي أشتري سيارة.", uk: "Я заощаджую, щоб купити машину.", fa: "من پس‌انداز می‌کنم تا خودرو بخرم." }, { de: "Sie ging, ohne etwas zu sagen.", ku: "ڕۆیشت بەبێ ئەوەی شتێک بڵێت.", tr: "Bir şey söylemeden gitti.", en: "She left without saying anything.", ar: "ذهبت من دون أن تقول شيئاً.", uk: "Вона пішла, нічого не сказавши.", fa: "او رفت بدون اینکه چیزی بگوید." }, { de: "Statt zu arbeiten, spielt er.", ku: "لەبری کارکردن، یاری دەکات.", tr: "Çalışmak yerine oynuyor.", en: "Instead of working, he plays.", ar: "بدلاً من أن يعمل، يلعب.", uk: "Замість того щоб працювати, він грає.", fa: "به‌جای اینکه کار کند، بازی می‌کند." } ] },
    { de: "Passiv (Vorgangspassiv)", ku: "ڕستەی چالاک‌نەبوو", icon: "⊡",
      ...
      ex: [ { de: "Das Auto wird repariert.", ku: "ئۆتۆمبێلەکە چاک دەکرێتەوە.", tr: "Araba tamir ediliyor.", en: "The car is being repaired.", ar: "تُصلَح السيارة.", uk: "Машину ремонтують.", fa: "خودرو تعمیر می‌شود." }, { de: "Die Tür wird geöffnet.", ku: "دەرگاکە دەکرێتەوە.", tr: "Kapı açılıyor.", en: "The door is being opened.", ar: "يُفتح الباب.", uk: "Двері відчиняють.", fa: "در باز می‌شود." }, { de: "Deutsch wird hier gesprochen.", ku: "لێرە ئەڵمانی قسە دەکرێت.", tr: "Burada Almanca konuşuluyor.", en: "German is spoken here.", ar: "تُتحدَّث الألمانية هنا.", uk: "Тут розмовляють німецькою.", fa: "اینجا آلمانی صحبت می‌شود." }, { de: "Das Buch wird gelesen.", ku: "کتێبەکە دەخوێنرێتەوە.", tr: "Kitap okunuyor.", en: "The book is being read.", ar: "يُقرأ الكتاب.", uk: "Книгу читають.", fa: "کتاب خوانده می‌شود." }, { de: "Die Arbeit wird gemacht.", ku: "کارەکە دەکرێت.", tr: "İş yapılıyor.", en: "The work is being done.", ar: "يُنجَز العمل.", uk: "Роботу виконують.", fa: "کار انجام می‌شود." }, { de: "Das Essen wird gekocht.", ku: "خواردنەکە لێدەنرێت.", tr: "Yemek pişiriliyor.", en: "The food is being cooked.", ar: "يُطهى الطعام.", uk: "Їжу готують.", fa: "غذا پخته می‌شود." } ] },
    { de: "Konjunktiv II", ku: "کۆنیونکتیڤ II (مەرجی)", icon: "≈",
      ...
      ex: [ { de: "Ich würde gern kommen.", ku: "حەز دەکەم بێم.", tr: "Gelmek isterdim.", en: "I would love to come.", ar: "أود أن آتي.", uk: "Я б залюбки прийшов.", fa: "من با کمال میل می‌آمدم." }, { de: "Ich hätte eine Frage.", ku: "پرسیارێکم هەبووایە.", tr: "Bir sorum olurdu.", en: "I would have a question.", ar: "كان لدي سؤال.", uk: "У мене було б питання.", fa: "من یک سؤال داشتم." }, { de: "Könnten Sie mir helfen?", ku: "دەتوانن یارمەتیم بدەن؟", tr: "Yardım edebilir misiniz?", en: "Could you help me?", ar: "هل يمكنكم مساعدتي؟", uk: "Ви могли б мені допомогти?", fa: "می‌توانید به من کمک کنید؟" }, { de: "Wenn ich reich wäre, ...", ku: "ئەگەر دەوڵەمەند بوومایە، ...", tr: "Zengin olsaydım, ...", en: "If I were rich, ...", ar: "لو كنتُ غنياً، ...", uk: "Якби я був багатий, …", fa: "اگر ثروتمند بودم، …" }, { de: "Das wäre toll.", ku: "ئەمە نایاب دەبوو.", tr: "Harika olurdu.", en: "That would be great.", ar: "سيكون ذلك رائعاً.", uk: "Це було б чудово.", fa: "این عالی می‌شد." }, { de: "Ich würde lieber bleiben.", ku: "پێم باشترە بمێنمەوە.", tr: "Kalmayı tercih ederdim.", en: "I would rather stay.", ar: "أُفضّل البقاء.", uk: "Я б краще залишився.", fa: "من ترجیح می‌دادم بمانم." } ] },
  ],
  B2: [
