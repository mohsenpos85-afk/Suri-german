export const GRAMMAR = {
  A1: [
    { de: "Personalpronomen", ku: "جێناوی کەسی", icon: "✺",
      ...
      ex: [ { de: "Ich bin Student.", ku: "من خوێندکارم.", tr: "Ben öğrenciyim.", en: "I am a student.", ar: "أنا طالب.", uk: "Я студент.", fa: "من دانشجو هستم." ,"es":"Soy estudiante.","fr":"Je suis étudiant."}, { de: "Wir lernen Deutsch.", ku: "ئێمە ئەڵمانی فێردەبین.", tr: "Almanca öğreniyoruz.", en: "We are learning German.", ar: "نحن نتعلم الألمانية.", uk: "Ми вивчаємо німецьку.", fa: "ما آلمانی یاد می‌گیریم." ,"es":"Estamos aprendiendo alemán.","fr":"Nous apprenons l'allemand."}, { de: "Sie ist Lehrerin.", ku: "ئەو (مێ) مامۆستایە.", tr: "O (dişil) öğretmen.", en: "She is a teacher.", ar: "هي معلمة.", uk: "Вона вчителька.", fa: "او (مؤنث) معلم است." ,"es":"Ella es una maestra.","fr":"Elle est enseignante."}, { de: "Er kommt aus Erbil.", ku: "ئەو خەڵکی هەولێرە.", tr: "O Erbil'den.", en: "He is from Erbil.", ar: "هو من أربيل.", uk: "Він з Ербіля.", fa: "او اهل اربیل است." ,"es":"Es de Erbil.","fr":"Il est d'Erbil."}, { de: "Ihr seid willkommen.", ku: "ئێوە بەخێربێن.", tr: "Siz hoş geldiniz.", en: "You (all) are welcome.", ar: "أنتم مرحب بكم.", uk: "Ласкаво просимо.", fa: "شما خوش آمدید." ,"es":"De nada.","fr":"Vous êtes tous les bienvenus."}, { de: "Es ist kalt heute.", ku: "ئەمڕۆ ساردە.", tr: "Bugün soğuk.", en: "It is cold today.", ar: "الجو بارد اليوم.", uk: "Сьогодні холодно.", fa: "امروز هوا سرد است." ,"es":"Hace frío hoy.","fr":"Il fait froid aujourd'hui."} ] ,"es":"Pronombres personales","expEs":"Nombres: ich (I), du (you), er/sie/es (he/she/it), wir (we), ihr (you alls), sie (they), Sie (you - formal).","fr":"Pronoms personnels","expFr":"Zamirir: ich (I), du (sen), er/sie/es (o), wir (we), ihr (You), sie (ils), Sie (vous - officiel)."},
    { de: "sein und haben", ku: "کرداری «بوون» و «هەبوون»", icon: "◈",
      ...
      ex: [ { de: "Ich bin müde.", ku: "ماندووم.", tr: "Yorgunum.", en: "I am tired.", ar: "أنا متعب.", uk: "Я втомився.", fa: "من خسته‌ام." ,"es":"Estoy cansado.","fr":"Je suis fatigué."}, { de: "Du hast Zeit.", ku: "کاتت هەیە.", tr: "Zamanın var.", en: "You have time.", ar: "لديك وقت.", uk: "У тебе є час.", fa: "تو وقت داری." ,"es":"Tienes tiempo.","fr":"Vous avez le temps."}, { de: "Wir sind hier.", ku: "ئێمە لێرەین.", tr: "Biz buradayız.", en: "We are here.", ar: "نحن هنا.", uk: "Ми тут.", fa: "ما اینجا هستیم." ,"es":"Estamos aquí.","fr":"Nous sommes ici."}, { de: "Er ist mein Bruder.", ku: "ئەو برامە.", tr: "O benim kardeşim.", en: "He is my brother.", ar: "هو أخي.", uk: "Він мій брат.", fa: "او برادر من است." ,"es":"Es mi hermano.","fr":"C'est mon frère."}, { de: "Sie hat ein Auto.", ku: "ئەو ئۆتۆمبێلێکی هەیە.", tr: "Onun arabası var.", en: "She has a car.", ar: "لديها سيارة.", uk: "У неї є машина.", fa: "او یک ماشین دارد." ,"es":"Tiene un coche.","fr":"Elle a une voiture."}, { de: "Ihr seid spät.", ku: "ئێوە درەنگن.", tr: "Siz geç kaldınız.", en: "You (all) are late.", ar: "أنتم متأخرون.", uk: "Ви запізнилися.", fa: "شما دیر کرده‌اید." ,"es":"Llegan tarde.","fr":"Vous êtes tous en retard."} ] ,"es":"\"sein\" y \"haben\" (ser / tener)","expEs":"Sein (ser): ich bin, du bist, er ist, wir sind, ihr seid, sie sind. haben (tener): ich habe, du hast, er hat, wir haben, ihr habt, sie haben. Son muy importantes porque forman la base de muchas cosas.","fr":"\"sén\" et \"habiter\" (être / avoir)","expFr":"Vous voyez: ich bin, du bist, er ist, wir sind, ihr seid, sie sind. haben: ich habe, du hast, er hat, wir haben, ihr habt, sie haben. Ils sont très importants parce qu'ils sont la base de beaucoup de choses."},
    { de: "Präsens — regelmäßige Verben", ku: "کاتی ئێستا — کرداری ڕێکوپێک", icon: "▸",
      ...
      ex: [ { de: "ich lerne", ku: "فێردەبم", tr: "öğreniyorum", en: "I learn / I am learning", ar: "أنا أتعلّم", uk: "я вчуся / я навчаюся", fa: "من یاد می‌گیرم" ,"es":"Yo aprendo / Yo estoy aprendiendo","fr":"J'apprends / J'apprends"}, { de: "du lernst", ku: "تۆ فێردەبیت", tr: "sen öğreniyorsun", en: "you learn / you are learning", ar: "أنت تتعلّم", uk: "ти вчишся", fa: "تو یاد می‌گیری" ,"es":"aprendes / estás aprendiendo","fr":"vous apprenez / vous apprenez"}, { de: "wir lernen", ku: "ئێمە فێردەبین", tr: "biz öğreniyoruz", en: "we learn / we are learning", ar: "نحن نتعلّم", uk: "ми вчимося", fa: "ما یاد می‌گیریم" ,"es":"aprendemos / estamos aprendiendo","fr":"nous apprenons / nous apprenons"}, { de: "er spielt Fußball.", ku: "ئەو تۆپی پێ یاری دەکات.", tr: "O futbol oynuyor.", en: "He plays football.", ar: "هو يلعب كرة القدم.", uk: "Він грає у футбол.", fa: "او فوتبال بازی می‌کند." ,"es":"Juega al fútbol.","fr":"Il joue au football."}, { de: "ihr arbeitet viel.", ku: "ئێوە زۆر کار دەکەن.", tr: "Siz çok çalışıyorsunuz.", en: "You (all) work a lot.", ar: "أنتم تعملون كثيرا.", uk: "Ви багато працюєте.", fa: "شما زیاد کار می‌کنید." ,"es":"Ustedes (todos) trabajan mucho.","fr":"Vous travaillez beaucoup."}, { de: "sie wohnen hier.", ku: "ئەوان لێرە نیشتەجێن.", tr: "Onlar burada yaşıyor.", en: "They live here.", ar: "هم يسكنون هنا.", uk: "Вони тут живуть.", fa: "آن‌ها اینجا زندگی می‌کنند." ,"es":"Viven aquí.","fr":"Ils vivent ici."} ] ,"es":"Tiempo presente — verbos regulares","expEs":"• • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •","fr":"Le présent — verbes réguliers","expFr":"Racine de fiil + ich -e, du -st, er/sie/s -t, wir -en, ihr -t, sie/Sie -en. Exemple: larnen ich ich lerne."},
    { de: "Artikel: der, die, das", ku: "ئارتیکڵ (der/die/das)", icon: "✦",
      ...
      groups: [
        { art: "der", emoji: "🔵", es: "Masculino (männlich)", uk: "Чоловічий (männlich)", fa: "مذکر (männlich)", rulesUk: ["Дні тижня, місяці, пори року","Більшість професій","Закінчення: -er, -en, -el (часто)","Більшість осіб чоловічої статі"], rulesFa: ["روزهای هفته، ماه‌ها، فصل‌ها","بیشتر مشاغل","پایانه‌ها: -er، -en، -el (اغلب)","بیشتر افراد مذکر"], tr: "Eril (männlich)", ku: "نێر (männlich)", color: "#2f6f8f", rules: ["ڕۆژەکانی هەفتە، مانگەکان، وەرزەکان", "زۆربەی پیشەکان", "کۆتاییەکان: -er، -en، -el (زۆرجار)", "زۆربەی کەسانی نێر"], rulesTr: ["Haftanın günleri, aylar, mevsimler", "Çoğu meslek", "Sonekler: -er, -en, -el (çoğunlukla)", "Çoğu erkek kişi"], rulesEn: ["Days of the week, months, seasons", "Most professions", "Endings: -er, -en, -el (often)", "Most male persons"], rulesAr: ["أيام الأسبوع، الأشهر، الفصول", "معظم المهن", "اللواحق: -er، -en، -el (غالبًا)", "معظم الأشخاص الذكور"], words: [["der Mann","پیاو","adam","man","رجل","чоловік","مرد","hombre","homme"],["der Vater","باوک","baba","father","أب","батько","پدر","padre","père"],["der Sohn","کوڕ","oğul","son","ابن","син","پسر","hijo","fils"],["der Bruder","برا","erkek kardeş","brother","أخ","брат","برادر","hermano","frère"],["der Lehrer","مامۆستا","öğretmen","teacher","معلم","вчитель","معلم","profesor","enseignant"],["der Arzt","پزیشک","doktor","doctor","طبيب","лікар","پزشک","doctor","médecin"],["der Student","خوێندکار","öğrenci","student","طالب","студент","دانشجو","estudiante","étudiant"],["der Fahrer","شۆفێر","şoför","driver","سائق","водій","راننده","controlador","conducteur"],["der Bäcker","نانەوا","fırıncı","baker","خبّاز","пекар","نانوا","panadero","Boulangerie"],["der Computer","کۆمپیوتەر","bilgisayar","computer","حاسوب","комп'ютер","رایانه","ordenador","ordinateur"],["der Tisch","مێز","masa","table","طاولة","стіл","میز","Cuadro","Tableau"],["der Stuhl","کورسی","sandalye","chair","كرسي","стілець","صندلی","silla","Président"],["der Fernseher","تەلەفزیۆن","televizyon","television","تلفاز","телевізор","تلویزیون","televisión","télévision"],["der Kühlschrank","بەفرگر / سەلاجە","buzdolabı","refrigerator","ثلاجة","холодильник","یخچال","nevera","réfrigérateur"],["der Montag","دووشەممە","pazartesi","Monday","الاثنين","понеділок","دوشنبه","Lunes","Lundi"],["der Dienstag","سێشەممە","salı","Tuesday","الثلاثاء","вівторок","سه‌شنبه","Martes","Mardi"],["der Mittwoch","چوارشەممە","çarşamba","Wednesday","الأربعاء","середа","چهارشنبه","Miércoles","Mercredi"],["der Januar","ژانویە","ocak","January","يناير","січень","ژانویه","Enero","Janvier"],["der Februar","شوبات","şubat","February","فبراير","лютий","فوریه","Febrero","Février"],["der Sommer","هاوین","yaz","summer","الصيف","літо","تابستان","verano","été"],["der Winter","زستان","kış","winter","الشتاء","зима","زمستان","invierno","hiver"]] ,"rulesEs":["Días de la semana, meses, estaciones","La mayoría de las profesiones","Finales: -er, -en, -el (a menudo)","La mayoría de los hombres"],"rulesFr":["Jours de la semaine, mois, saisons","La plupart des professions","Sonics: -er, -en, -presque)","La plupart des hommes sont"],"fr":"Eril (männlich)"},
        { art: "die", emoji: "🔴", es: "Femenino (feminin)", uk: "Жіночий (feminin)", fa: "مؤنث (feminin)", rulesUk: ["Закінчення: -e, -ung, -heit, -keit, -ion, -schaft, -ie","Більшість осіб жіночої статі","Більшість міст і предметів"], rulesFa: ["پایانه‌ها: -e، -ung، -heit، -keit، -ion، -schaft، -ie","بیشتر افراد مؤنث","بیشتر شهرها و اشیاء"], tr: "Dişil (feminin)", ku: "مێ (feminin)", color: "#b8412e", rules: ["کۆتاییەکان: -e، -ung، -heit، -keit، -ion، -schaft، -ie", "زۆربەی کەسانی مێ", "زۆربەی شار و شتەکان"], rulesTr: ["Sonekler: -e, -ung, -heit, -keit, -ion, -schaft, -ie", "Çoğu dişi kişi", "Çoğu şehir ve nesne"], rulesEn: ["Endings: -e, -ung, -heit, -keit, -ion, -schaft, -ie", "Most female persons", "Most cities and objects"], rulesAr: ["اللواحق: -e، -ung، -heit، -keit، -ion، -schaft، -ie", "معظم الأشخاص الإناث", "معظم المدن والأشياء"], words: [["die Frau","ژن","kadın","woman","امرأة","жінка","زن","mujer","femme"],["die Mutter","دایک","anne","mother","أم","мати","مادر","madre","mère"],["die Tochter","کچ","kız","daughter","ابنة","донька","دختر","hija","fille"],["die Schwester","خوشک","kız kardeş","sister","أخت","сестра","خواهر","hermana","sœur"],["die Lehrerin","مامۆستا (ژن)","öğretmen (kadın)","teacher (female)","معلمة","вчителька","معلم (زن)","Profesora (mujeres)","enseignante (femme)"],["die Ärztin","پزیشک (ژن)","doktor (kadın)","doctor (female)","طبيبة","лікарка","پزشک (زن)","Doctora (mujeres)","médecin (femme)"],["die Lampe","چرا / لامپە","lamba","lamp","مصباح","лампа","لامپ","lámpara","feu"],["die Tür","دەرگا","kapı","door","باب","двері","در","puerta","porte"],["die Schule","قوتابخانە","okul","school","مدرسة","школа","مدرسه","escuela","école"],["die Stadt","شار","şehir","city","مدينة","місто","شهر","ciudad","ville"],["die Wohnung","ئەپارتمان / نیشتەجێ","daire","apartment","شقة","квартира","آپارتمان","apartamento","appartement"],["die Küche","چێشتخانە","mutfak","kitchen","مطبخ","кухня","آشپزخانه","cocina","cuisine"],["die Straße","شەقام","sokak","street","شارع","вулиця","خیابان","calle","rue"],["die Prüfung","تاقیکردنەوە","sınav","exam","امتحان","іспит","امتحان","examen","examen"],["die Zeitung","ڕۆژنامە","gazete","newspaper","جريدة","газета","روزنامه","periódico","journal"],["die Meinung","بۆچوون","görüş","opinion","رأي","думка","نظر","Dictamen","avis"],["die Freiheit","ئازادی","özgürlük","freedom","حرية","свобода","آزادی","libertad","liberté"],["die Möglichkeit","دەرفەت / ئەگەر","olasılık / imkân","possibility","إمكانية","можливість","امکان","posibilidad","possibilité"],["die Freundschaft","هاوڕێیەتی","arkadaşlık","friendship","صداقة","дружба","دوستی","amistad","l'amitié"],["die Nation","نەتەوە","millet","nation","أمة","нація","ملت","nación","pays"],["die Situation","بارودۆخ","durum","situation","وضع / حالة","ситуація","وضعیت","situación","Situation actuelle"],["die Biologie","زیندەزانی","biyoloji","biology","علم الأحياء","біологія","زیست‌شناسی","biología","biologie"],["die Musik","مۆسیقا","müzik","music","موسيقى","музика","موسیقی","música","Musique"]] ,"rulesEs":["Fin: -e, -ung, -heit, -keit, -ion, -schaft, -ie","La mayoría de las mujeres","La mayoría de las ciudades y objetos"],"rulesFr":["Soniques: -e, -ung, -heit, -kiit, -ion, -schaft, -ie","La plupart des femmes","La plupart des villes et des objets"],"fr":"Féminine"},
        { art: "das", emoji: "🟡", es: "Neutro (neutral)", uk: "Середній (neutral)", fa: "خنثی (neutral)", rulesUk: ["Закінчення: -chen, -lein, -ment, -um","Дієслова, вжиті як іменники","Діти та предмети"], rulesFa: ["پایانه‌ها: -chen، -lein، -ment، -um","افعالِ به‌کاررفته به‌عنوان اسم","کودکان و اشیاء"], tr: "Nötr (neutral)", ku: "بێلایەن (neutral)", color: "#c8922a", rules: ["کۆتاییەکان: -chen، -lein، -ment، -um", "کردار وەک ناو", "منداڵ و شتەکان"], rulesTr: ["Sonekler: -chen, -lein, -ment, -um", "İsim olarak kullanılan fiiller", "Çocuklar ve nesneler"], rulesEn: ["Endings: -chen, -lein, -ment, -um", "Verbs used as nouns", "Children and objects"], rulesAr: ["اللواحق: -chen، -lein، -ment، -um", "الأفعال المستخدمة كأسماء", "الأطفال والأشياء"], words: [["das Kind","منداڵ","çocuk","child","طفل","дитина","کودک","niño","enfant"],["das Baby","کۆرپە","bebek","baby","رضيع","немовля","نوزاد","bebé","bébé"],["das Mädchen","کچ (بچووک)","kız (küçük)","girl (young)","فتاة (صغيرة)","дівчинка","دختر (کوچک)","niña (joven)","jeune fille"],["das Haus","ماڵ / خانوو","ev","house","بيت / منزل","будинок","خانه","casa","maison"],["das Auto","ئۆتۆمبێل","araba","car","سيارة","автомобіль","خودرو","coche","voiture"],["das Buch","کتێب","kitap","book","كتاب","книга","کتاب","libro","livre"],["das Fenster","پەنجەرە","pencere","window","نافذة","вікно","پنجره","ventana","fenêtre"],["das Wasser","ئاو","su","water","ماء","вода","آب","agua","eau"],["das Essen","خواردن","yemek","food","طعام","їжа","غذا","alimentos","Produits alimentaires"],["das Trinken","خواردنەوە","içecek","drinking / beverage","شرب / مشروب","напій","نوشیدنی","beber / beber","boisson / boisson"],["das Spiel","یاری","oyun","game","لعبة","гра","بازی","juego","jeu"],["das Zimmer","ژوور","oda","room","غرفة","кімната","اتاق","habitación","chambre"],["das Krankenhaus","نەخۆشخانە","hastane","hospital","مستشفى","лікарня","بیمارستان","hospital","hôpital"],["das Studium","خوێندن","üniversite eğitimi","university studies","الدراسة الجامعية","навчання","تحصیلات دانشگاهی","Estudios universitarios","études universitaires"],["das Museum","مۆزەخانە","müze","museum","متحف","музей","موزه","museo","musée"],["das Zentrum","ناوەند","merkez","center","مركز","центр","مرکز","centro","centre"],["das Instrument","ئامێری مۆسیقا","enstrüman","instrument","آلة موسيقية","інструмент","ساز","instrumento","instrument"],["das Problem","کێشە","sorun","problem","مشكلة","проблема","مشکل","problema","problème"],["das Telefon","تەلەفۆن","telefon","telephone","هاتف","телефон","تلفن","teléfono","téléphone"],["das Foto","وێنە","fotoğraf","photo","صورة","фото","عکس","foto","photo"]] ,"rulesEs":["Fin: -chen, -lein, -ment, -um","Verbos utilizados como sustantivos","Niños y objetos"],"rulesFr":["Soniques: -chen, -lein, -ment, -um","Les verbes utilisés comme noms","Enfants et objets"],"fr":"Neutr (neutre)"},
      ],
      merksatz: [ { de: "der", ku: "نێر (männlich)", tr: "Eril (männlich)", en: "Masculine (männlich)", ar: "مذكر (männlich)" ,"es":"Masculino (männlich)","fr":"Masculine (männlich)"}, { de: "die", ku: "مێ (weiblich)", tr: "Dişil (weiblich)", en: "Feminine (weiblich)", ar: "مؤنث (weiblich)" ,"es":"Femenino (weiblich)","fr":"Féminine (weiblich)"}, { de: "das", ku: "بێلایەن (neutral)", tr: "Nötr (neutral)", en: "Neuter (neutral)", ar: "محايد (neutral)" ,"es":"Neutro (neutro)","fr":"Neutre (neutre)"} ],
      ex: [ { de: "der Tisch", ku: "مێز (نێر)", tr: "masa (eril)", en: "table (masculine)", ar: "طاولة (مذكر)", uk: "стіл (чоловічий рід)", fa: "میز (مذکر)" ,"es":"tabla (masculina)","fr":"Tableau (masculin)"}, { de: "die Lampe", ku: "چرا (مێ)", tr: "lamba (dişil)", en: "lamp (feminine)", ar: "مصباح (مؤنث)", uk: "лампа (жіночий рід)", fa: "لامپ (مؤنث)" ,"es":"luz (femenina)","fr":"lampe (féminine)"}, { de: "das Buch", ku: "کتێب (بێلایەن)", tr: "kitap (yansız)", en: "book (neuter)", ar: "كتاب (محايد)", uk: "книга (середній рід)", fa: "کتاب (خنثی)" ,"es":"libro (neuter)","fr":"livre (neutre)"}, { de: "der Stuhl ist neu.", ku: "کورسییەکە نوێیە.", tr: "Sandalye yeni.", en: "The chair is new.", ar: "الكرسي جديد.", uk: "Стілець новий.", fa: "صندلی نو است." ,"es":"La silla es nueva.","fr":"La chaise est nouvelle."}, { de: "die Tür ist offen.", ku: "دەرگاکە کراوەیە.", tr: "Kapı açık.", en: "The door is open.", ar: "الباب مفتوح.", uk: "Двері відчинені.", fa: "در باز است." ,"es":"La puerta está abierta.","fr":"La porte est ouverte."}, { de: "das Fenster ist groß.", ku: "پەنجەرەکە گەورەیە.", tr: "Pencere büyük.", en: "The window is big.", ar: "النافذة كبيرة.", uk: "Вікно велике.", fa: "پنجره بزرگ است." ,"es":"La ventana es grande.","fr":"La fenêtre est grande."} ] ,"es":"Artículos: der, die, das","expEs":"En alemán, cada sustantivo tiene un género: masculino «der», femenino «die», neutro «das». El artículo se presenta ante el sustantivo y debe ser aprendido junto con él, ya que no siempre es lógico. A continuación, las reglas y los ejemplos se separan por cada artículo.","fr":"Articles: der, die, das","expFr":"En allemand, chaque nom a un genre : mâle, femelle,,die, faux,,,,,,,,,, le nom doit être porté avant le nom, et il n'est pas toujours logique parce qu'il y a des règles et des exemples qui sont fixés par chaque ferraille."},
    { de: "Plural", ku: "کۆ (زۆرینە)", icon: "❖",
      ...
      ex: [ { de: "das Kind → die Kinder", ku: "منداڵ → منداڵان", tr: "çocuk → çocuklar", en: "the child → the children", ar: "الطفل ← الأطفال", uk: "дитина → діти", fa: "کودک ← کودکان" ,"es":"el niño → los niños","fr":"l'enfant → les enfants"}, { de: "die Frau → die Frauen", ku: "ژن → ژنان", tr: "kadın → kadınlar", en: "the woman → the women", ar: "المرأة ← النساء", uk: "жінка → жінки", fa: "زن ← زنان" ,"es":"la mujer → las mujeres","fr":"la femme → les femmes"}, { de: "das Auto → die Autos", ku: "ئۆتۆمبێل → ئۆتۆمبێلەکان", tr: "araba → arabalar", en: "the car → the cars", ar: "السيارة ← السيارات", uk: "машина → машини", fa: "خودرو ← خودروها" ,"es":"el coche → los coches","fr":"la voiture → les voitures"}, { de: "der Tisch → die Tische", ku: "مێز → مێزەکان", tr: "masa → masalar", en: "the table → the tables", ar: "الطاولة ← الطاولات", uk: "стіл → столи", fa: "میز ← میزها" ,"es":"el cuadro → los cuadros","fr":"le tableau → les tableaux"}, { de: "der Apfel → die Äpfel", ku: "سێو → سێوەکان", tr: "elma → elmalar", en: "the apple → the apples", ar: "التفاحة ← التفاحات", uk: "яблуко → яблука", fa: "سیب ← سیب‌ها" ,"es":"la manzana → las manzanas","fr":"la pomme → les pommes"}, { de: "das Buch → die Bücher", ku: "کتێب → کتێبەکان", tr: "kitap → kitaplar", en: "the book → the books", ar: "الكتاب ← الكتب", uk: "книга → книги", fa: "کتاب ← کتاب‌ها" ,"es":"el libro → los libros","fr":"le livre → les livres"} ] ,"es":"Plural","expEs":"En alemán hay varias maneras de formar el plural: -e, -n/-en, -er, -s, o sin cambios. En plural, el artículo siempre es «die».","fr":"Pluriel","expFr":"Il existe plusieurs façons de faire le pluriel en allemand: e, n, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e, e,"},
    { de: "Bestimmte / unbestimmte Artikel", ku: "ئارتیکڵی دیاریکراو و نادیار", icon: "✧",
      ...
      ex: [ { de: "Das ist ein Buch.", ku: "ئەمە کتێبێکە (نادیار).", tr: "Bu bir kitap. (belirsiz)", en: "This is a book. (indefinite)", ar: "هذا كتاب. (نكرة)", uk: "Це книга. (неозначений)", fa: "این یک کتاب است. (نکره)" ,"es":"Esto es un libro.","fr":"C'est un livre."}, { de: "Das Buch ist neu.", ku: "کتێبەکە نوێیە (دیاریکراو).", tr: "Kitap yeni. (belirli)", en: "The book is new. (definite)", ar: "الكتاب جديد. (معرفة)", uk: "Книга нова. (означений)", fa: "کتاب نو است. (معرفه)" ,"es":"El libro es nuevo.","fr":"Le livre est nouveau. (défini)"}, { de: "Ich habe eine Frage.", ku: "پرسیارێکم هەیە.", tr: "Bir sorum var.", en: "I have a question.", ar: "لدي سؤال.", uk: "У мене є питання.", fa: "من یک سؤال دارم." ,"es":"Tengo una pregunta.","fr":"J'ai une question."}, { de: "Ein Mann wartet draußen.", ku: "پیاوێک لە دەرەوە چاوەڕێیە.", tr: "Dışarıda bir adam bekliyor.", en: "A man is waiting outside.", ar: "رجل ينتظر في الخارج.", uk: "Надворі чекає чоловік.", fa: "مردی بیرون منتظر است." ,"es":"Un hombre está esperando afuera.","fr":"Un homme attend dehors."}, { de: "Der Mann ist mein Vater.", ku: "پیاوەکە باوکمە.", tr: "Adam babam.", en: "The man is my father.", ar: "الرجل هو أبي.", uk: "Цей чоловік — мій батько.", fa: "این مرد پدر من است." ,"es":"El hombre es mi padre.","fr":"Cet homme est mon père."}, { de: "Eine Katze schläft hier.", ku: "پشیلەیەک لێرە خەوتووە.", tr: "Burada bir kedi uyuyor.", en: "A cat is sleeping here.", ar: "قطة نائمة هنا.", uk: "Тут спить кішка.", fa: "گربه‌ای اینجا خوابیده است." ,"es":"Un gato está durmiendo aquí.","fr":"Un chat dort ici."} ] ,"es":"Artículos definidos / indefinidos","expEs":"«der/die/das» se utiliza para cosas definidas (cosas que ya sabemos). «ein/eine» se utiliza para cosas indefinidas (algo que se menciona por primera vez). Para neutro y masculino, se utiliza «ein»; para femenino, se utiliza «eine».","fr":"Articles de valeur définie ou indéterminée","expFr":"▪der/die/das/as used for certain things we know. οneine οneine οneine οn pour les indéterminés et erinon, pour les femelles."},
    { de: "Akkusativ", ku: "ئاککوزاتیڤ (بەرکاری ڕاستەوخۆ)", icon: "→",
      ...
      ex: [ { de: "Ich sehe den Mann.", ku: "پیاوەکە دەبینم.", tr: "Adamı görüyorum.", en: "I see the man.", ar: "أرى الرجل.", uk: "Я бачу чоловіка.", fa: "من مرد را می‌بینم." ,"es":"Veo al hombre.","fr":"Je vois l'homme."}, { de: "Ich kaufe einen Apfel.", ku: "سێوێک دەکڕم.", tr: "Bir elma satın alıyorum.", en: "I am buying an apple.", ar: "أشتري تفاحة.", uk: "Я купую яблуко.", fa: "من یک سیب می‌خرم." ,"es":"Estoy comprando una manzana.","fr":"Je vais acheter une pomme."}, { de: "Ich lese das Buch.", ku: "کتێبەکە دەخوێنمەوە.", tr: "Kitabı okuyorum.", en: "I am reading the book.", ar: "أقرأ الكتاب.", uk: "Я читаю книгу.", fa: "من کتاب را می‌خوانم." ,"es":"Estoy leyendo el libro.","fr":"Je lis le livre."}, { de: "Er hat einen Hund.", ku: "سەگێکی هەیە.", tr: "Bir köpeği var.", en: "He has a dog.", ar: "لديه كلب.", uk: "У нього є собака.", fa: "او یک سگ دارد." ,"es":"Tiene un perro.","fr":"Il a un chien."}, { de: "Wir brauchen den Schlüssel.", ku: "پێویستیمان بە کلیلەکەیە.", tr: "Anahtara ihtiyacımız var.", en: "We need the key.", ar: "نحتاج إلى المفتاح.", uk: "Нам потрібен ключ.", fa: "ما به کلید نیاز داریم." ,"es":"Necesitamos la llave.","fr":"Il nous faut la clé."}, { de: "Ich trinke eine Cola.", ku: "کۆلایەک دەخۆمەوە.", tr: "Bir kola içiyorum.", en: "I am drinking a cola.", ar: "أشرب كولا.", uk: "Я п'ю колу.", fa: "من یک نوشابه می‌نوشم." ,"es":"Estoy bebiendo una cola.","fr":"Je bois un cola."} ] ,"es":"Causa acusativa","expEs":"El acusador es el caso del objeto directo. Sólo el artículo masculino cambia: der → den, ein → einen. Femenino y neutro no cambian.","fr":"Cas de preuve","expFr":"L'acousative est un état objet direct. Seul le fondu reste différent du der, ein einen. Il ne change pas de sexe féminin et indirect."},
    { de: "Possessivartikel", ku: "ئارتیکڵی خاوەندارێتی", icon: "✪",
      ...
      ex: [ { de: "Das ist mein Buch.", ku: "ئەمە کتێبی منە.", tr: "Bu benim kitabım.", en: "This is my book.", ar: "هذا كتابي.", uk: "Це моя книга.", fa: "این کتاب من است." ,"es":"Este es mi libro.","fr":"C'est mon livre."}, { de: "Deine Tasche ist schön.", ku: "جانتاکەت جوانە.", tr: "Çantan güzel.", en: "Your bag is nice.", ar: "حقيبتك جميلة.", uk: "Твоя сумка гарна.", fa: "کیف تو قشنگ است." ,"es":"Tu bolso es bonito.","fr":"Ton sac est sympa."}, { de: "Sein Auto ist neu.", ku: "ئۆتۆمبێلەکەی نوێیە.", tr: "Onun arabası yeni.", en: "His car is new.", ar: "سيارته جديدة.", uk: "Його машина нова.", fa: "ماشین او نو است." ,"es":"Su coche es nuevo.","fr":"Sa voiture est neuve."}, { de: "Ihre Mutter ist Ärztin.", ku: "دایکی پزیشکە.", tr: "Annesi doktor.", en: "Her mother is a doctor.", ar: "أمها طبيبة.", uk: "Її мати лікарка.", fa: "مادر او پزشک است." ,"es":"Su madre es doctora.","fr":"Sa mère est médecin."}, { de: "Unser Haus ist groß.", ku: "خانووەکەمان گەورەیە.", tr: "Evimiz büyük.", en: "Our house is big.", ar: "بيتنا كبير.", uk: "Наш будинок великий.", fa: "خانهٔ ما بزرگ است." ,"es":"Nuestra casa es grande.","fr":"Notre maison est grande."}, { de: "Euer Lehrer ist nett.", ku: "مامۆستاکەتان بەسۆزە.", tr: "Öğretmeniniz nazik.", en: "Your (all) teacher is nice.", ar: "معلمكم لطيف.", uk: "Ваш учитель добрий.", fa: "معلم شما مهربان است." ,"es":"Tu (todos) profesor es agradable.","fr":"Votre professeur est gentil."} ] ,"es":"Artículos de posesión","expEs":"Mein (mi), dein (tu), sein (su), ihr (su), unser (nuestro), están de acuerdo con el género del sustantivo.","fr":"Articles de possession","expFr":"A moi, à toi, à toi, à toi, à toi, à toi-même, à toi, à ta mouille, à ton nom, ils sont le sexe de ton nom."},
    { de: "Negation: nicht / kein", ku: "نەرێ کردن (nicht/kein)", icon: "⊘",
      ...
      ex: [ { de: "Ich verstehe nicht.", ku: "تێناگەم.", tr: "Anlamıyorum.", en: "I don't understand.", ar: "لا أفهم.", uk: "Я не розумію.", fa: "من نمی‌فهمم." ,"es":"No entiendo.","fr":"Je ne comprends pas."}, { de: "Ich habe kein Geld.", ku: "پارەم نییە.", tr: "Param yok.", en: "I have no money.", ar: "ليس لدي مال.", uk: "У мене немає грошей.", fa: "من پول ندارم." ,"es":"No tengo dinero.","fr":"Je n'ai pas d'argent."}, { de: "Das ist nicht richtig.", ku: "ئەمە ڕاست نییە.", tr: "Bu doğru değil.", en: "That is not correct.", ar: "هذا ليس صحيحا.", uk: "Це неправильно.", fa: "این درست نیست." ,"es":"Eso no es correcto.","fr":"Ce n'est pas exact."}, { de: "Er ist nicht hier.", ku: "ئەو لێرە نییە.", tr: "O burada değil.", en: "He is not here.", ar: "هو ليس هنا.", uk: "Його тут немає.", fa: "او اینجا نیست." ,"es":"No está aquí.","fr":"Il n'est pas là."}, { de: "Ich habe keine Zeit.", ku: "کاتم نییە.", tr: "Zamanım yok.", en: "I have no time.", ar: "ليس لدي وقت.", uk: "У мене немає часу.", fa: "من وقت ندارم." ,"es":"No tengo tiempo.","fr":"Je n'ai pas le temps."}, { de: "Das macht keinen Spaß.", ku: "ئەمە خۆش نییە.", tr: "Bu eğlenceli değil.", en: "That's not fun.", ar: "هذا ليس ممتعا.", uk: "Це не весело.", fa: "این اصلاً لذت‌بخش نیست." ,"es":"Eso no es divertido.","fr":"Ce n'est pas drôle."} ] ,"es":"Negación: nicht / kein","expEs":"«nicht» niega un verbo, adjetivo o frase. «kein» niega un sustantivo (usado con un artículo indefinido o sin artículo).","fr":"Négatif: nicht / kein","expFr":"Les noms font négatif (indistinctement par le nom de ne plus)."},
    { de: "W-Fragen", ku: "پرسیاری W", icon: "?",
      ...
      ex: [ { de: "Wo wohnst du?", ku: "لەکوێ نیشتەجێیت؟", tr: "Nerede yaşıyorsun?", en: "Where do you live?", ar: "أين تسكن؟", uk: "Де ти живеш?", fa: "کجا زندگی می‌کنی؟" ,"es":"¿Dónde vives?","fr":"Où habitez-vous?"}, { de: "Was machst du?", ku: "چی دەکەیت؟", tr: "Ne yapıyorsun?", en: "What are you doing?", ar: "ماذا تفعل؟", uk: "Що ти робиш?", fa: "چه کار می‌کنی؟" ,"es":"¿Qué estás haciendo?","fr":"Qu'est-ce que tu fais?"}, { de: "Wann kommst du?", ku: "کەی دێیت؟", tr: "Ne zaman geliyorsun?", en: "When are you coming?", ar: "متى ستأتي؟", uk: "Коли ти прийдеш?", fa: "کِی می‌آیی؟" ,"es":"¿Cuándo vienes?","fr":"Quand venez-vous?"}, { de: "Wer ist das?", ku: "ئەمە کێیە؟", tr: "Bu kim?", en: "Who is that?", ar: "من هذا؟", uk: "Хто це?", fa: "این کیست؟" ,"es":"¿Quién es?","fr":"Qui est-ce?"}, { de: "Wie heißt du?", ku: "ناوت چییە؟", tr: "Adın ne?", en: "What is your name?", ar: "ما اسمك؟", uk: "Як тебе звати?", fa: "اسمت چیست؟" ,"es":"¿Cómo te llamas?","fr":"Quel est votre nom?"}, { de: "Warum lernst du Deutsch?", ku: "بۆچی ئەڵمانی فێردەبیت؟", tr: "Neden Almanca öğreniyorsun?", en: "Why are you learning German?", ar: "لماذا تتعلم الألمانية؟", uk: "Чому ти вчиш німецьку?", fa: "چرا آلمانی یاد می‌گیری؟" ,"es":"¿Por qué estás aprendiendo alemán?","fr":"Pourquoi tu apprends l'allemand?"} ] ,"es":"Preguntas WH","expEs":"Una pregunta comienza con una palabra de pregunta: wer (quién), wann (cuándo), wie (cómo), warum (por qué). El verbo viene en segunda posición.","fr":"Questions WH","expFr":"Les questions commencent par le mot « question », « était », « wo », « wonn », «wie », « quoiqu'il en soit », «warum», «pourquoi» vient en deuxième position."},
    { de: "Ja/Nein-Fragen", ku: "پرسیاری بەڵێ/نەخێر", icon: "↔",
      ...
      ex: [ { de: "Kommst du mit?", ku: "لەگەڵم دێیت؟", tr: "Benimle geliyor musun?", en: "Are you coming along?", ar: "هل ستأتي معي؟", uk: "Ти йдеш зі мною?", fa: "با من می‌آیی؟" ,"es":"¿Vienes?","fr":"Vous venez?"}, { de: "Hast du Zeit?", ku: "کاتت هەیە؟", tr: "Zamanın var mı?", en: "Do you have time?", ar: "هل لديك وقت؟", uk: "У тебе є час?", fa: "وقت داری؟" ,"es":"¿Tienes tiempo?","fr":"Vous avez le temps?"}, { de: "Ist das richtig?", ku: "ئەمە ڕاستە؟", tr: "Bu doğru mu?", en: "Is that correct?", ar: "هل هذا صحيح؟", uk: "Це правильно?", fa: "این درست است؟" ,"es":"¿Es eso correcto?","fr":"Est-ce exact?"}, { de: "Sprichst du Englisch?", ku: "ئینگلیزی قسە دەکەیت؟", tr: "İngilizce konuşuyor musun?", en: "Do you speak English?", ar: "هل تتحدث الإنجليزية؟", uk: "Ти розмовляєш англійською?", fa: "انگلیسی صحبت می‌کنی؟" ,"es":"¿Hablas inglés?","fr":"Vous parlez anglais?"}, { de: "Magst du Tee?", ku: "حەزت لە چایە؟", tr: "Çayı sever misin?", en: "Do you like tea?", ar: "هل تحب الشاي؟", uk: "Ти любиш чай?", fa: "چای دوست داری؟" ,"es":"¿Te gusta el té?","fr":"Tu aimes le thé?"}, { de: "Wohnst du hier?", ku: "لێرە نیشتەجێیت؟", tr: "Burada mı yaşıyorsun?", en: "Do you live here?", ar: "هل تسكن هنا؟", uk: "Ти тут живеш?", fa: "اینجا زندگی می‌کنی؟" ,"es":"¿Vives aquí?","fr":"Vous vivez ici?"} ] ,"es":"Sí/No preguntas","expEs":"Estas preguntas comienzan con el verbo (el verbo viene en primera posición). La respuesta es ja (sí) o nein (no).","fr":"Oui/Pas de questions","expFr":"Ces questions commencent par des verbes (le remplissage vient en premier). La réponse est ja (oui) ou nein (non)."},
    { de: "Satzstellung", ku: "ڕیزبەندی ڕستە", icon: "≡",
      ...
      ex: [ { de: "Ich lerne heute Deutsch.", ku: "ئەمڕۆ ئەڵمانی فێردەبم.", tr: "Bugün Almanca öğreniyorum.", en: "I am learning German today.", ar: "أتعلم الألمانية اليوم.", uk: "Сьогодні я вчу німецьку.", fa: "من امروز آلمانی یاد می‌گیرم." ,"es":"Hoy estoy aprendiendo alemán.","fr":"J'apprends l'allemand aujourd'hui."}, { de: "Heute lerne ich Deutsch.", ku: "ئەمڕۆ ئەڵمانی فێردەبم (کردار هێشتا جێی ٢).", tr: "Bugün Almanca öğreniyorum (fiil hâlâ 2. sırada).", en: "Today I am learning German (verb still in position 2).", ar: "اليوم أتعلم الألمانية (الفعل ما زال في الموضع الثاني).", uk: "Сьогодні я вчу німецьку (дієслово все одно на другій позиції).", fa: "امروز آلمانی یاد می‌گیرم (فعل باز هم در جایگاه دوم است)." ,"es":"Hoy estoy aprendiendo alemán (verbo todavía en posición 2).","fr":"Aujourd'hui, j'apprends l'allemand (verbe toujours en position 2)."}, { de: "Morgen gehe ich nach Hause.", ku: "سبەینێ دەچمە ماڵەوە.", tr: "Yarın eve gidiyorum.", en: "Tomorrow I am going home.", ar: "غدا سأذهب إلى البيت.", uk: "Завтра я йду додому.", fa: "فردا به خانه می‌روم." ,"es":"Mañana me voy a casa.","fr":"Demain, je rentre chez moi."}, { de: "Am Abend sehe ich fern.", ku: "ئێوارە تەلەفزیۆن سەیر دەکەم.", tr: "Akşam televizyon izliyorum.", en: "In the evening I watch TV.", ar: "في المساء أشاهد التلفاز.", uk: "Увечері я дивлюся телевізор.", fa: "شب تلویزیون تماشا می‌کنم." ,"es":"Por la noche veo la televisión.","fr":"Le soir, je regarde la télé."}, { de: "In Bochum wohne ich.", ku: "لە بۆخوم نیشتەجێم.", tr: "Bochum'da yaşıyorum.", en: "I live in Bochum.", ar: "أسكن في بوخوم.", uk: "Я живу в Бохумі.", fa: "من در بوخوم زندگی می‌کنم." ,"es":"Vivo en Bochum.","fr":"Je vis à Bochum."}, { de: "Jetzt esse ich.", ku: "ئێستا دەخۆم.", tr: "Şimdi yiyorum.", en: "Now I am eating.", ar: "الآن أنا آكل.", uk: "Зараз я їм.", fa: "الان غذا می‌خورم." ,"es":"Ahora estoy comiendo.","fr":"Maintenant, je mange."} ] ,"es":"Orden de palabras","expEs":"En una oración normal, el verbo está siempre en segunda posición. «Posición 2» es una regla muy importante en alemán.","fr":"Ordre des mots","expFr":"Le verbe est toujours deuxième dans la phrase normale. La deuxième position est une règle très importante en allemand."},
    { de: "Modalverben", ku: "کرداری یاریدەدەر (مۆداڵ)", icon: "◆",
      ...
      ex: [ { de: "Ich kann schwimmen.", ku: "دەتوانم مەلە بکەم.", tr: "Yüzebiliyorum.", en: "I can swim.", ar: "أستطيع السباحة.", uk: "Я вмію плавати.", fa: "من می‌توانم شنا کنم." ,"es":"Puedo nadar.","fr":"Je sais nager."}, { de: "Du musst lernen.", ku: "دەبێت فێربیت.", tr: "Çalışmak zorundasın.", en: "You have to study.", ar: "يجب أن تدرس.", uk: "Ти мусиш вчитися.", fa: "تو باید درس بخوانی." ,"es":"Tienes que estudiar.","fr":"Tu dois étudier."}, { de: "Wir wollen essen.", ku: "دەمانەوێت بخۆین.", tr: "Yemek istiyoruz.", en: "We want to eat.", ar: "نريد أن نأكل.", uk: "Ми хочемо їсти.", fa: "ما می‌خواهیم غذا بخوریم." ,"es":"Queremos comer.","fr":"On veut manger."}, { de: "Darf ich rein?", ku: "دەکرێت بێمە ژوورەوە؟", tr: "İçeri girebilir miyim?", en: "May I come in?", ar: "هل يمكنني الدخول؟", uk: "Можна мені зайти?", fa: "اجازه دارم بیایم داخل؟" ,"es":"¿Puedo pasar?","fr":"Je peux entrer?"}, { de: "Du sollst warten.", ku: "دەبێت چاوەڕێ بکەیت.", tr: "Beklemelisin.", en: "You should wait.", ar: "ينبغي أن تنتظر.", uk: "Ти маєш почекати.", fa: "تو باید صبر کنی." ,"es":"Deberías esperar.","fr":"Tu devrais attendre."}, { de: "Ich möchte Kaffee.", ku: "قاوەم دەوێت.", tr: "Kahve istiyorum.", en: "I would like coffee.", ar: "أريد قهوة.", uk: "Я хотів би кави.", fa: "من قهوه می‌خواهم." ,"es":"Me gustaría café.","fr":"J'aimerais du café."} ] ,"es":"Verbos modales","expEs":"können (ser capaz), müssen (tener que hacerlo), wollen (querir hacerlo), dürfen (permitirlo), sollen (debería hacerlo), möchten (quisiera hacerlo). El segundo verbo va al final de la oración en su forma infinitiva.","fr":"verbes modaux","expFr":"Pour pouvoir le faire vient le deuxième verbe comme un ax à la fin de la phrase."},
    { de: "Unregelmäßige Verben", ku: "کرداری ناڕێک (بنەڕەتی)", icon: "↯",
      ...
      ex: [ { de: "fahren → er fährt", ku: "لێخوڕین → ئەو لێدەخوڕێت", tr: "gitmek → o gidiyor", en: "to drive → he drives", ar: "يقود ← هو يقود", uk: "їхати → він їде", fa: "راندن ← او می‌راند" ,"es":"para conducir → conduce","fr":"pour conduire → il conduit"}, { de: "essen → du isst", ku: "خواردن → تۆ دەخۆیت", tr: "yemek → sen yiyorsun", en: "to eat → you eat", ar: "يأكل ← أنت تأكل", uk: "їсти → ти їси", fa: "خوردن ← تو می‌خوری" ,"es":"comer → usted come","fr":"manger → vous mangez"}, { de: "sehen → er sieht", ku: "بینین → ئەو دەبینێت", tr: "görmek → o görüyor", en: "to see → he sees", ar: "يرى ← هو يرى", uk: "бачити → він бачить", fa: "دیدن ← او می‌بیند" ,"es":"ver → él ve","fr":"pour voir → il voit"}, { de: "geben → du gibst", ku: "دان → تۆ دەدەیت", tr: "vermek → sen veriyorsun", en: "to give → you give", ar: "يعطي ← أنت تعطي", uk: "давати → ти даєш", fa: "دادن ← تو می‌دهی" ,"es":"para dar → usted da","fr":"pour donner → vous donner"}, { de: "lesen → sie liest", ku: "خوێندنەوە → ئەو دەیخوێنێتەوە", tr: "okumak → o okuyor", en: "to read → she reads", ar: "يقرأ ← هي تقرأ", uk: "читати → вона читає", fa: "خواندن ← او می‌خواند" ,"es":"leer → ella lee","fr":"pour lire → elle lit"}, { de: "schlafen → er schläft", ku: "خەوتن → ئەو دەخەوێت", tr: "uyumak → o uyuyor", en: "to sleep → he sleeps", ar: "ينام ← هو ينام", uk: "спати → він спить", fa: "خوابیدن ← او می‌خوابد" ,"es":"dormir → duerme","fr":"pour dormir → il dort"} ] ,"es":"Verbos irregulares","expEs":"Algunos verbos cambian su vocal en las formas «du» y «er/sie/es» (a, e→i/ie). Ejemplo: fahren → du fährst, essen → du isst.","fr":"verbes irréguliers","expFr":"Certains verbes changent de nom pour οr/sie/esφe/ie). Exemple: Fahren φ du fährst, essen φst."},
    { de: "Trennbare Verben", ku: "کرداری لێکدراو", icon: "⇿",
      ...
      ex: [ { de: "Ich stehe um 7 auf.", ku: "کاتژمێر ٧ هەڵدەستم.", tr: "Saat 7'de kalkıyorum.", en: "I get up at 7.", ar: "أستيقظ الساعة السابعة.", uk: "Я встаю о 7-й.", fa: "من ساعت ۷ بیدار می‌شوم." ,"es":"Me levanto a las 7.","fr":"Je me lève à 7 h."}, { de: "Er kauft ein.", ku: "ئەو بازاڕ دەکات.", tr: "O alışveriş yapıyor.", en: "He goes shopping.", ar: "هو يتسوّق.", uk: "Він робить покупки.", fa: "او خرید می‌کند." ,"es":"Va de compras.","fr":"Il fait des courses."}, { de: "Wir kommen an.", ku: "ئێمە دەگەین.", tr: "Biz varıyoruz.", en: "We arrive.", ar: "نحن نصل.", uk: "Ми прибуваємо.", fa: "ما می‌رسیم." ,"es":"Llegamos.","fr":"Nous arrivons."}, { de: "Ruf mich an!", ku: "پەیوەندیم پێوە بکە!", tr: "Beni ara!", en: "Call me!", ar: "اتصل بي!", uk: "Зателефонуй мені!", fa: "به من زنگ بزن!" ,"es":"¡Llámame!","fr":"Appelez-moi!"}, { de: "Der Zug fährt ab.", ku: "شەمەندەفەرەکە بەڕێدەکەوێت.", tr: "Tren kalkıyor.", en: "The train departs.", ar: "القطار يغادر.", uk: "Потяг відходить.", fa: "قطار حرکت می‌کند." ,"es":"El tren sale.","fr":"Le train part."}, { de: "Ich räume das Zimmer auf.", ku: "ژوورەکە ڕێک دەخەم.", tr: "Odayı toparlıyorum.", en: "I am tidying up the room.", ar: "أرتّب الغرفة.", uk: "Я прибираю кімнату.", fa: "من اتاق را مرتب می‌کنم." ,"es":"Estoy ordenando la habitación.","fr":"Je range la pièce."} ] ,"es":"Verbos separables","expEs":"Algunos verbos tienen un prefijo que se separa en el tiempo presente y se mueve al final de la oración. Ejemplo: aufstehen → ich stehe auf.","fr":"verbes séparables","expFr":"Certains verbes ont un ensemble de prose à grand temps et vont à la fin de la phrase. Exemple: aufstehen ic stehe auf."},
    { de: "Imperativ", ku: "فەرمان", icon: "!",
      ...
      ex: [ { de: "Komm her!", ku: "وەرە ئێرە!", tr: "Buraya gel!", en: "Come here!", ar: "تعال هنا!", uk: "Іди сюди!", fa: "بیا اینجا!" ,"es":"¡Ven aquí!","fr":"Approche!"}, { de: "Macht die Tür zu!", ku: "دەرگاکە دابخەن!", tr: "Kapıyı kapatın!", en: "Close the door!", ar: "أغلقوا الباب!", uk: "Зачиніть двері!", fa: "در را ببندید!" ,"es":"¡Cierra la puerta!","fr":"Fermez la porte!"}, { de: "Warten Sie bitte!", ku: "تکایە چاوەڕێ بکەن!", tr: "Lütfen bekleyin!", en: "Please wait!", ar: "من فضلكم انتظروا!", uk: "Зачекайте, будь ласка!", fa: "لطفاً صبر کنید!" ,"es":"¡Por favor, espere!","fr":"Attendez!"}, { de: "Iss dein Essen!", ku: "خواردنەکەت بخۆ!", tr: "Yemeğini ye!", en: "Eat your food!", ar: "كل طعامك!", uk: "Їж свою їжу!", fa: "غذایت را بخور!" ,"es":"¡Come tu comida!","fr":"Mange ta nourriture!"}, { de: "Sei ruhig!", ku: "بێدەنگ بە!", tr: "Sessiz ol!", en: "Be quiet!", ar: "كن هادئا!", uk: "Будь тихо!", fa: "ساکت باش!" ,"es":"¡Cállate!","fr":"Taisez-vous!"}, { de: "Hören Sie zu!", ku: "گوێ بگرن!", tr: "Dinleyin!", en: "Listen!", ar: "استمعوا!", uk: "Слухайте!", fa: "گوش کنید!" ,"es":"¡Escucha!","fr":"Écoute!"} ] ,"es":"Imperativo","expEs":"Para dar órdenes. du: verbo stem (Komm!). ihr: stem + t (Kommt!). Sie: verbo + Sie (Kommen Sie!).","fr":"Impératif","expFr":"Pour donner l'ordre. du: verbe root (comm!). ihr: root + t (comm!). Sie: verbe + Sie (Commmen Sie!)."},
    { de: "Präpositionen: Ort & Zeit", ku: "ئامرازی شوێن و کات", icon: "⌖",
      ...
      ex: [ { de: "Ich bin in der Schule.", ku: "لە قوتابخانەم.", tr: "Okuldayım.", en: "I am at school.", ar: "أنا في المدرسة.", uk: "Я в школі.", fa: "من در مدرسه هستم." ,"es":"Estoy en la escuela.","fr":"Je suis à l'école."}, { de: "Um 8 Uhr.", ku: "کاتژمێر ٨.", tr: "Saat 8.", en: "At 8 o'clock.", ar: "الساعة الثامنة.", uk: "О 8-й годині.", fa: "ساعت ۸." ,"es":"A las 8 en punto.","fr":"A 8 heures."}, { de: "Im Sommer.", ku: "لە هاویندا.", tr: "Yazın.", en: "In summer.", ar: "في الصيف.", uk: "Влітку.", fa: "در تابستان." ,"es":"En verano.","fr":"En été."}, { de: "Am Montag arbeite ich.", ku: "دووشەممە کار دەکەم.", tr: "Pazartesi çalışıyorum.", en: "I work on Monday.", ar: "أعمل يوم الاثنين.", uk: "У понеділок я працюю.", fa: "روز دوشنبه کار می‌کنم." ,"es":"Trabajo el lunes.","fr":"Je travaille lundi."}, { de: "Das Bild ist an der Wand.", ku: "وێنەکە لەسەر دیوارەکەیە.", tr: "Resim duvardaki.", en: "The picture is on the wall.", ar: "اللوحة على الحائط.", uk: "Картина на стіні.", fa: "تابلو روی دیوار است." ,"es":"La foto está en la pared.","fr":"L'image est sur le mur."}, { de: "Die Tasche ist auf dem Tisch.", ku: "جانتاکە لەسەر مێزەکەیە.", tr: "Çanta masanın üzerinde.", en: "The bag is on the table.", ar: "الحقيبة على الطاولة.", uk: "Сумка на столі.", fa: "کیف روی میز است." ,"es":"La bolsa está en la mesa.","fr":"Le sac est sur la table."} ] ,"es":"Preposiciones: lugar y hora","expEs":"Lugar: en (dentro), un (próximo a/on), auf (arriba de), neben (próximo a). Tiempo: um (durante una hora específica), am (durante un día), im (durante un mes/temporada).","fr":"Prépositions: lieu et heure","expFr":"Et la terre est au bon endroit, et le bon côté, et le bon côté, et le temps est pour l'umm, l'amy et la lune."},
  ],
  A2: [
    { de: "Perfekt", ku: "کاتی ڕابردووی تەواو (Perfekt)", icon: "↩",
      ...
      ex: [ { de: "Ich habe gegessen.", ku: "خواردم.", tr: "Yedim.", en: "I have eaten.", ar: "أكلتُ.", uk: "Я поїв.", fa: "من غذا خورده‌ام." ,"es":"He comido.","fr":"J'ai mangé."}, { de: "Wir haben gelernt.", ku: "فێربووین.", tr: "Öğrendik.", en: "We have learned.", ar: "تعلّمنا.", uk: "Ми навчилися.", fa: "ما یاد گرفته‌ایم." ,"es":"Hemos aprendido.","fr":"Nous avons appris."}, { de: "Er ist gegangen.", ku: "ئەو ڕۆیشت.", tr: "O gitti.", en: "He went.", ar: "لقد ذهب.", uk: "Він пішов.", fa: "او رفته است." ,"es":"Se fue.","fr":"Il est parti."}, { de: "Sie hat ein Buch gekauft.", ku: "کتێبێکی کڕی.", tr: "Bir kitap satın aldı.", en: "She bought a book.", ar: "اشترت كتابًا.", uk: "Вона купила книгу.", fa: "او یک کتاب خریده است." ,"es":"Ella compró un libro.","fr":"Elle a acheté un livre."}, { de: "Ich bin nach Berlin gefahren.", ku: "چووم بۆ بەرلین.", tr: "Berlin'e gittim.", en: "I traveled to Berlin.", ar: "سافرتُ إلى برلين.", uk: "Я поїхав до Берліна.", fa: "من به برلین رفته‌ام." ,"es":"Viajé a Berlín.","fr":"J'ai voyagé à Berlin."}, { de: "Hast du das gesehen?", ku: "ئەمەت بینی؟", tr: "Bunu gördün mü?", en: "Did you see that?", ar: "هل رأيت ذلك؟", uk: "Ти це бачив?", fa: "این را دیدی؟" ,"es":"¿Viste eso?","fr":"Vous avez vu ça?"} ] ,"es":"Presente perfecto","expEs":"haben/sein + Partizip II. La mayoría de los verbos toman haben; los verbos de movimiento y cambio toman sein. El partizip II se forma generalmente con ge...t o ge...en.","fr":"Présent parfait","expFr":"La plupart des verbes prennent haben/sein + Partizip II; la plupart des verbes prennent haben; les verbes du mouvement et du changement prennent sen; Partizip est habituellement: g...t ou g...en."},
    { de: "Präteritum (sein, haben, Modalverben)", ku: "ڕابردووی سادە", icon: "↪",
      ...
      ex: [ { de: "Ich war krank.", ku: "نەخۆش بووم.", tr: "Hasta idim.", en: "I was sick.", ar: "كنتُ مريضًا.", uk: "Я був хворий.", fa: "من مریض بودم." ,"es":"Estaba enfermo.","fr":"J'étais malade."}, { de: "Sie hatte Zeit.", ku: "کاتی هەبوو.", tr: "Zamanı vardı.", en: "She had time.", ar: "كان لديها وقت.", uk: "У неї був час.", fa: "او وقت داشت." ,"es":"Tuvo tiempo.","fr":"Elle avait le temps."}, { de: "Wir konnten nicht kommen.", ku: "نەماندەتوانی بێین.", tr: "Gelemezdik.", en: "We could not come.", ar: "لم نستطع القدوم.", uk: "Ми не могли прийти.", fa: "ما نتوانستیم بیاییم." ,"es":"No pudimos venir.","fr":"Nous ne pouvions pas venir."}, { de: "Es war sehr kalt.", ku: "زۆر سارد بوو.", tr: "Çok soğuktu.", en: "It was very cold.", ar: "كان الجو باردًا جدًا.", uk: "Було дуже холодно.", fa: "هوا خیلی سرد بود." ,"es":"Hacía mucho frío.","fr":"Il faisait très froid."}, { de: "Er musste arbeiten.", ku: "پێویست بوو کار بکات.", tr: "Çalışmak zorundaydı.", en: "He had to work.", ar: "كان عليه أن يعمل.", uk: "Він мусив працювати.", fa: "او مجبور بود کار کند." ,"es":"Tenía que trabajar.","fr":"Il devait travailler."}, { de: "Ich hatte keine Wahl.", ku: "هیچ هەڵبژاردنێکم نەبوو.", tr: "Seçeneğim yoktu.", en: "I had no choice.", ar: "لم يكن لديّ خيار.", uk: "У мене не було вибору.", fa: "من چاره‌ای نداشتم." ,"es":"No tenía elección.","fr":"Je n'avais pas le choix."} ] ,"es":"Pasado simple (sein, haben, verbos modales)","expEs":"Para los verbos sein, haben y modal, el präteritum (pasado simple) también se utiliza en el habla cotidiana: guerra (era), hatte (had), konnte (podría), musste (había).","fr":"Passage simple (sein, haben, verbes modaux)","expFr":"Le discours pour le sein, le haben et les verbes mode utilise également Prästérium: guerre (auparavant), hatte (ici), konte (can), musclé (devrait faire)."},
    { de: "Dativ", ku: "داتیڤ (بەرکاری ناڕاستەوخۆ)", icon: "→",
      ...
      ex: [ { de: "Ich gebe dem Kind ein Buch.", ku: "کتێبێک دەدەم بە منداڵەکە.", tr: "Çocuğa bir kitap veriyorum.", en: "I am giving the child a book.", ar: "أعطي الطفلَ كتابًا.", uk: "Я даю дитині книгу.", fa: "من به کودک یک کتاب می‌دهم." ,"es":"Le estoy dando un libro al niño.","fr":"Je donne un livre à l'enfant."}, { de: "Ich helfe der Frau.", ku: "یارمەتی ژنەکە دەدەم.", tr: "Kadına yardım ediyorum.", en: "I am helping the woman.", ar: "أساعد المرأةَ.", uk: "Я допомагаю жінці.", fa: "من به زن کمک می‌کنم." ,"es":"Estoy ayudando a la mujer.","fr":"J'aide la femme."}, { de: "Es gehört dem Mann.", ku: "هی پیاوەکەیە.", tr: "O adama ait.", en: "It belongs to the man.", ar: "إنه يخص الرجل.", uk: "Це належить чоловікові.", fa: "این متعلق به مرد است." ,"es":"Pertenece al hombre.","fr":"Il appartient à l'homme."}, { de: "Ich danke dir.", ku: "سوپاست دەکەم.", tr: "Sana teşekkür ederim.", en: "I thank you.", ar: "أشكرك.", uk: "Я дякую тобі.", fa: "از تو تشکر می‌کنم." ,"es":"Gracias.","fr":"Je vous remercie."}, { de: "Das Buch gehört mir.", ku: "کتێبەکە هی منە.", tr: "Kitap bana ait.", en: "The book belongs to me.", ar: "الكتاب لي.", uk: "Книга належить мені.", fa: "کتاب متعلق به من است." ,"es":"El libro me pertenece.","fr":"Le livre m'appartient."}, { de: "Sie hilft den Kindern.", ku: "یارمەتی منداڵەکان دەدات.", tr: "Çocuklara yardım ediyor.", en: "She helps the children.", ar: "تساعد الأطفالَ.", uk: "Вона допомагає дітям.", fa: "او به کودکان کمک می‌کند." ,"es":"Ayuda a los niños.","fr":"Elle aide les enfants."} ] ,"es":"Caso Dativo","expEs":"Dative es el caso de objeto indirecto (¿a quién?). El artículo cambia: der→dem, die→der, das→dem, die (plural)→den+n.","fr":"Cas indicatif","expFr":"Datif est un état d'objet indirect (qui?). Changements artiques: der..dem, die.der, das.dem, die."},
    { de: "Wechselpräpositionen", ku: "ئامرازی دوولایەن", icon: "⇆",
      ...
      ex: [ { de: "Ich gehe in die Schule.", ku: "دەچمە قوتابخانە (جووڵە/Akk).", tr: "Okula gidiyorum (hareket/Akk).", en: "I am going to school (motion/Akk).", ar: "أذهب إلى المدرسة (حركة/نصب).", uk: "Я йду до школи (рух/Akk).", fa: "من به مدرسه می‌روم (حرکت/Akk)." ,"es":"Voy a la escuela (moción/Akk).","fr":"Je vais à l'école (motion/Akk)."}, { de: "Ich bin in der Schule.", ku: "لە قوتابخانەم (شوێن/Dativ).", tr: "Okuldayım (yer/Datif).", en: "I am at school (location/Dativ).", ar: "أنا في المدرسة (مكان/جر).", uk: "Я в школі (місце/Dativ).", fa: "من در مدرسه هستم (مکان/Dativ)." ,"es":"Estoy en la escuela (ubicación/Dativ).","fr":"Je suis à l'école (localisation/Dativ)."}, { de: "Das Buch liegt auf dem Tisch.", ku: "کتێبەکە لەسەر مێزەکەیە.", tr: "Kitap masanın üzerinde.", en: "The book is lying on the table.", ar: "الكتاب موضوع على الطاولة.", uk: "Книга лежить на столі.", fa: "کتاب روی میز قرار دارد." ,"es":"El libro está sobre la mesa.","fr":"Le livre est couché sur la table."}, { de: "Ich lege das Buch auf den Tisch.", ku: "کتێبەکە دەخەمە سەر مێزەکە.", tr: "Kitabı masanın üzerine koyuyorum.", en: "I am putting the book on the table.", ar: "أضع الكتاب على الطاولة.", uk: "Я кладу книгу на стіл.", fa: "من کتاب را روی میز می‌گذارم." ,"es":"Pondré el libro sobre la mesa.","fr":"Je mets le livre sur la table."}, { de: "Die Katze ist unter dem Bett.", ku: "پشیلەکە لەژێر جێگاکەیە.", tr: "Kedi yatağın altında.", en: "The cat is under the bed.", ar: "القطة تحت السرير.", uk: "Кішка під ліжком.", fa: "گربه زیر تخت است." ,"es":"El gato está debajo de la cama.","fr":"Le chat est sous le lit."}, { de: "Er hängt das Bild an die Wand.", ku: "وێنەکە بە دیوارەوە هەڵدەواسێت.", tr: "Resmi duvara asıyor.", en: "He is hanging the picture on the wall.", ar: "يعلّق الصورة على الحائط.", uk: "Він вішає картину на стіну.", fa: "او تابلو را به دیوار می‌آویزد." ,"es":"Está colgando la foto en la pared.","fr":"Il accroche la photo sur le mur."} ] ,"es":"Preposiciones bidireccionales","expEs":"Nueve preposiciones (en, af, über, unter, vor, hinter, neben, zwischen) toman tanto Akkusativ y Dativ. Motion→Akkusativ (¿a dónde?), location→Dativ (¿dónde?).","fr":"Prépositions à deux sens","expFr":"Neuf édats (dans, un, auf, uber, unter, vor, hinter, nében, zwischen) prennent tous deux Acuzative et Datif."},
    { de: "Pronomen: Personal-, Possessiv-, Demonstrativ-", ku: "جۆرەکانی جێناو", icon: "⁂",
      ...
      ex: [ { de: "Ich sehe ihn.", ku: "ئەو دەبینم.", tr: "Onu görüyorum.", en: "I see him.", ar: "أراه.", uk: "Я бачу його.", fa: "من او را می‌بینم." ,"es":"Lo veo.","fr":"Je le vois."}, { de: "Dieser Stuhl ist frei.", ku: "ئەم کورسییە بەتاڵە.", tr: "Bu sandalye boş.", en: "This chair is free.", ar: "هذا الكرسي فارغ.", uk: "Цей стілець вільний.", fa: "این صندلی خالی است." ,"es":"Esta silla es gratis.","fr":"Cette chaise est gratuite."}, { de: "Das ist meiner.", ku: "ئەمە هی منە.", tr: "Bu benimki.", en: "That is mine.", ar: "هذا لي.", uk: "Це моє.", fa: "این مالِ من است." ,"es":"Eso es mío.","fr":"C'est à moi."}, { de: "Ich gebe ihm das Buch.", ku: "کتێبەکەی دەدەمێ.", tr: "Ona kitabı veriyorum.", en: "I am giving him the book.", ar: "أعطيه الكتاب.", uk: "Я даю йому книгу.", fa: "من کتاب را به او می‌دهم." ,"es":"Le estoy dando el libro.","fr":"Je lui donne le livre."}, { de: "Diese Tasche ist schön.", ku: "ئەم جانتایە جوانە.", tr: "Bu çanta güzel.", en: "This bag is beautiful.", ar: "هذه الحقيبة جميلة.", uk: "Ця сумка гарна.", fa: "این کیف قشنگ است." ,"es":"Esta bolsa es hermosa.","fr":"Ce sac est magnifique."}, { de: "Welches möchtest du? Dieses.", ku: "کامەت دەوێت؟ ئەمە.", tr: "Hangisini istiyorsun? Bunu.", en: "Which one do you want? This one.", ar: "أيّها تريد؟ هذا.", uk: "Яку ти хочеш? Оцю.", fa: "کدام را می‌خواهی؟ این یکی." ,"es":"¿Cuál quieres?","fr":"- Lequel tu veux?"} ] ,"es":"Pronombres: personal, posesivo, demostrativo","expEs":"Pronombres personales (er, ihn, ihm), pronombres posesivos (meiner, deiner), pronombres demostrativos (dieser, jener) — para señalar las cosas y evitar repetir un sustantivo.","fr":"Pronoms : personnels, possessifs, démonstratifs","expFr":"Pour pointer et empêcher un nom répété."},
    { de: "Reflexive Verben", ku: "کرداری لێکدراوەی خۆ", icon: "↺",
      ...
      ex: [ { de: "Ich freue mich.", ku: "دڵخۆشم.", tr: "Sevincim var.", en: "I am glad.", ar: "أنا سعيد.", uk: "Я радію.", fa: "من خوشحالم." ,"es":"Me alegro.","fr":"Je suis content."}, { de: "Er wäscht sich.", ku: "خۆی دەشوات.", tr: "O yıkanıyor.", en: "He is washing himself.", ar: "هو يغتسل.", uk: "Він миється.", fa: "او خودش را می‌شوید." ,"es":"Se está lavando.","fr":"Il se lave."}, { de: "Wir treffen uns.", ku: "یەکتر دەبینین.", tr: "Birbirimizle buluşuyoruz.", en: "We are meeting each other.", ar: "نلتقي ببعضنا.", uk: "Ми зустрічаємося.", fa: "ما همدیگر را می‌بینیم." ,"es":"Nos vamos a encontrar.","fr":"Nous nous rencontrons."}, { de: "Setz dich bitte.", ku: "تکایە دانیشە.", tr: "Lütfen oturun.", en: "Please sit down.", ar: "تفضل بالجلوس من فضلك.", uk: "Сідай, будь ласка.", fa: "لطفاً بنشین." ,"es":"Por favor, siéntese.","fr":"Asseyez-vous."}, { de: "Sie interessiert sich für Musik.", ku: "ئارەزووی مۆسیقا دەکات.", tr: "Müziğe ilgi duyuyor.", en: "She is interested in music.", ar: "هي مهتمة بالموسيقى.", uk: "Вона цікавиться музикою.", fa: "او به موسیقی علاقه دارد." ,"es":"Está interesada en la música.","fr":"Elle s'intéresse à la musique."}, { de: "Ich fühle mich gut.", ku: "هەست بە باشی دەکەم.", tr: "Kendimi iyi hissediyorum.", en: "I feel good.", ar: "أشعر بأنني بخير.", uk: "Я почуваюся добре.", fa: "من احساس خوبی دارم." ,"es":"Me siento bien.","fr":"Je me sens bien."} ] ,"es":"Verbos reflexivos","expEs":"Algunos verbos toman un pronombre reflexivo (mich, dich, sich...). Ejemplo: sich freuen (para alegrarse), sich waschen (para lavarse).","fr":"verbes réflexifs","expFr":"Certains verbes prennent un pronom spindivat (mich, dich, sich...). Exemple: sich freuen (bien-aimé), sich waschen (wash)."},
    { de: "Komparativ", ku: "بەراوردی (پلەی بەرز)", icon: "≷",
      ...
      ex: [ { de: "Er ist größer als ich.", ku: "ئەو لە من گەورەترە.", tr: "O benden uzun.", en: "He is taller than me.", ar: "هو أطول مني.", uk: "Він вищий за мене.", fa: "او از من بلندقدتر است." ,"es":"Es más alto que yo.","fr":"Il est plus grand que moi."}, { de: "Heute ist es kälter.", ku: "ئەمڕۆ ساردترە.", tr: "Bugün daha soğuk.", en: "Today it is colder.", ar: "اليوم الجو أبرد.", uk: "Сьогодні холодніше.", fa: "امروز سردتر است." ,"es":"Hoy hace más frío.","fr":"Aujourd'hui, il fait plus froid."}, { de: "Das ist besser.", ku: "ئەمە باشترە.", tr: "Bu daha iyi.", en: "That is better.", ar: "هذا أفضل.", uk: "Це краще.", fa: "این بهتر است." ,"es":"Eso está mejor.","fr":"C'est mieux."}, { de: "Sie ist jünger als er.", ku: "ئەو لە ئەو گەنجترە.", tr: "O ondan genç.", en: "She is younger than him.", ar: "هي أصغر منه سنًا.", uk: "Вона молодша за нього.", fa: "او از او جوان‌تر است." ,"es":"Ella es más joven que él.","fr":"Elle est plus jeune que lui."}, { de: "Dieses Auto ist teurer.", ku: "ئەم ئۆتۆمبێلە گرانترە.", tr: "Bu araba daha pahalı.", en: "This car is more expensive.", ar: "هذه السيارة أغلى.", uk: "Ця машина дорожча.", fa: "این خودرو گران‌تر است." ,"es":"Este coche es más caro.","fr":"Cette voiture est plus chère."}, { de: "Deutsch ist schwerer als Englisch.", ku: "ئەڵمانی لە ئینگلیزی قورسترە.", tr: "Almanca İngilizce'den zor.", en: "German is harder than English.", ar: "الألمانية أصعب من الإنجليزية.", uk: "Німецька важча за англійську.", fa: "آلمانی از انگلیسی سخت‌تر است." ,"es":"El alemán es más difícil que el inglés.","fr":"L'allemand est plus dur que l'anglais."} ] ,"es":"Comparative","expEs":"Para comparación: adjetivo + -er + als. Ejemplo: groß → gr","fr":"Comparaison","expFr":"Pour comparaison: adjectif + -er + als. Exemple: groß φ größer als."},
    { de: "Superlativ", ku: "بەرزترین پلە", icon: "★",
      ...
      ex: [ { de: "Er ist am größten.", ku: "ئەو گەورەترینە.", tr: "O en uzun.", en: "He is the tallest.", ar: "هو الأطول.", uk: "Він найвищий.", fa: "او بلندقدترین است." ,"es":"Es el más alto.","fr":"C'est le plus grand."}, { de: "Das ist das beste Buch.", ku: "ئەمە باشترین کتێبە.", tr: "Bu en iyi kitap.", en: "That is the best book.", ar: "هذا أفضل كتاب.", uk: "Це найкраща книга.", fa: "این بهترین کتاب است." ,"es":"Ese es el mejor libro.","fr":"C'est le meilleur livre."}, { de: "Sie läuft am schnellsten.", ku: "ئەو خێراترین ڕادەکات.", tr: "O en hızlı koşuyor.", en: "She runs the fastest.", ar: "هي تركض الأسرع.", uk: "Вона біжить найшвидше.", fa: "او سریع‌ترین می‌دود." ,"es":"Ella corre más rápido.","fr":"Elle court le plus vite possible."}, { de: "Das ist der höchste Berg.", ku: "ئەمە بەرزترین شاخە.", tr: "Bu en yüksek dağ.", en: "That is the highest mountain.", ar: "هذا أعلى جبل.", uk: "Це найвища гора.", fa: "این بلندترین کوه است." ,"es":"Esa es la montaña más alta.","fr":"C'est la plus haute montagne."}, { de: "Heute ist der kälteste Tag.", ku: "ئەمڕۆ ساردترین ڕۆژە.", tr: "Bugün en soğuk gün.", en: "Today is the coldest day.", ar: "اليوم هو أبرد يوم.", uk: "Сьогодні найхолодніший день.", fa: "امروز سردترین روز است." ,"es":"Hoy es el día más frío.","fr":"Aujourd'hui est le jour le plus froid."}, { de: "Du bist mein bester Freund.", ku: "تۆ باشترین هاوڕێمی.", tr: "Sen en iyi arkadaşımsın.", en: "You are my best friend.", ar: "أنت أفضل صديق لي.", uk: "Ти мій найкращий друг.", fa: "تو بهترین دوست من هستی." ,"es":"Eres mi mejor amigo.","fr":"Tu es mon meilleur ami."} ] ,"es":"Superlativo","expEs":"Superlativo: am + adjetivo + -sten, o der/die/das + -ste. Ejemplo: am gr­oten (el más grande/talle).","fr":"Superlative","expFr":"Degré maximal: am + adjectif + -sten ou der/die/das + -ste. Exemple: am größten (grossesse)."},
    { de: "Konjunktionen: und, oder, aber, denn, sondern", ku: "گرێدەرە سادەکان", icon: "&",
      ...
      ex: [ { de: "Ich lerne, denn es ist wichtig.", ku: "فێردەبم، چونکە گرنگە.", tr: "Öğreniyorum, çünkü önemli.", en: "I am studying, because it is important.", ar: "أتعلّم لأنه مهم.", uk: "Я вчуся, бо це важливо.", fa: "من درس می‌خوانم، زیرا مهم است." ,"es":"Estoy estudiando, porque es importante.","fr":"Je étudie, parce que c'est important."}, { de: "Tee oder Kaffee?", ku: "چا یان قاوە؟", tr: "Çay mı kahve mi?", en: "Tea or coffee?", ar: "شاي أم قهوة؟", uk: "Чай чи кава?", fa: "چای یا قهوه؟" ,"es":"¿Té o café?","fr":"Thé ou café?"}, { de: "Nicht heute, sondern morgen.", ku: "نەک ئەمڕۆ، بەڵکو سبەینێ.", tr: "Bugün değil, yarın.", en: "Not today, but tomorrow.", ar: "ليس اليوم، بل غدًا.", uk: "Не сьогодні, а завтра.", fa: "نه امروز، بلکه فردا." ,"es":"Hoy no, pero mañana.","fr":"Pas aujourd'hui, mais demain."}, { de: "Ich bin müde, aber glücklich.", ku: "ماندووم، بەڵام بەختەوەرم.", tr: "Yorgunum ama mutluyum.", en: "I am tired, but happy.", ar: "أنا متعب لكن سعيد.", uk: "Я втомлений, але щасливий.", fa: "من خسته‌ام، اما خوشحالم." ,"es":"Estoy cansado, pero feliz.","fr":"Je suis fatigué, mais heureux."}, { de: "Er kommt und sie geht.", ku: "ئەو دێت و ئەو دەڕوات.", tr: "O geliyor, o gidiyor.", en: "He is coming and she is going.", ar: "هو يأتي وهي تذهب.", uk: "Він приходить, а вона йде.", fa: "او می‌آید و او می‌رود." ,"es":"Él viene y ella se va.","fr":"Il vient et elle y va."}, { de: "Ich bleibe, aber du gehst.", ku: "دەمێنمەوە، بەڵام تۆ دەڕۆیت.", tr: "Kalıyorum ama sen gidiyorsun.", en: "I am staying, but you are going.", ar: "أنا أبقى لكنك تذهب.", uk: "Я залишаюся, але ти йдеш.", fa: "من می‌مانم، اما تو می‌روی." ,"es":"Me quedo, pero tú te vas.","fr":"Je reste, mais vous partez."} ] ,"es":"Conjunciones: und, oder, aber, denn, sondern","expEs":"Estas conjunciones no cambian el orden de la palabra (el verbo permanece en la posición 2): und (y), oder (o), aber (pero), denn (porque), sondern (pero más bien).","fr":"Conjonctions: und, oder, aber, denn, sondern","expFr":"Ces liens ne changent pas la structure de la phrase (fiil deuxième place): und (and), oder (or), ab (but), parce que, sondern (inverse)."},
    { de: "Nebensatz: weil, dass", ku: "ڕستەی لاوەکی (weil/dass)", icon: "⟜",
      ...
      ex: [ { de: "Ich bleibe, weil ich krank bin.", ku: "دەمێنمەوە، چونکە نەخۆشم.", tr: "Kalıyorum çünkü hastayım.", en: "I am staying because I am sick.", ar: "أبقى لأني مريض.", uk: "Я залишаюся, бо я хворий.", fa: "من می‌مانم، زیرا مریض هستم." ,"es":"Me quedo porque estoy enfermo.","fr":"Je reste parce que je suis malade."}, { de: "Ich weiß, dass du kommst.", ku: "دەزانم کە دێیت.", tr: "Geldiğini biliyorum.", en: "I know that you are coming.", ar: "أعلم أنك قادم.", uk: "Я знаю, що ти прийдеш.", fa: "من می‌دانم که تو می‌آیی." ,"es":"Sé que vas a venir.","fr":"Je sais que tu viens."}, { de: "Er sagt, dass es regnet.", ku: "دەڵێت کە باران دەبارێت.", tr: "Yağmur yağdığını söylüyor.", en: "He says that it is raining.", ar: "يقول إنّ المطر يهطل.", uk: "Він каже, що йде дощ.", fa: "او می‌گوید که باران می‌بارد." ,"es":"Dice que está lloviendo.","fr":"Il dit qu'il pleut."}, { de: "Ich lerne, weil ich es brauche.", ku: "فێردەبم، چونکە پێویستمە.", tr: "İhtiyacım olduğu için öğreniyorum.", en: "I am learning because I need it.", ar: "أتعلّم لأنني بحاجة إليه.", uk: "Я вчуся, бо мені це потрібно.", fa: "من درس می‌خوانم، زیرا به آن نیاز دارم." ,"es":"Estoy aprendiendo porque lo necesito.","fr":"J'apprends parce que j'en ai besoin."}, { de: "Sie glaubt, dass es stimmt.", ku: "پێیوایە کە ڕاستە.", tr: "Doğru olduğuna inanıyor.", en: "She believes that it is true.", ar: "تعتقد أن ذلك صحيح.", uk: "Вона вірить, що це правда.", fa: "او باور دارد که درست است." ,"es":"Ella cree que es verdad.","fr":"Elle croit que c'est vrai."}, { de: "Wir gehen, weil es spät ist.", ku: "دەڕۆین، چونکە درەنگە.", tr: "Geç olduğu için gidiyoruz.", en: "We are leaving because it is late.", ar: "نذهب لأن الوقت متأخر.", uk: "Ми йдемо, бо вже пізно.", fa: "ما می‌رویم، زیرا دیر است." ,"es":"Nos vamos porque es tarde.","fr":"Nous partons parce qu'il est tard."} ] ,"es":"Cláusulas subordinadas: weil, dass","expEs":"Después de weil (porque) y dass (que), el verbo se mueve al final de la cláusula subordinada. Esto es una diferencia importante de una oración simple.","fr":"Clauses subordonnées: weil, dass","expFr":"Après weil (parce que) et dass (ki/) le verbe va à la fin de la phrase suivante. C'est une différence significative par rapport à la phrase simple."},
    { de: "Relativsätze (basic)", ku: "ڕستەی پەیوەندیدار (سادە)", icon: "⌐",
      ...
      ex: [ { de: "Der Mann, der dort steht, ...", ku: "ئەو پیاوەی لەوێ ڕاوەستاوە، ...", tr: "Orada duran adam, ...", en: "The man who is standing there, ...", ar: "الرجل الذي يقف هناك، ...", uk: "Чоловік, який там стоїть, …", fa: "مردی که آنجا ایستاده است، …" ,"es":"El hombre que está parado allí,...","fr":"L'homme qui est là,..."}, { de: "Das Buch, das ich lese, ...", ku: "ئەو کتێبەی دەیخوێنمەوە، ...", tr: "Okuduğum kitap, ...", en: "The book that I am reading, ...", ar: "الكتاب الذي أقرؤه، ...", uk: "Книга, яку я читаю, …", fa: "کتابی که می‌خوانم، …" ,"es":"El libro que estoy leyendo,...","fr":"Le livre que je lis,..."}, { de: "Die Frau, die singt, ...", ku: "ئەو ژنەی گۆرانی دەڵێت، ...", tr: "Şarkı söyleyen kadın, ...", en: "The woman who is singing, ...", ar: "المرأة التي تغني، ...", uk: "Жінка, яка співає, …", fa: "زنی که آواز می‌خواند، …" ,"es":"La mujer que está cantando,...","fr":"La femme qui chante,..."}, { de: "Das Auto, das rot ist, ...", ku: "ئەو ئۆتۆمبێلەی سوورە، ...", tr: "Kırmızı araba, ...", en: "The red car, ...", ar: "السيارة الحمراء، ...", uk: "Машина, яка червона, …", fa: "خودرویی که قرمز است، …" ,"es":"El coche rojo,...","fr":"La voiture rouge,..."}, { de: "Der Freund, der hilft, ...", ku: "ئەو هاوڕێیەی یارمەتی دەدات، ...", tr: "Yardım eden arkadaş, ...", en: "The friend who helps, ...", ar: "الصديق الذي يساعد، ...", uk: "Друг, який допомагає, …", fa: "دوستی که کمک می‌کند، …" ,"es":"El amigo que ayuda,...","fr":"L'ami qui aide,..."}, { de: "Die Stadt, die schön ist, ...", ku: "ئەو شارەی جوانە، ...", tr: "Güzel şehir, ...", en: "The beautiful city, ...", ar: "المدينة الجميلة، ...", uk: "Місто, яке гарне, …", fa: "شهری که زیبا است، …" ,"es":"La hermosa ciudad,...","fr":"La belle ville,..."} ] ,"es":"Cláusulas relativas (básicas)","expEs":"Se usa para dar más información sobre un sustantivo. El pronombre relativo (der, die, das) está de acuerdo con el género del sustantivo, y el verbo se mueve hasta el final.","fr":"Clauses relatives (de base)","expFr":"Pour donner plus d'informations sur le nom. Le nom correspond au genre du nom (der, die, das) et le verbe va à la fin de la phrase."},
    { de: "Genitiv (Einführung)", ku: "گەنیتیڤ (ناساندن)", icon: "'s",
      ...
      ex: [ { de: "das Auto des Mannes", ku: "ئۆتۆمبێلی پیاوەکە", tr: "adamın arabası", en: "the man's car", ar: "سيارة الرجل", uk: "машина чоловіка", fa: "خودروی آن مرد" ,"es":"el coche del hombre","fr":"la voiture de l'homme"}, { de: "die Farbe der Blume", ku: "ڕەنگی گوڵەکە", tr: "çiçeğin rengi", en: "the flower's color", ar: "لون الزهرة", uk: "колір квітки", fa: "رنگ آن گل" ,"es":"el color de la flor","fr":"la couleur de la fleur"}, { de: "der Titel des Buches", ku: "ناونیشانی کتێبەکە", tr: "kitabın başlığı", en: "the book's title", ar: "عنوان الكتاب", uk: "назва книги", fa: "عنوان آن کتاب" ,"es":"el título del libro","fr":"le titre du livre"}, { de: "das Haus meiner Eltern", ku: "خانووی دایک و باوکم", tr: "annemin babamın evi", en: "my parents' house", ar: "بيت والدَيّ", uk: "будинок моїх батьків", fa: "خانهٔ والدینم" ,"es":"casa de mis padres","fr":"La maison de mes parents"}, { de: "der Name des Kindes", ku: "ناوی منداڵەکە", tr: "çocuğun adı", en: "the child's name", ar: "اسم الطفل", uk: "ім'я дитини", fa: "نامِ آن کودک" ,"es":"el nombre del niño","fr":"le nom de l'enfant"}, { de: "die Tür des Hauses", ku: "دەرگای خانووەکە", tr: "evin kapısı", en: "the house's door", ar: "باب البيت", uk: "двері будинку", fa: "درِ آن خانه" ,"es":"la puerta de la casa","fr":"la porte de la maison"} ] ,"es":"Genitivo (introducción)","expEs":"El genito muestra la posesión (¿de quién?). Artículo: des/eines (+s para los sustantivos masculinos/neuter), der (femenino).","fr":"Produit (introduction)","expFr":"Il montre la propriété génétique (qui est-ce)."},
  ],
  B1: [
    { de: "Adjektivdeklination", ku: "ڕەوانبێژی سیفەت", icon: "✦",
      ...
      ex: [ { de: "der rote Apfel", ku: "سێوە سوورەکە", tr: "kırmızı elma (belirli eril)", en: "the red apple (definite masculine)", ar: "التفاحة الحمراء (مذكر معرّف)", uk: "червоне яблуко (означений, чоловічий рід)", fa: "سیب قرمز (معرفه، مذکر)" ,"es":"la manzana roja (masculino definido)","fr":"la pomme rouge (finale masculine)"}, { de: "ein roter Apfel", ku: "سێوێکی سوور", tr: "kırmızı bir elma (belirsiz)", en: "a red apple (indefinite)", ar: "تفاحة حمراء (نكرة)", uk: "червоне яблуко (неозначений)", fa: "یک سیب قرمز (نکره)" ,"es":"una manzana roja (indefinida)","fr":"une pomme rouge (indéfinie)"}, { de: "mit dem roten Auto", ku: "بە ئۆتۆمبێلە سوورەکە", tr: "kırmızı arabayla", en: "with the red car", ar: "بالسيارة الحمراء", uk: "з червоною машиною", fa: "با خودروی قرمز" ,"es":"con el coche rojo","fr":"avec la voiture rouge"}, { de: "die schöne Stadt", ku: "شارە جوانەکە", tr: "güzel şehir", en: "the beautiful city", ar: "المدينة الجميلة", uk: "гарне місто", fa: "شهر زیبا" ,"es":"la hermosa ciudad","fr":"la belle ville"}, { de: "ein gutes Buch", ku: "کتێبێکی باش", tr: "iyi bir kitap", en: "a good book", ar: "كتاب جيد", uk: "хороша книга", fa: "یک کتاب خوب" ,"es":"un buen libro","fr":"un bon livre"}, { de: "kaltes Wasser", ku: "ئاوی سارد", tr: "soğuk su (artikelsiz)", en: "cold water (without article)", ar: "ماء بارد (بدون أداة تعريف)", uk: "холодна вода (без артикля)", fa: "آب سرد (بدون حرف تعریف)" ,"es":"Agua fría (sin artículo)","fr":"eau froide (sans objet)"} ] ,"es":"Descenso de la aplicación","expEs":"Cuando un adjetivo viene antes de un sustantivo, su final cambia según el artículo, género y caso. Después de der/die/das es normalmente -e o -en.","fr":"Déclension adjective","expFr":"Lorsque l'adjectif arrive au devant du nom, l'éclectique change selon le sédiment, le sexe et l'état."},
    { de: "Genitiv", ku: "گەنیتیڤ (تەواو)", icon: "'s",
      ...
      ex: [ { de: "das Haus meines Vaters", ku: "خانووی باوکم", tr: "babamın evi", en: "my father's house", ar: "بيت أبي", uk: "будинок мого батька", fa: "خانهٔ پدرم" ,"es":"La casa de mi padre","fr":"La maison de mon père"}, { de: "wegen des Wetters", ku: "بەهۆی کەش‌وهەواوە", tr: "hava yüzünden", en: "because of the weather", ar: "بسبب الطقس", uk: "через погоду", fa: "به‌خاطر هوا" ,"es":"debido al tiempo","fr":"à cause du temps"}, { de: "trotz des Regens", ku: "سەرەڕای بارانەکە", tr: "yağmura rağmen", en: "despite the rain", ar: "رغم المطر", uk: "попри дощ", fa: "با وجود باران" ,"es":"a pesar de la lluvia","fr":"malgré la pluie"}, { de: "die Meinung der Leute", ku: "بۆچوونی خەڵک", tr: "halkın görüşü", en: "the opinion of the people", ar: "رأي الناس", uk: "думка людей", fa: "نظر مردم" ,"es":"la opinión del pueblo","fr":"l'opinion du peuple"}, { de: "während des Tages", ku: "لە ماوەی ڕۆژدا", tr: "gündüz boyunca", en: "during the day", ar: "خلال النهار", uk: "протягом дня", fa: "در طول روز" ,"es":"durante el día","fr":"pendant la journée"}, { de: "der Anfang des Films", ku: "سەرەتای فیلمەکە", tr: "filmin başlangıcı", en: "the beginning of the film", ar: "بداية الفيلم", uk: "початок фільму", fa: "آغاز فیلم" ,"es":"el comienzo de la película","fr":"le début du film"} ] ,"es":"Genitivo (completo)","expEs":"Posesión y conexión. Los sustantivos masculinos/neuter toman +s. También se usan con ciertas preposiciones (wegen, trotz).","fr":"Genitifs (complètes)","expFr":"Propriété et connexion. Eril/sunless names get +s. Aussi utilisé avec certains types d'éditions (wegen, trotz)."},
    { de: "Präpositionen mit Genitiv", ku: "ئامراز لەگەڵ گەنیتیڤ", icon: "⌖",
      ...
      ex: [ { de: "während des Kurses", ku: "لە ماوەی خولەکەدا", tr: "ders boyunca", en: "during the course", ar: "أثناء الدورة", uk: "протягом курсу", fa: "در طول دوره" ,"es":"durante el curso","fr":"pendant le cours"}, { de: "wegen des Problems", ku: "بەهۆی کێشەکەوە", tr: "sorun yüzünden", en: "because of the problem", ar: "بسبب المشكلة", uk: "через проблему", fa: "به‌خاطر مشکل" ,"es":"debido al problema","fr":"à cause du problème"}, { de: "trotz der Kälte", ku: "سەرەڕای ساردی", tr: "soğuğa rağmen", en: "despite the cold", ar: "رغم البرد", uk: "попри холод", fa: "با وجود سرما" ,"es":"a pesar del frío","fr":"malgré le froid"}, { de: "statt des Kaffees", ku: "لەبری قاوەکە", tr: "kahve yerine", en: "instead of the coffee", ar: "بدلاً من القهوة", uk: "замість кави", fa: "به‌جای قهوه" ,"es":"en lugar del café","fr":"au lieu du café"}, { de: "innerhalb einer Woche", ku: "لە ماوەی هەفتەیەکدا", tr: "bir hafta içinde", en: "within a week", ar: "خلال أسبوع", uk: "протягом тижня", fa: "ظرف یک هفته" ,"es":"dentro de una semana","fr":"dans une semaine"}, { de: "außerhalb der Stadt", ku: "لە دەرەوەی شارەکە", tr: "şehrin dışında", en: "outside the city", ar: "خارج المدينة", uk: "за межами міста", fa: "بیرون از شهر" ,"es":"fuera de la ciudad","fr":"à l'extérieur de la ville"} ] ,"es":"Preposiciones con genitivo","expEs":"Algunas preposiciones toman el genitivo: wegen (debido a), trotz (a pesar), während (durante), (an)statt (en lugar de).","fr":"Prépositions avec génie","expFr":"Certains édits prennent le Genitif: wegen (de face), trotz (de la langue), während (à l'écran), (an)statt (-en place)."},
    { de: "Plusquamperfekt", ku: "ڕابردووی دوور", icon: "⟲",
      ...
      ex: [ { de: "Ich hatte schon gegessen.", ku: "پێشتر خواردبووم.", tr: "Daha önce yemiştim.", en: "I had already eaten.", ar: "كنتُ قد أكلتُ بالفعل.", uk: "Я вже поїв.", fa: "من از قبل غذا خورده بودم." ,"es":"Ya había comido.","fr":"J'avais déjà mangé."}, { de: "Er war schon gegangen.", ku: "ئەو پێشتر ڕۆیشتبوو.", tr: "O daha önce gitmişti.", en: "He had already left.", ar: "كان قد ذهب بالفعل.", uk: "Він уже пішов.", fa: "او از قبل رفته بود." ,"es":"Ya se había ido.","fr":"Il était déjà parti."}, { de: "Nachdem ich gegessen hatte, ...", ku: "دوای ئەوەی خواردبووم، ...", tr: "Yedikten sonra, ...", en: "After I had eaten, ...", ar: "بعد أن كنتُ قد أكلتُ، ...", uk: "Після того, як я поїв, …", fa: "بعد از اینکه غذا خورده بودم، …" ,"es":"Después de comer,...","fr":"Après avoir mangé,..."}, { de: "Sie hatte den Brief geschrieben.", ku: "نامەکەی نووسیبوو.", tr: "Mektubu yazmıştı.", en: "She had written the letter.", ar: "كانت قد كتبت الرسالة.", uk: "Вона написала листа.", fa: "او نامه را نوشته بود." ,"es":"Ella había escrito la carta.","fr":"Elle avait écrit la lettre."}, { de: "Wir waren schon angekommen.", ku: "پێشتر گەیشتبووین.", tr: "Daha önce gelmiştik.", en: "We had already arrived.", ar: "كنا قد وصلنا بالفعل.", uk: "Ми вже прибули.", fa: "ما از قبل رسیده بودیم." ,"es":"Ya habíamos llegado.","fr":"Nous étions déjà arrivés."}, { de: "Hattest du das gewusst?", ku: "ئەمەت زانیبوو؟", tr: "Bunu biliyor muydun?", en: "Had you known that?", ar: "هل كنتَ قد عرفتَ ذلك؟", uk: "Ти це знав?", fa: "آیا این را می‌دانستی؟" ,"es":"¿Lo sabías?","fr":"Tu le savais?"} ] ,"es":"Pasado perfecto (Plusquamperfekt)","expEs":"Para una acción que ocurrió antes de otra acción en el pasado. hatte/war + Partizip II. A menudo se utiliza con nachdem.","fr":"Parfait (Plusquamperfekt)","expFr":"Pour une action qui s'est produite avant un autre incident dans le passé. La ligne/guerre + Partizip II. est habituellement utilisée avec nachdem."},
    { de: "Futur I", ku: "داهاتوو (Futur I)", icon: "⇉",
      ...
      ex: [ { de: "Ich werde Deutsch lernen.", ku: "ئەڵمانی فێردەبم (داهاتوو).", tr: "Almanca öğreneceğim (gelecek).", en: "I will learn German (future).", ar: "سأتعلم الألمانية (المستقبل).", uk: "Я вивчатиму німецьку (майбутній).", fa: "من آلمانی یاد خواهم گرفت (آینده)." ,"es":"Aprenderé alemán (futuro).","fr":"Je vais apprendre l'allemand (futur)."}, { de: "Es wird regnen.", ku: "باران دەبارێت.", tr: "Yağmur yağacak.", en: "It will rain.", ar: "ستمطر.", uk: "Буде дощ.", fa: "باران خواهد بارید." ,"es":"Lloverá.","fr":"Il va pleuvoir."}, { de: "Wir werden sehen.", ku: "دەبینین.", tr: "Göreceğiz.", en: "We will see.", ar: "سنرى.", uk: "Побачимо.", fa: "خواهیم دید." ,"es":"Ya veremos.","fr":"Nous verrons."}, { de: "Sie wird Ärztin werden.", ku: "دەبێتە پزیشک.", tr: "Doktor olacak.", en: "She will become a doctor.", ar: "ستصبح طبيبة.", uk: "Вона стане лікаркою.", fa: "او پزشک خواهد شد." ,"es":"Se convertirá en doctora.","fr":"Elle deviendra médecin."}, { de: "Ich werde dich anrufen.", ku: "پەیوەندیت پێوە دەکەم.", tr: "Seni arayacağım.", en: "I will call you.", ar: "سأتصل بك.", uk: "Я тобі зателефоную.", fa: "من به تو زنگ خواهم زد." ,"es":"Te llamaré.","fr":"Je vous appellerai."}, { de: "Morgen wird es kalt sein.", ku: "سبەینێ سارد دەبێت.", tr: "Yarın soğuk olacak.", en: "Tomorrow it will be cold.", ar: "غداً سيكون الجو بارداً.", uk: "Завтра буде холодно.", fa: "فردا هوا سرد خواهد بود." ,"es":"Mañana estará frío.","fr":"Demain, il fera froid."} ] ,"es":"Tiempo futuro I","expEs":"Para el futuro y las suposiciones. werden + infinitive (al final). Sin embargo, el tiempo presente se utiliza a menudo para el futuro en el discurso diario.","fr":"Le futur est tendu I","expFr":"Werden + maître (dernier) mais pour les conversations quotidiennes, le présent est généralement utilisé pour l'avenir."},
    { de: "Konjunktionen: obwohl, wenn, als, während…", ku: "گرێدەرە لاوەکییەکان", icon: "⟜",
      ...
      ex: [ { de: "Als ich klein war, ...", ku: "کاتێک بچووک بووم، ...", tr: "Küçükken, ...", en: "When I was little, ...", ar: "عندما كنتُ صغيراً، ...", uk: "Коли я був малий, …", fa: "وقتی کوچک بودم، …" ,"es":"Cuando era pequeña,...","fr":"Quand j'étais petite,..."}, { de: "Bevor ich gehe, esse ich.", ku: "پێش ئەوەی بڕۆم، دەخۆم.", tr: "Gitmeden önce yiyorum.", en: "Before I go, I eat.", ar: "قبل أن أذهب، آكل.", uk: "Перш ніж піти, я їм.", fa: "پیش از رفتن، غذا می‌خورم." ,"es":"Antes de irme, como.","fr":"Avant de partir, je mange."}, { de: "Seitdem er hier ist, ...", ku: "لەو کاتەوەی لێرەیە، ...", tr: "O burada olduğundan beri, ...", en: "Since he has been here, ...", ar: "منذ أن أصبح هنا، ...", uk: "Відтоді, як він тут, …", fa: "از وقتی که او اینجاست، …" ,"es":"Desde que ha estado aquí,...","fr":"Depuis qu'il est ici,..."}, { de: "Obwohl es regnet, gehe ich.", ku: "هەرچەندە باران دەبارێت، دەڕۆم.", tr: "Her ne kadar yağmur yağsa da gidiyorum.", en: "Although it's raining, I'm going.", ar: "رغم أن المطر يهطل، سأذهب.", uk: "Хоча йде дощ, я йду.", fa: "اگرچه باران می‌بارد، من می‌روم." ,"es":"Aunque llueva, me voy.","fr":"Bien qu'il pleuve, je m'en vais."}, { de: "Wenn ich Zeit habe, komme ich.", ku: "ئەگەر کاتم هەبێت، دێم.", tr: "Zamanım olursa gelirim.", en: "If I have time, I'll come.", ar: "إذا كان لدي وقت، سآتي.", uk: "Якщо матиму час, я прийду.", fa: "اگر وقت داشته باشم، می‌آیم." ,"es":"Si tengo tiempo, iré.","fr":"Si j'ai le temps, je viendrai."}, { de: "Während sie kocht, lese ich.", ku: "لە کاتێکدا ئەو خواردن لێدەنێ، دەخوێنمەوە.", tr: "O pişirirken okuyorum.", en: "While she cooks, I read.", ar: "بينما تطبخ، أقرأ.", uk: "Поки вона готує, я читаю.", fa: "در حالی که او آشپزی می‌کند، من می‌خوانم." ,"es":"Mientras ella cocina, yo leo.","fr":"Pendant qu'elle cuisine, j'ai lu."} ] ,"es":"Conjunciones de cláusulas subordinadas","expEs":"obwohl (aunque), wenn (si/cuándo), als (cuando - pasado), während (mientras tanto), bevor (antes), nachdem (después), seitdem (desde entonces). El verbo va al final de la cláusula.","fr":"Conjointions de clauses subordonnées","expFr":"obwohl (jamais), après (si/quand), als (quand-pas), während (dik), bevor (avant), nachdem (après), seitdem (depuis lors)."},
    { de: "Relativsätze (detail)", ku: "ڕستەی پەیوەندیدار (ورد)", icon: "⌐",
      ...
      ex: [ { de: "Der Mann, dem ich helfe, ...", ku: "ئەو پیاوەی یارمەتی دەدەم، ... (Dativ)", tr: "Yardım ettiğim adam, ... (Datif)", en: "The man whom I help, ... (dative)", ar: "الرجل الذي أساعده، ... (حالة الجر)", uk: "Чоловік, якому я допомагаю, … (давальний)", fa: "مردی که به او کمک می‌کنم، … (Dativ)" ,"es":"El hombre al que ayudo,... (dativo)","fr":"L'homme que j'aide,... (dative)"}, { de: "Das Kind, dessen Buch ...", ku: "ئەو منداڵەی کتێبەکەی ... (Genitiv)", tr: "Kitabı olan çocuk, ... (Genitif)", en: "The child whose book ... (genitive)", ar: "الطفل الذي كتابه ... (حالة الإضافة)", uk: "Дитина, чия книга … (родовий)", fa: "کودکی که کتابش … (Genitiv)" ,"es":"El niño cuyo libro... (genitivo)","fr":"L'enfant dont le livre... (génitif)"}, { de: "Die Stadt, in der ich wohne, ...", ku: "ئەو شارەی تێیدا دەژیم، ...", tr: "İçinde yaşadığım şehir, ...", en: "The city in which I live, ...", ar: "المدينة التي أعيش فيها، ...", uk: "Місто, в якому я живу, …", fa: "شهری که در آن زندگی می‌کنم، …" ,"es":"La ciudad en la que vivo,...","fr":"La ville dans laquelle je vis,..."}, { de: "Der Film, den ich gesehen habe, ...", ku: "ئەو فیلمەی بینیم، ...", tr: "İzlediğim film, ...", en: "The film that I have watched, ...", ar: "الفيلم الذي شاهدته، ...", uk: "Фільм, який я подивився, …", fa: "فیلمی که دیده‌ام، …" ,"es":"La película que he visto,...","fr":"Le film que j'ai regardé,..."}, { de: "Die Leute, mit denen ich arbeite, ...", ku: "ئەو کەسانەی لەگەڵیان کار دەکەم، ...", tr: "Birlikte çalıştığım insanlar, ...", en: "The people with whom I work, ...", ar: "الأشخاص الذين أعمل معهم، ...", uk: "Люди, з якими я працюю, …", fa: "کسانی که با آن‌ها کار می‌کنم، …" ,"es":"La gente con la que trabajo,...","fr":"Les gens avec qui je travaille,..."}, { de: "Das Auto, das er kaufte, ...", ku: "ئەو ئۆتۆمبێلەی کڕی، ...", tr: "Satın aldığı araba, ...", en: "The car that he bought, ...", ar: "السيارة التي اشتراها، ...", uk: "Машина, яку він купив, …", fa: "خودرویی که او خرید، …" ,"es":"El coche que compró,...","fr":"La voiture qu'il a achetée,..."} ] ,"es":"Cláusulas relativas (detalles)","expEs":"El pronombre relativo cambia en cada caso: nominativo (der), acusativo (den), dativo (dem), genitivo (dessen/deren).","fr":"Clauses relatives (détaillées)","expFr":"Le pronom relatif change dans tous les cas: dans tous les cas: insinuate (d), isolation (den), Datif (dem), Genitif (dessen/deren)."},
    { de: "Indirekte Fragen", ku: "پرسیاری ناڕاستەوخۆ", icon: "?",
      ...
      ex: [ { de: "Weißt du, wo er ist?", ku: "دەزانیت لەکوێیە؟", tr: "Nerede olduğunu biliyor musun?", en: "Do you know where he is?", ar: "هل تعرف أين هو؟", uk: "Ти знаєш, де він?", fa: "می‌دانی او کجاست؟" ,"es":"¿Sabes dónde está?","fr":"Savez-vous où il est?"}, { de: "Ich frage, ob es regnet.", ku: "دەپرسم ئایا باران دەبارێت.", tr: "Yağmur yağıp yağmadığını soruyorum.", en: "I'm asking whether it's raining.", ar: "أسأل عما إذا كان المطر يهطل.", uk: "Я питаю, чи йде дощ.", fa: "می‌پرسم آیا باران می‌بارد." ,"es":"Estoy preguntando si está lloviendo.","fr":"Je demande s'il pleut."}, { de: "Sag mir, wann du kommst.", ku: "پێم بڵێ کەی دێیت.", tr: "Ne zaman geldiğini söyle.", en: "Tell me when you're coming.", ar: "أخبرني متى ستأتي.", uk: "Скажи мені, коли ти прийдеш.", fa: "به من بگو کِی می‌آیی." ,"es":"Dime cuándo vas a venir.","fr":"Dis-moi quand tu viendras."}, { de: "Ich weiß nicht, was das ist.", ku: "نازانم ئەمە چییە.", tr: "Bunun ne olduğunu bilmiyorum.", en: "I don't know what that is.", ar: "لا أعرف ما هذا.", uk: "Я не знаю, що це.", fa: "نمی‌دانم این چیست." ,"es":"No sé qué es eso.","fr":"Je ne sais pas ce que c'est."}, { de: "Kannst du mir sagen, wie es geht?", ku: "دەتوانیت پێم بڵێیت چۆنە؟", tr: "Nasıl olduğunu söyleyebilir misiniz?", en: "Can you tell me how it's going?", ar: "هل يمكنك أن تخبرني كيف الحال؟", uk: "Можеш сказати мені, як справи?", fa: "می‌توانی به من بگویی اوضاع چطور است؟" ,"es":"¿Puedes decirme cómo va todo?","fr":"Pouvez-vous me dire comment ça se passe?"}, { de: "Er fragt, warum du gehst.", ku: "دەپرسێت بۆچی دەڕۆیت.", tr: "Neden gittiğini soruyor.", en: "He asks why you're leaving.", ar: "يسأل لماذا تذهب.", uk: "Він питає, чому ти йдеш.", fa: "او می‌پرسد چرا می‌روی." ,"es":"Pregunta por qué te vas.","fr":"Il demande pourquoi tu pars."} ] ,"es":"Cuestiones indirectas","expEs":"La pregunta está incrustada dentro de una oración; el verbo va al final. Con ob (si) para preguntas sí/no.","fr":"Questions indirectes","expFr":"La question est placée dans une phrase; le verbe va à la fin. Avec ob (adhésion) pour oui/non questions."},
    { de: "Infinitiv mit zu", ku: "ئینفینیتیڤ لەگەڵ zu", icon: "zu",
      ...
      ex: [ { de: "Ich versuche zu lernen.", ku: "هەوڵ دەدەم فێربم.", tr: "Öğrenmeye çalışıyorum.", en: "I try to learn.", ar: "أحاول أن أتعلم.", uk: "Я намагаюся вчитися.", fa: "من سعی می‌کنم یاد بگیرم." ,"es":"Trato de aprender.","fr":"J'essaie d'apprendre."}, { de: "Es ist wichtig zu üben.", ku: "گرنگە مەشق بکەیت.", tr: "Alıştırma yapmak önemli.", en: "It's important to practice.", ar: "من المهم أن تتدرب.", uk: "Важливо тренуватися.", fa: "تمرین کردن مهم است." ,"es":"Es importante practicar.","fr":"C'est important de s'entraîner."}, { de: "Ich habe vergessen anzurufen.", ku: "بیرم چووە پەیوەندی بکەم.", tr: "Aramayı unuttum.", en: "I forgot to call.", ar: "نسيتُ أن أتصل.", uk: "Я забув зателефонувати.", fa: "فراموش کردم زنگ بزنم." ,"es":"Olvidé llamar.","fr":"J'ai oublié d'appeler."}, { de: "Ich hoffe dich zu sehen.", ku: "هیوادارم بتبینم.", tr: "Seni görmeyi umuyorum.", en: "I hope to see you.", ar: "أتمنى أن أراك.", uk: "Сподіваюся тебе побачити.", fa: "امیدوارم تو را ببینم." ,"es":"Espero verte.","fr":"J'espère vous voir."}, { de: "Es macht Spaß zu reisen.", ku: "گەشتکردن خۆشە.", tr: "Seyahat etmek eğlenceli.", en: "Traveling is fun.", ar: "السفر ممتع.", uk: "Подорожувати весело.", fa: "سفر کردن لذت‌بخش است." ,"es":"Viajar es divertido.","fr":"Voyager est amusant."}, { de: "Ich habe keine Zeit zu warten.", ku: "کاتم نییە چاوەڕێ بکەم.", tr: "Bekleyecek zamanım yok.", en: "I don't have time to wait.", ar: "ليس لدي وقت لأنتظر.", uk: "У мене немає часу чекати.", fa: "من وقت ندارم صبر کنم." ,"es":"No tengo tiempo para esperar.","fr":"Je n'ai pas le temps d'attendre."} ] ,"es":"Infinitivo con \"zu\"","expEs":"Después de ciertos verbos, sustantivos o adjetivos, el segundo verbo viene con 'zu + infinitivo'. Ejemplo: 'Ich versuche zu lernen' (Trato de aprender).","fr":"Infinitive avec \"zu\"","expFr":"Après quelques verbes/noms/s, le second verbe est livré avec ο ο ο ο ο ο ο ο οn Mastar οn. Par exemple: οch versuche zu lernen."},
    { de: "um…zu / ohne…zu / statt…zu", ku: "um/ohne/statt + zu", icon: "⊕",
      ...
      ex: [ { de: "Ich lerne, um zu bestehen.", ku: "فێردەبم بۆ ئەوەی سەربکەوم.", tr: "Sınavı geçmek için çalışıyorum.", en: "I study in order to pass.", ar: "أدرس لكي أنجح.", uk: "Я вчуся, щоб скласти іспит.", fa: "من درس می‌خوانم تا قبول شوم." ,"es":"Estudio para pasar.","fr":"Je fais mes études pour passer."}, { de: "Er geht, ohne zu grüßen.", ku: "دەڕوات بەبێ ئەوەی سڵاو بکات.", tr: "Selamlama yapmadan gitti.", en: "He leaves without saying hello.", ar: "يذهب من دون أن يلقي التحية.", uk: "Він іде, не привітавшись.", fa: "او می‌رود بدون اینکه سلام کند." ,"es":"Se va sin saludar.","fr":"Il part sans dire bonjour."}, { de: "Statt zu schlafen, lese ich.", ku: "لەبری خەوتن، دەخوێنمەوە.", tr: "Uyumak yerine okuyorum.", en: "Instead of sleeping, I read.", ar: "بدلاً من أن أنام، أقرأ.", uk: "Замість того щоб спати, я читаю.", fa: "به‌جای اینکه بخوابم، می‌خوانم." ,"es":"En vez de dormir, leo.","fr":"Au lieu de dormir, je lis."}, { de: "Ich spare, um ein Auto zu kaufen.", ku: "پارە کۆدەکەمەوە بۆ کڕینی ئۆتۆمبێل.", tr: "Araba almak için para biriktiriyorum.", en: "I'm saving up in order to buy a car.", ar: "أدخر المال لكي أشتري سيارة.", uk: "Я заощаджую, щоб купити машину.", fa: "من پس‌انداز می‌کنم تا خودرو بخرم." ,"es":"Estoy ahorrando para comprar un coche.","fr":"Je économise pour acheter une voiture."}, { de: "Sie ging, ohne etwas zu sagen.", ku: "ڕۆیشت بەبێ ئەوەی شتێک بڵێت.", tr: "Bir şey söylemeden gitti.", en: "She left without saying anything.", ar: "ذهبت من دون أن تقول شيئاً.", uk: "Вона пішла, нічого не сказавши.", fa: "او رفت بدون اینکه چیزی بگوید." ,"es":"Se fue sin decir nada.","fr":"Elle est partie sans rien dire."}, { de: "Statt zu arbeiten, spielt er.", ku: "لەبری کارکردن، یاری دەکات.", tr: "Çalışmak yerine oynuyor.", en: "Instead of working, he plays.", ar: "بدلاً من أن يعمل، يلعب.", uk: "Замість того щоб працювати, він грає.", fa: "به‌جای اینکه کار کند، بازی می‌کند." ,"es":"En vez de trabajar, juega.","fr":"Au lieu de travailler, il joue."} ] ,"es":"um...zu / ohne...zu / statt...zu","expEs":"um...zu (para), ohne...zu (sin hacer), statt...zu (en lugar de hacer). Ambas cláusulas comparten el mismo tema.","fr":"- Oui.","expFr":"Uh... zu, ohne...zu, statut...zu, au lieu de... les deux phrases ont le même sujet."},
    { de: "Passiv (Vorgangspassiv)", ku: "ڕستەی چالاک‌نەبوو", icon: "⊡",
      ...
      ex: [ { de: "Das Auto wird repariert.", ku: "ئۆتۆمبێلەکە چاک دەکرێتەوە.", tr: "Araba tamir ediliyor.", en: "The car is being repaired.", ar: "تُصلَح السيارة.", uk: "Машину ремонтують.", fa: "خودرو تعمیر می‌شود." ,"es":"El coche está siendo reparado.","fr":"La voiture est en cours de réparation."}, { de: "Die Tür wird geöffnet.", ku: "دەرگاکە دەکرێتەوە.", tr: "Kapı açılıyor.", en: "The door is being opened.", ar: "يُفتح الباب.", uk: "Двері відчиняють.", fa: "در باز می‌شود." ,"es":"La puerta está siendo abierta.","fr":"La porte est ouverte."}, { de: "Deutsch wird hier gesprochen.", ku: "لێرە ئەڵمانی قسە دەکرێت.", tr: "Burada Almanca konuşuluyor.", en: "German is spoken here.", ar: "تُتحدَّث الألمانية هنا.", uk: "Тут розмовляють німецькою.", fa: "اینجا آلمانی صحبت می‌شود." ,"es":"Aquí se habla alemán.","fr":"L'allemand est parlé ici."}, { de: "Das Buch wird gelesen.", ku: "کتێبەکە دەخوێنرێتەوە.", tr: "Kitap okunuyor.", en: "The book is being read.", ar: "يُقرأ الكتاب.", uk: "Книгу читають.", fa: "کتاب خوانده می‌شود." ,"es":"El libro está siendo leído.","fr":"Le livre est en train d'être lu."}, { de: "Die Arbeit wird gemacht.", ku: "کارەکە دەکرێت.", tr: "İş yapılıyor.", en: "The work is being done.", ar: "يُنجَز العمل.", uk: "Роботу виконують.", fa: "کار انجام می‌شود." ,"es":"El trabajo está siendo hecho.","fr":"Le travail est en cours."}, { de: "Das Essen wird gekocht.", ku: "خواردنەکە لێدەنرێت.", tr: "Yemek pişiriliyor.", en: "The food is being cooked.", ar: "يُطهى الطعام.", uk: "Їжу готують.", fa: "غذا پخته می‌شود." ,"es":"La comida está siendo cocinada.","fr":"La nourriture est cuite."} ] ,"es":"Voz pasiva (acción pasiva)","expEs":"Se usa cuando la acción es más importante que quién la realiza. werden + Partizip II. Ejemplo: 'Das Haus wird gebaut' (La casa está siendo construida).","fr":"Voix passive (action passive)","expFr":"Quand votre action est plus importante que par qui elle a été faite."},
    { de: "Konjunktiv II", ku: "کۆنیونکتیڤ II (مەرجی)", icon: "≈",
      ...
      ex: [ { de: "Ich würde gern kommen.", ku: "حەز دەکەم بێم.", tr: "Gelmek isterdim.", en: "I would love to come.", ar: "أود أن آتي.", uk: "Я б залюбки прийшов.", fa: "من با کمال میل می‌آمدم." ,"es":"Me encantaría venir.","fr":"J'aimerais bien venir."}, { de: "Ich hätte eine Frage.", ku: "پرسیارێکم هەبووایە.", tr: "Bir sorum olurdu.", en: "I would have a question.", ar: "كان لدي سؤال.", uk: "У мене було б питання.", fa: "من یک سؤال داشتم." ,"es":"Yo tendría una pregunta.","fr":"J'aurais une question."}, { de: "Könnten Sie mir helfen?", ku: "دەتوانن یارمەتیم بدەن؟", tr: "Yardım edebilir misiniz?", en: "Could you help me?", ar: "هل يمكنكم مساعدتي؟", uk: "Ви могли б мені допомогти?", fa: "می‌توانید به من کمک کنید؟" ,"es":"¿Podrías ayudarme?","fr":"Tu peux m'aider?"}, { de: "Wenn ich reich wäre, ...", ku: "ئەگەر دەوڵەمەند بوومایە، ...", tr: "Zengin olsaydım, ...", en: "If I were rich, ...", ar: "لو كنتُ غنياً، ...", uk: "Якби я був багатий, …", fa: "اگر ثروتمند بودم، …" ,"es":"Si fuera rico,...","fr":"Si j'étais riche,..."}, { de: "Das wäre toll.", ku: "ئەمە نایاب دەبوو.", tr: "Harika olurdu.", en: "That would be great.", ar: "سيكون ذلك رائعاً.", uk: "Це було б чудово.", fa: "این عالی می‌شد." ,"es":"Eso sería genial.","fr":"Ce serait génial."}, { de: "Ich würde lieber bleiben.", ku: "پێم باشترە بمێنمەوە.", tr: "Kalmayı tercih ederdim.", en: "I would rather stay.", ar: "أُفضّل البقاء.", uk: "Я б краще залишився.", fa: "من ترجیح می‌دادم بمانم." ,"es":"Prefiero quedarme.","fr":"Je préfère rester."} ] ,"es":"Subjuntivo II (Konjunktiv II)","expEs":"Para deseos, hipótesis, y cortesía. würde + infinitive, o hätte/wäre/könnte. A menudo se utiliza para sonar educado.","fr":"Sous-jonctive II (Konjunktiv II)","expFr":"Les demandes sont utilisées pour des hypothèses et de la gentillesse."},
  ],
  B2: [
    { de: "Passiv (alle Formen)", ku: "ڕستەی چالاک‌نەبوو (هەموو فۆرمەکان)", icon: "⊡",
      ...
      ex: [ { de: "Das Haus wurde gebaut.", ku: "خانووەکە دروستکرا.", tr: "Ev yapıldı.", en: "The house was built.", ar: "بُني البيت.", uk: "Будинок збудували." ,"es":"La casa fue construida.","fr":"La maison a été construite."}, { de: "Es ist verkauft worden.", ku: "فرۆشراوە.", tr: "Satıldı.", en: "It has been sold.", ar: "لقد بيع.", uk: "Це продали." ,"es":"Se ha vendido.","fr":"Il a été vendu."}, { de: "Das wird gemacht werden.", ku: "ئەمە دەکرێت (داهاتوو).", tr: "Bu yapılacak (gelecek).", en: "This will be done (future).", ar: "سيُفعل هذا (المستقبل).", uk: "Це буде зроблено (майбутній)." ,"es":"Esto se hará (futuro).","fr":"Cela sera fait (futur)."}, { de: "Der Brief wurde geschrieben.", ku: "نامەکە نووسرا.", tr: "Mektup yazıldı.", en: "The letter was written.", ar: "كُتبت الرسالة.", uk: "Листа написали." ,"es":"La carta fue escrita.","fr":"La lettre a été écrite."}, { de: "Die Stadt ist zerstört worden.", ku: "شارەکە وێران کراوە.", tr: "Şehir yıkıldı.", en: "The city has been destroyed.", ar: "دُمّرت المدينة.", uk: "Місто зруйнували." ,"es":"La ciudad ha sido destruida.","fr":"La ville a été détruite."}, { de: "Die Regeln werden erklärt.", ku: "یاساکان ڕوون دەکرێنەوە.", tr: "Kurallar açıklanıyor.", en: "The rules are being explained.", ar: "تُشرح القواعد.", uk: "Правила пояснюють." ,"es":"Las reglas están siendo explicadas.","fr":"Les règles sont expliquées."} ] ,"es":"Voz pasiva (todos los formularios)","expEs":"Pasivo en todos los tiempos: presente (girl gemacht), pasado (wurde gemacht), perfecto (est gemacht worden). «worden» es el marcador del pasado pasivo.","fr":"Voix passive (toutes formes)","expFr":"Le courant (Gemacht) est un signe du passé (Gemacht wurde), Perfect (mot de Gemacht)."},
    { de: "Zustandspassiv", ku: "Passivی دۆخ", icon: "▣",
      ...
      ex: [ { de: "Das Geschäft ist geschlossen.", ku: "دوکانەکە داخراوە.", tr: "Dükkan kapalı.", en: "The shop is closed.", ar: "المحل مغلق.", uk: "Магазин зачинений." ,"es":"La tienda está cerrada.","fr":"La boutique est fermée."}, { de: "Der Brief ist geschrieben.", ku: "نامەکە نووسراوە.", tr: "Mektup yazılmış.", en: "The letter is written.", ar: "الرسالة مكتوبة.", uk: "Лист написаний." ,"es":"La carta está escrita.","fr":"La lettre est écrite."}, { de: "Alles ist vorbereitet.", ku: "هەمووشت ئامادەکراوە.", tr: "Her şey hazır.", en: "Everything is prepared.", ar: "كل شيء جاهز.", uk: "Усе підготовлено." ,"es":"Todo está preparado.","fr":"Tout est prêt."}, { de: "Das Fenster ist geöffnet.", ku: "پەنجەرەکە کراوەیە.", tr: "Pencere açık.", en: "The window is open.", ar: "النافذة مفتوحة.", uk: "Вікно відчинене." ,"es":"La ventana está abierta.","fr":"La fenêtre est ouverte."}, { de: "Die Arbeit ist erledigt.", ku: "کارەکە تەواوکراوە.", tr: "İş tamamlandı.", en: "The work is done.", ar: "العمل منجز.", uk: "Роботу виконано." ,"es":"El trabajo está hecho.","fr":"Le travail est fait."}, { de: "Das Problem ist gelöst.", ku: "کێشەکە چارەسەرکراوە.", tr: "Sorun çözüldü.", en: "The problem is solved.", ar: "المشكلة محلولة.", uk: "Проблему вирішено." ,"es":"El problema está resuelto.","fr":"Le problème est résolu."} ] ,"es":"Pasivos estables","expEs":"Muestra el resultado de una acción, no la acción misma. sein + Partizip II. Ejemplo: «Die Tür ist geschlossen» (La puerta está cerrada — estado).","fr":"Statatif passif","expFr":"Il montre le résultat d'une action, pas l'acte lui-même. Voir + Partizip II Exemple: ▪ Die Type ist geschlossen (porte fermée)."},
    { de: "Passiv mit Modalverben", ku: "Passiv لەگەڵ مۆداڵ", icon: "⊞",
      ...
      ex: [ { de: "Das muss repariert werden.", ku: "ئەمە دەبێت چاک بکرێتەوە.", tr: "Bu tamir edilmeli.", en: "This must be repaired.", ar: "يجب إصلاح هذا.", uk: "Це треба відремонтувати." ,"es":"Esto debe ser reparado.","fr":"Ça doit être réparé."}, { de: "Es kann gemacht werden.", ku: "دەکرێت بکرێت.", tr: "Yapılabilir.", en: "It can be done.", ar: "يمكن فعله.", uk: "Це можна зробити." ,"es":"Se puede hacer.","fr":"Ça peut être fait."}, { de: "Es sollte vermieden werden.", ku: "دەبێت خۆی لێ بپارێزرێت.", tr: "Kaçınılmalıydı.", en: "It should be avoided.", ar: "ينبغي تجنّب ذلك.", uk: "Цього слід уникати." ,"es":"Debería evitarse.","fr":"Il faut l'éviter."}, { de: "Das darf nicht gesagt werden.", ku: "ئەمە نابێت بگوترێت.", tr: "Bu söylenmemeli.", en: "This must not be said.", ar: "لا يجوز قول هذا.", uk: "Цього не можна казати." ,"es":"Esto no debe decirse.","fr":"Cela ne doit pas être dit."}, { de: "Die Regeln müssen befolgt werden.", ku: "دەبێت یاساکان پەیڕەو بکرێن.", tr: "Kurallara uyulmalı.", en: "The rules must be followed.", ar: "يجب اتباع القواعد.", uk: "Правил треба дотримуватися." ,"es":"Las reglas deben ser seguidas.","fr":"Les règles doivent être respectées."}, { de: "Es kann nicht geändert werden.", ku: "ناتوانرێت بگۆڕدرێت.", tr: "Değiştirilemez.", en: "It cannot be changed.", ar: "لا يمكن تغييره.", uk: "Це неможливо змінити." ,"es":"No puede cambiarse.","fr":"Il ne peut pas être changé."} ] ,"es":"Pasivo con verbos modal","expEs":"Verbo modal + Partizip II + werden. Ejemplo: «Das muss gemacht werden» (Esto debe hacerse).","fr":"Passif avec verbes modaux","expFr":"Modal + Partizip II + werden. Exemple: ▪ Das mss Gemacht werden."},
    { de: "Konjunktiv II (fortgeschritten)", ku: "کۆنیونکتیڤ II (پێشکەوتوو)", icon: "≈",
      ...
      ex: [ { de: "Ich hätte dir geholfen.", ku: "یارمەتیم بدایایت.", tr: "Sana yardım ederdim.", en: "I would have helped you.", ar: "كنت سأساعدك.", uk: "Я б тобі допоміг." ,"es":"Te habría ayudado.","fr":"Je t'aurais aidé."}, { de: "Wenn ich Zeit gehabt hätte, ...", ku: "ئەگەر کاتم هەبووایە، ...", tr: "Zamanım olsaydı, ...", en: "If I had had time, ...", ar: "لو كان لدي وقت، ...", uk: "Якби я мав час, …" ,"es":"Si hubiera tenido tiempo,...","fr":"Si j'avais eu le temps,..."}, { de: "Das wäre besser gewesen.", ku: "ئەمە باشتر دەبوو.", tr: "Bu daha iyi olurdu.", en: "That would have been better.", ar: "كان ذلك سيكون أفضل.", uk: "Так було б краще." ,"es":"Eso hubiera sido mejor.","fr":"Ça aurait été mieux."}, { de: "Ich hätte das nicht gesagt.", ku: "ئەمەم نەدەگوت.", tr: "Bunu söylemezdim.", en: "I would not have said that.", ar: "ما كنت لأقول ذلك.", uk: "Я б цього не сказав." ,"es":"No habría dicho eso.","fr":"Je n'aurais pas dit ça."}, { de: "Wärst du gekommen, ...", ku: "ئەگەر هاتبووایت، ...", tr: "Gelmiş olsaydın, ...", en: "Had you come, ...", ar: "لو كنت قد أتيت، ...", uk: "Якби ти прийшов, …" ,"es":"Si hubieras venido...","fr":"Si tu étais venu,..."}, { de: "Sie hätte gewinnen können.", ku: "دەیتوانی بباتەوە.", tr: "Kazanabilirdi.", en: "She could have won.", ar: "كان بإمكانها أن تفوز.", uk: "Вона могла б перемогти." ,"es":"Podría haber ganado.","fr":"Elle aurait pu gagner."} ] ,"es":"Subjuntivo II (avanzado)","expEs":"Para hipótesis y arrepentimientos pasados. hätte/wäre + Partizip II. Ejemplo: «Ich hätte das gemacht» (habría hecho esto).","fr":"Sous-jonctive II (avancée)","expFr":"Pour les hypothèses et les regrets passés."},
    { de: "Konjunktiv I (indirekte Rede)", ku: "کۆنیونکتیڤ I (قسەی ناڕاستەوخۆ)", icon: "❝",
      ...
      ex: [ { de: "Er sagt, er sei krank.", ku: "دەڵێت کە نەخۆشە.", tr: "Hasta olduğunu söylüyor.", en: "He says he is sick.", ar: "يقول إنه مريض.", uk: "Він каже, що хворий." ,"es":"Dice que está enfermo.","fr":"Il dit qu'il est malade."}, { de: "Sie meint, sie habe Zeit.", ku: "پێیوایە کاتی هەیە.", tr: "Zamanının olduğunu düşünüyor.", en: "She thinks she has time.", ar: "تعتقد أن لديها وقتاً.", uk: "Вона вважає, що має час." ,"es":"Cree que tiene tiempo.","fr":"Elle pense qu'elle a le temps."}, { de: "Man sagt, es komme bald.", ku: "دەگوترێت بەم زووانە دێت.", tr: "Yakında geleceği söyleniyor.", en: "They say it will come soon.", ar: "يُقال إنه سيأتي قريباً.", uk: "Кажуть, що це скоро прийде." ,"es":"Dicen que llegará pronto.","fr":"Ils disent que ça va arriver bientôt."}, { de: "Er behauptet, er wisse nichts.", ku: "بانگەشە دەکات هیچ نازانێت.", tr: "Hiçbir şey bilmediğini iddia ediyor.", en: "He claims he knows nothing.", ar: "يدّعي أنه لا يعرف شيئاً.", uk: "Він стверджує, що нічого не знає." ,"es":"Dice que no sabe nada.","fr":"Il prétend ne rien savoir."}, { de: "Sie sagte, sie werde kommen.", ku: "گوتی دێت.", tr: "Geleceğini söyledi.", en: "She said she would come.", ar: "قالت إنها ستأتي.", uk: "Вона сказала, що прийде." ,"es":"Dijo que vendría.","fr":"Elle a dit qu'elle viendrait."}, { de: "Der Minister sagt, er habe recht.", ku: "وەزیر دەڵێت ڕاستە.", tr: "Bakan haklı olduğunu söylüyor.", en: "The minister says he is right.", ar: "يقول الوزير إنه على حق.", uk: "Міністр каже, що має рацію." ,"es":"El ministro dice que tiene razón.","fr":"Le ministre dit qu'il a raison."} ] ,"es":"Subjuntivo I (hablas comunicadas)","expEs":"Para informar del discurso de otras personas (especialmente en periodismo). Ejemplo: er sei, er habe, er komme.","fr":"Sous-jonctive I (discours rapporté)","expFr":"Pour transmettre les paroles des autres (surtout dans le journalisme). Exemple: er sei, er habe, er komme."},
    { de: "Erweiterte Relativsätze", ku: "ڕستەی پەیوەندیداری فراوان", icon: "⌐",
      ...
      ex: [ { de: "der Tag, an dem wir ...", ku: "ئەو ڕۆژەی کە ئێمە ...", tr: "... ettiğimiz gün", en: "the day on which we ...", ar: "اليوم الذي فيه ...", uk: "день, у який ми …" ,"es":"el día en que...","fr":"le jour où nous..."}, { de: "das Thema, über das ...", ku: "ئەو بابەتەی دەربارەی ...", tr: "... hakkında konuştuğumuz konu", en: "the topic about which ...", ar: "الموضوع الذي عنه ...", uk: "тема, про яку …" ,"es":"el tema sobre el cual...","fr":"le sujet sur lequel..."}, { de: "alles, was du brauchst", ku: "هەرچی پێویستتە", tr: "ihtiyacın olan her şey", en: "everything that you need", ar: "كل ما تحتاجه", uk: "усе, що тобі потрібно" ,"es":"todo lo que necesitas","fr":"tout ce dont vous avez besoin"}, { de: "die Firma, bei der ich arbeite, ...", ku: "ئەو کۆمپانیایەی تێیدا کار دەکەم، ...", tr: "çalıştığım şirket, ...", en: "the company where I work, ...", ar: "الشركة التي أعمل بها، ...", uk: "компанія, де я працюю, …" ,"es":"la empresa donde trabajo,...","fr":"la société où je travaille,..."}, { de: "der Grund, aus dem ...", ku: "ئەو هۆکارەی کە ...", tr: "... sebebi", en: "the reason why ...", ar: "السبب الذي ...", uk: "причина, через яку …" ,"es":"la razón por la que...","fr":"la raison pour laquelle..."}, { de: "das, was wichtig ist, ...", ku: "ئەوەی گرنگە، ...", tr: "önemli olan, ...", en: "what is important, ...", ar: "ما هو مهم، ...", uk: "те, що важливо, …" ,"es":"lo que es importante,...","fr":"ce qui est important,..."} ] ,"es":"Cláusulas relativas ampliadas","expEs":"Cláusulas relativas con preposiciones: «in dem», «mit der», ber den». También era/wo para referencia general.","fr":"Clauses relatives étendues","expFr":"Les sentences de drogués sont prononcées:"},
    { de: "Kausale, konsekutive, konzessive Sätze", ku: "ڕستەی هۆکاری، ئەنجامی، ڕێگری", icon: "⟜",
      ...
      ex: [ { de: "Da es regnet, bleiben wir.", ku: "لەبەر ئەوەی باران دەبارێت، دەمێنینەوە.", tr: "Yağmur yağdığı için kalıyoruz.", en: "Since it is raining, we are staying.", ar: "بما أن المطر يهطل، سنبقى.", uk: "Оскільки йде дощ, ми залишаємося." ,"es":"Ya que está lloviendo, nos quedamos.","fr":"Comme il pleut, nous restons."}, { de: "Es war so kalt, dass ...", ku: "ئەوەندە سارد بوو کە ...", tr: "O kadar soğuktu ki ...", en: "It was so cold that ...", ar: "كان الجو بارداً جداً لدرجة أن ...", uk: "Було так холодно, що …" ,"es":"Hacía tanto frío que...","fr":"Il faisait si froid que..."}, { de: "Obwohl er müde ist, arbeitet er.", ku: "هەرچەندە ماندووە، کار دەکات.", tr: "Her ne kadar yorgun olsa da çalışıyor.", en: "Although he is tired, he is working.", ar: "على الرغم من أنه متعب، إلا أنه يعمل.", uk: "Хоча він втомлений, він працює." ,"es":"Aunque está cansado, está trabajando.","fr":"Bien qu'il soit fatigué, il travaille."}, { de: "Er lernte viel, sodass er bestand.", ku: "زۆر خوێندی، بۆیە سەرکەوت.", tr: "Çok çalıştı, bu yüzden başardı.", en: "He studied a lot, so he passed.", ar: "درس كثيراً، لذلك نجح.", uk: "Він багато вчився, тож склав іспит." ,"es":"Estudió mucho, así que murió.","fr":"Il a beaucoup étudié, donc il est mort."}, { de: "Weil sie krank war, blieb sie.", ku: "چونکە نەخۆش بوو، مایەوە.", tr: "Hasta olduğu için kaldı.", en: "Because she was sick, she stayed.", ar: "لأنها كانت مريضة، بقيت.", uk: "Оскільки вона була хвора, вона залишилася." ,"es":"Porque estaba enferma, se quedó.","fr":"Parce qu'elle était malade, elle est restée."}, { de: "Trotzdem gab er nicht auf.", ku: "لەگەڵ ئەوەشدا واز نەهێنا.", tr: "Yine de pes etmedi.", en: "Nevertheless, he did not give up.", ar: "مع ذلك، لم يستسلم.", uk: "Попри це, він не здався." ,"es":"Sin embargo, no se dio por vencido.","fr":"Néanmoins, il n'abandonna pas."} ] ,"es":"Cláusulas causales, consecutivas y concestivas","expEs":"Causal (da, weil), consecutiva/resultado (sodass, so...dass), concessive (obwohl, obgleich). Para la conexión lógica entre cláusulas.","fr":"Clauses causales, consécutives, accessoires","expFr":"Causalité (da, weil), résultat (so...dass, so...dass), opposé/tress (obwohl, obgleich) pour une connexion logique entre les phrases."},
    { de: "Futur II", ku: "داهاتووی دووەم", icon: "⇉",
      ...
      ex: [ { de: "Bis morgen werde ich es beendet haben.", ku: "تا سبەینێ تەوای دەکەم.", tr: "Yarına kadar bitirmiş olacağım.", en: "By tomorrow I will have finished it.", ar: "بحلول الغد سأكون قد أنهيته.", uk: "До завтра я це закінчу." ,"es":"Mañana lo habré terminado.","fr":"Demain, je l'aurai fini."}, { de: "Er wird angekommen sein.", ku: "ئەو گەیشتووی دەبێت.", tr: "Varmış olacak.", en: "He will have arrived.", ar: "سيكون قد وصل.", uk: "Він уже прибуде." ,"es":"Él habrá llegado.","fr":"Il sera arrivé."}, { de: "Sie wird es vergessen haben.", ku: "لەوانەیە بیری چووبێت.", tr: "Unutmuş olabilir.", en: "She will have forgotten it.", ar: "لعلها تكون قد نسيت ذلك.", uk: "Вона це вже забуде." ,"es":"Ella lo habrá olvidado.","fr":"Elle l'aura oublié."}, { de: "Bis dahin werden wir fertig sein.", ku: "تا ئەو کاتە تەواو دەبین.", tr: "O zamana kadar bitirmiş olacağız.", en: "By then we will be finished.", ar: "بحلول ذلك الوقت سنكون قد انتهينا.", uk: "На той час ми будемо готові." ,"es":"Para entonces habremos terminado.","fr":"D'ici là, nous serons finis."}, { de: "Er wird das gelesen haben.", ku: "ئەو ئەمەی خوێندووەتەوە (گریمانە).", tr: "Okumuş olacak (tahmin).", en: "He will have read that (assumption).", ar: "سيكون قد قرأ ذلك (افتراض).", uk: "Він, напевно, це прочитав (припущення)." ,"es":"Él habrá leído eso (suposición).","fr":"Il aura lu cela (hypothèse)."}, { de: "Sie werden gegangen sein.", ku: "ئەوان ڕۆیشتوون (گریمانە).", tr: "Gitmiş olacaklar (tahmin).", en: "They will have left (assumption).", ar: "سيكونون قد رحلوا (افتراض).", uk: "Вони, напевно, вже пішли (припущення)." ,"es":"Se habrán ido (supuestos).","fr":"Ils seront partis (hypothèse)."} ] ,"es":"Tiempo futuro II","expEs":"Para una acción que se completará en el futuro. werden + Partizip II + haben/sein. Ejemplo: «Ich werde es gemacht haben».","fr":"Temps de détente II","expFr":"Pour une action qui sera achevée dans le futur. Werden + Partizip II + haben/sein. Exemple: Ιch werde es Gemacht haben."},
    { de: "Partizip I", ku: "پارتیسیپی یەکەم", icon: "Ⅰ",
      ...
      ex: [ { de: "das spielende Kind", ku: "منداڵە یاریکەرەکە", tr: "oynayan çocuk", en: "the playing child", ar: "الطفل اللاعب", uk: "дитина, що грається" ,"es":"el niño que juega","fr":"l'enfant qui joue"}, { de: "die schlafende Katze", ku: "پشیلە خەوتووەکە", tr: "uyuyan kedi", en: "the sleeping cat", ar: "القطة النائمة", uk: "кішка, що спить" ,"es":"el gato durmiente","fr":"le chat endormi"}, { de: "lachend", ku: "بەپێکەنینەوە", tr: "gülerek", en: "laughing", ar: "ضاحكاً", uk: "сміючись" ,"es":"Riendo","fr":"rire"}, { de: "die singende Frau", ku: "ژنە گۆرانیبێژەکە", tr: "şarkı söyleyen kadın", en: "the singing woman", ar: "المرأة المغنية", uk: "жінка, що співає" ,"es":"la mujer cantante","fr":"la femme qui chante"}, { de: "ein weinendes Baby", ku: "کۆرپەیەکی گریان", tr: "ağlayan bir bebek", en: "a crying baby", ar: "طفل رضيع يبكي", uk: "немовля, що плаче" ,"es":"un bebé llorando","fr":"un bébé pleurant"}, { de: "die kommende Woche", ku: "هەفتەی داهاتوو", tr: "gelecek hafta", en: "next week", ar: "الأسبوع القادم", uk: "наступного тижня" ,"es":"la semana próxima","fr":"la semaine prochaine"} ] ,"es":"Participante actual (Partizip I)","expEs":"Infinitivo + d. Como adjetivo, muestra una acción continua/simultáneo. Ejemplo: spielend (jugando, mientras se juega).","fr":"Participe actuel (Partizip I)","expFr":"Le Mastar + d. montre l'acte en cours comme adjectif. Exemple: spielend (joueur, joueur)."},
    { de: "Partizip II als Adjektiv", ku: "پارتیسیپی دووەم وەک سیفەت", icon: "Ⅱ",
      ...
      ex: [ { de: "die geöffnete Tür", ku: "دەرگا کراوەکە", tr: "açık kapı", en: "the open door", ar: "الباب المفتوح", uk: "відчинені двері" ,"es":"la puerta abierta","fr":"la porte ouverte"}, { de: "ein gebrauchtes Auto", ku: "ئۆتۆمبێلێکی بەکارهاتوو", tr: "kullanılmış araba", en: "a used car", ar: "سيارة مستعملة", uk: "вживана машина" ,"es":"un automóvil usado","fr":"une voiture d'occasion"}, { de: "das geschriebene Wort", ku: "وشە نووسراوەکە", tr: "yazılmış kelime", en: "the written word", ar: "الكلمة المكتوبة", uk: "написане слово" ,"es":"la palabra escrita","fr":"le mot écrit"}, { de: "die gekochte Suppe", ku: "شۆربا لێنراوەکە", tr: "pişirilmiş çorba", en: "the cooked soup", ar: "الحساء المطبوخ", uk: "зварений суп" ,"es":"la sopa cocida","fr":"la soupe cuite"}, { de: "ein verlorenes Spiel", ku: "یارییەکی دۆڕاو", tr: "kaybedilmiş oyun", en: "a lost game", ar: "مباراة خاسرة", uk: "програна гра" ,"es":"una partida perdida","fr":"un jeu perdu"}, { de: "die reparierte Uhr", ku: "کاتژمێرە چاککراوەکە", tr: "tamir edilmiş saat", en: "the repaired watch", ar: "الساعة المُصلَّحة", uk: "відремонтований годинник" ,"es":"el reloj reparado","fr":"la montre réparée"} ] ,"es":"Participio pasado como adjetivo","expEs":"Partizip II puede ser utilizado como adjetivo para mostrar un resultado. Ejemplo: «das gekochte Essen» (la comida cocida).","fr":"Participe passé comme adjectif","expFr":"Le Partizip II peut être utilisé comme adjectif et montre le résultat. Exemple: vrdas gekkochte Essen."},
    { de: "Nominalisierung", ku: "ناوکردن (نۆمیناڵایزەیشن)", icon: "N",
      ...
      ex: [ { de: "das Lernen", ku: "فێربوون (وەک ناو)", tr: "öğrenme (isim olarak)", en: "learning (as a noun)", ar: "التعلّم (كاسم)", uk: "навчання (як іменник)" ,"es":"aprendizaje (como sustantivo)","fr":"l'apprentissage (en tant que nom)"}, { de: "beim Lesen", ku: "لە کاتی خوێندنەوەدا", tr: "okuma sırasında", en: "while reading", ar: "أثناء القراءة", uk: "під час читання" ,"es":"mientras leía","fr":"en lisant"}, { de: "nach der Ankunft", ku: "دوای گەیشتن", tr: "varıştan sonra", en: "after arrival", ar: "بعد الوصول", uk: "після прибуття" ,"es":"después de la llegada","fr":"après l'arrivée"}, { de: "vor dem Schlafen", ku: "پێش خەوتن", tr: "uyumadan önce", en: "before sleeping", ar: "قبل النوم", uk: "перед сном" ,"es":"antes de dormir","fr":"avant de dormir"}, { de: "das Rauchen ist verboten", ku: "جگەرەکێشان قەدەغەیە", tr: "sigara içmek yasak", en: "smoking is forbidden", ar: "التدخين ممنوع", uk: "паління заборонено" ,"es":"Está prohibido fumar","fr":"il est interdit de fumer"}, { de: "durch das Üben", ku: "بەهۆی مەشقکردنەوە", tr: "pratik yaparak", en: "through practicing", ar: "من خلال الممارسة", uk: "завдяки практиці" ,"es":"a través de la práctica","fr":"par la pratique"} ] ,"es":"Nominalización","expEs":"Convertir un verbo/cláusula en un sustantivo — una característica específica del alemán formal y académico. Ejemplo: «beim Lernen» = «mientras aprende».","fr":"Nominalisation","expFr":"L'idée de transformer le verbe/scramble en un nom est officielle et académique allemand. Exemple:... Je suis Lernen."},
    { de: "Funktionsverbgefüge", ku: "گرێدانی ناو-کردار", icon: "⚙",
      ...
      ex: [ { de: "eine Entscheidung treffen", ku: "بڕیاردان", tr: "karar vermek", en: "to make a decision", ar: "اتخاذ قرار", uk: "ухвалити рішення" ,"es":"para tomar una decisión","fr":"de prendre une décision"}, { de: "in Frage stellen", ku: "گومان لێکردن", tr: "sorgulamak", en: "to call into question", ar: "التشكيك في", uk: "ставити під сумнів" ,"es":"para cuestionar","fr":"de remettre en question"}, { de: "zur Verfügung stehen", ku: "بەردەست بوون", tr: "mevcut olmak", en: "to be available", ar: "أن يكون متاحاً", uk: "бути в наявності" ,"es":"a disposición","fr":"à être disponible"}, { de: "eine Rolle spielen", ku: "ڕۆڵ گێڕان", tr: "rol oynamak", en: "to play a role", ar: "لعب دور", uk: "відігравати роль" ,"es":"desempeñar un papel","fr":"jouer un rôle"}, { de: "Rücksicht nehmen", ku: "ڕەچاوکردن", tr: "saygı göstermek", en: "to show consideration", ar: "المراعاة", uk: "виявляти увагу" ,"es":"para mostrar consideración","fr":"pour montrer la considération"}, { de: "in Anspruch nehmen", ku: "سوود وەرگرتن لە", tr: "yararlanmak", en: "to make use of", ar: "الاستفادة من", uk: "скористатися" ,"es":"para hacer uso de","fr":"pour utiliser"} ] ,"es":"Construcciones de soporte-verbo","expEs":"Combinaciones de sustantivo+verbo que funcionan como una unidad de un solo significado, común en alemán formal. Ejemplo: «eine Entscheidung treffen» (para tomar una decisión).","fr":"Constructions en verbe de soutien","expFr":"La composition de nom+fiil crée une unité de signification, communément utilisée en allemand. Exemple: ▪eine Entscheidung treffen."},
    { de: "Verben/Adjektive/Nomen mit Präpositionen", ku: "وشە لەگەڵ ئامرازی جێگیر", icon: "⌖",
      ...
      ex: [ { de: "Ich warte auf den Bus.", ku: "چاوەڕوانی پاس دەکەم.", tr: "Otobüsü bekliyorum.", en: "I am waiting for the bus.", ar: "أنا أنتظر الحافلة.", uk: "Я чекаю на автобус." ,"es":"Estoy esperando el autobús.","fr":"J'attends le bus."}, { de: "Ich denke an dich.", ku: "بیرت دەکەمەوە.", tr: "Seni düşünüyorum.", en: "I am thinking of you.", ar: "أفكر فيك.", uk: "Я думаю про тебе." ,"es":"Estoy pensando en ti.","fr":"Je pense à toi."}, { de: "stolz auf etwas sein", ku: "شانازی بە شتێک کردن", tr: "bir şeyle gurur duymak", en: "to be proud of something", ar: "أن يكون فخوراً بشيء", uk: "пишатися чимось" ,"es":"para estar orgulloso de algo","fr":"être fier de quelque chose"}, { de: "Ich freue mich auf das Wochenende.", ku: "بە کۆتایی هەفتە دڵخۆشم.", tr: "Haftasonuna sevindim.", en: "I am looking forward to the weekend.", ar: "أتطلع إلى نهاية الأسبوع.", uk: "Я з нетерпінням чекаю вихідних." ,"es":"Estoy deseando el fin de semana.","fr":"J'attends avec impatience le week-end."}, { de: "Er interessiert sich für Politik.", ku: "ئارەزووی سیاسەت دەکات.", tr: "Siyasetle ilgileniyor.", en: "He is interested in politics.", ar: "إنه مهتم بالسياسة.", uk: "Він цікавиться політикою." ,"es":"Está interesado en la política.","fr":"Il s'intéresse à la politique."}, { de: "die Angst vor dem Versagen", ku: "ترس لە شکستهێنان", tr: "başarısızlık korkusu", en: "the fear of failure", ar: "الخوف من الفشل", uk: "страх перед невдачею" ,"es":"el miedo al fracaso","fr":"la peur de l'échec"} ] ,"es":"Verbos/adictivos/sustantivos con preposiciones fijas","expEs":"Muchos verbos, adjetivos y sustantivos tienen una preposición fija que debe memorizarse. Ejemplo: wasten auf (esperar), stolz auf (orgulloso de).","fr":"Verbes/adjectifs/nœuds avec prépositions fixes","expFr":"Beaucoup de verbes, adjectifs et noms ont une attitude fixe à apprendre. Exemple: Warten auf (attendez), stolz auf (orgueil d'oreille)."},
    { de: "Wortbildung: Präfixe & Suffixe", ku: "دروستکردنی وشە: پێشگر و پاشگر", icon: "✚",
      ...
      ex: [ { de: "glücklich → das Glück", ku: "بەختەوەر → بەختەوەری", tr: "mutlu → mutluluk", en: "happy → happiness", ar: "سعيد ← السعادة", uk: "щасливий → щастя" ,"es":"feliz → felicidad","fr":"bonheur → bonheur"}, { de: "frei → die Freiheit", ku: "ئازاد → ئازادی", tr: "özgür → özgürlük", en: "free → freedom", ar: "حر ← الحرية", uk: "вільний → свобода" ,"es":"libertad → libertad","fr":"libre → liberté"}, { de: "möglich → unmöglich", ku: "گونجاو → ناگونجاو", tr: "mümkün → imkânsız", en: "possible → impossible", ar: "ممكن ← مستحيل", uk: "можливий → неможливий" ,"es":"→ imposible","fr":"possible → impossible"}, { de: "arbeiten → die Arbeit", ku: "کارکردن → کار", tr: "çalışmak → iş", en: "to work → work", ar: "يعمل ← العمل", uk: "працювати → робота" ,"es":"trabajar → trabajar","fr":"pour travailler → travailler"}, { de: "krank → die Krankheit", ku: "نەخۆش → نەخۆشی", tr: "hasta → hastalık", en: "sick → illness", ar: "مريض ← المرض", uk: "хворий → хвороба" ,"es":"enfermedad → enfermedad","fr":"maladie → maladie"}, { de: "lesen → der Leser", ku: "خوێندنەوە → خوێنەر", tr: "okumak → okuyucu", en: "to read → reader", ar: "يقرأ ← القارئ", uk: "читати → читач" ,"es":"leer → lector","fr":"pour lire → lecteur"} ] ,"es":"Formación de palabras: prefijos y sufijos","expEs":"Las palabras nuevas se forman con prefijos (un-, ver-, ser-) y sufijos (-ung, -heit, -keit, -lich). Esto expande enormemente su vocabulario.","fr":"Formation de mots : préfixes & suffixes","expFr":"Les préceptes (un-, ver-, be-) et les sonnets (-ung, -heit, -kiit, -lich) sont produits avec de nouveaux mots. Cela élargit considérablement le vocabulaire."},
  ],
  C1: [
    { de: "Konjunktiv I (komplex)", ku: "کۆنیونکتیڤ I (ئاستبەرز)", icon: "❝",
      ...
      ex: [ { de: "Der Minister erklärte, er habe alles getan.", ku: "وەزیرەکە ڕووناکی کردەوە کە هەرشتێکی کردووە.", tr: "Bakan her şeyi yaptığını açıkladı.", en: "The minister explained that he had done everything.", ar: "أوضح الوزير أنه قام بكل شيء.", uk: "Міністр пояснив, що зробив усе." ,"es":"El ministro explicó que había hecho todo.","fr":"Le ministre a expliqué qu'il avait tout fait."}, { de: "Die Studie besagt, die Lage sei kritisch.", ku: "توێژینەوەکە دەڵێت دۆخەکە خەمئالودەیە.", tr: "Çalışma durumun kritik olduğunu söylüyor.", en: "The study states that the situation is critical.", ar: "تشير الدراسة إلى أن الوضع حرج.", uk: "Дослідження стверджує, що ситуація критична." ,"es":"El estudio afirma que la situación es crítica.","fr":"L'étude indique que la situation est critique."}, { de: "Laut Bericht sei die Entscheidung falsch gewesen.", ku: "بەپێی ڕاپۆڕتەکە بڕیارەکە هەڵە بووە.", tr: "Rapora göre karar yanlışmış.", en: "According to the report, the decision was said to have been wrong.", ar: "بحسب التقرير، يُقال إن القرار كان خاطئًا.", uk: "За повідомленням, рішення було нібито хибним." ,"es":"Según el informe, se dijo que la decisión era errónea.","fr":"Selon le rapport, la décision aurait été erronée."}, { de: "Er behauptete, er wisse nichts davon.", ku: "بانگەشەی کرد کە هیچی لێی نازانێت.", tr: "Hiçbir şey bilmediğini iddia etti.", en: "He claimed that he knew nothing about it.", ar: "زعم أنه لا يعرف شيئًا عن ذلك.", uk: "Він стверджував, що нічого про це не знає." ,"es":"Afirmó que no sabía nada al respecto.","fr":"Il a affirmé ne rien savoir."}, { de: "Die Firma teilte mit, sie werde expandieren.", ku: "کۆمپانیاکە ئاگادارکردەوە کە فراوان دەبێت.", tr: "Şirket büyüyeceğini duyurdu.", en: "The company announced that it would expand.", ar: "أعلنت الشركة أنها ستتوسع.", uk: "Компанія оголосила, що розширюватиметься." ,"es":"La compañía anunció que se expandiría.","fr":"La société a annoncé qu'elle allait s'étendre."}, { de: "Berichten zufolge seien mehrere Personen verletzt.", ku: "بەپێی ڕاپۆڕتەکان ژمارەیەک کەس برینداربوون.", tr: "Raporlara göre birkaç kişi yaralanmış.", en: "According to reports, several people were said to be injured.", ar: "وفقًا للتقارير، أُصيب عدة أشخاص.", uk: "За повідомленнями, кілька людей нібито поранені." ,"es":"Según los informes, varias personas resultaron heridas.","fr":"Selon des informations, plusieurs personnes auraient été blessées."} ] ,"es":"Subjuntivo I (complejo)","expEs":"Konjunktiv I es usado principalmente en periodismo para informar lo que otras personas han dicho. Cuando Konjunktiv I es idéntico en forma de Indikativ, Konjunktiv II toma su lugar en su lugar. Esta característica gramatical es extremadamente común en los medios alemanes.","fr":"Sous-jonctive I (complexe)","expFr":"Konjunktiv I est souvent utilisé pour transmettre les mots des autres dans le journalisme. Konjunktiv I I I I I I Je prends sa place quand il ressemble à Indikativ. Cette grammaire est très fréquente dans les médias allemands."},
    { de: "Kausale & konzessive Konnektoren (C1)", ku: "بەستەرەکانی هۆکاری و ڕێگری (C1)", icon: "↔",
      ...
      ex: [ { de: "Wenngleich es schwierig ist, werden wir weitermachen.", ku: "هەرچەندە سەختە، بەردەوام دەبین.", tr: "Her ne kadar zor olsa da devam edeceğiz.", en: "Although it is difficult, we will continue.", ar: "رغم أن الأمر صعب، سنواصل.", uk: "Хоча це важко, ми продовжимо." ,"es":"Aunque es difícil, continuaremos.","fr":"Bien que cela soit difficile, nous continuerons."}, { de: "Insofern das stimmt, müssen wir handeln.", ku: "لەو ڕووەوە کە ئەمە ڕاستە، دەبێت هەنگاو بنێین.", tr: "Bu doğru olduğu ölçüde harekete geçmemiz gerekir.", en: "Insofar as that is true, we must act.", ar: "بقدر ما يكون هذا صحيحًا، يجب أن نتصرف.", uk: "Остільки це правда, ми маємо діяти." ,"es":"En la medida en que eso es cierto, debemos actuar.","fr":"Dans la mesure où c'est vrai, nous devons agir."}, { de: "Zumal er krank ist, sollte er sich schonen.", ku: "بەتایبەت کە نەخۆشە، دەبێت خۆی بپارێزێت.", tr: "Özellikle hasta olduğu için dinlenmeli.", en: "Especially since he is sick, he should take it easy.", ar: "لا سيما أنه مريض، ينبغي أن يعتني بنفسه.", uk: "Тим паче що він хворий, йому слід поберегтися." ,"es":"Especialmente como está enfermo, debería tomárselo con calma.","fr":"Surtout qu'il est malade, il devrait se calmer."}, { de: "Er kann nicht fahren, geschweige denn fliegen.", ku: "ناتوانێت بمژێت، جا فڕین؟", tr: "Araba süremez, uçmak ise hiç.", en: "He can't drive, let alone fly.", ar: "لا يستطيع القيادة، ناهيك عن الطيران.", uk: "Він не вміє водити, не кажучи вже про те, щоб літати." ,"es":"No puede conducir, mucho menos volar.","fr":"Il ne peut pas conduire, encore moins voler."}, { de: "Sofern keine Einwände bestehen, beginnen wir.", ku: "ئەگەر دژایەتی نەبێت، دەست پێدەکەین.", tr: "İtiraz yoksa başlıyoruz.", en: "Provided there are no objections, we will begin.", ar: "بشرط ألا توجد اعتراضات، سنبدأ.", uk: "За умови, що не буде заперечень, ми почнемо." ,"es":"Siempre que no haya objeciones, empezaremos.","fr":"Pour autant qu'il n'y ait pas d'objections, nous commencerons."}, { de: "Ungeachtet der Kritik hielt er an seiner Meinung fest.", ku: "سەرەڕای ڕەخنەکان، لە بۆچوونەکەی مایەوە.", tr: "Eleştirilere rağmen görüşünde ısrar etti.", en: "Regardless of the criticism, he held onto his opinion.", ar: "بصرف النظر عن الانتقادات، تمسك برأيه.", uk: "Попри критику, він тримався своєї думки." ,"es":"Independientemente de las críticas, se mantuvo en su opinión.","fr":"Quelle que soit la critique, il a tenu à son opinion."} ] ,"es":"Conectores causales y concesivos (C1)","expEs":"En el nivel C1 hay conectores más concesivos: wenngleich (aunque), insofern (en la medida en que), sofern (siempre que), zumal (especialmente desde entonces), geschweige denn (por no hablar).","fr":"Connecteurs causaux et concessifs (C1)","expFr":"Il y a plus de liaisons anti-connectives à C1 : la wengleich (combien), insofern (cette taille), sofern (si), zoom (surtout), geschweige den (et ainsi de suite)."},
    { de: "Partizipialkonstruktionen", ku: "دروستکردنی هاوپەیوەند بە بەشداری", icon: "P",
      ...
      ex: [ { de: "Der auf dem Sofa schlafende Mann schnarcht.", ku: "پیاوەکەی کە لەسەر کەناپەکە خەوتووە خڕژاند دەکات.", tr: "Kanepede uyuyan adam horluyor.", en: "The man sleeping on the sofa is snoring.", ar: "الرجل النائم على الأريكة يشخر.", uk: "Чоловік, що спить на дивані, хропе." ,"es":"El hombre que duerme en el sofá está roncando.","fr":"L'homme qui dort sur le canapé ronfle."}, { de: "Das von ihr geschriebene Buch wurde ein Bestseller.", ku: "کتێبەکەی کە ئەوی نووسیوویەتی بەستسێلەر بوو.", tr: "Onun yazdığı kitap çok satanlar listesine girdi.", en: "The book written by her became a bestseller.", ar: "الكتاب الذي كتبته أصبح الأكثر مبيعًا.", uk: "Написана нею книга стала бестселером." ,"es":"El libro escrito por ella se convirtió en un bestseller.","fr":"Le livre qu'elle a écrit est devenu un best-seller."}, { de: "Die in der Zeitung erschienene Meldung war falsch.", ku: "هەواڵەکەی کە لە ڕۆژنامەدا چاپکراوە هەڵە بوو.", tr: "Gazetede çıkan haber yanlıştı.", en: "The report that appeared in the newspaper was wrong.", ar: "كان الخبر الذي نُشر في الصحيفة خاطئًا.", uk: "Повідомлення, що з'явилося в газеті, було хибним." ,"es":"El informe que apareció en el periódico estaba equivocado.","fr":"Le rapport qui parut dans le journal était faux."}, { de: "Die zubereiteten Speisen rochen gut.", ku: "خواردنەکانی ئامادەکراو بۆی خۆش دەدا.", tr: "Hazırlanan yemekler güzel kokuyordu.", en: "The prepared dishes smelled good.", ar: "كانت الأطباق المُعدّة رائحتها طيبة.", uk: "Приготовані страви приємно пахли." ,"es":"Los platos preparados olían bien.","fr":"Les plats préparés sentaient bon."}, { de: "Ein lächelndes Kind kam auf mich zu.", ku: "منداڵێکی پێکەنان لەبەرچاوم هات.", tr: "Gülen bir çocuk yanıma geldi.", en: "A smiling child came up to me.", ar: "اقترب مني طفل مبتسم.", uk: "До мене підійшла усміхнена дитина." ,"es":"Un niño sonriente se me acercó.","fr":"Un enfant souriant est venu me voir."}, { de: "Der verlorene Schlüssel war unter dem Tisch.", ku: "کلیلەکەی وەندراو لەژێر مێزەکەدا بوو.", tr: "Kaybolan anahtar masanın altındaydı.", en: "The lost key was under the table.", ar: "كان المفتاح المفقود تحت الطاولة.", uk: "Загублений ключ був під столом." ,"es":"La llave perdida estaba debajo de la mesa.","fr":"La clé perdue était sous la table."} ] ,"es":"Construcciones participativas","expEs":"En alemán, las cláusulas subordinadas pueden ser omitidas y reemplazadas por construcciones Partizip I o II. Esto aparece frecuentemente en la escritura formal y académica. Partizip I (verb stell + -d) se utiliza para acciones simultáneas, Partizip II para las completas.","fr":"Constructions participatives","expFr":"En allemand, la phrase est utilisée au lieu des phrases dépendantes Partizip I ou II. Ceci est souvent vu dans l'écriture officielle et académique. Partizip I (fiil + -d) est utilisé pour la co-action, Partizip II complété."},
    { de: "Erweiterte Infinitivkonstruktionen", ku: "دروستکردنی بێناو گەورەتر", icon: "∞",
      ...
      ex: [ { de: "Ich arbeite hart, um Erfolg zu haben.", ku: "زەحمەت دەکێشم بۆ ئەوەی سەرکەوتوو بمێنم.", tr: "Başarılı olmak için çok çalışıyorum.", en: "I work hard in order to be successful.", ar: "أعمل بجد لكي أنجح.", uk: "Я багато працюю, щоб бути успішним." ,"es":"Trabajo duro para tener éxito.","fr":"Je travaille dur pour réussir."}, { de: "Er ging, ohne sich zu verabschieden.", ku: "ڕۆیشت بەبێ ئەوەی خوداحافیزی بکات.", tr: "Veda etmeden gitti.", en: "He left without saying goodbye.", ar: "غادر من دون أن يودّع.", uk: "Він пішов, не попрощавшись." ,"es":"Se fue sin despedirse.","fr":"Il est parti sans dire au revoir."}, { de: "Statt zu lernen, spielte er.", ku: "لەبری ئەوەی فێربێت، یاری کرد.", tr: "Öğrenmek yerine oynadı.", en: "Instead of studying, he played.", ar: "بدلاً من أن يدرس، لعب.", uk: "Замість того щоб учитися, він грав." ,"es":"En vez de estudiar, jugó.","fr":"Au lieu d'étudier, il jouait."}, { de: "Du brauchst nicht zu warten.", ku: "پێویستت نییە چاوەڕوان بیت.", tr: "Beklemen gerekmiyor.", en: "You don't need to wait.", ar: "لست بحاجة إلى الانتظار.", uk: "Тобі не потрібно чекати." ,"es":"No tienes que esperar.","fr":"Tu n'as pas besoin d'attendre."}, { de: "Sie lernte Deutsch, um in Deutschland zu studieren.", ku: "ئەڵمانی فێربوو بۆ ئەوەی لە ئەڵمانیادا بخوێنێت.", tr: "Almanya'da okumak için Almanca öğrendi.", en: "She learned German in order to study in Germany.", ar: "تعلمت الألمانية لكي تدرس في ألمانيا.", uk: "Вона вивчила німецьку, щоб навчатися в Німеччині." ,"es":"Aprendió alemán para estudiar en Alemania.","fr":"Elle a appris l'allemand pour étudier en Allemagne."}, { de: "Er hörte auf zu rauchen, ohne zu kämpfen.", ku: "دوماندنی بەجێهێڵا بەبێ تەکاپۆ.", tr: "Mücadele etmeden içmeyi bıraktı.", en: "He stopped smoking without a struggle.", ar: "توقف عن التدخين من دون أن يكافح.", uk: "Він кинув палити без боротьби." ,"es":"Dejó de fumar sin luchar.","fr":"Il a arrêté de fumer sans se battre."} ] ,"es":"Construcciones infinitivas extendidas","expEs":"Con um...zu (para), ohne...zu (sin), statt/anstatt...zu (en lugar de), brauchen...zu (no es necesario).Estos sustituyen a las cláusulas subordinadas con construcciones más simples.","fr":"Constructions infinies étendues","expFr":"Um... zu, ohne...zu (à moins que), statt/antatt...zu (...), brouchen...zu (... tu n'as pas à le faire)."},
    { de: "Doppelter Infinitiv", ku: "دوو بێناوی تێکەڵ", icon: "∬",
      ...
      ex: [ { de: "Er hat kommen müssen.", ku: "پێویستی بووە بێت.", tr: "Gelmek zorundaydı.", en: "He had to come.", ar: "كان عليه أن يأتي.", uk: "Він мусив прийти." ,"es":"Tenía que venir.","fr":"Il devait venir."}, { de: "Sie hat es nicht sagen dürfen.", ku: "مۆڵەتی نەبووە بیڵێت.", tr: "Söylemesine izin yoktu.", en: "She was not allowed to say it.", ar: "لم يكن مسموحًا لها أن تقول ذلك.", uk: "Їй не дозволили цього сказати." ,"es":"No se le permitió decirlo.","fr":"Elle n'a pas été autorisée à le dire."}, { de: "Wir haben lange warten müssen.", ku: "پێویستمان بووە زۆر چاوەڕوان بین.", tr: "Uzun süre beklemek zorunda kaldık.", en: "We had to wait a long time.", ar: "كان علينا أن ننتظر طويلاً.", uk: "Нам довелося довго чекати." ,"es":"Tuvimos que esperar mucho tiempo.","fr":"On a dû attendre longtemps."}, { de: "Das hätte nicht passieren dürfen.", ku: "نەبایستی ڕوویدابایە.", tr: "Bu olmamalıydı.", en: "That should not have happened.", ar: "ما كان ينبغي لهذا أن يحدث.", uk: "Цього не мало б статися." ,"es":"Eso no debería haber sucedido.","fr":"Cela n'aurait pas dû arriver."}, { de: "Sie haben das Haus verlassen müssen.", ku: "پێویستیان بووە خانووەکە بەجێبهێڵن.", tr: "Evi terk etmek zorunda kaldılar.", en: "They had to leave the house.", ar: "كان عليهم أن يغادروا المنزل.", uk: "Їм довелося покинути будинок." ,"es":"Tuvieron que salir de la casa.","fr":"Ils ont dû quitter la maison."}, { de: "Ich werde es gemacht haben müssen.", ku: "پێویست دەبێت کردیبیت.", tr: "Yapmış olmak zorunda kalacağım.", en: "I will have had to have done it.", ar: "سيكون عليّ أن أكون قد فعلت ذلك.", uk: "Я, напевно, муситиму це зробити." ,"es":"Tendré que haberlo hecho.","fr":"J'aurais dû le faire."} ] ,"es":"Doble infinitivo","expEs":"Cuando se utiliza un verbo modal con el Perfekt o Futur II, dos infinitivos se colocan al final de la oración. Ejemplo: Er hat kommen müssen (Tenía que venir). Esto es gramática alemana avanzada, formal.","fr":"Double infinitif","expFr":"Utilisé avec un model Perfect ou Futur II, il est mis à la fin de deux phrases principales. Exemple: ligne privée kommen mussen (devrait venir) est avancé officiel allemand."},
    { de: "Nominalisierungsstil", ku: "شێوازی ناوکردن", icon: "N↑",
      ...
      ex: [ { de: "die Durchführung einer Analyse", ku: "ئەنجامدانی شیکاری (لەبری: شیکاری کردن)", tr: "bir analiz yapmak (yazmak yerine: analiz etmek)", en: "carrying out an analysis (instead of: to analyze)", ar: "إجراء تحليل (بدلاً من: أن يحلَّل)", uk: "проведення аналізу (замість: аналізувати)" ,"es":"realizar un análisis (en lugar de: analizar)","fr":"effectuer une analyse (au lieu de: analyser)"}, { de: "die Verbesserung der Situation", ku: "باشترکردنی دۆخەکە (لەبری: دۆخەکە باشتر کردن)", tr: "durumu iyileştirmek (durumu iyileştirmek yerine)", en: "the improvement of the situation (instead of: to improve the situation)", ar: "تحسين الوضع (بدلاً من: أن يُحسَّن الوضع)", uk: "поліпшення ситуації (замість: поліпшити ситуацію)" ,"es":"la mejora de la situación (en lugar de: mejorar la situación)","fr":"l'amélioration de la situation (au lieu de: améliorer la situation)"}, { de: "unter Berücksichtigung der Kosten", ku: "لەگەڵ ڕەچاوکردنی تێچووەکان", tr: "maliyetler göz önünde bulundurularak", en: "taking the costs into consideration", ar: "مع مراعاة التكاليف", uk: "з урахуванням витрат" ,"es":"teniendo en cuenta los costes","fr":"prise en compte des coûts"}, { de: "die Erreichung der Ziele", ku: "گەیشتن بە ئامانجەکان", tr: "hedeflere ulaşmak", en: "the achievement of the goals", ar: "تحقيق الأهداف", uk: "досягнення цілей" ,"es":"el logro de los objetivos","fr":"la réalisation des objectifs"}, { de: "zur Lösung des Problems beitragen", ku: "بەشداری کردن لە چارەسەرکردنی کێشەکە", tr: "sorunun çözümüne katkıda bulunmak", en: "to contribute to the solution of the problem", ar: "المساهمة في حل المشكلة", uk: "сприяти вирішенню проблеми" ,"es":"contribuir a la solución del problema","fr":"contribuer à la solution du problème"}, { de: "die Bearbeitung des Antrags", ku: "مامەڵەکردن لەگەڵ داواکاریەکە", tr: "başvuruyu işleme koymak", en: "the processing of the application", ar: "معالجة الطلب", uk: "опрацювання заяви" ,"es":"la tramitación de la solicitud","fr":"le traitement de la demande"} ] ,"es":"Estilo de designación","expEs":"En el mundo académico y empresarial, los verbos se convierten en sustantivos para hacer que las oraciones suenen más formales y complejas. Ejemplo: 'analysieren' se convierte en 'die Analyse durchführen' (para realizar un análisis), llamado Nominalisierungssstil (estilo de nominalización).","fr":"Style de nomination","expFr":"Dans les milieux académiques et les affaires, les verbes sont convertis en noms; la phrase est plus formelle et plus lourde. Exemple: ▪die Analse durchfuhhen."},
    { de: "Gehobene Schriftsprache", ku: "نووسینی فەرمی و ئاستبەرز", icon: "✦",
      ...
      ex: [ { de: "Angesichts der aktuellen Lage ist Vorsicht geboten.", ku: "بەرپێی دۆخی ئێستا، وریاکاری پێویستە.", tr: "Mevcut duruma bakıldığında dikkat gerekmektedir.", en: "In view of the current situation, caution is warranted.", ar: "نظرًا للوضع الراهن، يجب توخي الحذر.", uk: "З огляду на теперішню ситуацію, слід бути обережним." ,"es":"En vista de la situación actual, se debe actuar con cautela.","fr":"Compte tenu de la situation actuelle, il est nécessaire de faire preuve de prudence."}, { de: "Im Hinblick auf die Ergebnisse lässt sich sagen…", ku: "لە ڕووی ئەنجامەکانەوە دەتوانرێت بڵێین…", tr: "Sonuçlar açısından şunu söylenebilir…", en: "With regard to the results, it can be said that…", ar: "فيما يتعلق بالنتائج، يمكن القول إن…", uk: "Що стосується результатів, можна сказати, що…" ,"es":"Con respecto a los resultados, se puede decir que...","fr":"En ce qui concerne les résultats, on peut dire que..."}, { de: "Es ist darauf hinzuweisen, dass…", ku: "دەبێت سەرنج بدرێتە ئەوەی کە…", tr: "Şunu belirtmek gerekmektedir ki…", en: "It should be pointed out that…", ar: "تجدر الإشارة إلى أن…", uk: "Слід зазначити, що…" ,"es":"Hay que señalar que...","fr":"Il faut souligner que..."}, { de: "Gemäß den Vorschriften ist zu beachten…", ku: "بەپێی رێنماییەکان دەبێت ئامانج بدرێت…", tr: "Yönetmeliklere göre dikkat edilmesi gereken…", en: "In accordance with the regulations, it must be noted…", ar: "وفقًا للوائح، يجب مراعاة…", uk: "Згідно з приписами, треба зважати…" ,"es":"De acuerdo con las normas, hay que tener en cuenta...","fr":"Conformément aux règlements, il faut noter..."}, { de: "Infolgedessen wurde die Maßnahme ergriffen.", ku: "لە ئەنجامدا ئەم ڕێوشوێنە گرتە دەست.", tr: "Sonuç olarak bu önlem alındı.", en: "As a result, the measure was taken.", ar: "ونتيجة لذلك، تم اتخاذ هذا الإجراء.", uk: "Внаслідок цього було вжито заходу." ,"es":"Como resultado, se adoptó la medida.","fr":"La mesure a donc été prise."}, { de: "Unter Berücksichtigung aller Faktoren…", ku: "لە ڕووی هەموو هۆکارەکانەوە…", tr: "Tüm faktörler göz önünde bulundurulduğunda…", en: "Taking all factors into consideration…", ar: "مع مراعاة جميع العوامل…", uk: "З урахуванням усіх чинників…" ,"es":"Tomando en consideración todos los factores...","fr":"En tenant compte de tous les facteurs..."} ] ,"es":"Lenguaje escrito elevado","expEs":"En la escritura formal, los alemanes usan frases especiales: 'Es wurde festellt, dass...' (Se determinó que...), 'Angesichts der Tatsache, dass...' (En vista del hecho de que...), 'Im Hinblick auf...' (Con respecto a...).Estos son importantes en la academia y los negocios.","fr":"Langue écrite élevée","expFr":"Dans l'article officiel, les Allemands utilisent des formes spéciales:, Wurde festgestellt, dass..., Angesichts der Tatsache, dass..., ilm Hinblick auf.... celles-ci sont importantes dans la vie académique et commerciale."},
    { de: "Modalpartikeln", ku: "بەشداری هەستیار", icon: "~",
      ...
      ex: [ { de: "Komm doch mal vorbei!", ku: "تکایە ئەوبارە وەرە سەردانی بکە!", tr: "Bir ara uğra ya!", en: "Do come by sometime!", ar: "تعال لزيارتي في وقت ما!", uk: "Зайди ж якось!" ,"es":"¡Ven a verme alguna vez!","fr":"Venez un jour!"}, { de: "Das ist eigentlich ganz einfach.", ku: "ئەمە لە ڕاستیدا تەواو ئاسانە.", tr: "Bu aslında çok basit.", en: "That's actually quite simple.", ar: "هذا في الحقيقة بسيط جدًا.", uk: "Це, власне, доволі просто." ,"es":"Eso es bastante simple.","fr":"C'est assez simple."}, { de: "Er ist wohl krank.", ku: "بیم هەیە نەخۆشە.", tr: "Sanırım hasta.", en: "He's probably sick.", ar: "أظنه مريض.", uk: "Він, мабуть, хворий." ,"es":"Probablemente esté enfermo.","fr":"Il est probablement malade."}, { de: "Das ist eben so.", ku: "ئەوەیە دیکە، ئاوایە.", tr: "İşte böyle.", en: "That's just how it is.", ar: "هكذا هو الحال ببساطة.", uk: "Так уже воно є." ,"es":"Así es como es.","fr":"C'est comme ça."}, { de: "Das weißt du ja.", ku: "تۆیش دەزانیت باشە.", tr: "Biliyorsun zaten.", en: "You know that already, don't you.", ar: "أنت تعرف ذلك أصلاً.", uk: "Ти ж це вже знаєш." ,"es":"Ya lo sabes, ¿no?","fr":"Tu le sais déjà, n'est-ce pas?"}, { de: "Was machst du denn hier?", ku: "ئیتا تۆ لێرەدا چی دەکەیت؟", tr: "Peki sen burada ne yapıyorsun?", en: "So what are you doing here?", ar: "إذن ماذا تفعل هنا؟", uk: "Що ж ти тут робиш?" ,"es":"¿Qué haces aquí?","fr":"Alors que fais-tu ici?"} ] ,"es":"Partículas modales","expEs":"Las partículas modales son pequeñas palabras que transmiten el significado o la actitud del orador. Cambian el significado de una oración sin ser directamente traducibles. Estos incluyen: doch (después de todo/pero), mal (sólo/por una vez), eigentlich (en realidad), deten (simplemente), wohl (probablemente/supongo), eben (simplemente), ja (usted sabe/como usted sabe), denn (entonces/así, usado en preguntas).","fr":"Particules modales","expFr":"Les particules modales sont de petits mots qui transmettent le sens ou l'émotion de l'orateur. Ils changent le sens de la phrase sans traduction directe. Ce sont doch (ya), propriété (un fois), eientlich (en fait), merde (dans les affaires), wohl (je pense, émancipation), ja (vous savez), octivine (par exemple,"},
  ],
  C2: [
    { de: "Komplexe Satzgefüge", ku: "دروستکردنی ڕستەی پێچەواندار", icon: "🔗",
      ...
      ex: [ { de: "Da er sich vorbereitet hatte, gelang es, obwohl es schwierig war.", ku: "چونکە خۆی ئامادە کردبوو، سەرکەوتووی بوو هەرچەندە سەخت بوو.", tr: "Hazırlandığı için, zor da olsa başardı.", en: "Because he had prepared, he succeeded, even though it was difficult.", ar: "لأنه كان قد استعد، نجح رغم أن الأمر كان صعباً.", uk: "Оскільки він підготувався, йому вдалося, хоча це було важко." ,"es":"Porque se había preparado, lo logró, aunque era difícil.","fr":"Parce qu'il s'était préparé, il a réussi, même si c'était difficile."}, { de: "Nicht nur dass er zu spät kam, er hatte auch nichts mitgebracht.", ku: "نەتەنها دواخست، بەڵکو هیچیشی نەهاورد.", tr: "Sadece geç kalmakla kalmadı, bir şey de getirmedi.", en: "Not only did he arrive late, he also hadn't brought anything.", ar: "لم يتأخر فحسب، بل لم يُحضر معه شيئاً أيضاً.", uk: "Він не лише запізнився, а й нічого не приніс." ,"es":"No sólo llegó tarde, tampoco había traído nada.","fr":"Non seulement il est arrivé tard, mais il n'avait rien apporté."}, { de: "Je mehr man lernt, desto mehr erkennt man, wie viel man nicht weiß.", ku: "هەرچەند زیاتر فێربیت، زیاتر دەزانیت چەند نازانیت.", tr: "Ne kadar çok öğrenirsen, o kadar çok bilmediğini anlarsın.", en: "The more you learn, the more you realize how much you don't know.", ar: "كلما تعلّم المرء أكثر، أدرك أكثر كم هو لا يعرف.", uk: "Чим більше вчишся, тим більше усвідомлюєш, як багато не знаєш." ,"es":"Cuanto más aprendes, más te das cuenta de lo poco que sabes.","fr":"Plus on apprend, plus on réalise combien on ne sait pas."}, { de: "Wäre er pünktlich gewesen, hätte er den Zug nicht verpasst.", ku: "ئەگەر کاتی بووایە، ترینەکەی لەدەست نەدایە.", tr: "Vaktinde olsaydı, treni kaçırmazdı.", en: "Had he been on time, he would not have missed the train.", ar: "لو كان قد وصل في الوقت المحدد، لما فاته القطار.", uk: "Якби він був вчасно, він би не пропустив потяг." ,"es":"Si hubiera llegado a tiempo, no habría perdido el tren.","fr":"S'il était à l'heure, il n'aurait pas manqué le train."}, { de: "Kaum hatte er das Haus verlassen, fing es an zu regnen.", ku: "هێندە ئەوەی خانووەکەی بەجێهێڵا، باران دەستی کرد.", tr: "Evi terkeder terketmez yağmur başladı.", en: "Hardly had he left the house when it started to rain.", ar: "ما إن غادر المنزل حتى بدأ المطر بالهطول.", uk: "Щойно він вийшов з дому, як почався дощ." ,"es":"Apenas había salido de la casa cuando empezó a llover.","fr":"Il avait à peine quitté la maison quand il a commencé à pleuvoir."}, { de: "So wichtig das auch sein mag, es darf nicht alles bestimmen.", ku: "هەرچەند گرنگیش بێت، نابێت هەموو شت بخاتە بەژێر دەستی.", tr: "Bu önemli de olsa, her şeyi belirlememelidir.", en: "As important as that may be, it must not determine everything.", ar: "مهما كان ذلك مهماً، فلا يجوز أن يتحكم في كل شيء.", uk: "Хоч яким важливим це не було б, воно не повинно вирішувати все." ,"es":"Por importante que sea, no debe determinar todo.","fr":"Aussi important que cela puisse être, il ne doit pas tout déterminer."} ] ,"es":"Estructuras de frases complejas","expEs":"A nivel C2, se utilizan estructuras de oración complejas con múltiples niveles entrelazados de subordinación. Je mehr...desto mehr (más...más), Kaum...als (difícilmente...cuando), y Nicht nur...sondern auch (no sólo...sino también) están entre las construcciones más importantes.","fr":"Structures complexes des peines","expFr":"Au C2, on utilise plusieurs couches de phrases intersectées. Je mehr...desto mehr, Kaum...als, Nicht nur...sondern auch est l'une des structures les plus importantes."},
    { de: "Negationsstrukturen (C2)", ku: "دروستکردنی نەرێن (ئاستبەرز)", icon: "¬",
      ...
      ex: [ { de: "Weder er noch sie hat Recht.", ku: "نە ئەو نە ئەو تری ڕاستیان هەیە.", tr: "Ne o ne de o haklı.", en: "Neither he nor she is right.", ar: "لا هو على حق ولا هي.", uk: "Ні він, ні вона не мають рації." ,"es":"Ni él ni ella tienen razón.","fr":"Ni lui ni elle n'a raison."}, { de: "Das ist keineswegs akzeptabel.", ku: "بە هیچ شێوەیەک پەسەند نییە.", tr: "Bu hiçbir şekilde kabul edilemez.", en: "That is by no means acceptable.", ar: "هذا غير مقبول بأي حال من الأحوال.", uk: "Це аж ніяк не прийнятно." ,"es":"Eso no es aceptable en absoluto.","fr":"Cela n'est nullement acceptable."}, { de: "Nicht nur er, sondern auch sie war dabei.", ku: "نەتەنها ئەو، بەڵکو ئەو تریش تێیدا بوو.", tr: "Sadece o değil, o da oradaydı.", en: "Not only he but she too was present.", ar: "لم يكن هو فقط حاضراً، بل هي أيضاً.", uk: "Не лише він, а й вона була присутня." ,"es":"No sólo él, sino ella también estaba presente.","fr":"Non seulement lui, mais elle aussi était présente."}, { de: "Das stimmt mitnichten.", ku: "ئەمە بە هیچ جۆرێک ڕاست نییە.", tr: "Bu hiç doğru değil.", en: "That is not true in the least.", ar: "هذا غير صحيح إطلاقاً.", uk: "Це зовсім не так." ,"es":"Eso no es cierto en lo más mínimo.","fr":"Ce n'est pas le cas du moins."}, { de: "Bei weitem nicht genug.", ku: "بە دوورکەوتنی زۆر بەسنییە.", tr: "Yeterli değil, çok uzak.", en: "Far from enough.", ar: "غير كافٍ على الإطلاق.", uk: "Далеко не достатньо." ,"es":"Lejos de ser suficiente.","fr":"Loin de suffire."}, { de: "Keiner der Anwesenden sprach dagegen.", ku: "هیچکام لە ئامادەبووان دژی قسە نەکرد.", tr: "Oradakilerin hiçbiri itiraz etmedi.", en: "None of those present spoke against it.", ar: "لم يعترض أحد من الحاضرين.", uk: "Ніхто з присутніх не виступив проти." ,"es":"Ninguno de los presentes habló en contra.","fr":"Aucun des présents n'a exprimé son opposition."} ] ,"es":"Estructuras de negación (C2)","expEs":"En el nivel C2, la negación se expresa de maneras más especializadas: nicht nur...sondern auch (no sólo...sino también), weder...noch (ni...ni), kinewegs (de ninguna manera), mitnichten (no en absoluto), bei weitem nicht (lejos de).","fr":"Structures de négation (C2)","expFr":"Le négatif au niveau C2 est utilisé de manière plus spécifique: nicht nur...son auch, weder...noch, keineswegs, mitnichten, bei weitem nicht."},
    { de: "Register & Stilebenen", ku: "ئاستەکانی زمان و شێواز", icon: "≡",
      ...
      ex: [ { de: "Ich kriege keinen Hunger. (umgangssprachlich)", ku: "براشم نییە. (قسەی ڕۆژانە)", tr: "Açım. (günlük)", en: "I'm hungry. (colloquial)", ar: "أنا جوعان. (عامي)", uk: "Я голодний. (розмовно)" ,"es":"Tengo hambre.","fr":"J'ai faim."}, { de: "Ich habe keinen Appetit. (Standard)", ku: "خواست نییە بخۆم. (نڕمی)", tr: "Yemek yemek istemiyorum. (standart)", en: "I don't want to eat. (standard)", ar: "لا أريد أن آكل. (معياري)", uk: "Я не хочу їсти. (стандарт)" ,"es":"No quiero comer.","fr":"Je ne veux pas manger."}, { de: "Mir fehlt der Appetit. (gehoben)", ku: "خواستم نییە. (فەرمی)", tr: "İştahım yok. (resmi)", en: "I have no appetite. (formal)", ar: "لا شهية لي. (رسمي)", uk: "У мене немає апетиту. (формально)" ,"es":"No tengo apetito.","fr":"Je n'ai pas d'appétit."}, { de: "Was machst du? → Womit beschäftigen Sie sich?", ku: "چی دەکەیت؟ → بە چی بەرپرسی؟ (فەرمی)", tr: "Ne yapıyorsun? → Ne ile meşgulsünüz? (resmi)", en: "What are you doing? → What are you occupied with? (formal)", ar: "ماذا تفعل؟ ← بماذا تنشغلون؟ (رسمي)", uk: "Що ти робиш? → Чим Ви займаєтеся? (формально)" ,"es":"¿Qué estás haciendo? → ¿Con qué estás ocupado? (formal)","fr":"Que faites-vous? → Avec quoi êtes-vous occupé? (formel)"}, { de: "Klar! (umg.) → Selbstverständlich. (formell)", ku: "باشە! → بەتەواوی. (فەرمی)", tr: "Tabii! (günlük) → Elbette. (resmi)", en: "Sure! (colloquial) → Certainly. (formal)", ar: "أكيد! (عامي) ← بالتأكيد. (رسمي)", uk: "Звісно! (розмовно) → Безумовно. (формально)" ,"es":"¡Claro! (coloquial) → Ciertamente. (formal)","fr":"Bien sûr! (colloque) → Certainement. (formel)"}, { de: "Das geht nicht. → Das ist nicht möglich.", ku: "ئەمە نابێت. → ئەمە گونجاو نییە. (فەرمی)", tr: "Bu olmaz. → Bu mümkün değil. (resmi)", en: "That won't work. → That is not possible. (formal)", ar: "هذا لا يصلح. ← هذا غير ممكن. (رسمي)", uk: "Це не вийде. → Це неможливо. (формально)" ,"es":"Eso no funcionará. → Eso no es posible. (formal)","fr":"Cela ne marchera pas. → Ce n'est pas possible. (formel)"} ] ,"es":"Registrar niveles de & estilo","expEs":"El alemán tiene varios registros distintos: Umgangssprache (habla cotidiana coloquial), Standard (lenguaje estándar), gehobene Sprache (lenguaje formal elevado) y Amtssprache (lenguaje oficial/burocrático).Cada situación requiere un nivel diferente.","fr":"Enregistrer les niveaux & style","expFr":"Il existe différents niveaux de style allemand : Umgangssprache (parler pour le jour), Standard (standard), Geobene Sprache (niveau élevé officiel), Amtssprache (langue officielle). Chaque contexte nécessite un niveau différent."},
    { de: "Stilmittel", ku: "ئامرازەکانی شێواز", icon: "✍",
      ...
      ex: [ { de: "Das Leben ist ein Fluss. (Metapher)", ku: "ژیان ڕووبارێکە. (وێنەگرتن)", tr: "Hayat bir nehirdir. (Metafor)", en: "Life is a river. (metaphor)", ar: "الحياة نهر. (استعارة)", uk: "Життя — це річка. (метафора)" ,"es":"La vida es un río.","fr":"La vie est une rivière. (métaphor)"}, { de: "Ja, das war wirklich klug! (Ironie)", ku: "بەڵێ، ئەمە زۆر زیرەکانەیە! (پاقجی)", tr: "Evet, bu gerçekten akıllıca! (İroni)", en: "Yes, that was really clever! (irony)", ar: "نعم، كان ذلك ذكياً حقاً! (سخرية)", uk: "Так, це було справді розумно! (іронія)" ,"es":"¡Sí, eso fue muy inteligente!","fr":"Oui, c'était vraiment malin! (ironie)"}, { de: "arm und reich, jung und alt (Antithese)", ku: "هەژار و دەوڵەمەند، گەنج و پیر (دژایەتی)", tr: "fakir ve zengin, genç ve yaşlı (Antitez)", en: "poor and rich, young and old (antithesis)", ar: "فقير وغني، شاب وعجوز (طباق)", uk: "бідні й багаті, молоді й старі (антитеза)" ,"es":"pobres y ricos, jóvenes y mayores (antitesis)","fr":"pauvres et riches, jeunes et vieux (antithèse)"}, { de: "Ich kam, ich sah, ich siegte. (Anapher)", ku: "هاتم، بینم، برم. (دووبارەکردنەوە)", tr: "Geldim, gördüm, kazandım. (Anafora)", en: "I came, I saw, I conquered. (anaphora)", ar: "أتيت، رأيت، انتصرت. (تكرار استهلالي)", uk: "Я прийшов, я побачив, я переміг. (анафора)" ,"es":"Vine, vi, conquisté.","fr":"Je suis venu, j'ai vu, j'ai conquis."}, { de: "Das hab ich dir tausendmal gesagt! (Hyperbel)", ku: "هەزار جارت گوتووتمە! (زەیانی)", tr: "Bunu sana bin kez söyledim! (Abartma)", en: "I've told you that a thousand times! (hyperbole)", ar: "قلت لك هذا ألف مرة! (مبالغة)", uk: "Я казав тобі це тисячу разів! (гіпербола)" ,"es":"¡Te lo he dicho mil veces!","fr":"Je vous l'ai dit mille fois!"}, { de: "Das ist nicht schlecht. (Litotes = es ist gut)", ku: "ئەمە خراپ نییە. (واتا: باشە — Litotes)", tr: "Bu fena değil. (yani: iyi — Litotes)", en: "That's not bad. (litotes = it is good)", ar: "هذا ليس سيئاً. (أي: إنه جيد — تلطيف)", uk: "Це непогано. (літота = це добре)" ,"es":"Eso no está mal.","fr":"Ce n'est pas mal. (litotes = c'est bon)"} ] ,"es":"Dispositivos de estilismo","expEs":"Dispositivos literarios y retóricos: Metáfer (metafora), Ironía (irónica), Antítesis (antítesis), Anafera (anafora), Hiperbel (hiperbole), Litotes (subdeclaración por negación), Persifikation (personificación).","fr":"Dispositifs stylistiques","expFr":"Outils édébi et rhétorique: Métaphère (métafor), Ironie (ironi), Antithèse (antithèse), Anapher (anafora), Hyperbel (abartma), Litotes (positif par élimination), Personifiation (personnalisation)."},
    { de: "Kollokationen", ku: "کۆمەڵی وشەی جێگیر", icon: "⊕",
      ...
      ex: [ { de: "eine Entscheidung treffen", ku: "بڕیاردان (نەک: مەرج کردن)", tr: "karar vermek (yapmak değil)", en: "to make a decision (not: to do a decision)", ar: "اتخاذ قرار (وليس: صنع قرار)", uk: "ухвалити рішення (не: зробити рішення)" ,"es":"para tomar una decisión (no: para tomar una decisión)","fr":"de prendre une décision (pas: de prendre une décision)"}, { de: "eine Frage stellen", ku: "پرسیار کردن (نەک: دانان)", tr: "soru sormak (koymak değil)", en: "to ask a question (not: to put a question)", ar: "طرح سؤال (وليس: وضع سؤال)", uk: "поставити питання (не: покласти питання)" ,"es":"para hacer una pregunta (no: para hacer una pregunta)","fr":"poser une question (pas: poser une question)"}, { de: "Verantwortung übernehmen", ku: "بەرپرسیارێتی وەرگرتن", tr: "sorumluluk üstlenmek", en: "to take on responsibility", ar: "تحمّل المسؤولية", uk: "взяти на себе відповідальність" ,"es":"asumir la responsabilidad","fr":"assumer la responsabilité"}, { de: "einen Fehler begehen", ku: "هەڵەیەک کردن (فەرمی)", tr: "hata yapmak (resmi)", en: "to commit an error (formal)", ar: "ارتكاب خطأ (رسمي)", uk: "припуститися помилки (формально)" ,"es":"cometer un error (formal)","fr":"commettre une erreur (formelle)"}, { de: "in Betracht ziehen", ku: "بیر لێ کردنەوە / ڕەچاوکردن", tr: "göz önünde bulundurmak", en: "to take into consideration", ar: "أخذ بعين الاعتبار", uk: "взяти до уваги" ,"es":"a tener en cuenta","fr":"à prendre en considération"}, { de: "Rücksicht nehmen auf", ku: "ڕەچاو کردنی / گوێگرتن لە", tr: "saygı göstermek", en: "to show consideration for", ar: "مراعاة / إظهار الاحترام لـ", uk: "виявляти увагу до" ,"es":"para demostrar su consideración por","fr":"de présenter une considération pour"} ] ,"es":"Collocaciones","expEs":"Una collocación se refiere a palabras que naturalmente co-ocurren. Ejemplo: 'eine Entscheidung treffen' (para tomar una decisión), no 'eine Entscheidung machen'.","fr":"Collocations","expFr":"La collocation signifie utiliser des mots ensemble naturellement. Exemple: ▪eine Entscheidung treffen, pas, eine Entscheidung machen."},
    { de: "Redewendungen & Sprichwörter", ku: "دەستانووس و پەندوامۆڵ", icon: "💬",
      ...
      ex: [ { de: "Das ist nicht mein Bier.", ku: "ئەمە کارەکەم نییە.", tr: "Bu benim işim değil.", en: "That's not my business.", ar: "هذا ليس شأني.", uk: "Це не моя справа." ,"es":"Eso no es asunto mío.","fr":"Ce n'est pas mon problème."}, { de: "Lügen haben kurze Beine.", ku: "درۆ لەپێی خۆدا دەمێنێت.", tr: "Yalancının mumu yatsıya kadar yanar.", en: "Lies have short legs. (the truth always comes out)", ar: "للكذب أرجل قصيرة. (الحقيقة تظهر دائماً)", uk: "У брехні короткі ноги. (правда завжди виходить назовні)" ,"es":"Las mentiras tienen piernas cortas. (la verdad siempre sale)","fr":"Les mensonges ont des jambes courtes. (la vérité sort toujours)"}, { de: "Tomaten auf den Augen haben.", ku: "گومرا بوون / نەدیتن چییە پێشتا.", tr: "Görmemek / Gözü kapalı olmak.", en: "To have tomatoes on one's eyes. (to fail to notice the obvious)", ar: "أن يكون لديه طماطم على عينيه. (أي لا يلاحظ ما هو واضح)", uk: "Мати помідори на очах. (не помічати очевидного)" ,"es":"Tener tomates en los ojos. (no notar lo obvio)","fr":"Avoir des tomates sur les yeux. (pour ne pas remarquer l'évidence)"}, { de: "Den Nagel auf den Kopf treffen.", ku: "تێی گەیشتن / ڕاستی گوتن.", tr: "Tam yerine oturmak / Doğruyu söylemek.", en: "To hit the nail on the head.", ar: "أن يضرب المسمار على رأسه. (أي يصيب كبد الحقيقة)", uk: "Влучити цвяхом у голову. (влучити в саму суть)" ,"es":"Para golpear el clavo en la cabeza.","fr":"Pour frapper le clou sur la tête."}, { de: "Alles hat ein Ende, nur die Wurst hat zwei.", ku: "هەموو شتێک کۆتاییەکی هەیە.", tr: "Her şeyin bir sonu vardır.", en: "Everything has an end, only the sausage has two.", ar: "لكل شيء نهاية، أما السجق فله نهايتان.", uk: "Усе має кінець, лише ковбаса має два." ,"es":"Todo tiene un final, sólo la salchicha tiene dos.","fr":"Tout a une fin, seule la saucisse en a deux."}, { de: "Wer zuletzt lacht, lacht am besten.", ku: "ئەوەی دوایین دەپێکنێت باشترین پێکەنینی هەیە.", tr: "En son gülen en iyi güler.", en: "He who laughs last, laughs best.", ar: "من يضحك أخيراً يضحك أطول.", uk: "Хто сміється останнім, той сміється найкраще." ,"es":"El que ríe último, ríe mejor.","fr":"Celui qui rit le dernier, rit le mieux."} ] ,"es":"Idiomas y proverbios","expEs":"Los hablantes de alemán fluidos hacen un uso extenso de los idiomas Redewendungen y Sprichwörter (proverbios). Aprenderlos transmite una comprensión más profunda del contexto cultural.","fr":"Idiomes et proverbes","expFr":"Les locuteurs allemands utilisent couramment Redewendungen (redems) et Sprichwörter (ajustements)."},
    { de: "Dialekte & Varietäten", ku: "شێوەزارەکان و جۆرجۆری زمان", icon: "🗺",
      ...
      ex: [ { de: "Grüß Gott! (bayerisch) = Guten Tag!", ku: "سڵاوت لەگەڵ خودا! = ڕۆژباش! (بایەری)", tr: "Grüß Gott! (Bavyera) = Günaydın!", en: "Grüß Gott! (Bavarian) = Good day!", ar: "Grüß Gott! (بافارية) = طاب يومك!", uk: "Grüß Gott! (баварською) = Добрий день!" ,"es":"¡Gr","fr":"Grüß Gott! (Bavarien) = Bonne journée!"}, { de: "Servus! (österreichisch) = Hallo / Tschüss", ku: "سێروس! = سڵاو / خوداحافیز (ئەوستری)", tr: "Servus! (Avusturya) = Merhaba / Hoşça kal", en: "Servus! (Austrian) = Hello / Goodbye", ar: "Servus! (نمساوية) = مرحباً / وداعاً", uk: "Servus! (австрійською) = Привіт / Бувай" ,"es":"¡Servus! (Austriano) = Hola / Adiós","fr":"Servus! (Autriche) = Bonjour / Au revoir"}, { de: "Berlinerisch: ick statt ich", ku: "لە بەرلیندا: «ick» لەبری «ich»", tr: "Berlin'de: «ick» yerine «ich»", en: "Berlin dialect: 'ick' instead of 'ich'", ar: "في لهجة برلين: «ick» بدلاً من «ich»", uk: "Берлінський діалект: «ick» замість «ich»" ,"es":"dialecto berlinés: \"enfermo\" en lugar de \"ich\"","fr":"dialecte berlinois:'mal' au lieu de 'ich'"}, { de: "In der Schweiz: Grüezi! = Guten Tag", ku: "لە سویسرادا: «گرییتسی!» = ڕۆژباش", tr: "İsviçre'de: «Grüezi!» = Günaydın", en: "In Switzerland: 'Grüezi!' = Good day", ar: "في سويسرا: «Grüezi!» = طاب يومك", uk: "У Швейцарії: «Grüezi!» = Добрий день" ,"es":"En Suiza: 'Grüezi!' = Buenos días","fr":"En Suisse: 'Grüezi!' = Bonne journée"}, { de: "Net statt nicht (süddeutsch)", ku: "«نێت» لەبری «نیخت» (باشووری ئەڵمانیا)", tr: "«Net» yerine «nicht» (Güney Almanya)", en: "'Net' instead of 'nicht' (Southern Germany)", ar: "«Net» بدلاً من «nicht» (جنوب ألمانيا)", uk: "«Net» замість «nicht» (південнонімецькою)" ,"es":"«Net» en lugar de «nicht» (Alemania meridional)","fr":"«Net» au lieu de «nicht» (Allemagne du Sud)"}, { de: "Nix statt nichts (umgangssprachlich)", ku: "«نیکس» لەبری «نیختس» (قسەی ڕۆژانە)", tr: "«Nix» yerine «nichts» (günlük)", en: "'Nix' instead of 'nichts' (colloquial)", ar: "«Nix» بدلاً من «nichts» (عامية)", uk: "«Nix» замість «nichts» (розмовно)" ,"es":"'Nix' en lugar de 'nichts' (coloquial)","fr":"'Nix' au lieu de 'nichts' (colloque)"} ] ,"es":"Dialectos y variedades","expEs":"El alemán difiere en Alemania, Austria y Suiza. Bayerisch (Bavarian), Berlinerisch (Dialecto de Berlín), Wienerisch (Viennes), Schweizerdeutsch (Alemán suizo). Para C2 es bueno tener conocimiento de esto.","fr":"Dialectes et variétés","expFr":"C'est différent en Allemagne, en Autriche et en Suisse. C'est bon pour C2 de savoir à ce sujet."},
    { de: "Historisches Deutsch", ku: "زمانی ئەڵمانیی مێژووی", icon: "📜",
      ...
      ex: [ { de: "Habt Ihr das getan? (historisch formell)", ku: "ئایا ئێوە ئەمەی کردووە؟ (کۆن فەرمی)", tr: "Bunu yaptınız mı? (tarihsel resmi)", en: "Have you done that? (historical formal)", ar: "هل فعلتم ذلك؟ (تاريخي رسمي)", uk: "Ви це зробили? (історично формально)" ,"es":"¿Has hecho eso?","fr":"Vous avez fait ça?"}, { de: "Es ward Licht. (Bibeldeutsch)", ku: "ڕووناکی بوو. (زمانی کتێبی پیرۆز)", tr: "Işık olsun. (Kutsal Kitap Almancası)", en: "Let there be light. (Biblical German)", ar: "وليكن نور. (ألمانية الكتاب المقدس)", uk: "І стало світло. (біблійна німецька)" ,"es":"Que haya luz.","fr":"Qu'il y ait de la lumière."}, { de: "Ich bin's. (kontrahiert = ich bin es)", ku: "منم. (کورتکراو)", tr: "Benim. (kısaltılmış = ich bin es)", en: "It's me. (contracted = ich bin es)", ar: "هذا أنا. (مختصر = ich bin es)", uk: "Це я. (стягнено = ich bin es)" ,"es":"Soy yo.","fr":"C'est moi. (contrat = ich bin es)"}, { de: "Welch ein schöner Tag! (gehobene alte Form)", ku: "چەند ڕۆژێکی جوان! (کۆن فەرمی)", tr: "Ne güzel bir gün! (eski resmi)", en: "What a beautiful day! (elevated old form)", ar: "يا له من يوم جميل! (صيغة قديمة راقية)", uk: "Який гарний день! (піднесена стара форма)" ,"es":"¡Qué hermoso día! (elevada forma vieja)","fr":"Quelle belle journée! (ancienne forme élevée)"}, { de: "Das Wort «Weib» bedeutete früher «Frau».", ku: "وشەی «ڤایب» لەمێژوودا مانای «ژن» هەیدا.", tr: "«Weib» kelimesi eskiden «kadın» anlamına gelirdi.", en: "The word 'Weib' used to mean 'woman'.", ar: "كانت كلمة «Weib» تعني سابقاً «امرأة».", uk: "Слово «Weib» колись означало «жінка»." ,"es":"La palabra \"Weib\" solía significar \"mujer\".","fr":"Le mot \"Weib\" signifie \"femme\"."}, { de: "Man sprach damals anders.", ku: "لەو کاتەدا جیاوازتر قسە دەکران.", tr: "O zamanlar farklı konuşulurdu.", en: "People spoke differently back then.", ar: "كان الناس يتحدثون بشكل مختلف في ذلك الزمان.", uk: "Тоді говорили інакше." ,"es":"La gente hablaba de manera diferente en ese entonces.","fr":"Les gens parlaient différemment à l'époque."} ] ,"es":"Alemán histórico","expEs":"El alemán clásico (Goethe, Schiller) contiene varias diferencias fundamentales: Ihr en lugar de Sie, el uso más frecuente del präteritum, y las formas bíblicas.","fr":"Historique allemand","expFr":"L'allemand a changé dans l'histoire. Il contient quelques différences fondamentales dans l'allemand classique (Goethe, Schiller): au lieu de Sie, Ihr, plus Präteritum, formes bibliques."},
  ],
};
...
export const GTABLES = {
  ...
  "headersEs":["Género","Artículo","Ejemplo"],"rowsEs":[["Masculino","der","der Mann"],["Femenino","morir","die Frau"],["Neutro","das","das Kind"]],"headersFr":["Sexe","Artikel","Exemple"],"rowsFr":[["Éril","dit","der Mann"],["Féminine","mort","Die Frau"],["Neutre","das","C'est gentil."]]},
  ...
  "headersEs":["Género","Definido","Indefinido"],"rowsEs":[["Masculino","der","ein"],["Femenino","morir","eína"],["Neutro","das","ein"]],"headersFr":["Sexe","Certains","Indéterminé"],"rowsFr":[["Éril","dit","Dans"],["Féminine","mort","Eine"],["Neutre","das","Dans"]]},
  "Plural": {
  ...
  "headersEs":["Fin","Ejemplo"],"rowsEs":[["-e","der Tisch → die Tische"],["-er","das Kind → die Kinder"],["-(e)n","die Frau → die Frauen"],["-s","das Auto → die Autos"]],"headersFr":["Ajouter","Exemple"],"rowsFr":[["- E","der Tisch ▪ die Tisch"],["- Ils vont le faire.","Das Kind ▪ mourir Kinder"],["- (chant)","Die Frau ▪ die Frauen"],["-S","das Auto ve Autos"]]},
  "Personalpronomen": {
  ...
  "headersEs":["Alemán","página 2"],"rowsEs":[["ich","I"],["du","tú"],["er / sie / es","Él / ella / él"],["wir","nosotros"],["ihr","tú (pl.)"],["sie / Sie","ellos / usted (formal)"]],"headersFr":["Allemand","Turquie"],"rowsFr":[[",,,,,,,,","I"],["du","Toi"],["er / sie / es","Il est..."],["avec","Nous"],["Ihr","Toi"],["Sie / Sie","Ils / Vous (officiel)"]]},
  ...
  "headersEs":["Persona","lernen"],"rowsEs":[["ich","lerno"],["du","lernst"],["er/sie/es","lernt"],["wir","lernen"],["ihr","lernt"],["sie/Sie","lernen"]],"headersFr":["Personne à contacter","Lerène"],"rowsFr":[[",,,,,,,,","larne"],["du","Les"],["er/sie/sies","Lérnt"],["avec","Lerène"],["Ihr","Lérnt"],["Sie/Sie","Lerène"]]},
  ...
  "headersEs":["Persona","fahren","essen"],"rowsEs":[["ich","fahre","esse"],["du","fährst","isst"],["er/sie/es","fährt","isst"],["wir","fahren","essen"]],"headersFr":["Personne à contacter","Fahrenheit","égise"],"rowsFr":[[",,,,,,,,","FAHR",",E"],["du","Les",",est"],["er/sie/sies","Les",",est"],["avec","Fahrenheit","égise"]]},
  "sein und haben": {
  ...
  "headersEs":["Persona","sein","haben"],"rowsEs":[["ich","bin","hábé"],["du","bist","hast"],["er/sie/es","ist","sombrero"],["wir","sind","haben"],["ihr","seid","habt"],["sie/Sie","sind","haben"]],"headersFr":["Personne à contacter","senne","Habène"],"rowsFr":[[",,,,,,,,","Entrez.","habé"],["du","Bâton","hâtivement"],["er/sie/sies","Je veux","ligne"],["avec","péché","Habène"],["Ihr","seid","habt"],["Sie/Sie","péché","Habène"]]},
  "Modalverben": {
  ...
  "headersEs":["Verbo Modal","Significado"],"rowsEs":[["können","para poder"],["müssen","tener que hacerlo"],["wollen","a querer"],["dürfen","que se permita"],["sollen","que se supone que"],["möchten","me gustaría"]],"headersFr":["Kip Fili (Modale)","Signification"],"rowsFr":[["enduit","à faire"],["mussen","Doit"],["wollen","Je veux"],["S'il te plaît.","Prendre un jour de congé"],["gauche","besoin"],["möchten","Veux (en langage poli)"]]},
  "W-Fragen": {
  ...
  "headersEs":["Palabra de pregunta","Significado"],"rowsEs":[["wer","quién"],["era","¿Qué?"],["wo","donde"],["wann","cuando"],["wie","cómo"],["warum","¿Por qué?"]],"headersFr":["Mot de question","Signification"],"rowsFr":[["er","Qui"],["était","Quoi?"],["wo","Où est-il?"],["Wann","Quand"],["avec","Comment ça?"],["Warum","Pourquoi?"]]},
  "Ja/Nein-Fragen": {
  ...
  "headersEs":["1 (Verb)","2 (Asunto)","..."],"rowsEs":[["Kommst","du","¿Mit?"],["Hast","du","¿Zeit?"],["Ist","das","¿Richtig?"]],"headersFr":["1 (Fil)","2 (précédemment)","- Oui."],"rowsFr":[["Les","du","Mit?"],["Accroche-toi","du","Zeit?"],["Ist","das","Richtig?"]]},
  "Satzstellung": {
  ...
  "headersEs":["Posición 1","Posición 2 (Verb)","Resto"],"rowsEs":[["Ich","lerno","heute Deutsch"],["Heute","lerno","ich Deutsch"],["Morgen","gehe","ich nach Hause"]],"headersFr":["Fonction 1","Position 2 (fichier)","Reste"],"rowsFr":[["Ich","larne","Heu Deutsch"],["Heu","larne","ich Deutsch"],["Morgen","Gehe","ich nach Hause"]]},
  "Akkusativ": {
  ...
  "headersEs":["Género","Nominativ","Akkusativ"],"rowsEs":[["Masculino","der / ein","den/einen"],["Femenino","die / eine","die / eine"],["Neutro","das / ein","das / ein"],["Plural","morir","morir"]],"headersFr":["Sexe","Nominativ","Accusativ"],"rowsFr":[["Éril","der / ein","den / einen"],["Féminine","mort / être","mort / être"],["Neutre","DAS / EIN","DAS / EIN"],["Pluriel","mort","mort"]]},
  "Possessivartikel": {
  ...
  "headersEs":["Persona","Posesivo"],"rowsEs":[["ich","mein"],["du","dein"],["er","sein"],["sie","ihr"],["wir","unser"],["ihr","euer"]],"headersFr":["Personne à contacter","Autres"],"rowsFr":[[",,,,,,,,","- Oui."],["du","Dein"],["Er","senne"],["Sie","Ihr"],["avec","lors de l' arrêt"],["Ihr","Euer"]]},
  "Trennbare Verben": {
  ...
  "headersEs":["Verbo","Prefijo","En una frase"],"rowsEs":[["aufstehen","auf","ich stehe auf"],["einkaufen","ein","ich kaufe ein"],["ankommen","an","ich komme an"]],"headersFr":["Verbe","Avant Ek","Dans la phrase"],"rowsFr":[["Aufstehen","auf",",,,,,,,,,,,,,"],["einkaufène","Dans","ich kaufe ein"],["Ankommen","moment",",a"]]},
  "Negation: nicht / kein": {
  ...
  "headersEs":["Uso","Ejemplo"],"rowsEs":[["nicht (verbo/adictivo)","Ich verstehe nicht."],["kein (nombre indefinido)","Ich habe kein Geld."],["keina (femenina/plural)","Ich habe keine Zeit."]],"headersFr":["Utilisation","Exemple"],"rowsFr":[["nicht (fiil/syphate)","- C'est pas vrai."],["kényen (nom inconnu)","- Je suis un gorille."],["Céine (dent/la plus grande)","- Je suis un homme."]]},
  "Imperativ": {
  ...
  "headersEs":["Persona","Formulario"],"rowsEs":[["du","¡Komm!"],["ihr","¡Kommt!"],["Sie","¡Kommen Sie!"]],"headersFr":["Personne à contacter","Présentation"],"rowsFr":[["du","- C'est moi qui ai fait ça."],["Ihr","- C'est moi qui ai fait ça."],["Sie","Kommen Sie!"]]},
  ...
  "headersEs":["Preposición","Significado"],"rowsEs":[["en","interior"],["an","junto a / en"],["auf","el"],["um","hora (hora)"],["- Sí.","día (hora)"],["im","mes / temporada (hora)"]],"headersFr":["Édat","Signification"],"rowsFr":[["Dégage","à l'intérieur"],["moment","Suivant / ci-dessus"],["auf","le"],["- Oui.","temps (temps)"],["- Oui.","jour (heure)"],["Les","mois/saison (temps)"]]},
  "Dativ": {
  ...
  "headersEs":["Género","Nominativ","Dativ"],"rowsEs":[["Masculino","der","dem"],["Femenino","morir","der"],["Neutro","das","dem"],["Plural","morir","den (+n)"]],"headersFr":["Sexe","Nominativ","Dativ"],"rowsFr":[["Éril","dit","dem"],["Féminine","mort","dit"],["Neutre","das","dem"],["Pluriel","mort","de (+n)"]]},
  ...
  "headersEs":["Pregunta","Caso","Ejemplo"],"rowsEs":[["¿Wohin?","Akkusativ","en die Schule"],["(Localización)","Dativ","in der Schule"]],"headersFr":["Question","Manifestation (Statut consultatif spécial)","Exemple"],"rowsFr":[["- Quoi?","Accusativ","dans la mort de Schule"],["- C'est quoi, ça?","Dativ","dans le Schule"]]},
  "Perfekt": {
  ...
  "headersEs":["Verbo auxiliar","Ejemplo"],"rowsEs":[["haben","ich habe gemacht"],["sein (moción)","ich bin gegangen"]],"headersFr":["Fichier utile","Exemple"],"rowsFr":[["Habène","ich habe Gemacht"],["senne (action)","ich bin gegangen"]]},
  ...
  "headersEs":["Verbo","Präteritum"],"rowsEs":[["sein","guerra"],["haben","hatte"],["können","konnte"],["müssen","musste"],["wollen","wollte"]],"headersFr":["Verbe","Präteritum"],"rowsFr":[["senne","guerre"],["Habène","ligne"],["enduit","La Commission a décidé de ne pas modifier le règlement (CE) no 798/2008."],["mussen","doit être"],["wollen","à la loupe"]]},
  "Reflexive Verben": {
  ...
  "headersEs":["Persona","Pronombre reflexivo"],"rowsEs":[["ich","mich"],["du","dich"],["er/sie/es","sich"],["wir","uns"],["ihr","euch"],["sie/Sie","sich"]],"headersFr":["Personne à contacter","Zamir est revenu"],"rowsFr":[[",,,,,,,,","mich"],["du","Dich"],["er/sie/sies","Sich"],["avec","non"],["Ihr","ouch"],["Sie/Sie","Sich"]]},
  ...
  "headersEs":["Conjunción","Significado"],"rowsEs":[["und","y"],["oder","o"],["aber","pero"],["dens","porque/por"],["söndern","pero más bien"]],"headersFr":["Lier","Signification"],"rowsFr":[["et","Et"],["oder","ou"],["J'y suis.","Mais"],["de","Parce que"],["Fils","Au contraire."]]},
  "Nebensatz: weil, dass": {
  ...
  "headersEs":["Conjunción","Significado","Verbo"],"rowsEs":[["weil","porque","fin de la cláusula"],["dass","que","fin de la cláusula"]],"headersFr":["Lier","Signification","Verbe"],"rowsFr":[["Faible","Parce que","à la fin de la phrase"],["C'est vrai.","qui","à la fin de la phrase"]]},
  "Komparativ": {
  ...
  "headersEs":["Positiv","Komparativ"],"rowsEs":[["groß","grl"],["alt","älter"],["intestino","besser"],["viel","más"]],"headersFr":["Positiv","Comparaison"],"rowsFr":[["groß","Größer"],["inférieur","älter"],["goutte","cinq"],["Veau","- Oui."]]},
  "Superlativ": {
  ...
  "headersEs":["Positiv","Komparativ","Superlativ"],"rowsEs":[["groß","grl","am gr"],["intestino","besser","am besten"],["viel","más","am meisten"]],"headersFr":["Positiv","Comparaison","Superlativ"],"rowsFr":[["groß","Größer","Les"],["goutte","cinq","♪ J'écris ♪"],["Veau","- Oui.","Je suis méisten"]]},
  "Genitiv (Einführung)": {
  ...
  "headersEs":["Género","Genitiv"],"rowsEs":[["Masculino","des (+s)"],["Femenino","der"],["Neutro","des (+s)"],["Plural","der"]],"headersFr":["Sexe","Genitiv"],"rowsFr":[["Éril","des (+s)"],["Féminine","dit"],["Neutre","des (+s)"],["Pluriel","dit"]]},
  ...
  "headersEs":["Tipo","Ejemplo"],"rowsEs":[["Personal","um, hn, hm"],["Posesivo","meiner, deiner"],["Demostración","dierer, jener"]],"headersFr":["Type","Exemple"],"rowsFr":[["Personnel (personnel)","- Oui."],["Possiv (Iyssique)","meiner, deiner"],["Démonstration (signation)","Dieser, Jener"]]},
  "Relativsätze (basic)": {
  ...
  "headersEs":["Género","Pronombre relativo"],"rowsEs":[["Masculino","der"],["Femenino","morir"],["Neutro","das"],["Plural","morir"]],"headersFr":["Sexe","Soins Zamiri"],"rowsFr":[["Éril","dit"],["Féminine","mort"],["Neutre","das"],["Pluriel","mort"]]},
  "Plusquamperfekt": {
    headersUk: ["Допоміжне дієслово","Приклад"],
  ...
  "headersEs":["Verbo auxiliar","Ejemplo"],"rowsEs":[["Hatte + Partizip II","ich hatte gemacht"],["guerra + Partizip II (moción)","ich gegangen de guerra"]],"headersFr":["Fichier utile","Exemple"],"rowsFr":[["Ligne + Partizip II","ich hatte Gemacht"],["guerre + Partizip II (action)","ich war gegangen"]]},
  "Futur I": {
  ...
  "headersEs":["Persona","werden","+ Infinitiv"],"rowsEs":[["ich","werde","lernen"],["du","wirst","lernen"],["er/sie/es","wird","lernen"],["wir","werden","lernen"]],"headersFr":["Personne à contacter","Werden","+ Infinite"],"rowsFr":[[",,,,,,,,","Werde","Lerène"],["du","- Je suis pas là.","Lerène"],["er/sie/sies","avec","Lerène"],["avec","Werden","Lerène"]]},
  "Relativsätze (detail)": {
  ...
  "headersEs":["Caso","Masculino","Femenino","Neutro","Plural"],"rowsEs":[["Nom","der","morir","das","morir"],["Akk","den","morir","das","morir"],["Dativ","dem","der","dem","denen"],["Genitiv","dessen","deren","dessen","deren"]],"headersFr":["Manifestation (Statut consultatif spécial)","Éril","Féminine","Neutre","Pluriel"],"rowsFr":[["Nom","dit","mort","das","mort"],["Akk","de","mort","das","mort"],["Dativ","dem","dit","dem","appelé"],["Genitiv","dessen","min","dessen","min"]]},
  "Konjunktiv II": {
  ...
  "headersEs":["Formulario","Significado"],"rowsEs":[["würde + Infinitiv","para hipótesis/deseo"],["hätte","hubieran tenido"],["wäre","hubiera sido"],["könnte","podría/podría ser capaz de"]],"headersFr":["Format (formulaire)","Signification"],"rowsFr":[["würde + Infinite","pour hypothèse/pour"],["Les","s'il l'avait."],["wäre","si"],["Le taux de croissance est de 1 % en moyenne.","S'il le pouvait,"]]},
  ...
  "headersEs":["Aktiv","Passiv"],"rowsEs":[["Man baut das Haus.","Das Haus wird gebaut."],["El hombre miente en el Buch.","Das Buch wird gelesen."]],"headersFr":["Activiste","Passiv"],"rowsFr":[["L'homme Baut das Haus.","Das Haus est un gebaut."],["L'homme ment das Buch.","Das Buch a un coven."]]},
  "Infinitiv mit zu": {
  ...
  "headersEs":["Estructura","Ejemplo"],"rowsEs":[["Verbo + zu + Infinitiv","Ich versuche zu lernen."],["Es ist + Adj + zu + Inf","Es ist wichtig zu üben."]],"headersFr":["Bâtiment","Exemple"],"rowsFr":[["Verbe + zu + Infinite","Ich Versuche zu leren."],["Î ist + Adj + zu + Inf","- Oui, c'est ça."]]},
  ...
  "headersEs":["Estructura","Significado"],"rowsEs":[["um... zu","para"],["ohne... zu","sin hacer"],["statt... zu","en lugar de hacerlo"]],"headersFr":["Bâtiment","Signification"],"rowsFr":[["Euh... zu","- pour sortir d'ici."],["Ohne... zu","- Personne n'est autorisé."],["SAT... zu","- au lieu d'essayer."]]},
  "Adjektivdeklination": {
  ...
  "headersEs":["Después","Fin (No.","Ejemplo"],"rowsEs":[["der / die / das","-e","der rote Apfel"],["ein / eine","-er / -e / -es","ein roter Apfel"],["Sin artículo","-er / -e / -es","roter Wein"]],"headersFr":["Avant","Ek (Eril Nom)","Exemple"],"rowsFr":[["der / die / das","- E","der rote Apfel"],["Ein / Eine","-e / e / e","Pourriture de l'épissure"],["Plus d'utilisation","-e / e / e","pourriture"]]},
  "Genitiv": {
  ...
  "headersEs":["Género","Artículo relativo a la cuestión de la genética"],"rowsEs":[["Masculino","des (+s)"],["Femenino","der"],["Neutro","des (+s)"],["Plural","der"]],"headersFr":["Sexe","Genitiv Artikeli"],"rowsFr":[["Éril","des (+s)"],["Féminine","dit"],["Neutre","des (+s)"],["Pluriel","dit"]]},
  "Indirekte Fragen": {
  ...
  "headersEs":["Directo","Indirectas"],"rowsEs":[["¿Qué es esto?","¿Qué?"],["¿Kommt er? (sí/no)","Ich frage, ob er kommt."]],"headersFr":["Direct","Indirect"],"rowsFr":[["- C'est pas vrai?","Weißt du, wo er ist?"],["- Vous êtes là?","Ich frage, ober kommt."]]},
  ...
  "headersEs":["Conjunción","Significado"],"rowsEs":[["obwohl","aunque"],["wenn","si / cuando"],["als","cuando (pasado)"],["während","mientras"],["bevor","antes"],["nachdem","después"],["seitdem","Desde entonces"]],"headersFr":["Lier","Signification"],"rowsFr":[["- C'est pas vrai.","- Même si"],["Wenn","Si / -lorsque"],["Autres","- Quand vous aurez fini."],["Während","lorsque"],["amour","- avant que vous ne le fassiez"],["nachdem","- après ça."],["État","Depuis lors"]]},
  ...
  "headersEs":["Preposición","Significado"],"rowsEs":[["wegen","debido a"],["trotz","a pesar de"],["während","durante"],["statt","en lugar de"],["inrilhalb","dentro"],["außerhalb","fuera de"]],"headersFr":["Édat","Signification"],"rowsFr":[["Wegen","sur le visage"],["Troll","Même si"],["Während","Pendant"],["État","à la place"],["Innerhalb","à l'intérieur"],["Außerhalb","sauf"]]},
  "Passiv (alle Formen)": {
    headersUk: ["Час","Форма"],
  ...
  "headersEs":["Tenso","Formulario"],"rowsEs":[["Präsens","gema de wird"],["Präteritum","wurde gemacht"],["Perfekt","ist gemacht worden"],["Futur","wird gemacht werden"]],"headersFr":["Heure","Présentation"],"rowsFr":[["Präsens","avec Gemacht"],["Präteritum","Wurde Gemacht"],["Parfait","ist Gemacht worden"],["Futur","Gemacht Werden"]]},
  "Zustandspassiv": {
  ...
  "headersEs":["Vorgangspassiv (acción)","Zustandspassiv (estado)"],"rowsEs":[["wird geöffnet","ist geöffnet"],["wird geschlossen","ist geschlossen"]],"headersFr":["Vorgangspassiv (action)","Zustandspassiv (État)"],"rowsFr":[["Le geoffnet","Le geoffnet"],["et de la","ist geschlossen"]]},
  ...
  "headersEs":["Infinitiv","Konjunktiv I"],"rowsEs":[["sein","sei"],["haben","hábé"],["kommen","komme"],["werden","werde"]],"headersFr":["Infinite","Les données sont disponibles sur le site internet de l'Agence."],"rowsFr":[["senne","sï"],["Habène","habé"],["Commans","Comme"],["Werden","Werde"]]},
  ...
  "headersEs":["Tenso","Formulario"],"rowsEs":[["Presente","würde machen"],["Pasado","hätte gemacht"],["Pasado (moción)","wäre gegangen"]],"headersFr":["Heure","Présentation"],"rowsFr":[["Tout de suite","Würde machen"],["Historique","Hätte Gemacht"],["Historique (action)","Wäre gegangen"]]},
  "Nominalisierung": {
  ...
  "headersEs":["Verbo","Nombre"],"rowsEs":[["lernen","das Lernen"],["lesen","das Lesen"],["essen","das Essen"],["ankommen","die Ankunft"]],"headersFr":["Verbe","Dénomination"],"rowsFr":[["Lerène","das Lernen"],["ouvrés","Das Lesen"],["égise","Das Essen"],["Ankommen","Die Ankunft"]]},
  "Partizip I": {
  ...
  "headersEs":["Infinitiv","Partizip I"],"rowsEs":[["espielen","spielend"],["lachen","lachend"],["schlafen","schlafend"],["kommen","kommend"]],"headersFr":["Infinite","♪ C'est moi qui suis celui qui est celui qui est le"],"rowsFr":[["spielen","écaille"],["lachen","lachend"],["schlafen","schlafend"],["Commans","Félicitation"]]},
  ...
  "headersEs":["Verbo","Partizip II"],"rowsEs":[["öffnen","geöffnet"],["kochen","gekocht"],["schreiben","geschrieben"],["reparieren","repariert"]],"headersFr":["Verbe","Groupe II"],"rowsFr":[["ughnen","Geffnet"],["Kochen","Le système de contrôle de la qualité est utilisé pour les essais de conformité."],["schreiben","geschrieben"],["Reparieren","Suivant"]]},
  "Futur II": {
    headersUk: ["Структура","Приклад"],
  ...
  "headersEs":["Estructura","Ejemplo"],"rowsEs":[["werden + P II + haben","Ich werde es gemacht haben."],["werden + P II + sein (moción)","Er wird gegangen sein."]],"headersFr":["Bâtiment","Exemple"],"rowsFr":[["Werden + P II + haben","Ich wasde es Gemacht haben."],["Werden + P II + sein (action)","Un senneur privé."]]},
  ...
  "headersEs":["Tipo","Conjunción"],"rowsEs":[["Causal","weil, da"],["Consecutivo","sodas, así que... dass"],["Concesivo","obwohl, obgleich"]],"headersFr":["Type","Lier"],"rowsFr":[["Causal (Kausal)","Petit, da"],["Résultat (consective)","Soda, alors..."],["En face (Konzessiv)","- C'est pas vrai."]]},
  ...
  "headersEs":["Tipo","Ejemplo"],"rowsEs":[["Prefijo un-","möglich → unmöglich"],["Sufijo -ung","die Zeitung"],["Sufijo - heit","die Freiheit"],["Sufijo - Keit","die Möglichkeit"],["Sufijo -er","der Leser"]],"headersFr":["Type","Exemple"],"rowsFr":[["Farine de première rangée...","möglich ▪ unmöglich"],["Dernière aile -ung","Die Zeitung"],["Dernier supplément -heit","Die Freiheit"],["Dernière annonce - keit","Die Möglichkeit"],["Dernier ajout -er","der Leser"]]},
};
